...
func (c *jsiiProxy_ClouddeployAutomationRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ClouddeployAutomationRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
