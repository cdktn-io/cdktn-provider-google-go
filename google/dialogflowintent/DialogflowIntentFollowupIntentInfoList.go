...
func (j *jsiiProxy_DialogflowIntentFollowupIntentInfoList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDialogflowIntentFollowupIntentInfoList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DialogflowIntentFollowupIntentInfoList {
	_init_.Initialize()
...
func NewDialogflowIntentFollowupIntentInfoList_Override(d DialogflowIntentFollowupIntentInfoList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DialogflowIntentFollowupIntentInfoList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DialogflowIntentFollowupIntentInfoList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DialogflowIntentFollowupIntentInfoList) Resolve(context cdktn.IResolveContext) interface{} {
