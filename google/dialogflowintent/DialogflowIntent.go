...
func (j *jsiiProxy_DialogflowIntent) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DialogflowIntent) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DialogflowIntent) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_DialogflowIntent) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DialogflowIntent) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DialogflowIntent) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DialogflowIntent) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DialogflowIntent)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_DialogflowIntent)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DialogflowIntent)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DialogflowIntent)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DialogflowIntent_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DialogflowIntent) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DialogflowIntent) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DialogflowIntent) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DialogflowIntent) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DialogflowIntent) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DialogflowIntent) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		d,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (d *jsiiProxy_DialogflowIntent) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
