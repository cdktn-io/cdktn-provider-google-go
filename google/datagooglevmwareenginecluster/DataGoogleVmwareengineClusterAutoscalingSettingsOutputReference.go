...
func (j *jsiiProxy_DataGoogleVmwareengineClusterAutoscalingSettingsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleVmwareengineClusterAutoscalingSettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleVmwareengineClusterAutoscalingSettingsOutputReference {
	_init_.Initialize()
...
func NewDataGoogleVmwareengineClusterAutoscalingSettingsOutputReference_Override(d DataGoogleVmwareengineClusterAutoscalingSettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleVmwareengineClusterAutoscalingSettingsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleVmwareengineClusterAutoscalingSettingsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleVmwareengineClusterAutoscalingSettingsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGoogleVmwareengineClusterAutoscalingSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleVmwareengineClusterAutoscalingSettingsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
