...
func (j *jsiiProxy_RedisInstance) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_RedisInstance) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/redis_instance google_redis_instance} Resource.
...
func (j *jsiiProxy_RedisInstance)SetDeletionPolicy(val *string) {
...
func (r *jsiiProxy_RedisInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RedisInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RedisInstance) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		r,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (r *jsiiProxy_RedisInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
