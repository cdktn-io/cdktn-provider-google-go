...
func (j *jsiiProxy_RedisInstanceMaintenancePolicyWeeklyMaintenanceWindowList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRedisInstanceMaintenancePolicyWeeklyMaintenanceWindowList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RedisInstanceMaintenancePolicyWeeklyMaintenanceWindowList {
	_init_.Initialize()
...
func NewRedisInstanceMaintenancePolicyWeeklyMaintenanceWindowList_Override(r RedisInstanceMaintenancePolicyWeeklyMaintenanceWindowList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RedisInstanceMaintenancePolicyWeeklyMaintenanceWindowList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RedisInstanceMaintenancePolicyWeeklyMaintenanceWindowList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RedisInstanceMaintenancePolicyWeeklyMaintenanceWindowList) Resolve(context cdktn.IResolveContext) interface{} {
