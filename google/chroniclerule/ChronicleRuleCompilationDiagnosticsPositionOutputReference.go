...
func (c *jsiiProxy_ChronicleRuleCompilationDiagnosticsPositionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ChronicleRuleCompilationDiagnosticsPositionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
