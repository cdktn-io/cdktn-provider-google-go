...
func (j *jsiiProxy_ChronicleRuleCompilationDiagnosticsPositionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewChronicleRuleCompilationDiagnosticsPositionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ChronicleRuleCompilationDiagnosticsPositionOutputReference {
	_init_.Initialize()
...
func NewChronicleRuleCompilationDiagnosticsPositionOutputReference_Override(c ChronicleRuleCompilationDiagnosticsPositionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ChronicleRuleCompilationDiagnosticsPositionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ChronicleRuleCompilationDiagnosticsPositionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ChronicleRuleCompilationDiagnosticsPositionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ChronicleRuleCompilationDiagnosticsPositionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ChronicleRuleCompilationDiagnosticsPositionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
