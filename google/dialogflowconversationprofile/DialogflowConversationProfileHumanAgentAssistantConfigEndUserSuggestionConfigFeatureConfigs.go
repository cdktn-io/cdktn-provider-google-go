...
type DialogflowConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigs struct {
	...
	ConversationModelConfig *DialogflowConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigsConversationModelConfig `field:"optional" json:"conversationModelConfig" yaml:"conversationModelConfig"`
	...
	ConversationProcessConfig *DialogflowConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigsConversationProcessConfig `field:"optional" json:"conversationProcessConfig" yaml:"conversationProcessConfig"`
	...
	QueryConfig *DialogflowConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigsQueryConfig `field:"optional" json:"queryConfig" yaml:"queryConfig"`
	...
	SuggestionFeature *DialogflowConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigsSuggestionFeature `field:"optional" json:"suggestionFeature" yaml:"suggestionFeature"`
