...
type DialogflowConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigsQueryConfigDialogflowQuerySource struct {
	...
	HumanAgentSideConfig *DialogflowConversationProfileHumanAgentAssistantConfigEndUserSuggestionConfigFeatureConfigsQueryConfigDialogflowQuerySourceHumanAgentSideConfig `field:"optional" json:"humanAgentSideConfig" yaml:"humanAgentSideConfig"`
}
