...
func (d *jsiiProxy_DialogflowConversationProfileAutomatedAgentConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DialogflowConversationProfileAutomatedAgentConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
