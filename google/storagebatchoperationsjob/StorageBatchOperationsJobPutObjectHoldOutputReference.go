...
func (j *jsiiProxy_StorageBatchOperationsJobPutObjectHoldOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageBatchOperationsJobPutObjectHoldOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) StorageBatchOperationsJobPutObjectHoldOutputReference {
	_init_.Initialize()
...
func NewStorageBatchOperationsJobPutObjectHoldOutputReference_Override(s StorageBatchOperationsJobPutObjectHoldOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageBatchOperationsJobPutObjectHoldOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageBatchOperationsJobPutObjectHoldOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageBatchOperationsJobPutObjectHoldOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StorageBatchOperationsJobPutObjectHoldOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageBatchOperationsJobPutObjectHoldOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
