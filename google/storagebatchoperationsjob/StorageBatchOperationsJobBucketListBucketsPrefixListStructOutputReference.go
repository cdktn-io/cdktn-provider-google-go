...
func (s *jsiiProxy_StorageBatchOperationsJobBucketListBucketsPrefixListStructOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageBatchOperationsJobBucketListBucketsPrefixListStructOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
