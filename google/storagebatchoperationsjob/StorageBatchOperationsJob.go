...
func (j *jsiiProxy_StorageBatchOperationsJob) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_StorageBatchOperationsJob) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_StorageBatchOperationsJob) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_StorageBatchOperationsJob) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/storage_batch_operations_job google_storage_batch_operations_job} Resource.
...
func (j *jsiiProxy_StorageBatchOperationsJob)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_StorageBatchOperationsJob)SetDescription(val *string) {
...
func (s *jsiiProxy_StorageBatchOperationsJob) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageBatchOperationsJob) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StorageBatchOperationsJob) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		s,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (s *jsiiProxy_StorageBatchOperationsJob) ResetDescription() {
	_jsii_.InvokeVoid(
		s,
		"resetDescription",
		nil, // no parameters
...
func (s *jsiiProxy_StorageBatchOperationsJob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
