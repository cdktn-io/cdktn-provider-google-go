...
func (j *jsiiProxy_ComputeInterconnectAttachmentGroupAttachmentsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewComputeInterconnectAttachmentGroupAttachmentsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ComputeInterconnectAttachmentGroupAttachmentsList {
	_init_.Initialize()
...
func NewComputeInterconnectAttachmentGroupAttachmentsList_Override(c ComputeInterconnectAttachmentGroupAttachmentsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComputeInterconnectAttachmentGroupAttachmentsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (c *jsiiProxy_ComputeInterconnectAttachmentGroupAttachmentsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ComputeInterconnectAttachmentGroupAttachmentsList) Resolve(context cdktf.IResolveContext) interface{} {
