...
func (c *jsiiProxy_ComputeInstanceFromTemplateSchedulingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeInstanceFromTemplateSchedulingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
