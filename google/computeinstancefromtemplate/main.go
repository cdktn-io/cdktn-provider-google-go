...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.computeInstanceFromTemplate.ComputeInstanceFromTemplateWorkloadIdentityConfig",
		reflect.TypeOf((*ComputeInstanceFromTemplateWorkloadIdentityConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.computeInstanceFromTemplate.ComputeInstanceFromTemplateWorkloadIdentityConfigOutputReference",
		reflect.TypeOf((*ComputeInstanceFromTemplateWorkloadIdentityConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
