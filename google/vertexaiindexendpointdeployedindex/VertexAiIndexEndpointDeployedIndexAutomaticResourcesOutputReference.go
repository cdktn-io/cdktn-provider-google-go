...
func (v *jsiiProxy_VertexAiIndexEndpointDeployedIndexAutomaticResourcesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VertexAiIndexEndpointDeployedIndexAutomaticResourcesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
