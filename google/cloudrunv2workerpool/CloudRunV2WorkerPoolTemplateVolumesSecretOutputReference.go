...
func (c *jsiiProxy_CloudRunV2WorkerPoolTemplateVolumesSecretOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudRunV2WorkerPoolTemplateVolumesSecretOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
