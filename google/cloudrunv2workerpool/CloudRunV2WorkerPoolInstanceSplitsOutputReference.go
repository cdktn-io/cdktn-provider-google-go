...
func (c *jsiiProxy_CloudRunV2WorkerPoolInstanceSplitsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudRunV2WorkerPoolInstanceSplitsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
