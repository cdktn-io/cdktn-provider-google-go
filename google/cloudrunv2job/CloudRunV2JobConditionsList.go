...
func (j *jsiiProxy_CloudRunV2JobConditionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudRunV2JobConditionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudRunV2JobConditionsList {
	_init_.Initialize()
...
func NewCloudRunV2JobConditionsList_Override(c CloudRunV2JobConditionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudRunV2JobConditionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudRunV2JobConditionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudRunV2JobConditionsList) Resolve(context cdktn.IResolveContext) interface{} {
