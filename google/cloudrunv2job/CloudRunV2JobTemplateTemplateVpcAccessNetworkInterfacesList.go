...
func (j *jsiiProxy_CloudRunV2JobTemplateTemplateVpcAccessNetworkInterfacesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudRunV2JobTemplateTemplateVpcAccessNetworkInterfacesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudRunV2JobTemplateTemplateVpcAccessNetworkInterfacesList {
	_init_.Initialize()
...
func NewCloudRunV2JobTemplateTemplateVpcAccessNetworkInterfacesList_Override(c CloudRunV2JobTemplateTemplateVpcAccessNetworkInterfacesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudRunV2JobTemplateTemplateVpcAccessNetworkInterfacesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudRunV2JobTemplateTemplateVpcAccessNetworkInterfacesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudRunV2JobTemplateTemplateVpcAccessNetworkInterfacesList) Resolve(context cdktn.IResolveContext) interface{} {
