...
func (j *jsiiProxy_SqlDatabaseInstanceIpAddressList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSqlDatabaseInstanceIpAddressList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SqlDatabaseInstanceIpAddressList {
	_init_.Initialize()
...
func NewSqlDatabaseInstanceIpAddressList_Override(s SqlDatabaseInstanceIpAddressList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SqlDatabaseInstanceIpAddressList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SqlDatabaseInstanceIpAddressList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SqlDatabaseInstanceIpAddressList) Resolve(context cdktn.IResolveContext) interface{} {
