...
func (j *jsiiProxy_SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference) ConnectionPoolingEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference) ConnectionPoolingEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference) FlagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"flagsInput",
...
func (j *jsiiProxy_SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference {
	_init_.Initialize()
...
func NewSqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference_Override(s SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference)SetConnectionPoolingEnabled(val interface{}) {
...
func (j *jsiiProxy_SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (s *jsiiProxy_SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference) PutFlags(value interface{}) {
...
func (s *jsiiProxy_SqlDatabaseInstanceSettingsConnectionPoolConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
