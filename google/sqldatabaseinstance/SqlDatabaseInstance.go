...
func (j *jsiiProxy_SqlDatabaseInstance) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_SqlDatabaseInstance) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_SqlDatabaseInstance) EnforceNewSqlNetworkArchitecture() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SqlDatabaseInstance) EnforceNewSqlNetworkArchitectureInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SqlDatabaseInstance)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_SqlDatabaseInstance)SetEnforceNewSqlNetworkArchitecture(val interface{}) {
...
func (s *jsiiProxy_SqlDatabaseInstance) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		s,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (s *jsiiProxy_SqlDatabaseInstance) ResetEnforceNewSqlNetworkArchitecture() {
	_jsii_.InvokeVoid(
		s,
		"resetEnforceNewSqlNetworkArchitecture",
		nil, // no parameters
