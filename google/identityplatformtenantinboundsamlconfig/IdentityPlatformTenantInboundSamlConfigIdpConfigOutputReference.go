...
func (i *jsiiProxy_IdentityPlatformTenantInboundSamlConfigIdpConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IdentityPlatformTenantInboundSamlConfigIdpConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
