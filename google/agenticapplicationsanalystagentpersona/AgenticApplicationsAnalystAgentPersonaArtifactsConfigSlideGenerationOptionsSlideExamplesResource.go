...
type AgenticApplicationsAnalystAgentPersonaArtifactsConfigSlideGenerationOptionsSlideExamplesResource struct {
	...
	BigqueryResource *AgenticApplicationsAnalystAgentPersonaArtifactsConfigSlideGenerationOptionsSlideExamplesResourceBigqueryResource `field:"optional" json:"bigqueryResource" yaml:"bigqueryResource"`
	...
	F1Resource *AgenticApplicationsAnalystAgentPersonaArtifactsConfigSlideGenerationOptionsSlideExamplesResourceF1Resource `field:"optional" json:"f1Resource" yaml:"f1Resource"`
	...
	GoogleCloudStorageResource *AgenticApplicationsAnalystAgentPersonaArtifactsConfigSlideGenerationOptionsSlideExamplesResourceGoogleCloudStorageResource `field:"optional" json:"googleCloudStorageResource" yaml:"googleCloudStorageResource"`
	...
	GoogleDriveResource *AgenticApplicationsAnalystAgentPersonaArtifactsConfigSlideGenerationOptionsSlideExamplesResourceGoogleDriveResource `field:"optional" json:"googleDriveResource" yaml:"googleDriveResource"`
	...
	RawFileResource *AgenticApplicationsAnalystAgentPersonaArtifactsConfigSlideGenerationOptionsSlideExamplesResourceRawFileResource `field:"optional" json:"rawFileResource" yaml:"rawFileResource"`
