...
func (j *jsiiProxy_DataLossPreventionInspectTemplateInspectConfigRuleSetList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataLossPreventionInspectTemplateInspectConfigRuleSetList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataLossPreventionInspectTemplateInspectConfigRuleSetList {
	_init_.Initialize()
...
func NewDataLossPreventionInspectTemplateInspectConfigRuleSetList_Override(d DataLossPreventionInspectTemplateInspectConfigRuleSetList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataLossPreventionInspectTemplateInspectConfigRuleSetList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataLossPreventionInspectTemplateInspectConfigRuleSetList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataLossPreventionInspectTemplateInspectConfigRuleSetList) Resolve(context cdktn.IResolveContext) interface{} {
