...
func (d *jsiiProxy_DataLossPreventionInspectTemplateInspectConfigRuleSetInfoTypesList) validateResolveParameters(context cdktn.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_DataLossPreventionInspectTemplateInspectConfigRuleSetInfoTypesList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	return nil
}
...
func validateNewDataLossPreventionInspectTemplateInspectConfigRuleSetInfoTypesListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
