...
func (d *jsiiProxy_DataLossPreventionInspectTemplateInspectConfigRuleSetRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataLossPreventionInspectTemplateInspectConfigRuleSetRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
