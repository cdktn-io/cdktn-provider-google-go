...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/computetargethttpsproxy/internal"
...
func (j *jsiiProxy_ComputeTargetHttpsProxy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ComputeTargetHttpsProxy) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ComputeTargetHttpsProxy) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_ComputeTargetHttpsProxy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ComputeTargetHttpsProxy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ComputeTargetHttpsProxy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ComputeTargetHttpsProxy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/compute_target_https_proxy google_compute_target_https_proxy} Resource.
...
func (j *jsiiProxy_ComputeTargetHttpsProxy)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_ComputeTargetHttpsProxy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ComputeTargetHttpsProxy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ComputeTargetHttpsProxy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ComputeTargetHttpsProxy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ComputeTargetHttpsProxy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputeTargetHttpsProxy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ComputeTargetHttpsProxy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputeTargetHttpsProxy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputeTargetHttpsProxy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputeTargetHttpsProxy) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeTargetHttpsProxy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
