...
func (j *jsiiProxy_LustreInstance) CapacityGibInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"capacityGibInput",
...
func (j *jsiiProxy_LustreInstance) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LustreInstance) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_LustreInstance) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_LustreInstance) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_LustreInstance) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_LustreInstance) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_LustreInstance) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_LustreInstance) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_LustreInstance) Filesystem() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filesystem",
...
func (j *jsiiProxy_LustreInstance) FilesystemInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filesystemInput",
...
func (j *jsiiProxy_LustreInstance) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LustreInstance) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LustreInstance) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_LustreInstance) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_LustreInstance) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_LustreInstance) InstanceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceId",
...
func (j *jsiiProxy_LustreInstance) InstanceIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceIdInput",
...
func (j *jsiiProxy_LustreInstance) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_LustreInstance) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LustreInstance) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_LustreInstance) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_LustreInstance) MountPoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mountPoint",
...
func (j *jsiiProxy_LustreInstance) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_LustreInstance) Network() *string {
	var returns *string
	_jsii_.Get(
		j,
		"network",
...
func (j *jsiiProxy_LustreInstance) NetworkInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkInput",
...
func (j *jsiiProxy_LustreInstance) Node() constructs.Node {
...
func (j *jsiiProxy_LustreInstance) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_LustreInstance) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LustreInstance) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_LustreInstance) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_LustreInstance) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LustreInstance) Timeouts() LustreInstanceTimeoutsOutputReference {
	var returns LustreInstanceTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/lustre_instance google_lustre_instance} Resource.
func NewLustreInstance(scope constructs.Construct, id *string, config *LustreInstanceConfig) LustreInstance {
	_init_.Initialize()

	if err := validateNewLustreInstanceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_LustreInstance)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_LustreInstance)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LustreInstance)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LustreInstance)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LustreInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateLustreInstance_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func LustreInstance_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-google.lustreInstance.LustreInstance",
...
func (l *jsiiProxy_LustreInstance) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LustreInstance) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LustreInstance) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LustreInstance) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (l *jsiiProxy_LustreInstance) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (l *jsiiProxy_LustreInstance) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LustreInstance) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LustreInstance) GetStringAttribute(terraformAttribute *string) *string {
...
func (l *jsiiProxy_LustreInstance) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LustreInstance) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LustreInstance) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LustreInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LustreInstance) MoveFromId(id *string) {
...
func (l *jsiiProxy_LustreInstance) MoveToId(id *string) {
...
func (l *jsiiProxy_LustreInstance) OverrideLogicalId(newLogicalId *string) {
...
func (l *jsiiProxy_LustreInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LustreInstance) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		l,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (l *jsiiProxy_LustreInstance) ResetGkeSupportEnabled() {
	_jsii_.InvokeVoid(
		l,
		"resetGkeSupportEnabled",
		nil, // no parameters
...
func (l *jsiiProxy_LustreInstance) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
...
func (l *jsiiProxy_LustreInstance) ResetProject() {
	_jsii_.InvokeVoid(
		l,
		"resetProject",
		nil, // no parameters
...
func (l *jsiiProxy_LustreInstance) ResetTimeouts() {
	_jsii_.InvokeVoid(
		l,
		"resetTimeouts",
		nil, // no parameters
...
func (l *jsiiProxy_LustreInstance) ToString() *string {
	var returns *string
...
func (l *jsiiProxy_LustreInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
