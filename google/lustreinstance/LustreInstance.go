...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v16/lustreinstance/internal"
...
func (j *jsiiProxy_LustreInstance) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_LustreInstance) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_LustreInstance) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_LustreInstance) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LustreInstance) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_LustreInstance) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LustreInstance) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func LustreInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LustreInstance) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LustreInstance) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LustreInstance) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
