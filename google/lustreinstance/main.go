...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dynamicTierOptionsInput", GoGetter: "DynamicTierOptionsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putDynamicTierOptions", GoMethod: "PutDynamicTierOptions"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "maintenanceExclusionWindowInput", GoGetter: "MaintenanceExclusionWindowInput"},
			_jsii_.MemberMethod{JsiiMethod: "putMaintenanceExclusionWindow", GoMethod: "PutMaintenanceExclusionWindow"},
			_jsii_.MemberMethod{JsiiMethod: "putWeeklyMaintenanceWindows", GoMethod: "PutWeeklyMaintenanceWindows"},
			_jsii_.MemberMethod{JsiiMethod: "resetMaintenanceExclusionWindow", GoMethod: "ResetMaintenanceExclusionWindow"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
