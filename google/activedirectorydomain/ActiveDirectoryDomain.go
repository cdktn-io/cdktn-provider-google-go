...
func (j *jsiiProxy_ActiveDirectoryDomain) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ActiveDirectoryDomain) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_ActiveDirectoryDomain)SetDeletionPolicy(val *string) {
...
func (a *jsiiProxy_ActiveDirectoryDomain) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ActiveDirectoryDomain) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ActiveDirectoryDomain) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		a,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (a *jsiiProxy_ActiveDirectoryDomain) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
