...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/data-sources/project_organization_policy google_project_organization_policy} Data Source.
...
func (d *jsiiProxy_DataGoogleProjectOrganizationPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataGoogleProjectOrganizationPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
