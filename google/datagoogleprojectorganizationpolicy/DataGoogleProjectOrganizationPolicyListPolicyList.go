...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicyListPolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleProjectOrganizationPolicyListPolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleProjectOrganizationPolicyListPolicyList {
	_init_.Initialize()
...
func NewDataGoogleProjectOrganizationPolicyListPolicyList_Override(d DataGoogleProjectOrganizationPolicyListPolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicyListPolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleProjectOrganizationPolicyListPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleProjectOrganizationPolicyListPolicyList) Resolve(context cdktn.IResolveContext) interface{} {
