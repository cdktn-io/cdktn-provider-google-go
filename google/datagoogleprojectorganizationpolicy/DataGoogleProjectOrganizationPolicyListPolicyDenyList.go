...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicyListPolicyDenyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleProjectOrganizationPolicyListPolicyDenyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleProjectOrganizationPolicyListPolicyDenyList {
	_init_.Initialize()
...
func NewDataGoogleProjectOrganizationPolicyListPolicyDenyList_Override(d DataGoogleProjectOrganizationPolicyListPolicyDenyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicyListPolicyDenyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleProjectOrganizationPolicyListPolicyDenyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleProjectOrganizationPolicyListPolicyDenyList) Resolve(context cdktn.IResolveContext) interface{} {
