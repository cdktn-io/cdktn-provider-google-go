...
func (j *jsiiProxy_ServiceAccountKey) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServiceAccountKey) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ServiceAccountKey) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_ServiceAccountKey) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServiceAccountKey) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServiceAccountKey) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServiceAccountKey) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/service_account_key google_service_account_key} Resource.
func NewServiceAccountKey(scope constructs.Construct, id *string, config *ServiceAccountKeyConfig) ServiceAccountKey {
	...
	_jsii_.Create(
		"@cdktn/provider-google.serviceAccountKey.ServiceAccountKey",
...
func (j *jsiiProxy_ServiceAccountKey)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_ServiceAccountKey)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServiceAccountKey)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServiceAccountKey)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ServiceAccountKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServiceAccountKey) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceAccountKey) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServiceAccountKey) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceAccountKey) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServiceAccountKey) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServiceAccountKey) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		s,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (s *jsiiProxy_ServiceAccountKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
