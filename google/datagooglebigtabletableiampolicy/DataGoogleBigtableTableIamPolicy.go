...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v16/datagooglebigtabletableiampolicy/internal"
...
func NewDataGoogleBigtableTableIamPolicy(scope constructs.Construct, id *string, config *DataGoogleBigtableTableIamPolicyConfig) DataGoogleBigtableTableIamPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleBigtableTableIamPolicy.DataGoogleBigtableTableIamPolicy",
