...
func (j *jsiiProxy_DataCatalogEntryBigqueryTableSpecViewSpecList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCatalogEntryBigqueryTableSpecViewSpecList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCatalogEntryBigqueryTableSpecViewSpecList {
	_init_.Initialize()
...
func NewDataCatalogEntryBigqueryTableSpecViewSpecList_Override(d DataCatalogEntryBigqueryTableSpecViewSpecList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCatalogEntryBigqueryTableSpecViewSpecList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCatalogEntryBigqueryTableSpecViewSpecList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCatalogEntryBigqueryTableSpecViewSpecList) Resolve(context cdktn.IResolveContext) interface{} {
