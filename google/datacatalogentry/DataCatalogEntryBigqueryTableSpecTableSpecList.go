...
func (j *jsiiProxy_DataCatalogEntryBigqueryTableSpecTableSpecList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCatalogEntryBigqueryTableSpecTableSpecList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCatalogEntryBigqueryTableSpecTableSpecList {
	_init_.Initialize()
...
func NewDataCatalogEntryBigqueryTableSpecTableSpecList_Override(d DataCatalogEntryBigqueryTableSpecTableSpecList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCatalogEntryBigqueryTableSpecTableSpecList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCatalogEntryBigqueryTableSpecTableSpecList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCatalogEntryBigqueryTableSpecTableSpecList) Resolve(context cdktn.IResolveContext) interface{} {
