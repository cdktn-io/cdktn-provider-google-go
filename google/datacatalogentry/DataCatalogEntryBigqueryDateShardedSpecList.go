...
func (j *jsiiProxy_DataCatalogEntryBigqueryDateShardedSpecList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCatalogEntryBigqueryDateShardedSpecList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCatalogEntryBigqueryDateShardedSpecList {
	_init_.Initialize()
...
func NewDataCatalogEntryBigqueryDateShardedSpecList_Override(d DataCatalogEntryBigqueryDateShardedSpecList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCatalogEntryBigqueryDateShardedSpecList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCatalogEntryBigqueryDateShardedSpecList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCatalogEntryBigqueryDateShardedSpecList) Resolve(context cdktn.IResolveContext) interface{} {
