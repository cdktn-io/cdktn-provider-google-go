...
type ColabNotebookExecutionConfig struct {
	...
	CustomEnvironmentSpec *ColabNotebookExecutionCustomEnvironmentSpec `field:"optional" json:"customEnvironmentSpec" yaml:"customEnvironmentSpec"`
	...
	WorkbenchRuntime *ColabNotebookExecutionWorkbenchRuntime `field:"optional" json:"workbenchRuntime" yaml:"workbenchRuntime"`
}
