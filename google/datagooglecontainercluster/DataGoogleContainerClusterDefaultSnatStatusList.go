...
func (j *jsiiProxy_DataGoogleContainerClusterDefaultSnatStatusList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleContainerClusterDefaultSnatStatusList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleContainerClusterDefaultSnatStatusList {
	_init_.Initialize()
...
func NewDataGoogleContainerClusterDefaultSnatStatusList_Override(d DataGoogleContainerClusterDefaultSnatStatusList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleContainerClusterDefaultSnatStatusList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleContainerClusterDefaultSnatStatusList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleContainerClusterDefaultSnatStatusList) Resolve(context cdktn.IResolveContext) interface{} {
