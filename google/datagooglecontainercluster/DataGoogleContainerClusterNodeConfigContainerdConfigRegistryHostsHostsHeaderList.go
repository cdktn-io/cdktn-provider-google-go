...
func (j *jsiiProxy_DataGoogleContainerClusterNodeConfigContainerdConfigRegistryHostsHostsHeaderList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleContainerClusterNodeConfigContainerdConfigRegistryHostsHostsHeaderList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleContainerClusterNodeConfigContainerdConfigRegistryHostsHostsHeaderList {
	_init_.Initialize()
...
func NewDataGoogleContainerClusterNodeConfigContainerdConfigRegistryHostsHostsHeaderList_Override(d DataGoogleContainerClusterNodeConfigContainerdConfigRegistryHostsHostsHeaderList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleContainerClusterNodeConfigContainerdConfigRegistryHostsHostsHeaderList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleContainerClusterNodeConfigContainerdConfigRegistryHostsHostsHeaderList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleContainerClusterNodeConfigContainerdConfigRegistryHostsHostsHeaderList) Resolve(context cdktn.IResolveContext) interface{} {
