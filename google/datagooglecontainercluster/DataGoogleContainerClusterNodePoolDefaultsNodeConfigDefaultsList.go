...
func (j *jsiiProxy_DataGoogleContainerClusterNodePoolDefaultsNodeConfigDefaultsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleContainerClusterNodePoolDefaultsNodeConfigDefaultsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleContainerClusterNodePoolDefaultsNodeConfigDefaultsList {
	_init_.Initialize()
...
func NewDataGoogleContainerClusterNodePoolDefaultsNodeConfigDefaultsList_Override(d DataGoogleContainerClusterNodePoolDefaultsNodeConfigDefaultsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleContainerClusterNodePoolDefaultsNodeConfigDefaultsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleContainerClusterNodePoolDefaultsNodeConfigDefaultsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleContainerClusterNodePoolDefaultsNodeConfigDefaultsList) Resolve(context cdktn.IResolveContext) interface{} {
