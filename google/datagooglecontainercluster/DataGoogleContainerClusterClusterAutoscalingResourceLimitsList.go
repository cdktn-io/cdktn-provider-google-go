...
func (j *jsiiProxy_DataGoogleContainerClusterClusterAutoscalingResourceLimitsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleContainerClusterClusterAutoscalingResourceLimitsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleContainerClusterClusterAutoscalingResourceLimitsList {
	_init_.Initialize()
...
func NewDataGoogleContainerClusterClusterAutoscalingResourceLimitsList_Override(d DataGoogleContainerClusterClusterAutoscalingResourceLimitsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleContainerClusterClusterAutoscalingResourceLimitsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleContainerClusterClusterAutoscalingResourceLimitsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleContainerClusterClusterAutoscalingResourceLimitsList) Resolve(context cdktn.IResolveContext) interface{} {
