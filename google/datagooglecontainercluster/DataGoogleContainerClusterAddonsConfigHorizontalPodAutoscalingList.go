...
func (j *jsiiProxy_DataGoogleContainerClusterAddonsConfigHorizontalPodAutoscalingList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleContainerClusterAddonsConfigHorizontalPodAutoscalingList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleContainerClusterAddonsConfigHorizontalPodAutoscalingList {
	_init_.Initialize()
...
func NewDataGoogleContainerClusterAddonsConfigHorizontalPodAutoscalingList_Override(d DataGoogleContainerClusterAddonsConfigHorizontalPodAutoscalingList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleContainerClusterAddonsConfigHorizontalPodAutoscalingList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleContainerClusterAddonsConfigHorizontalPodAutoscalingList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleContainerClusterAddonsConfigHorizontalPodAutoscalingList) Resolve(context cdktn.IResolveContext) interface{} {
