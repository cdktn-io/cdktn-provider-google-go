...
func (j *jsiiProxy_DataGoogleContainerClusterNodeConfigContainerdConfigRegistryHostsHostsClientCertList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleContainerClusterNodeConfigContainerdConfigRegistryHostsHostsClientCertList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleContainerClusterNodeConfigContainerdConfigRegistryHostsHostsClientCertList {
	_init_.Initialize()
...
func NewDataGoogleContainerClusterNodeConfigContainerdConfigRegistryHostsHostsClientCertList_Override(d DataGoogleContainerClusterNodeConfigContainerdConfigRegistryHostsHostsClientCertList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleContainerClusterNodeConfigContainerdConfigRegistryHostsHostsClientCertList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleContainerClusterNodeConfigContainerdConfigRegistryHostsHostsClientCertList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleContainerClusterNodeConfigContainerdConfigRegistryHostsHostsClientCertList) Resolve(context cdktn.IResolveContext) interface{} {
