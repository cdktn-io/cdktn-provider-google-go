...
func (j *jsiiProxy_DataGoogleContainerClusterAddonsConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleContainerClusterAddonsConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleContainerClusterAddonsConfigOutputReference {
	_init_.Initialize()
...
func NewDataGoogleContainerClusterAddonsConfigOutputReference_Override(d DataGoogleContainerClusterAddonsConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleContainerClusterAddonsConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleContainerClusterAddonsConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleContainerClusterAddonsConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGoogleContainerClusterAddonsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleContainerClusterAddonsConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
