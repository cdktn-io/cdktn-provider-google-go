...
func (j *jsiiProxy_DataGoogleContainerClusterResourceUsageExportConfigBigqueryDestinationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleContainerClusterResourceUsageExportConfigBigqueryDestinationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleContainerClusterResourceUsageExportConfigBigqueryDestinationList {
	_init_.Initialize()
...
func NewDataGoogleContainerClusterResourceUsageExportConfigBigqueryDestinationList_Override(d DataGoogleContainerClusterResourceUsageExportConfigBigqueryDestinationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleContainerClusterResourceUsageExportConfigBigqueryDestinationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleContainerClusterResourceUsageExportConfigBigqueryDestinationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleContainerClusterResourceUsageExportConfigBigqueryDestinationList) Resolve(context cdktn.IResolveContext) interface{} {
