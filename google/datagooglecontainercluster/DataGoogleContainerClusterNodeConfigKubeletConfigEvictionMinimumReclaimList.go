...
func (j *jsiiProxy_DataGoogleContainerClusterNodeConfigKubeletConfigEvictionMinimumReclaimList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleContainerClusterNodeConfigKubeletConfigEvictionMinimumReclaimList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleContainerClusterNodeConfigKubeletConfigEvictionMinimumReclaimList {
	_init_.Initialize()
...
func NewDataGoogleContainerClusterNodeConfigKubeletConfigEvictionMinimumReclaimList_Override(d DataGoogleContainerClusterNodeConfigKubeletConfigEvictionMinimumReclaimList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleContainerClusterNodeConfigKubeletConfigEvictionMinimumReclaimList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleContainerClusterNodeConfigKubeletConfigEvictionMinimumReclaimList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleContainerClusterNodeConfigKubeletConfigEvictionMinimumReclaimList) Resolve(context cdktn.IResolveContext) interface{} {
