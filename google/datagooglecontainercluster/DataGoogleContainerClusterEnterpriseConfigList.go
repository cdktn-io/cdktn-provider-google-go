...
func (j *jsiiProxy_DataGoogleContainerClusterEnterpriseConfigList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleContainerClusterEnterpriseConfigList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataGoogleContainerClusterEnterpriseConfigList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_DataGoogleContainerClusterEnterpriseConfigList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DataGoogleContainerClusterEnterpriseConfigList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DataGoogleContainerClusterEnterpriseConfigList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataGoogleContainerClusterEnterpriseConfigList) Get(index *float64) DataGoogleContainerClusterEnterpriseConfigOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DataGoogleContainerClusterEnterpriseConfigOutputReference
...
func (d *jsiiProxy_DataGoogleContainerClusterEnterpriseConfigList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DataGoogleContainerClusterEnterpriseConfigList) ToString() *string {
	var returns *string
