...
func (j *jsiiProxy_DataGoogleContainerClusterAddonsConfigRayOperatorConfigRayClusterLoggingConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleContainerClusterAddonsConfigRayOperatorConfigRayClusterLoggingConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleContainerClusterAddonsConfigRayOperatorConfigRayClusterLoggingConfigList {
	_init_.Initialize()
...
func NewDataGoogleContainerClusterAddonsConfigRayOperatorConfigRayClusterLoggingConfigList_Override(d DataGoogleContainerClusterAddonsConfigRayOperatorConfigRayClusterLoggingConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleContainerClusterAddonsConfigRayOperatorConfigRayClusterLoggingConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleContainerClusterAddonsConfigRayOperatorConfigRayClusterLoggingConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleContainerClusterAddonsConfigRayOperatorConfigRayClusterLoggingConfigList) Resolve(context cdktn.IResolveContext) interface{} {
