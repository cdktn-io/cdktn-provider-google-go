...
func (j *jsiiProxy_DataGoogleContainerClusterAddonsConfigConfigConnectorConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleContainerClusterAddonsConfigConfigConnectorConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleContainerClusterAddonsConfigConfigConnectorConfigList {
	_init_.Initialize()
...
func NewDataGoogleContainerClusterAddonsConfigConfigConnectorConfigList_Override(d DataGoogleContainerClusterAddonsConfigConfigConnectorConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleContainerClusterAddonsConfigConfigConnectorConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleContainerClusterAddonsConfigConfigConnectorConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleContainerClusterAddonsConfigConfigConnectorConfigList) Resolve(context cdktn.IResolveContext) interface{} {
