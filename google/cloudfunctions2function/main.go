...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "directVpcEgressInput", GoGetter: "DirectVpcEgressInput"},
			_jsii_.MemberProperty{JsiiProperty: "directVpcNetworkInterface", GoGetter: "DirectVpcNetworkInterface"},
			_jsii_.MemberProperty{JsiiProperty: "directVpcNetworkInterfaceInput", GoGetter: "DirectVpcNetworkInterfaceInput"},
			_jsii_.MemberProperty{JsiiProperty: "environmentVariables", GoGetter: "EnvironmentVariables"},
			_jsii_.MemberProperty{JsiiProperty: "environmentVariablesInput", GoGetter: "EnvironmentVariablesInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putDirectVpcNetworkInterface", GoMethod: "PutDirectVpcNetworkInterface"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDirectVpcEgress", GoMethod: "ResetDirectVpcEgress"},
			_jsii_.MemberMethod{JsiiMethod: "resetDirectVpcNetworkInterface", GoMethod: "ResetDirectVpcNetworkInterface"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnvironmentVariables", GoMethod: "ResetEnvironmentVariables"},
