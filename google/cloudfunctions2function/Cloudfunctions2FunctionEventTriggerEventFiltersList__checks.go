...
func (j *jsiiProxy_Cloudfunctions2FunctionEventTriggerEventFiltersList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*Cloudfunctions2FunctionEventTriggerEventFilters; received %#v (a %T)", val, val)
		}
	}
