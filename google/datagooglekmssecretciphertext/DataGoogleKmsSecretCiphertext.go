...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/datagooglekmssecretciphertext/internal"
...
func (j *jsiiProxy_DataGoogleKmsSecretCiphertext) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataGoogleKmsSecretCiphertext) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataGoogleKmsSecretCiphertext) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGoogleKmsSecretCiphertext) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataGoogleKmsSecretCiphertext) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataGoogleKmsSecretCiphertext)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGoogleKmsSecretCiphertext)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataGoogleKmsSecretCiphertext)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataGoogleKmsSecretCiphertext_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataGoogleKmsSecretCiphertext) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleKmsSecretCiphertext) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleKmsSecretCiphertext) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataGoogleKmsSecretCiphertext) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
