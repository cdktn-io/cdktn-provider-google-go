...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/vertex_ai_tensorboard google_vertex_ai_tensorboard} Resource.
...
func (v *jsiiProxy_VertexAiTensorboard) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VertexAiTensorboard) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VertexAiTensorboard) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
