...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/secure_source_manager_repository google_secure_source_manager_repository} Resource.
...
func (s *jsiiProxy_SecureSourceManagerRepository) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecureSourceManagerRepository) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecureSourceManagerRepository) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
