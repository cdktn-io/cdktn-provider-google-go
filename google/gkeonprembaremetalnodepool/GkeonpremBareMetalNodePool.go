...
func (j *jsiiProxy_GkeonpremBareMetalNodePool) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GkeonpremBareMetalNodePool) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GkeonpremBareMetalNodePool)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GkeonpremBareMetalNodePool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GkeonpremBareMetalNodePool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GkeonpremBareMetalNodePool) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GkeonpremBareMetalNodePool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
