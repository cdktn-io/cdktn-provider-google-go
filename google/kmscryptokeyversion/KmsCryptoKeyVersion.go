...
func (j *jsiiProxy_KmsCryptoKeyVersion) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_KmsCryptoKeyVersion) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_KmsCryptoKeyVersion)SetDeletionPolicy(val *string) {
...
func (k *jsiiProxy_KmsCryptoKeyVersion) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KmsCryptoKeyVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KmsCryptoKeyVersion) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		k,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (k *jsiiProxy_KmsCryptoKeyVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
