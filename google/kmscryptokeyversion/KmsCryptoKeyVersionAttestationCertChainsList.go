...
func (j *jsiiProxy_KmsCryptoKeyVersionAttestationCertChainsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKmsCryptoKeyVersionAttestationCertChainsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KmsCryptoKeyVersionAttestationCertChainsList {
	_init_.Initialize()
...
func NewKmsCryptoKeyVersionAttestationCertChainsList_Override(k KmsCryptoKeyVersionAttestationCertChainsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KmsCryptoKeyVersionAttestationCertChainsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KmsCryptoKeyVersionAttestationCertChainsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KmsCryptoKeyVersionAttestationCertChainsList) Resolve(context cdktn.IResolveContext) interface{} {
