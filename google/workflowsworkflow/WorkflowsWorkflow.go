...
func (w *jsiiProxy_WorkflowsWorkflow) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WorkflowsWorkflow) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WorkflowsWorkflow) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
