...
func (j *jsiiProxy_CertificateManagerTrustConfigTrustStoresOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCertificateManagerTrustConfigTrustStoresOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CertificateManagerTrustConfigTrustStoresOutputReference {
	_init_.Initialize()
...
func NewCertificateManagerTrustConfigTrustStoresOutputReference_Override(c CertificateManagerTrustConfigTrustStoresOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CertificateManagerTrustConfigTrustStoresOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CertificateManagerTrustConfigTrustStoresOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CertificateManagerTrustConfigTrustStoresOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CertificateManagerTrustConfigTrustStoresOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CertificateManagerTrustConfigTrustStoresOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
