...
func (j *jsiiProxy_DataGoogleCloudRunV2WorkerPoolTemplateContainersEnvValueSourceList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleCloudRunV2WorkerPoolTemplateContainersEnvValueSourceList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudRunV2WorkerPoolTemplateContainersEnvValueSourceList {
	_init_.Initialize()
...
func NewDataGoogleCloudRunV2WorkerPoolTemplateContainersEnvValueSourceList_Override(d DataGoogleCloudRunV2WorkerPoolTemplateContainersEnvValueSourceList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudRunV2WorkerPoolTemplateContainersEnvValueSourceList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudRunV2WorkerPoolTemplateContainersEnvValueSourceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCloudRunV2WorkerPoolTemplateContainersEnvValueSourceList) Resolve(context cdktf.IResolveContext) interface{} {
