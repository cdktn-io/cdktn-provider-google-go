...
func (j *jsiiProxy_DataGoogleCloudRunV2WorkerPoolTemplateContainersOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudRunV2WorkerPoolTemplateContainersOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleCloudRunV2WorkerPoolTemplateContainersOutputReference {
	_init_.Initialize()
...
func NewDataGoogleCloudRunV2WorkerPoolTemplateContainersOutputReference_Override(d DataGoogleCloudRunV2WorkerPoolTemplateContainersOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudRunV2WorkerPoolTemplateContainersOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudRunV2WorkerPoolTemplateContainersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleCloudRunV2WorkerPoolTemplateContainersOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGoogleCloudRunV2WorkerPoolTemplateContainersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleCloudRunV2WorkerPoolTemplateContainersOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
