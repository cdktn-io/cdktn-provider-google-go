...
func (j *jsiiProxy_DataGooglePubsubTopicMessageStoragePolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGooglePubsubTopicMessageStoragePolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGooglePubsubTopicMessageStoragePolicyList {
	_init_.Initialize()
...
func NewDataGooglePubsubTopicMessageStoragePolicyList_Override(d DataGooglePubsubTopicMessageStoragePolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGooglePubsubTopicMessageStoragePolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGooglePubsubTopicMessageStoragePolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGooglePubsubTopicMessageStoragePolicyList) Resolve(context cdktn.IResolveContext) interface{} {
