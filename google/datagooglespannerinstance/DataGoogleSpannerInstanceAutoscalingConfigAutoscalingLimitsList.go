...
func (j *jsiiProxy_DataGoogleSpannerInstanceAutoscalingConfigAutoscalingLimitsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleSpannerInstanceAutoscalingConfigAutoscalingLimitsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleSpannerInstanceAutoscalingConfigAutoscalingLimitsList {
	_init_.Initialize()
...
func NewDataGoogleSpannerInstanceAutoscalingConfigAutoscalingLimitsList_Override(d DataGoogleSpannerInstanceAutoscalingConfigAutoscalingLimitsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleSpannerInstanceAutoscalingConfigAutoscalingLimitsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleSpannerInstanceAutoscalingConfigAutoscalingLimitsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleSpannerInstanceAutoscalingConfigAutoscalingLimitsList) Resolve(context cdktn.IResolveContext) interface{} {
