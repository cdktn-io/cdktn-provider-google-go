...
func (j *jsiiProxy_DataGoogleCloudQuotasQuotaInfoDimensionsInfosDetailsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudQuotasQuotaInfoDimensionsInfosDetailsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudQuotasQuotaInfoDimensionsInfosDetailsList {
	_init_.Initialize()
...
func NewDataGoogleCloudQuotasQuotaInfoDimensionsInfosDetailsList_Override(d DataGoogleCloudQuotasQuotaInfoDimensionsInfosDetailsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudQuotasQuotaInfoDimensionsInfosDetailsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudQuotasQuotaInfoDimensionsInfosDetailsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCloudQuotasQuotaInfoDimensionsInfosDetailsList) Resolve(context cdktn.IResolveContext) interface{} {
