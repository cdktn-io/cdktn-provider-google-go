...
func (a *jsiiProxy_AccessContextManagerServicePerimeterEgressPolicyEgressToOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AccessContextManagerServicePerimeterEgressPolicyEgressToOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
