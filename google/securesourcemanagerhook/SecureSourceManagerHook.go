...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/secure_source_manager_hook google_secure_source_manager_hook} Resource.
...
func (s *jsiiProxy_SecureSourceManagerHook) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecureSourceManagerHook) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
