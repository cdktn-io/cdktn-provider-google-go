...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/datagooglesqlbackuprun/internal"
...
func (j *jsiiProxy_DataGoogleSqlBackupRun) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataGoogleSqlBackupRun) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataGoogleSqlBackupRun) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGoogleSqlBackupRun) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataGoogleSqlBackupRun) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/data-sources/sql_backup_run google_sql_backup_run} Data Source.
func NewDataGoogleSqlBackupRun(scope constructs.Construct, id *string, config *DataGoogleSqlBackupRunConfig) DataGoogleSqlBackupRun {
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleSqlBackupRun.DataGoogleSqlBackupRun",
...
func (j *jsiiProxy_DataGoogleSqlBackupRun)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGoogleSqlBackupRun)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataGoogleSqlBackupRun)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataGoogleSqlBackupRun_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataGoogleSqlBackupRun) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleSqlBackupRun) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleSqlBackupRun) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataGoogleSqlBackupRun) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
