...
func (j *jsiiProxy_ComputePreviewFeature) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ComputePreviewFeature) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ComputePreviewFeature) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ComputePreviewFeature) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ComputePreviewFeature) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/compute_preview_feature google_compute_preview_feature} Resource.
...
func (j *jsiiProxy_ComputePreviewFeature)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ComputePreviewFeature)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ComputePreviewFeature)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ComputePreviewFeature_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ComputePreviewFeature) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputePreviewFeature) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ComputePreviewFeature) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputePreviewFeature) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputePreviewFeature) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputePreviewFeature) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
