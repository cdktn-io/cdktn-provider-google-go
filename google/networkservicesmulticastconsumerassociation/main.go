...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "multicastConsumerAssociationId", GoGetter: "MulticastConsumerAssociationId"},
			_jsii_.MemberProperty{JsiiProperty: "multicastConsumerAssociationIdInput", GoGetter: "MulticastConsumerAssociationIdInput"},
