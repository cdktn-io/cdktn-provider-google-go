...
func (m *jsiiProxy_MonitoringAlertPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MonitoringAlertPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MonitoringAlertPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
