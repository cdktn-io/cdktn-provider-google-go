...
func (m *jsiiProxy_MonitoringAlertPolicyDocumentationLinksList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_MonitoringAlertPolicyDocumentationLinksList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_MonitoringAlertPolicyDocumentationLinksList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
