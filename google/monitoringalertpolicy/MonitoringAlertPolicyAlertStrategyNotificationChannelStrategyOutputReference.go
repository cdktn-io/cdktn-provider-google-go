...
func (m *jsiiProxy_MonitoringAlertPolicyAlertStrategyNotificationChannelStrategyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitoringAlertPolicyAlertStrategyNotificationChannelStrategyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
