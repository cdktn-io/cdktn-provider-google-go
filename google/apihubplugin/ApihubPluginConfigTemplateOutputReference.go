...
type ApihubPluginConfigTemplateOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *ApihubPluginConfigTemplate
	SetInternalValue(val *ApihubPluginConfigTemplate)
	// Experimental.
...
func (j *jsiiProxy_ApihubPluginConfigTemplateOutputReference) AdditionalConfigTemplate() ApihubPluginConfigTemplateAdditionalConfigTemplateList {
	var returns ApihubPluginConfigTemplateAdditionalConfigTemplateList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApihubPluginConfigTemplateOutputReference) AuthConfigTemplate() ApihubPluginConfigTemplateAuthConfigTemplateOutputReference {
	var returns ApihubPluginConfigTemplateAuthConfigTemplateOutputReference
	_jsii_.Get(
		j,
		"authConfigTemplate",
		&returns,
...
func (j *jsiiProxy_ApihubPluginConfigTemplateOutputReference) AuthConfigTemplateInput() *ApihubPluginConfigTemplateAuthConfigTemplate {
...
func (j *jsiiProxy_ApihubPluginConfigTemplateOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApihubPluginConfigTemplateOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ApihubPluginConfigTemplateOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ApihubPluginConfigTemplateOutputReference) InternalValue() *ApihubPluginConfigTemplate {
...
func (j *jsiiProxy_ApihubPluginConfigTemplateOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (a *jsiiProxy_ApihubPluginConfigTemplateOutputReference) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_ApihubPluginConfigTemplateOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_ApihubPluginConfigTemplateOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_ApihubPluginConfigTemplateOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_ApihubPluginConfigTemplateOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_ApihubPluginConfigTemplateOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_ApihubPluginConfigTemplateOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_ApihubPluginConfigTemplateOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_ApihubPluginConfigTemplateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApihubPluginConfigTemplateOutputReference) PutAuthConfigTemplate(value *ApihubPluginConfigTemplateAuthConfigTemplate) {
	if err := a.validatePutAuthConfigTemplateParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_ApihubPluginConfigTemplateOutputReference) ResetAdditionalConfigTemplate() {
	_jsii_.InvokeVoid(
		a,
		"resetAdditionalConfigTemplate",
		nil, // no parameters
...
func (a *jsiiProxy_ApihubPluginConfigTemplateOutputReference) ResetAuthConfigTemplate() {
	_jsii_.InvokeVoid(
		a,
		"resetAuthConfigTemplate",
		nil, // no parameters
...
func (a *jsiiProxy_ApihubPluginConfigTemplateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (a *jsiiProxy_ApihubPluginConfigTemplateOutputReference) ToString() *string {
	var returns *string
