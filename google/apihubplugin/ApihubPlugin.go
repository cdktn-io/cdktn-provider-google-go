...
func (j *jsiiProxy_ApihubPlugin) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ApihubPlugin) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_ApihubPlugin)SetDeletionPolicy(val *string) {
...
func (a *jsiiProxy_ApihubPlugin) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApihubPlugin) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApihubPlugin) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		a,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (a *jsiiProxy_ApihubPlugin) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
