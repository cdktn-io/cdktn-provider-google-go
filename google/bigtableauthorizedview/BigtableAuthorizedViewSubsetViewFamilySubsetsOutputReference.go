...
func (b *jsiiProxy_BigtableAuthorizedViewSubsetViewFamilySubsetsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BigtableAuthorizedViewSubsetViewFamilySubsetsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
