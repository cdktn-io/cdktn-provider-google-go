...
func (j *jsiiProxy_BigtableAuthorizedView) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BigtableAuthorizedView) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BigtableAuthorizedView) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BigtableAuthorizedView) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BigtableAuthorizedView) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/bigtable_authorized_view google_bigtable_authorized_view} Resource.
...
func (j *jsiiProxy_BigtableAuthorizedView)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BigtableAuthorizedView)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BigtableAuthorizedView)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BigtableAuthorizedView_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BigtableAuthorizedView) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BigtableAuthorizedView) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BigtableAuthorizedView) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BigtableAuthorizedView) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BigtableAuthorizedView) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BigtableAuthorizedView) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
