...
func (b *jsiiProxy_BigtableAuthorizedViewSubsetViewOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BigtableAuthorizedViewSubsetViewOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
