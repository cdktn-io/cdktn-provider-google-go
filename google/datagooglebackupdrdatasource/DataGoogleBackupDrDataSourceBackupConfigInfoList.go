...
func (j *jsiiProxy_DataGoogleBackupDrDataSourceBackupConfigInfoList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleBackupDrDataSourceBackupConfigInfoList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleBackupDrDataSourceBackupConfigInfoList {
	_init_.Initialize()
...
func NewDataGoogleBackupDrDataSourceBackupConfigInfoList_Override(d DataGoogleBackupDrDataSourceBackupConfigInfoList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleBackupDrDataSourceBackupConfigInfoList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleBackupDrDataSourceBackupConfigInfoList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleBackupDrDataSourceBackupConfigInfoList) Resolve(context cdktn.IResolveContext) interface{} {
