...
func (j *jsiiProxy_VpcAccessConnector) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VpcAccessConnector) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VpcAccessConnector) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VpcAccessConnector) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VpcAccessConnector) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_VpcAccessConnector)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VpcAccessConnector)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VpcAccessConnector)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VpcAccessConnector_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VpcAccessConnector) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpcAccessConnector) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VpcAccessConnector) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpcAccessConnector) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpcAccessConnector) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VpcAccessConnector) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
