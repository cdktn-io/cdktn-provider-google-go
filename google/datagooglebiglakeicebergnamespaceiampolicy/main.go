...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google.dataGoogleBiglakeIcebergNamespaceIamPolicy.DataGoogleBiglakeIcebergNamespaceIamPolicy",
		reflect.TypeOf((*DataGoogleBiglakeIcebergNamespaceIamPolicy)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataGoogleBiglakeIcebergNamespaceIamPolicy{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnTerraformDataSource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dataGoogleBiglakeIcebergNamespaceIamPolicy.DataGoogleBiglakeIcebergNamespaceIamPolicyConfig",
		reflect.TypeOf((*DataGoogleBiglakeIcebergNamespaceIamPolicyConfig)(nil)).Elem(),
	)
}
