...
func (j *jsiiProxy_DataGoogleComputeRouterNat) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (d *jsiiProxy_DataGoogleComputeRouterNat) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataGoogleComputeRouterNat) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
