...
func (j *jsiiProxy_DataGoogleComputeRouterNatRulesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeRouterNatRulesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeRouterNatRulesList {
	_init_.Initialize()
...
func NewDataGoogleComputeRouterNatRulesList_Override(d DataGoogleComputeRouterNatRulesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeRouterNatRulesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeRouterNatRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeRouterNatRulesList) Resolve(context cdktn.IResolveContext) interface{} {
