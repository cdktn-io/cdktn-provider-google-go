...
func (j *jsiiProxy_DataplexLakeMetastoreStatusList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataplexLakeMetastoreStatusList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataplexLakeMetastoreStatusList {
	_init_.Initialize()
...
func NewDataplexLakeMetastoreStatusList_Override(d DataplexLakeMetastoreStatusList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataplexLakeMetastoreStatusList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataplexLakeMetastoreStatusList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataplexLakeMetastoreStatusList) Resolve(context cdktn.IResolveContext) interface{} {
