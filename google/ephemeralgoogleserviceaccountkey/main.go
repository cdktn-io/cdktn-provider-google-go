...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google.ephemeralGoogleServiceAccountKey.EphemeralGoogleServiceAccountKey",
		reflect.TypeOf((*EphemeralGoogleServiceAccountKey)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "fetchKey", GoGetter: "FetchKey"},
			_jsii_.MemberProperty{JsiiProperty: "fetchKeyInput", GoGetter: "FetchKeyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFetchKey", GoMethod: "ResetFetchKey"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServiceAccountId", GoMethod: "ResetServiceAccountId"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.ephemeralGoogleServiceAccountKey.EphemeralGoogleServiceAccountKeyConfig",
		reflect.TypeOf((*EphemeralGoogleServiceAccountKeyConfig)(nil)).Elem(),
	)
}
