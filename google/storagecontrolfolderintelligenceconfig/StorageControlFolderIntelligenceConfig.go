...
func (j *jsiiProxy_StorageControlFolderIntelligenceConfig) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_StorageControlFolderIntelligenceConfig) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_StorageControlFolderIntelligenceConfig) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StorageControlFolderIntelligenceConfig) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_StorageControlFolderIntelligenceConfig) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func StorageControlFolderIntelligenceConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StorageControlFolderIntelligenceConfig) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageControlFolderIntelligenceConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_StorageControlFolderIntelligenceConfig) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
