...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/storage_control_folder_intelligence_config google_storage_control_folder_intelligence_config} Resource.
...
func (s *jsiiProxy_StorageControlFolderIntelligenceConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageControlFolderIntelligenceConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StorageControlFolderIntelligenceConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
