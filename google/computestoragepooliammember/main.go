...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ComputeStoragePoolIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.computeStoragePoolIamMember.ComputeStoragePoolIamMemberCondition",
		reflect.TypeOf((*ComputeStoragePoolIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.computeStoragePoolIamMember.ComputeStoragePoolIamMemberConditionOutputReference",
		reflect.TypeOf((*ComputeStoragePoolIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.computeStoragePoolIamMember.ComputeStoragePoolIamMemberConfig",
		reflect.TypeOf((*ComputeStoragePoolIamMemberConfig)(nil)).Elem(),
	)
}
