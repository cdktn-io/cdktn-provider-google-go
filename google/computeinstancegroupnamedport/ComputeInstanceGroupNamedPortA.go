...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/computeinstancegroupnamedport/internal"
...
func (j *jsiiProxy_ComputeInstanceGroupNamedPortA) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ComputeInstanceGroupNamedPortA) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_ComputeInstanceGroupNamedPortA)SetDeletionPolicy(val *string) {
...
func (c *jsiiProxy_ComputeInstanceGroupNamedPortA) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputeInstanceGroupNamedPortA) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputeInstanceGroupNamedPortA) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeInstanceGroupNamedPortA) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
