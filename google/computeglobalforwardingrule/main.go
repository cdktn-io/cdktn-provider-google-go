...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "externalManagedBackendBucketMigrationStateInput", GoGetter: "ExternalManagedBackendBucketMigrationStateInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "externalManagedBackendBucketMigrationTestingPercentageInput", GoGetter: "ExternalManagedBackendBucketMigrationTestingPercentageInput"},
