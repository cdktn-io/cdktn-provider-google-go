...
func (j *jsiiProxy_DataGoogleComputeForwardingRule) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/data-sources/compute_forwarding_rule google_compute_forwarding_rule} Data Source.
func NewDataGoogleComputeForwardingRule(scope constructs.Construct, id *string, config *DataGoogleComputeForwardingRuleConfig) DataGoogleComputeForwardingRule {
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleComputeForwardingRule.DataGoogleComputeForwardingRule",
