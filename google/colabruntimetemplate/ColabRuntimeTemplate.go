...
func (j *jsiiProxy_ColabRuntimeTemplate) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ColabRuntimeTemplate) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_ColabRuntimeTemplate)SetDeletionPolicy(val *string) {
...
func (c *jsiiProxy_ColabRuntimeTemplate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ColabRuntimeTemplate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ColabRuntimeTemplate) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_ColabRuntimeTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
