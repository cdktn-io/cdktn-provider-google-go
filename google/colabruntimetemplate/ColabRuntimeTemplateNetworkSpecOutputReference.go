...
func (c *jsiiProxy_ColabRuntimeTemplateNetworkSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ColabRuntimeTemplateNetworkSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
