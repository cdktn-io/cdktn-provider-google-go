...
func (j *jsiiProxy_DataGoogleSecretManagerRegionalSecretsSecretsTopicsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleSecretManagerRegionalSecretsSecretsTopicsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleSecretManagerRegionalSecretsSecretsTopicsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleSecretManagerRegionalSecrets.DataGoogleSecretManagerRegionalSecretsSecretsTopicsList",
...
func NewDataGoogleSecretManagerRegionalSecretsSecretsTopicsList_Override(d DataGoogleSecretManagerRegionalSecretsSecretsTopicsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleSecretManagerRegionalSecretsSecretsTopicsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleSecretManagerRegionalSecretsSecretsTopicsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleSecretManagerRegionalSecretsSecretsTopicsList) Resolve(context cdktn.IResolveContext) interface{} {
