...
func (j *jsiiProxy_DataprocJobIamMember) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataprocJobIamMember) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataprocJobIamMember) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataprocJobIamMember) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataprocJobIamMember) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataprocJobIamMember(scope constructs.Construct, id *string, config *DataprocJobIamMemberConfig) DataprocJobIamMember {
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataprocJobIamMember.DataprocJobIamMember",
...
func (j *jsiiProxy_DataprocJobIamMember)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataprocJobIamMember)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataprocJobIamMember)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataprocJobIamMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataprocJobIamMember) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataprocJobIamMember) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DataprocJobIamMember) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataprocJobIamMember) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataprocJobIamMember) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataprocJobIamMember) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
