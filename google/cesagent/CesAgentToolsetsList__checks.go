...
func (j *jsiiProxy_CesAgentToolsetsList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*CesAgentToolsets:
		val := val.(*[]*CesAgentToolsets)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*CesAgentToolsets; received %#v (a %T)", val, val)
		}
	}
