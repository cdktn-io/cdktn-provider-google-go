...
func (c *jsiiProxy_CesAgent) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CesAgent) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
