...
func (j *jsiiProxy_ComputeFirewallPolicyWithRulesPredefinedRulesOutputReference) Disabled() cdktn.IResolvable {
...
func (j *jsiiProxy_ComputeFirewallPolicyWithRulesPredefinedRulesOutputReference) EnableLogging() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"enableLogging",
...
func (j *jsiiProxy_ComputeFirewallPolicyWithRulesPredefinedRulesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func (j *jsiiProxy_ComputeFirewallPolicyWithRulesPredefinedRulesOutputReference) TlsInspect() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"tlsInspect",
...
func NewComputeFirewallPolicyWithRulesPredefinedRulesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ComputeFirewallPolicyWithRulesPredefinedRulesOutputReference {
	_init_.Initialize()
...
func NewComputeFirewallPolicyWithRulesPredefinedRulesOutputReference_Override(c ComputeFirewallPolicyWithRulesPredefinedRulesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComputeFirewallPolicyWithRulesPredefinedRulesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ComputeFirewallPolicyWithRulesPredefinedRulesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputeFirewallPolicyWithRulesPredefinedRulesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ComputeFirewallPolicyWithRulesPredefinedRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputeFirewallPolicyWithRulesPredefinedRulesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
