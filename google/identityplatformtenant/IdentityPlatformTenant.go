...
func (j *jsiiProxy_IdentityPlatformTenant) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_IdentityPlatformTenant) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_IdentityPlatformTenant)SetDeletionPolicy(val *string) {
...
func (i *jsiiProxy_IdentityPlatformTenant) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IdentityPlatformTenant) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IdentityPlatformTenant) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		i,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (i *jsiiProxy_IdentityPlatformTenant) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
