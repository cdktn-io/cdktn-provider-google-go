...
func (j *jsiiProxy_IdentityPlatformConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IdentityPlatformConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IdentityPlatformConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IdentityPlatformConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IdentityPlatformConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/identity_platform_config google_identity_platform_config} Resource.
...
func (j *jsiiProxy_IdentityPlatformConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IdentityPlatformConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IdentityPlatformConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IdentityPlatformConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IdentityPlatformConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IdentityPlatformConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IdentityPlatformConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IdentityPlatformConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IdentityPlatformConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IdentityPlatformConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
