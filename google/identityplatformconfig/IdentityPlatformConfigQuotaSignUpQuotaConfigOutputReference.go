...
func (i *jsiiProxy_IdentityPlatformConfigQuotaSignUpQuotaConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IdentityPlatformConfigQuotaSignUpQuotaConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
