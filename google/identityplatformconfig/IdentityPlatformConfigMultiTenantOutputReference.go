...
func (i *jsiiProxy_IdentityPlatformConfigMultiTenantOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IdentityPlatformConfigMultiTenantOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
