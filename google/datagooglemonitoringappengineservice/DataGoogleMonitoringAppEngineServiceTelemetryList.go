...
func (j *jsiiProxy_DataGoogleMonitoringAppEngineServiceTelemetryList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleMonitoringAppEngineServiceTelemetryList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleMonitoringAppEngineServiceTelemetryList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleMonitoringAppEngineService.DataGoogleMonitoringAppEngineServiceTelemetryList",
...
func NewDataGoogleMonitoringAppEngineServiceTelemetryList_Override(d DataGoogleMonitoringAppEngineServiceTelemetryList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleMonitoringAppEngineServiceTelemetryList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleMonitoringAppEngineServiceTelemetryList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleMonitoringAppEngineServiceTelemetryList) Resolve(context cdktn.IResolveContext) interface{} {
