...
func (j *jsiiProxy_DataGoogleStorageControlProjectIntelligenceConfigEffectiveIntelligenceConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleStorageControlProjectIntelligenceConfigEffectiveIntelligenceConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleStorageControlProjectIntelligenceConfigEffectiveIntelligenceConfigList {
	_init_.Initialize()
...
func NewDataGoogleStorageControlProjectIntelligenceConfigEffectiveIntelligenceConfigList_Override(d DataGoogleStorageControlProjectIntelligenceConfigEffectiveIntelligenceConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleStorageControlProjectIntelligenceConfigEffectiveIntelligenceConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleStorageControlProjectIntelligenceConfigEffectiveIntelligenceConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleStorageControlProjectIntelligenceConfigEffectiveIntelligenceConfigList) Resolve(context cdktn.IResolveContext) interface{} {
