...
func (f *jsiiProxy_FilestoreInstance) validatePutNetworksParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*FilestoreInstanceNetworks; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_FilestoreInstance) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
