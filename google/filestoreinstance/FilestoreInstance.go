...
func (j *jsiiProxy_FilestoreInstance) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_FilestoreInstance) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/filestore_instance google_filestore_instance} Resource.
...
func (j *jsiiProxy_FilestoreInstance)SetDeletionPolicy(val *string) {
...
func (f *jsiiProxy_FilestoreInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FilestoreInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FilestoreInstance) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		f,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (f *jsiiProxy_FilestoreInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
