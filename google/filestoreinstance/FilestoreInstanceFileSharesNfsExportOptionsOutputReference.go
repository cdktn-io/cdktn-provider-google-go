...
func (j *jsiiProxy_FilestoreInstanceFileSharesNfsExportOptionsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFilestoreInstanceFileSharesNfsExportOptionsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FilestoreInstanceFileSharesNfsExportOptionsOutputReference {
	_init_.Initialize()
...
func NewFilestoreInstanceFileSharesNfsExportOptionsOutputReference_Override(f FilestoreInstanceFileSharesNfsExportOptionsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FilestoreInstanceFileSharesNfsExportOptionsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FilestoreInstanceFileSharesNfsExportOptionsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FilestoreInstanceFileSharesNfsExportOptionsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FilestoreInstanceFileSharesNfsExportOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FilestoreInstanceFileSharesNfsExportOptionsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
