...
func (f *jsiiProxy_FilestoreInstancePerformanceConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FilestoreInstancePerformanceConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
