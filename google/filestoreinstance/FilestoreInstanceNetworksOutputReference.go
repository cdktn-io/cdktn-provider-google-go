...
func (j *jsiiProxy_FilestoreInstanceNetworksOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFilestoreInstanceNetworksOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FilestoreInstanceNetworksOutputReference {
	_init_.Initialize()
...
func NewFilestoreInstanceNetworksOutputReference_Override(f FilestoreInstanceNetworksOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FilestoreInstanceNetworksOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FilestoreInstanceNetworksOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FilestoreInstanceNetworksOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FilestoreInstanceNetworksOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FilestoreInstanceNetworksOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
