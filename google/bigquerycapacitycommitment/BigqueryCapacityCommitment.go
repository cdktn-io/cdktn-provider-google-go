...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/bigquerycapacitycommitment/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/bigquery_capacity_commitment google_bigquery_capacity_commitment} Resource.
...
func (b *jsiiProxy_BigqueryCapacityCommitment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BigqueryCapacityCommitment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BigqueryCapacityCommitment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
