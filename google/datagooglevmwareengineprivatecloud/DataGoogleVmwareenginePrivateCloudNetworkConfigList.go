...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloudNetworkConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleVmwareenginePrivateCloudNetworkConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleVmwareenginePrivateCloudNetworkConfigList {
	_init_.Initialize()
...
func NewDataGoogleVmwareenginePrivateCloudNetworkConfigList_Override(d DataGoogleVmwareenginePrivateCloudNetworkConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloudNetworkConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloudNetworkConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloudNetworkConfigList) Resolve(context cdktn.IResolveContext) interface{} {
