...
func (j *jsiiProxy_DataGoogleComputeSubnetworkSecondaryIpRangeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeSubnetworkSecondaryIpRangeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeSubnetworkSecondaryIpRangeList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleComputeSubnetwork.DataGoogleComputeSubnetworkSecondaryIpRangeList",
...
func NewDataGoogleComputeSubnetworkSecondaryIpRangeList_Override(d DataGoogleComputeSubnetworkSecondaryIpRangeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeSubnetworkSecondaryIpRangeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeSubnetworkSecondaryIpRangeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeSubnetworkSecondaryIpRangeList) Resolve(context cdktn.IResolveContext) interface{} {
