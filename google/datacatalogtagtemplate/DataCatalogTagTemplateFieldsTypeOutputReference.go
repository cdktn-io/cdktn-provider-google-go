...
func (d *jsiiProxy_DataCatalogTagTemplateFieldsTypeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCatalogTagTemplateFieldsTypeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
