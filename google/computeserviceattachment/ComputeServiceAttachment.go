...
func (j *jsiiProxy_ComputeServiceAttachment) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ComputeServiceAttachment) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/resources/compute_service_attachment google_compute_service_attachment} Resource.
...
func (j *jsiiProxy_ComputeServiceAttachment)SetDeletionPolicy(val *string) {
...
func (c *jsiiProxy_ComputeServiceAttachment) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
