...
func (c *jsiiProxy_ComputeServiceAttachmentConsumerAcceptListsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeServiceAttachmentConsumerAcceptListsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
