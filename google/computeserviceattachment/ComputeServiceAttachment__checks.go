...
func (c *jsiiProxy_ComputeServiceAttachment) validatePutConsumerAcceptListsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ComputeServiceAttachmentConsumerAcceptLists; received %#v (a %T)", value, value)
		}
	}
