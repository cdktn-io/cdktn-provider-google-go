...
func (c *jsiiProxy_ComputeInstanceGroupManagerUpdatePolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeInstanceGroupManagerUpdatePolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
