...
type ComputeInstanceGroupManagerConfig struct {
	...
	ResourcePolicies *ComputeInstanceGroupManagerResourcePolicies `field:"optional" json:"resourcePolicies" yaml:"resourcePolicies"`
	...
	TargetSizePolicy interface{} `field:"optional" json:"targetSizePolicy" yaml:"targetSizePolicy"`
