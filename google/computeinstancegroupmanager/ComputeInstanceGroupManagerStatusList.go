...
func (j *jsiiProxy_ComputeInstanceGroupManagerStatusList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewComputeInstanceGroupManagerStatusList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ComputeInstanceGroupManagerStatusList {
	_init_.Initialize()
...
func NewComputeInstanceGroupManagerStatusList_Override(c ComputeInstanceGroupManagerStatusList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComputeInstanceGroupManagerStatusList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ComputeInstanceGroupManagerStatusList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ComputeInstanceGroupManagerStatusList) Resolve(context cdktn.IResolveContext) interface{} {
