...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/datagooglecomputetargethttpsproxy/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/data-sources/compute_target_https_proxy google_compute_target_https_proxy} Data Source.
func NewDataGoogleComputeTargetHttpsProxy(scope constructs.Construct, id *string, config *DataGoogleComputeTargetHttpsProxyConfig) DataGoogleComputeTargetHttpsProxy {
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleComputeTargetHttpsProxy.DataGoogleComputeTargetHttpsProxy",
...
func (d *jsiiProxy_DataGoogleComputeTargetHttpsProxy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
