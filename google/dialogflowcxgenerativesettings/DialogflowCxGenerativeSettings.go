...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/dialogflow_cx_generative_settings google_dialogflow_cx_generative_settings}.
...
func (j *jsiiProxy_DialogflowCxGenerativeSettings) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DialogflowCxGenerativeSettings) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DialogflowCxGenerativeSettings) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DialogflowCxGenerativeSettings) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DialogflowCxGenerativeSettings) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/dialogflow_cx_generative_settings google_dialogflow_cx_generative_settings} Resource.
...
func (j *jsiiProxy_DialogflowCxGenerativeSettings)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DialogflowCxGenerativeSettings)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DialogflowCxGenerativeSettings)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a DialogflowCxGenerativeSettings resource upon running "cdktn plan <stack-name>".
func DialogflowCxGenerativeSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DialogflowCxGenerativeSettings) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DialogflowCxGenerativeSettings) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DialogflowCxGenerativeSettings) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DialogflowCxGenerativeSettings) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DialogflowCxGenerativeSettings) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DialogflowCxGenerativeSettings) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
