...
func (j *jsiiProxy_DialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrasesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrasesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrasesList {
	_init_.Initialize()
...
func NewDialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrasesList_Override(d DialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrasesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrasesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrasesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrasesList) Resolve(context cdktn.IResolveContext) interface{} {
