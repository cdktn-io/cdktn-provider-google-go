...
func (d *jsiiProxy_DialogflowCxGenerativeSettingsKnowledgeConnectorSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DialogflowCxGenerativeSettingsKnowledgeConnectorSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
