...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VertexAiEvaluationMetric)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "evaluationMetricId", GoGetter: "EvaluationMetricId"},
			_jsii_.MemberProperty{JsiiProperty: "evaluationMetricIdInput", GoGetter: "EvaluationMetricIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEvaluationMetricId", GoMethod: "ResetEvaluationMetricId"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.vertexAiEvaluationMetric.VertexAiEvaluationMetricConfig",
		reflect.TypeOf((*VertexAiEvaluationMetricConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.vertexAiEvaluationMetric.VertexAiEvaluationMetricEncryptionSpec",
		reflect.TypeOf((*VertexAiEvaluationMetricEncryptionSpec)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.vertexAiEvaluationMetric.VertexAiEvaluationMetricEncryptionSpecOutputReference",
		reflect.TypeOf((*VertexAiEvaluationMetricEncryptionSpecOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_VertexAiEvaluationMetricEncryptionSpecOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.vertexAiEvaluationMetric.VertexAiEvaluationMetricTimeouts",
		reflect.TypeOf((*VertexAiEvaluationMetricTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.vertexAiEvaluationMetric.VertexAiEvaluationMetricTimeoutsOutputReference",
		reflect.TypeOf((*VertexAiEvaluationMetricTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
