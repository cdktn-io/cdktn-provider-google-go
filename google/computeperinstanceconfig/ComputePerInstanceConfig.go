...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/compute_per_instance_config google_compute_per_instance_config}.
...
func (j *jsiiProxy_ComputePerInstanceConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ComputePerInstanceConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ComputePerInstanceConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ComputePerInstanceConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ComputePerInstanceConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/compute_per_instance_config google_compute_per_instance_config} Resource.
...
func (j *jsiiProxy_ComputePerInstanceConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ComputePerInstanceConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ComputePerInstanceConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ComputePerInstanceConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ComputePerInstanceConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputePerInstanceConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ComputePerInstanceConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputePerInstanceConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputePerInstanceConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputePerInstanceConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
