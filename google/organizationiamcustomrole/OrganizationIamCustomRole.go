...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/organizationiamcustomrole/internal"
...
func (j *jsiiProxy_OrganizationIamCustomRole) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_OrganizationIamCustomRole) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/organization_iam_custom_role google_organization_iam_custom_role} Resource.
...
func (j *jsiiProxy_OrganizationIamCustomRole)SetDeletionPolicy(val *string) {
...
func (o *jsiiProxy_OrganizationIamCustomRole) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OrganizationIamCustomRole) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_OrganizationIamCustomRole) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		o,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (o *jsiiProxy_OrganizationIamCustomRole) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
