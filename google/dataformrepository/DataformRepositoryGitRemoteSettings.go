...
type DataformRepositoryGitRemoteSettings struct {
	...
	SshAuthenticationConfig *DataformRepositoryGitRemoteSettingsSshAuthenticationConfig `field:"optional" json:"sshAuthenticationConfig" yaml:"sshAuthenticationConfig"`
}
