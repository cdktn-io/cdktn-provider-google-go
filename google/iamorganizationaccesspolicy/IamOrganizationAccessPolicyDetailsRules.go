...
type IamOrganizationAccessPolicyDetailsRules struct {
	...
	Operation *IamOrganizationAccessPolicyDetailsRulesOperation `field:"required" json:"operation" yaml:"operation"`
