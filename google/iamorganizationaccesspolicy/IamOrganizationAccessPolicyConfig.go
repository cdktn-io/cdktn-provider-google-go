...
type IamOrganizationAccessPolicyConfig struct {
	// Experimental.
	...
	Details *IamOrganizationAccessPolicyDetails `field:"optional" json:"details" yaml:"details"`
	...
	Timeouts *IamOrganizationAccessPolicyTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
