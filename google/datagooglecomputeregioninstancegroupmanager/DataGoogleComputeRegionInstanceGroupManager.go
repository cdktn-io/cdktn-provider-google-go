...
func (j *jsiiProxy_DataGoogleComputeRegionInstanceGroupManager) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DataGoogleComputeRegionInstanceGroupManager) InstanceFlexibilityPolicy() DataGoogleComputeRegionInstanceGroupManagerInstanceFlexibilityPolicyList {
	var returns DataGoogleComputeRegionInstanceGroupManagerInstanceFlexibilityPolicyList
	_jsii_.Get(
		j,
