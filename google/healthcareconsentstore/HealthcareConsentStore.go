...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/healthcareconsentstore/internal"
...
func (j *jsiiProxy_HealthcareConsentStore) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_HealthcareConsentStore) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_HealthcareConsentStore) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_HealthcareConsentStore) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_HealthcareConsentStore) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_HealthcareConsentStore) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_HealthcareConsentStore) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_HealthcareConsentStore) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_HealthcareConsentStore) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/healthcare_consent_store google_healthcare_consent_store} Resource.
...
func (j *jsiiProxy_HealthcareConsentStore)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_HealthcareConsentStore)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_HealthcareConsentStore)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_HealthcareConsentStore)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func HealthcareConsentStore_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (h *jsiiProxy_HealthcareConsentStore) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HealthcareConsentStore) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (h *jsiiProxy_HealthcareConsentStore) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HealthcareConsentStore) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (h *jsiiProxy_HealthcareConsentStore) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (h *jsiiProxy_HealthcareConsentStore) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		h,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (h *jsiiProxy_HealthcareConsentStore) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
