...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/binary_authorization_policy google_binary_authorization_policy} Resource.
...
func (b *jsiiProxy_BinaryAuthorizationPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BinaryAuthorizationPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BinaryAuthorizationPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
