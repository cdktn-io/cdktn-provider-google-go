...
func (j *jsiiProxy_BinaryAuthorizationPolicyClusterAdmissionRulesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBinaryAuthorizationPolicyClusterAdmissionRulesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BinaryAuthorizationPolicyClusterAdmissionRulesList {
	_init_.Initialize()
...
func NewBinaryAuthorizationPolicyClusterAdmissionRulesList_Override(b BinaryAuthorizationPolicyClusterAdmissionRulesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BinaryAuthorizationPolicyClusterAdmissionRulesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BinaryAuthorizationPolicyClusterAdmissionRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BinaryAuthorizationPolicyClusterAdmissionRulesList) Resolve(context cdktn.IResolveContext) interface{} {
