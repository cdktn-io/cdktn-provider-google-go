...
func (j *jsiiProxy_ServiceDirectoryService) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServiceDirectoryService) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServiceDirectoryService) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServiceDirectoryService) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServiceDirectoryService) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewServiceDirectoryService(scope constructs.Construct, id *string, config *ServiceDirectoryServiceConfig) ServiceDirectoryService {
	...
	_jsii_.Create(
		"@cdktn/provider-google.serviceDirectoryService.ServiceDirectoryService",
...
func (j *jsiiProxy_ServiceDirectoryService)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServiceDirectoryService)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServiceDirectoryService)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ServiceDirectoryService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServiceDirectoryService) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceDirectoryService) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServiceDirectoryService) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceDirectoryService) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServiceDirectoryService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServiceDirectoryService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
