...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IapLocationWebIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.iapLocationWebIamMember.IapLocationWebIamMemberCondition",
		reflect.TypeOf((*IapLocationWebIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.iapLocationWebIamMember.IapLocationWebIamMemberConditionOutputReference",
		reflect.TypeOf((*IapLocationWebIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.iapLocationWebIamMember.IapLocationWebIamMemberConfig",
		reflect.TypeOf((*IapLocationWebIamMemberConfig)(nil)).Elem(),
	)
}
