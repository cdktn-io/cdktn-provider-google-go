...
func (d *jsiiProxy_DataplexAssetDiscoverySpecCsvOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataplexAssetDiscoverySpecCsvOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
