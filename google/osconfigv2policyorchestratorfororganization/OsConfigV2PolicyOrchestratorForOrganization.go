...
func (j *jsiiProxy_OsConfigV2PolicyOrchestratorForOrganization) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_OsConfigV2PolicyOrchestratorForOrganization) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_OsConfigV2PolicyOrchestratorForOrganization)SetDeletionPolicy(val *string) {
...
func (o *jsiiProxy_OsConfigV2PolicyOrchestratorForOrganization) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OsConfigV2PolicyOrchestratorForOrganization) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_OsConfigV2PolicyOrchestratorForOrganization) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		o,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (o *jsiiProxy_OsConfigV2PolicyOrchestratorForOrganization) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
