...
func (n *jsiiProxy_NetworkServicesGateway) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkServicesGateway) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkServicesGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
