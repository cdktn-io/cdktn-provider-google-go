...
func (c *jsiiProxy_ComputeUrlMapDefaultCustomErrorResponsePolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeUrlMapDefaultCustomErrorResponsePolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
