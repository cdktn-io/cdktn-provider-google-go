...
type ComputeUrlMapDefaultRouteActionCachePolicyNegativeCachingPolicy struct {
	...
	Ttl *ComputeUrlMapDefaultRouteActionCachePolicyNegativeCachingPolicyTtl `field:"optional" json:"ttl" yaml:"ttl"`
}
