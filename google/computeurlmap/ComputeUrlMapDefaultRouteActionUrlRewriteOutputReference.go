...
func (c *jsiiProxy_ComputeUrlMapDefaultRouteActionUrlRewriteOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeUrlMapDefaultRouteActionUrlRewriteOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
