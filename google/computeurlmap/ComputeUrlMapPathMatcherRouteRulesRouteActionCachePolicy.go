...
type ComputeUrlMapPathMatcherRouteRulesRouteActionCachePolicy struct {
	...
	CacheKeyPolicy *ComputeUrlMapPathMatcherRouteRulesRouteActionCachePolicyCacheKeyPolicy `field:"optional" json:"cacheKeyPolicy" yaml:"cacheKeyPolicy"`
	...
	ClientTtl *ComputeUrlMapPathMatcherRouteRulesRouteActionCachePolicyClientTtl `field:"optional" json:"clientTtl" yaml:"clientTtl"`
	// default_ttl block.
	//
	...
	DefaultTtl *ComputeUrlMapPathMatcherRouteRulesRouteActionCachePolicyDefaultTtl `field:"optional" json:"defaultTtl" yaml:"defaultTtl"`
	// max_ttl block.
	//
	...
	MaxTtl *ComputeUrlMapPathMatcherRouteRulesRouteActionCachePolicyMaxTtl `field:"optional" json:"maxTtl" yaml:"maxTtl"`
