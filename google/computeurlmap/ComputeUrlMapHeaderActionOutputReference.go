...
func (c *jsiiProxy_ComputeUrlMapHeaderActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeUrlMapHeaderActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
