...
func (d *jsiiProxy_DataLossPreventionDiscoveryConfigActionsTagResourcesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataLossPreventionDiscoveryConfigActionsTagResourcesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
