...
func (j *jsiiProxy_DataLossPreventionDiscoveryConfigTargetsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataLossPreventionDiscoveryConfigTargetsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataLossPreventionDiscoveryConfigTargetsOutputReference {
	_init_.Initialize()
...
func NewDataLossPreventionDiscoveryConfigTargetsOutputReference_Override(d DataLossPreventionDiscoveryConfigTargetsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataLossPreventionDiscoveryConfigTargetsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataLossPreventionDiscoveryConfigTargetsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataLossPreventionDiscoveryConfigTargetsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataLossPreventionDiscoveryConfigTargetsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataLossPreventionDiscoveryConfigTargetsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
