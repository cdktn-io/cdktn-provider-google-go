...
func (j *jsiiProxy_IdentityPlatformTenantDefaultSupportedIdpConfig) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_IdentityPlatformTenantDefaultSupportedIdpConfig) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_IdentityPlatformTenantDefaultSupportedIdpConfig)SetDeletionPolicy(val *string) {
...
func (i *jsiiProxy_IdentityPlatformTenantDefaultSupportedIdpConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IdentityPlatformTenantDefaultSupportedIdpConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IdentityPlatformTenantDefaultSupportedIdpConfig) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		i,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (i *jsiiProxy_IdentityPlatformTenantDefaultSupportedIdpConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
