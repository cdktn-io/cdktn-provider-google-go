...
func (j *jsiiProxy_AppEngineStandardAppVersion) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_AppEngineStandardAppVersion) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/app_engine_standard_app_version google_app_engine_standard_app_version} Resource.
...
func (j *jsiiProxy_AppEngineStandardAppVersion)SetDeletionPolicy(val *string) {
...
func (a *jsiiProxy_AppEngineStandardAppVersion) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		a,
		"resetDeletionPolicy",
		nil, // no parameters
