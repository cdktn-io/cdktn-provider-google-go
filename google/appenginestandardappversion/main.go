...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "appEngineBundledServices", GoGetter: "AppEngineBundledServices"},
			_jsii_.MemberProperty{JsiiProperty: "appEngineBundledServicesInput", GoGetter: "AppEngineBundledServicesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAppEngineBundledServices", GoMethod: "ResetAppEngineBundledServices"},
