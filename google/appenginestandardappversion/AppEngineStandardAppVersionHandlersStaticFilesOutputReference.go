...
func (a *jsiiProxy_AppEngineStandardAppVersionHandlersStaticFilesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppEngineStandardAppVersionHandlersStaticFilesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
