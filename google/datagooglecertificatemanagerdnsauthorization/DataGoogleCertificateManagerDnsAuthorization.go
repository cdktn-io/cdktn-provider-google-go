...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/datagooglecertificatemanagerdnsauthorization/internal"
...
type DataGoogleCertificateManagerDnsAuthorization interface {
	...
	Description() *string
	DnsResourceRecord() DataGoogleCertificateManagerDnsAuthorizationDnsResourceRecordList
	Domain() *string
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) DnsResourceRecord() DataGoogleCertificateManagerDnsAuthorizationDnsResourceRecordList {
	var returns DataGoogleCertificateManagerDnsAuthorizationDnsResourceRecordList
	_jsii_.Get(
		j,
		"dnsResourceRecord",
		&returns,
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) Domain() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domain",
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) DomainInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainInput",
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/data-sources/certificate_manager_dns_authorization google_certificate_manager_dns_authorization} Data Source.
func NewDataGoogleCertificateManagerDnsAuthorization(scope constructs.Construct, id *string, config *DataGoogleCertificateManagerDnsAuthorizationConfig) DataGoogleCertificateManagerDnsAuthorization {
	...
	if err := validateNewDataGoogleCertificateManagerDnsAuthorizationParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGoogleCertificateManagerDnsAuthorization{}

	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleCertificateManagerDnsAuthorization.DataGoogleCertificateManagerDnsAuthorization",
...
func DataGoogleCertificateManagerDnsAuthorization_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-google.dataGoogleCertificateManagerDnsAuthorization.DataGoogleCertificateManagerDnsAuthorization",
...
func (d *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) ResetLocation() {
	_jsii_.InvokeVoid(
		d,
		"resetLocation",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCertificateManagerDnsAuthorization) ToString() *string {
	var returns *string
