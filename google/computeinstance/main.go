...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.computeInstance.ComputeInstanceWorkloadIdentityConfig",
		reflect.TypeOf((*ComputeInstanceWorkloadIdentityConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.computeInstance.ComputeInstanceWorkloadIdentityConfigOutputReference",
		reflect.TypeOf((*ComputeInstanceWorkloadIdentityConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
