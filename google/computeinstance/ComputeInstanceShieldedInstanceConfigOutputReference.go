...
func (c *jsiiProxy_ComputeInstanceShieldedInstanceConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeInstanceShieldedInstanceConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
