...
func (c *jsiiProxy_ComputeInstanceBootDiskInitializeParamsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeInstanceBootDiskInitializeParamsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
