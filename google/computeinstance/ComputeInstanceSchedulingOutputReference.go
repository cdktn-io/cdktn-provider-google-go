...
func (j *jsiiProxy_ComputeInstanceSchedulingOutputReference) HostErrorTimeoutSeconds() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeInstanceSchedulingOutputReference) HostErrorTimeoutSecondsInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeInstanceSchedulingOutputReference)SetHostErrorTimeoutSeconds(val *float64) {
...
func (c *jsiiProxy_ComputeInstanceSchedulingOutputReference) ResetHostErrorTimeoutSeconds() {
	_jsii_.InvokeVoid(
		c,
		"resetHostErrorTimeoutSeconds",
		nil, // no parameters
