...
func (j *jsiiProxy_PubsubSubscriptionCloudStorageConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPubsubSubscriptionCloudStorageConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PubsubSubscriptionCloudStorageConfigOutputReference {
	_init_.Initialize()
...
func NewPubsubSubscriptionCloudStorageConfigOutputReference_Override(p PubsubSubscriptionCloudStorageConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PubsubSubscriptionCloudStorageConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PubsubSubscriptionCloudStorageConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PubsubSubscriptionCloudStorageConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PubsubSubscriptionCloudStorageConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PubsubSubscriptionCloudStorageConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
