...
func (p *jsiiProxy_PubsubSubscriptionDeadLetterPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PubsubSubscriptionDeadLetterPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
