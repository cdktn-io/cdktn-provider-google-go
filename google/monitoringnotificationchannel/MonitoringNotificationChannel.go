...
func (j *jsiiProxy_MonitoringNotificationChannel) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MonitoringNotificationChannel) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MonitoringNotificationChannel) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MonitoringNotificationChannel) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MonitoringNotificationChannel) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/monitoring_notification_channel google_monitoring_notification_channel} Resource.
...
func (j *jsiiProxy_MonitoringNotificationChannel)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MonitoringNotificationChannel)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MonitoringNotificationChannel)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MonitoringNotificationChannel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MonitoringNotificationChannel) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitoringNotificationChannel) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MonitoringNotificationChannel) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitoringNotificationChannel) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MonitoringNotificationChannel) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MonitoringNotificationChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
