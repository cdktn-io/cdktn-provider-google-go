...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/kmskeyringimportjob/internal"
...
func (j *jsiiProxy_KmsKeyRingImportJob) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_KmsKeyRingImportJob) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_KmsKeyRingImportJob) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KmsKeyRingImportJob) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_KmsKeyRingImportJob) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/kms_key_ring_import_job google_kms_key_ring_import_job} Resource.
func NewKmsKeyRingImportJob(scope constructs.Construct, id *string, config *KmsKeyRingImportJobConfig) KmsKeyRingImportJob {
	...
	_jsii_.Create(
		"@cdktn/provider-google.kmsKeyRingImportJob.KmsKeyRingImportJob",
...
func (j *jsiiProxy_KmsKeyRingImportJob)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KmsKeyRingImportJob)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KmsKeyRingImportJob)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func KmsKeyRingImportJob_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KmsKeyRingImportJob) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KmsKeyRingImportJob) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (k *jsiiProxy_KmsKeyRingImportJob) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KmsKeyRingImportJob) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KmsKeyRingImportJob) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KmsKeyRingImportJob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
