...
func (j *jsiiProxy_DataGoogleCloudfunctionsFunctionSecretEnvironmentVariablesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudfunctionsFunctionSecretEnvironmentVariablesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudfunctionsFunctionSecretEnvironmentVariablesList {
	_init_.Initialize()
...
func NewDataGoogleCloudfunctionsFunctionSecretEnvironmentVariablesList_Override(d DataGoogleCloudfunctionsFunctionSecretEnvironmentVariablesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudfunctionsFunctionSecretEnvironmentVariablesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudfunctionsFunctionSecretEnvironmentVariablesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCloudfunctionsFunctionSecretEnvironmentVariablesList) Resolve(context cdktn.IResolveContext) interface{} {
