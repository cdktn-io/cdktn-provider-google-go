...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/bigqueryanalyticshublistingiampolicy/internal"
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingIamPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingIamPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingIamPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
