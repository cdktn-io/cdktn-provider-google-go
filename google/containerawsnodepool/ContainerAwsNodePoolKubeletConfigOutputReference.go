...
func (c *jsiiProxy_ContainerAwsNodePoolKubeletConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerAwsNodePoolKubeletConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
