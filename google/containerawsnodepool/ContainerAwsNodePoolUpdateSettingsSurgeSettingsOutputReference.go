...
func (c *jsiiProxy_ContainerAwsNodePoolUpdateSettingsSurgeSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerAwsNodePoolUpdateSettingsSurgeSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
