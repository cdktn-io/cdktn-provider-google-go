...
type SccOrganizationCustomModuleCustomConfig struct {
	// predicate block.
	//
	...
	Predicate *SccOrganizationCustomModuleCustomConfigPredicate `field:"required" json:"predicate" yaml:"predicate"`
	...
	ResourceSelector *SccOrganizationCustomModuleCustomConfigResourceSelector `field:"required" json:"resourceSelector" yaml:"resourceSelector"`
	...
	CustomOutput *SccOrganizationCustomModuleCustomConfigCustomOutput `field:"optional" json:"customOutput" yaml:"customOutput"`
