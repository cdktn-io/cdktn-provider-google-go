...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/ephemeralgooglesecretmanagersecretversion/internal"
...
func NewEphemeralGoogleSecretManagerSecretVersion(scope constructs.Construct, id *string, config *EphemeralGoogleSecretManagerSecretVersionConfig) EphemeralGoogleSecretManagerSecretVersion {
	...
	_jsii_.Create(
		"@cdktn/provider-google.ephemeralGoogleSecretManagerSecretVersion.EphemeralGoogleSecretManagerSecretVersion",
