...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EphemeralGoogleSecretManagerSecretVersion)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.ephemeralGoogleSecretManagerSecretVersion.EphemeralGoogleSecretManagerSecretVersionConfig",
		reflect.TypeOf((*EphemeralGoogleSecretManagerSecretVersionConfig)(nil)).Elem(),
	)
}
