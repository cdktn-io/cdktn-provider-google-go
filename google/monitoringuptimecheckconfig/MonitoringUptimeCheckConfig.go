...
func (j *jsiiProxy_MonitoringUptimeCheckConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MonitoringUptimeCheckConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MonitoringUptimeCheckConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MonitoringUptimeCheckConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MonitoringUptimeCheckConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/monitoring_uptime_check_config google_monitoring_uptime_check_config} Resource.
...
func (j *jsiiProxy_MonitoringUptimeCheckConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MonitoringUptimeCheckConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MonitoringUptimeCheckConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MonitoringUptimeCheckConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MonitoringUptimeCheckConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitoringUptimeCheckConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MonitoringUptimeCheckConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitoringUptimeCheckConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MonitoringUptimeCheckConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MonitoringUptimeCheckConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
