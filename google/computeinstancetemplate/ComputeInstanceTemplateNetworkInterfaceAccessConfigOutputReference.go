...
func (c *jsiiProxy_ComputeInstanceTemplateNetworkInterfaceAccessConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeInstanceTemplateNetworkInterfaceAccessConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
