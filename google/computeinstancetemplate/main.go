...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.computeInstanceTemplate.ComputeInstanceTemplateWorkloadIdentityConfig",
		reflect.TypeOf((*ComputeInstanceTemplateWorkloadIdentityConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.computeInstanceTemplate.ComputeInstanceTemplateWorkloadIdentityConfigOutputReference",
		reflect.TypeOf((*ComputeInstanceTemplateWorkloadIdentityConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
