...
func (j *jsiiProxy_ComputeInstanceTemplateAdvancedMachineFeaturesOutputReference) EnableUefiNetworking() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeInstanceTemplateAdvancedMachineFeaturesOutputReference) EnableUefiNetworkingInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeInstanceTemplateAdvancedMachineFeaturesOutputReference) PerformanceMonitoringUnit() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeInstanceTemplateAdvancedMachineFeaturesOutputReference) PerformanceMonitoringUnitInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeInstanceTemplateAdvancedMachineFeaturesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewComputeInstanceTemplateAdvancedMachineFeaturesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ComputeInstanceTemplateAdvancedMachineFeaturesOutputReference {
	_init_.Initialize()
...
func NewComputeInstanceTemplateAdvancedMachineFeaturesOutputReference_Override(c ComputeInstanceTemplateAdvancedMachineFeaturesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComputeInstanceTemplateAdvancedMachineFeaturesOutputReference)SetEnableUefiNetworking(val interface{}) {
...
func (j *jsiiProxy_ComputeInstanceTemplateAdvancedMachineFeaturesOutputReference)SetPerformanceMonitoringUnit(val *string) {
...
func (j *jsiiProxy_ComputeInstanceTemplateAdvancedMachineFeaturesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ComputeInstanceTemplateAdvancedMachineFeaturesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputeInstanceTemplateAdvancedMachineFeaturesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ComputeInstanceTemplateAdvancedMachineFeaturesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputeInstanceTemplateAdvancedMachineFeaturesOutputReference) ResetEnableUefiNetworking() {
	_jsii_.InvokeVoid(
		c,
		"resetEnableUefiNetworking",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeInstanceTemplateAdvancedMachineFeaturesOutputReference) ResetPerformanceMonitoringUnit() {
	_jsii_.InvokeVoid(
		c,
		"resetPerformanceMonitoringUnit",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeInstanceTemplateAdvancedMachineFeaturesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
