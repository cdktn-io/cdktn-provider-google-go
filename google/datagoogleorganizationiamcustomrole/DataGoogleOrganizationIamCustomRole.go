...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v19/datagoogleorganizationiamcustomrole/internal"
...
func (j *jsiiProxy_DataGoogleOrganizationIamCustomRole) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.33.0/docs/data-sources/organization_iam_custom_role google_organization_iam_custom_role} Data Source.
