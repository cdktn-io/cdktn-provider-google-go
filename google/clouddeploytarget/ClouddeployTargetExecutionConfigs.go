...
type ClouddeployTargetExecutionConfigs struct {
	...
	DefaultPool *ClouddeployTargetExecutionConfigsDefaultPool `field:"optional" json:"defaultPool" yaml:"defaultPool"`
	// Optional.
	//
	...
	PrivatePool *ClouddeployTargetExecutionConfigsPrivatePool `field:"optional" json:"privatePool" yaml:"privatePool"`
