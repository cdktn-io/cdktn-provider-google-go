...
func (c *jsiiProxy_ClouddeployTargetExecutionConfigsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ClouddeployTargetExecutionConfigsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
