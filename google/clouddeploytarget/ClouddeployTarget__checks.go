...
func (c *jsiiProxy_ClouddeployTarget) validatePutAssociatedEntitiesParameters(value interface{}) error {
	...
	case *[]*ClouddeployTargetAssociatedEntities:
		value := value.(*[]*ClouddeployTargetAssociatedEntities)
	...
	case []*ClouddeployTargetAssociatedEntities:
		value_ := value.([]*ClouddeployTargetAssociatedEntities)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ClouddeployTargetAssociatedEntities; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ClouddeployTarget) validatePutExecutionConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ClouddeployTargetExecutionConfigs; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_ClouddeployTarget) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
