...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BigqueryRoutineIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.bigqueryRoutineIamMember.BigqueryRoutineIamMemberCondition",
		reflect.TypeOf((*BigqueryRoutineIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.bigqueryRoutineIamMember.BigqueryRoutineIamMemberConditionOutputReference",
		reflect.TypeOf((*BigqueryRoutineIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.bigqueryRoutineIamMember.BigqueryRoutineIamMemberConfig",
		reflect.TypeOf((*BigqueryRoutineIamMemberConfig)(nil)).Elem(),
	)
}
