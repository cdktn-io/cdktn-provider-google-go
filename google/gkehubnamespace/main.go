...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "scopeNamespaceId", GoGetter: "ScopeNamespaceId"},
			_jsii_.MemberProperty{JsiiProperty: "scopeNamespaceIdInput", GoGetter: "ScopeNamespaceIdInput"},
