...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/tagstagbinding/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/tags_tag_binding google_tags_tag_binding} Resource.
...
func (t *jsiiProxy_TagsTagBinding) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_TagsTagBinding) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (t *jsiiProxy_TagsTagBinding) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
