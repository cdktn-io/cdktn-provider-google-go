...
func (j *jsiiProxy_DataGoogleComputeReservationShareSettingsProjectMapList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeReservationShareSettingsProjectMapList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeReservationShareSettingsProjectMapList {
	_init_.Initialize()
...
func NewDataGoogleComputeReservationShareSettingsProjectMapList_Override(d DataGoogleComputeReservationShareSettingsProjectMapList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeReservationShareSettingsProjectMapList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeReservationShareSettingsProjectMapList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeReservationShareSettingsProjectMapList) Resolve(context cdktn.IResolveContext) interface{} {
