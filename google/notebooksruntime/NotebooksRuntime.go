...
func (j *jsiiProxy_NotebooksRuntime) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_NotebooksRuntime) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/notebooks_runtime google_notebooks_runtime} Resource.
...
func (j *jsiiProxy_NotebooksRuntime)SetDeletionPolicy(val *string) {
...
func (n *jsiiProxy_NotebooksRuntime) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NotebooksRuntime) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NotebooksRuntime) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		n,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (n *jsiiProxy_NotebooksRuntime) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
