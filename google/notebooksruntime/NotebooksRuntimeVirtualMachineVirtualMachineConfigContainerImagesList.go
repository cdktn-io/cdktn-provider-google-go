...
func (j *jsiiProxy_NotebooksRuntimeVirtualMachineVirtualMachineConfigContainerImagesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNotebooksRuntimeVirtualMachineVirtualMachineConfigContainerImagesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NotebooksRuntimeVirtualMachineVirtualMachineConfigContainerImagesList {
	_init_.Initialize()
...
func NewNotebooksRuntimeVirtualMachineVirtualMachineConfigContainerImagesList_Override(n NotebooksRuntimeVirtualMachineVirtualMachineConfigContainerImagesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NotebooksRuntimeVirtualMachineVirtualMachineConfigContainerImagesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NotebooksRuntimeVirtualMachineVirtualMachineConfigContainerImagesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NotebooksRuntimeVirtualMachineVirtualMachineConfigContainerImagesList) Resolve(context cdktn.IResolveContext) interface{} {
