...
type DatabaseMigrationServiceMigrationJobConfig struct {
	...
	ObjectsConfig *DatabaseMigrationServiceMigrationJobObjectsConfig `field:"optional" json:"objectsConfig" yaml:"objectsConfig"`
	...
	PostgresHomogeneousConfig *DatabaseMigrationServiceMigrationJobPostgresHomogeneousConfig `field:"optional" json:"postgresHomogeneousConfig" yaml:"postgresHomogeneousConfig"`
	...
	StopOnWarnings interface{} `field:"optional" json:"stopOnWarnings" yaml:"stopOnWarnings"`
	// timeouts block.
	//
