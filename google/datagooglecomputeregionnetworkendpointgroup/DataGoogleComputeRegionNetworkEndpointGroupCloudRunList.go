...
func (j *jsiiProxy_DataGoogleComputeRegionNetworkEndpointGroupCloudRunList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeRegionNetworkEndpointGroupCloudRunList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeRegionNetworkEndpointGroupCloudRunList {
	_init_.Initialize()
...
func NewDataGoogleComputeRegionNetworkEndpointGroupCloudRunList_Override(d DataGoogleComputeRegionNetworkEndpointGroupCloudRunList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeRegionNetworkEndpointGroupCloudRunList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeRegionNetworkEndpointGroupCloudRunList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeRegionNetworkEndpointGroupCloudRunList) Resolve(context cdktn.IResolveContext) interface{} {
