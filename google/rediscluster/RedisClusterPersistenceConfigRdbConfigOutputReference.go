...
func (r *jsiiProxy_RedisClusterPersistenceConfigRdbConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RedisClusterPersistenceConfigRdbConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
