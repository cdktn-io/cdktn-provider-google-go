...
func (j *jsiiProxy_RedisClusterDiscoveryEndpointsPscConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRedisClusterDiscoveryEndpointsPscConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RedisClusterDiscoveryEndpointsPscConfigList {
	_init_.Initialize()
...
func NewRedisClusterDiscoveryEndpointsPscConfigList_Override(r RedisClusterDiscoveryEndpointsPscConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RedisClusterDiscoveryEndpointsPscConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RedisClusterDiscoveryEndpointsPscConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RedisClusterDiscoveryEndpointsPscConfigList) Resolve(context cdktn.IResolveContext) interface{} {
