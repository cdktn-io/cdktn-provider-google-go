...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/integrations_auth_config google_integrations_auth_config}.
...
func (j *jsiiProxy_IntegrationsAuthConfig) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_IntegrationsAuthConfig) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/integrations_auth_config google_integrations_auth_config} Resource.
...
func (j *jsiiProxy_IntegrationsAuthConfig)SetDeletionPolicy(val *string) {
...
func (i *jsiiProxy_IntegrationsAuthConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IntegrationsAuthConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IntegrationsAuthConfig) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		i,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (i *jsiiProxy_IntegrationsAuthConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
