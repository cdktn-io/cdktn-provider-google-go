...
func (j *jsiiProxy_ManagedKafkaConnector) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ManagedKafkaConnector) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_ManagedKafkaConnector)SetDeletionPolicy(val *string) {
...
func (m *jsiiProxy_ManagedKafkaConnector) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_ManagedKafkaConnector) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_ManagedKafkaConnector) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		m,
		"resetDeletionPolicy",
		nil, // no parameters
