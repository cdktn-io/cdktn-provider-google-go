...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/cloudtasksqueueiambinding/internal"
...
func (j *jsiiProxy_CloudTasksQueueIamBinding) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudTasksQueueIamBinding) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudTasksQueueIamBinding) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudTasksQueueIamBinding) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudTasksQueueIamBinding) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/cloud_tasks_queue_iam_binding google_cloud_tasks_queue_iam_binding} Resource.
func NewCloudTasksQueueIamBinding(scope constructs.Construct, id *string, config *CloudTasksQueueIamBindingConfig) CloudTasksQueueIamBinding {
	...
	_jsii_.Create(
		"@cdktn/provider-google.cloudTasksQueueIamBinding.CloudTasksQueueIamBinding",
...
func (j *jsiiProxy_CloudTasksQueueIamBinding)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudTasksQueueIamBinding)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudTasksQueueIamBinding)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CloudTasksQueueIamBinding_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudTasksQueueIamBinding) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudTasksQueueIamBinding) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudTasksQueueIamBinding) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudTasksQueueIamBinding) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudTasksQueueIamBinding) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudTasksQueueIamBinding) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
