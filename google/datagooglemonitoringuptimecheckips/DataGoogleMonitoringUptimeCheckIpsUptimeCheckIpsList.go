...
func (j *jsiiProxy_DataGoogleMonitoringUptimeCheckIpsUptimeCheckIpsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleMonitoringUptimeCheckIpsUptimeCheckIpsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleMonitoringUptimeCheckIpsUptimeCheckIpsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleMonitoringUptimeCheckIps.DataGoogleMonitoringUptimeCheckIpsUptimeCheckIpsList",
...
func NewDataGoogleMonitoringUptimeCheckIpsUptimeCheckIpsList_Override(d DataGoogleMonitoringUptimeCheckIpsUptimeCheckIpsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleMonitoringUptimeCheckIpsUptimeCheckIpsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleMonitoringUptimeCheckIpsUptimeCheckIpsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleMonitoringUptimeCheckIpsUptimeCheckIpsList) Resolve(context cdktn.IResolveContext) interface{} {
