...
type CesToolDataStoreToolBoostSpecs struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.39.0/docs/resources/ces_tool#data_stores CesTool#data_stores}
	DataStores *[]*string `field:"required" json:"dataStores" yaml:"dataStores"`
	// spec block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.39.0/docs/resources/ces_tool#spec CesTool#spec}
