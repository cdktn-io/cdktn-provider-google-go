...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/ces_tool google_ces_tool}.
type CesTool interface {
	cdktn.TerraformResource
	AgentTool() CesToolAgentToolOutputReference
	AgentToolInput() *CesToolAgentTool
	App() *string
	SetApp(val *string)
	AppInput() *string
	// Experimental.
	...
	ConnectorTool() CesToolConnectorToolList
	// Experimental.
	...
	FileSearchTool() CesToolFileSearchToolOutputReference
	FileSearchToolInput() *CesToolFileSearchTool
	// Experimental.
	...
	RemoteAgentTool() CesToolRemoteAgentToolList
	...
	ToolIdInput() *string
	UpdateTime() *string
	WidgetTool() CesToolWidgetToolOutputReference
	WidgetToolInput() *CesToolWidgetTool
...
func (j *jsiiProxy_CesTool) AgentTool() CesToolAgentToolOutputReference {
	var returns CesToolAgentToolOutputReference
	_jsii_.Get(
		j,
		"agentTool",
		&returns,
...
func (j *jsiiProxy_CesTool) AgentToolInput() *CesToolAgentTool {
...
func (j *jsiiProxy_CesTool) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CesTool) ConnectorTool() CesToolConnectorToolList {
	var returns CesToolConnectorToolList
	_jsii_.Get(
		j,
		"connectorTool",
		&returns,
...
func (j *jsiiProxy_CesTool) FileSearchTool() CesToolFileSearchToolOutputReference {
	var returns CesToolFileSearchToolOutputReference
	_jsii_.Get(
		j,
		"fileSearchTool",
		&returns,
...
func (j *jsiiProxy_CesTool) FileSearchToolInput() *CesToolFileSearchTool {
...
func (j *jsiiProxy_CesTool) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CesTool) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CesTool) McpTool() CesToolMcpToolList {
	var returns CesToolMcpToolList
	_jsii_.Get(
		j,
		"mcpTool",
		&returns,
...
func (j *jsiiProxy_CesTool) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CesTool) RemoteAgentTool() CesToolRemoteAgentToolList {
	var returns CesToolRemoteAgentToolList
	_jsii_.Get(
		j,
		"remoteAgentTool",
		&returns,
...
func (j *jsiiProxy_CesTool) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CesTool) WidgetTool() CesToolWidgetToolOutputReference {
	var returns CesToolWidgetToolOutputReference
	_jsii_.Get(
		j,
		"widgetTool",
		&returns,
...
func (j *jsiiProxy_CesTool) WidgetToolInput() *CesToolWidgetTool {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/ces_tool google_ces_tool} Resource.
...
func (j *jsiiProxy_CesTool)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CesTool)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CesTool)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CesTool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CesTool) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CesTool) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CesTool) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CesTool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CesTool) PutAgentTool(value *CesToolAgentTool) {
	if err := c.validatePutAgentToolParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CesTool) PutFileSearchTool(value *CesToolFileSearchTool) {
	if err := c.validatePutFileSearchToolParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CesTool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CesTool) ResetAgentTool() {
	_jsii_.InvokeVoid(
		c,
		"resetAgentTool",
		nil, // no parameters
...
func (c *jsiiProxy_CesTool) ResetFileSearchTool() {
	_jsii_.InvokeVoid(
		c,
		"resetFileSearchTool",
		nil, // no parameters
...
func (c *jsiiProxy_CesTool) ResetWidgetTool() {
	_jsii_.InvokeVoid(
		c,
		"resetWidgetTool",
		nil, // no parameters
...
func (c *jsiiProxy_CesTool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
