...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.healthcareDicomStore.HealthcareDicomStoreConfig",
		reflect.TypeOf((*HealthcareDicomStoreConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.healthcareDicomStore.HealthcareDicomStoreNotificationConfig",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSendForBulkImport", GoMethod: "ResetSendForBulkImport"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "sendForBulkImport", GoGetter: "SendForBulkImport"},
			_jsii_.MemberProperty{JsiiProperty: "sendForBulkImportInput", GoGetter: "SendForBulkImportInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.healthcareDicomStore.HealthcareDicomStoreTimeouts",
