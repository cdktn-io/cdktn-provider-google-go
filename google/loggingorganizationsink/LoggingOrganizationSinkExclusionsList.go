...
func (j *jsiiProxy_LoggingOrganizationSinkExclusionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLoggingOrganizationSinkExclusionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LoggingOrganizationSinkExclusionsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google.loggingOrganizationSink.LoggingOrganizationSinkExclusionsList",
...
func NewLoggingOrganizationSinkExclusionsList_Override(l LoggingOrganizationSinkExclusionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LoggingOrganizationSinkExclusionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LoggingOrganizationSinkExclusionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LoggingOrganizationSinkExclusionsList) Resolve(context cdktn.IResolveContext) interface{} {
