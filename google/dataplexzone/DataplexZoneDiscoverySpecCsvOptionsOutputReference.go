...
func (d *jsiiProxy_DataplexZoneDiscoverySpecCsvOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataplexZoneDiscoverySpecCsvOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
