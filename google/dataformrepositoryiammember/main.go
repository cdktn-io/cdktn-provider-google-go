...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataformRepositoryIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dataformRepositoryIamMember.DataformRepositoryIamMemberCondition",
		reflect.TypeOf((*DataformRepositoryIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.dataformRepositoryIamMember.DataformRepositoryIamMemberConditionOutputReference",
		reflect.TypeOf((*DataformRepositoryIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dataformRepositoryIamMember.DataformRepositoryIamMemberConfig",
		reflect.TypeOf((*DataformRepositoryIamMemberConfig)(nil)).Elem(),
	)
}
