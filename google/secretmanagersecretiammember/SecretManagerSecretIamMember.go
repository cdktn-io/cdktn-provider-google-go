...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/secretmanagersecretiammember/internal"
...
func (j *jsiiProxy_SecretManagerSecretIamMember) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SecretManagerSecretIamMember) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecretManagerSecretIamMember) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecretManagerSecretIamMember) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SecretManagerSecretIamMember) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/secret_manager_secret_iam_member google_secret_manager_secret_iam_member} Resource.
...
func (j *jsiiProxy_SecretManagerSecretIamMember)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecretManagerSecretIamMember)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecretManagerSecretIamMember)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SecretManagerSecretIamMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SecretManagerSecretIamMember) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecretManagerSecretIamMember) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecretManagerSecretIamMember) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecretManagerSecretIamMember) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecretManagerSecretIamMember) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecretManagerSecretIamMember) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
