...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/datagooglemonitoringistiocanonicalservice/internal"
...
func (j *jsiiProxy_DataGoogleMonitoringIstioCanonicalService) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataGoogleMonitoringIstioCanonicalService) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DataGoogleMonitoringIstioCanonicalService) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataGoogleMonitoringIstioCanonicalService) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGoogleMonitoringIstioCanonicalService) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataGoogleMonitoringIstioCanonicalService) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataGoogleMonitoringIstioCanonicalService) UserLabels() cdktn.StringMap {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/data-sources/monitoring_istio_canonical_service google_monitoring_istio_canonical_service} Data Source.
func NewDataGoogleMonitoringIstioCanonicalService(scope constructs.Construct, id *string, config *DataGoogleMonitoringIstioCanonicalServiceConfig) DataGoogleMonitoringIstioCanonicalService {
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleMonitoringIstioCanonicalService.DataGoogleMonitoringIstioCanonicalService",
...
func (j *jsiiProxy_DataGoogleMonitoringIstioCanonicalService)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGoogleMonitoringIstioCanonicalService)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataGoogleMonitoringIstioCanonicalService)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataGoogleMonitoringIstioCanonicalService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataGoogleMonitoringIstioCanonicalService) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleMonitoringIstioCanonicalService) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleMonitoringIstioCanonicalService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataGoogleMonitoringIstioCanonicalService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
