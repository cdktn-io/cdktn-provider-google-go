...
func (j *jsiiProxy_ClouddeployDeliveryPipelineConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewClouddeployDeliveryPipelineConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ClouddeployDeliveryPipelineConditionList {
	_init_.Initialize()
...
func NewClouddeployDeliveryPipelineConditionList_Override(c ClouddeployDeliveryPipelineConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ClouddeployDeliveryPipelineConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ClouddeployDeliveryPipelineConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ClouddeployDeliveryPipelineConditionList) Resolve(context cdktn.IResolveContext) interface{} {
