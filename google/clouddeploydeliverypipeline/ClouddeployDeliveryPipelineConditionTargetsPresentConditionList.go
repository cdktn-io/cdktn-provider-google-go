...
func (j *jsiiProxy_ClouddeployDeliveryPipelineConditionTargetsPresentConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewClouddeployDeliveryPipelineConditionTargetsPresentConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ClouddeployDeliveryPipelineConditionTargetsPresentConditionList {
	_init_.Initialize()
...
func NewClouddeployDeliveryPipelineConditionTargetsPresentConditionList_Override(c ClouddeployDeliveryPipelineConditionTargetsPresentConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ClouddeployDeliveryPipelineConditionTargetsPresentConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ClouddeployDeliveryPipelineConditionTargetsPresentConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ClouddeployDeliveryPipelineConditionTargetsPresentConditionList) Resolve(context cdktn.IResolveContext) interface{} {
