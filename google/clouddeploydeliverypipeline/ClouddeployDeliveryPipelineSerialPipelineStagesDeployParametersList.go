...
func (j *jsiiProxy_ClouddeployDeliveryPipelineSerialPipelineStagesDeployParametersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewClouddeployDeliveryPipelineSerialPipelineStagesDeployParametersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ClouddeployDeliveryPipelineSerialPipelineStagesDeployParametersList {
	_init_.Initialize()
...
func NewClouddeployDeliveryPipelineSerialPipelineStagesDeployParametersList_Override(c ClouddeployDeliveryPipelineSerialPipelineStagesDeployParametersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ClouddeployDeliveryPipelineSerialPipelineStagesDeployParametersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ClouddeployDeliveryPipelineSerialPipelineStagesDeployParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ClouddeployDeliveryPipelineSerialPipelineStagesDeployParametersList) Resolve(context cdktn.IResolveContext) interface{} {
