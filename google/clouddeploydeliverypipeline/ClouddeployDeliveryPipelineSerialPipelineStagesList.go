...
func (j *jsiiProxy_ClouddeployDeliveryPipelineSerialPipelineStagesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewClouddeployDeliveryPipelineSerialPipelineStagesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ClouddeployDeliveryPipelineSerialPipelineStagesList {
	_init_.Initialize()
...
func NewClouddeployDeliveryPipelineSerialPipelineStagesList_Override(c ClouddeployDeliveryPipelineSerialPipelineStagesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ClouddeployDeliveryPipelineSerialPipelineStagesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ClouddeployDeliveryPipelineSerialPipelineStagesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ClouddeployDeliveryPipelineSerialPipelineStagesList) Resolve(context cdktn.IResolveContext) interface{} {
