...
func (j *jsiiProxy_DataGoogleRedisClusterAutomatedBackupConfigFixedFrequencyScheduleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleRedisClusterAutomatedBackupConfigFixedFrequencyScheduleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleRedisClusterAutomatedBackupConfigFixedFrequencyScheduleList {
	_init_.Initialize()
...
func NewDataGoogleRedisClusterAutomatedBackupConfigFixedFrequencyScheduleList_Override(d DataGoogleRedisClusterAutomatedBackupConfigFixedFrequencyScheduleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleRedisClusterAutomatedBackupConfigFixedFrequencyScheduleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleRedisClusterAutomatedBackupConfigFixedFrequencyScheduleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleRedisClusterAutomatedBackupConfigFixedFrequencyScheduleList) Resolve(context cdktn.IResolveContext) interface{} {
