...
func (c *jsiiProxy_ComputeHealthCheckGrpcHealthCheckOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeHealthCheckGrpcHealthCheckOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
