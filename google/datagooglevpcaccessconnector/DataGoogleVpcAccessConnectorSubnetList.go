...
func (j *jsiiProxy_DataGoogleVpcAccessConnectorSubnetList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleVpcAccessConnectorSubnetList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleVpcAccessConnectorSubnetList {
	_init_.Initialize()
...
func NewDataGoogleVpcAccessConnectorSubnetList_Override(d DataGoogleVpcAccessConnectorSubnetList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleVpcAccessConnectorSubnetList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleVpcAccessConnectorSubnetList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleVpcAccessConnectorSubnetList) Resolve(context cdktn.IResolveContext) interface{} {
