...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "feedbackContexts", GoGetter: "FeedbackContexts"},
			_jsii_.MemberProperty{JsiiProperty: "feedbackContextsInput", GoGetter: "FeedbackContextsInput"},
			_jsii_.MemberProperty{JsiiProperty: "feedbackId", GoGetter: "FeedbackId"},
			_jsii_.MemberProperty{JsiiProperty: "feedbackIdInput", GoGetter: "FeedbackIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "feedbackType", GoGetter: "FeedbackType"},
			_jsii_.MemberProperty{JsiiProperty: "feedbackTypeInput", GoGetter: "FeedbackTypeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putFeedbackContexts", GoMethod: "PutFeedbackContexts"},
