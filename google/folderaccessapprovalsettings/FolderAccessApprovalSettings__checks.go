...
func (f *jsiiProxy_FolderAccessApprovalSettings) validatePutEnrolledServicesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*FolderAccessApprovalSettingsEnrolledServices; received %#v (a %T)", value, value)
		}
	}
