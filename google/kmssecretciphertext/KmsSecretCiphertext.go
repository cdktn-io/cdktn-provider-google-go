...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/kmssecretciphertext/internal"
...
func (k *jsiiProxy_KmsSecretCiphertext) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KmsSecretCiphertext) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KmsSecretCiphertext) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
