...
func (j *jsiiProxy_MemcacheInstance) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_MemcacheInstance) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_MemcacheInstance)SetDeletionPolicy(val *string) {
...
func (m *jsiiProxy_MemcacheInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MemcacheInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MemcacheInstance) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		m,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (m *jsiiProxy_MemcacheInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
