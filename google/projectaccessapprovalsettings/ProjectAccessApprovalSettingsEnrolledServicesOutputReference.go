...
func (j *jsiiProxy_ProjectAccessApprovalSettingsEnrolledServicesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewProjectAccessApprovalSettingsEnrolledServicesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ProjectAccessApprovalSettingsEnrolledServicesOutputReference {
	_init_.Initialize()
...
func NewProjectAccessApprovalSettingsEnrolledServicesOutputReference_Override(p ProjectAccessApprovalSettingsEnrolledServicesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ProjectAccessApprovalSettingsEnrolledServicesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_ProjectAccessApprovalSettingsEnrolledServicesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_ProjectAccessApprovalSettingsEnrolledServicesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_ProjectAccessApprovalSettingsEnrolledServicesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_ProjectAccessApprovalSettingsEnrolledServicesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
