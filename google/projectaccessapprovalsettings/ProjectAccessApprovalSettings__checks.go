...
func (p *jsiiProxy_ProjectAccessApprovalSettings) validatePutEnrolledServicesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ProjectAccessApprovalSettingsEnrolledServices; received %#v (a %T)", value, value)
		}
	}
