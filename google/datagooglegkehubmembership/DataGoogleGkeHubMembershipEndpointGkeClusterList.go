...
func (j *jsiiProxy_DataGoogleGkeHubMembershipEndpointGkeClusterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleGkeHubMembershipEndpointGkeClusterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleGkeHubMembershipEndpointGkeClusterList {
	_init_.Initialize()
...
func NewDataGoogleGkeHubMembershipEndpointGkeClusterList_Override(d DataGoogleGkeHubMembershipEndpointGkeClusterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipEndpointGkeClusterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleGkeHubMembershipEndpointGkeClusterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleGkeHubMembershipEndpointGkeClusterList) Resolve(context cdktn.IResolveContext) interface{} {
