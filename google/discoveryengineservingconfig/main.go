...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "boostControlIds", GoGetter: "BoostControlIds"},
			_jsii_.MemberProperty{JsiiProperty: "boostControlIdsInput", GoGetter: "BoostControlIdsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "filterControlIds", GoGetter: "FilterControlIds"},
			_jsii_.MemberProperty{JsiiProperty: "filterControlIdsInput", GoGetter: "FilterControlIdsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "promoteControlIds", GoGetter: "PromoteControlIds"},
			_jsii_.MemberProperty{JsiiProperty: "promoteControlIdsInput", GoGetter: "PromoteControlIdsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPromoteControlIds", GoMethod: "ResetPromoteControlIds"},
			_jsii_.MemberMethod{JsiiMethod: "resetRedirectControlIds", GoMethod: "ResetRedirectControlIds"},
			_jsii_.MemberMethod{JsiiMethod: "resetServingConfigId", GoMethod: "ResetServingConfigId"},
			_jsii_.MemberMethod{JsiiMethod: "resetSynonymsControlIds", GoMethod: "ResetSynonymsControlIds"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "servingConfigId", GoGetter: "ServingConfigId"},
			_jsii_.MemberProperty{JsiiProperty: "servingConfigIdInput", GoGetter: "ServingConfigIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "synonymsControlIds", GoGetter: "SynonymsControlIds"},
			_jsii_.MemberProperty{JsiiProperty: "synonymsControlIdsInput", GoGetter: "SynonymsControlIdsInput"},
