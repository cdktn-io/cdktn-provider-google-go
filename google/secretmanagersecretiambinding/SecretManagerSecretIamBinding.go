...
func (j *jsiiProxy_SecretManagerSecretIamBinding) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SecretManagerSecretIamBinding) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecretManagerSecretIamBinding) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecretManagerSecretIamBinding) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SecretManagerSecretIamBinding) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/secret_manager_secret_iam_binding google_secret_manager_secret_iam_binding} Resource.
...
func (j *jsiiProxy_SecretManagerSecretIamBinding)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecretManagerSecretIamBinding)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecretManagerSecretIamBinding)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SecretManagerSecretIamBinding_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SecretManagerSecretIamBinding) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecretManagerSecretIamBinding) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecretManagerSecretIamBinding) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecretManagerSecretIamBinding) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecretManagerSecretIamBinding) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecretManagerSecretIamBinding) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
