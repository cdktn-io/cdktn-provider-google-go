...
func (j *jsiiProxy_HypercomputeclusterClusterOrchestratorSlurmPartitionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHypercomputeclusterClusterOrchestratorSlurmPartitionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HypercomputeclusterClusterOrchestratorSlurmPartitionsList {
	_init_.Initialize()
...
func NewHypercomputeclusterClusterOrchestratorSlurmPartitionsList_Override(h HypercomputeclusterClusterOrchestratorSlurmPartitionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HypercomputeclusterClusterOrchestratorSlurmPartitionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HypercomputeclusterClusterOrchestratorSlurmPartitionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HypercomputeclusterClusterOrchestratorSlurmPartitionsList) Resolve(context cdktn.IResolveContext) interface{} {
