...
func (j *jsiiProxy_LoggingBillingAccountSink) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LoggingBillingAccountSink) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_LoggingBillingAccountSink) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_LoggingBillingAccountSink) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LoggingBillingAccountSink) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LoggingBillingAccountSink) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LoggingBillingAccountSink) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LoggingBillingAccountSink)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_LoggingBillingAccountSink)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LoggingBillingAccountSink)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LoggingBillingAccountSink)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LoggingBillingAccountSink_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LoggingBillingAccountSink) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LoggingBillingAccountSink) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LoggingBillingAccountSink) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LoggingBillingAccountSink) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LoggingBillingAccountSink) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LoggingBillingAccountSink) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		l,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingBillingAccountSink) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
