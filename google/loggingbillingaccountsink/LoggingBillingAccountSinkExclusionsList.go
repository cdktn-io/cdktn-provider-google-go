...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v17/loggingbillingaccountsink/internal"
...
func (j *jsiiProxy_LoggingBillingAccountSinkExclusionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLoggingBillingAccountSinkExclusionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LoggingBillingAccountSinkExclusionsList {
	_init_.Initialize()
...
func NewLoggingBillingAccountSinkExclusionsList_Override(l LoggingBillingAccountSinkExclusionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LoggingBillingAccountSinkExclusionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LoggingBillingAccountSinkExclusionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LoggingBillingAccountSinkExclusionsList) Resolve(context cdktn.IResolveContext) interface{} {
