...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkConnectivityGatewayAdvertisedRoute)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.networkConnectivityGatewayAdvertisedRoute.NetworkConnectivityGatewayAdvertisedRouteConfig",
		reflect.TypeOf((*NetworkConnectivityGatewayAdvertisedRouteConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.networkConnectivityGatewayAdvertisedRoute.NetworkConnectivityGatewayAdvertisedRouteTimeouts",
		reflect.TypeOf((*NetworkConnectivityGatewayAdvertisedRouteTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkConnectivityGatewayAdvertisedRouteTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
