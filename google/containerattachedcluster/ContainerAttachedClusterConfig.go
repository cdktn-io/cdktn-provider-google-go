...
type ContainerAttachedClusterConfig struct {
	...
	BinaryAuthorization *ContainerAttachedClusterBinaryAuthorization `field:"optional" json:"binaryAuthorization" yaml:"binaryAuthorization"`
	...
	ProxyConfig *ContainerAttachedClusterProxyConfig `field:"optional" json:"proxyConfig" yaml:"proxyConfig"`
	...
	SecurityPostureConfig *ContainerAttachedClusterSecurityPostureConfig `field:"optional" json:"securityPostureConfig" yaml:"securityPostureConfig"`
	// timeouts block.
	//
