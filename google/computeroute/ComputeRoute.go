...
type ComputeRoute interface {
	...
	ParamsInput() *ComputeRouteParams
	Priority() *float64
	...
	PutParams(value *ComputeRouteParams)
...
func (j *jsiiProxy_ComputeRoute) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ComputeRoute) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ComputeRoute) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_ComputeRoute) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ComputeRoute) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ComputeRoute) Params() ComputeRouteParamsOutputReference {
	var returns ComputeRouteParamsOutputReference
	_jsii_.Get(
		j,
		"params",
		&returns,
...
func (j *jsiiProxy_ComputeRoute) ParamsInput() *ComputeRouteParams {
...
func (j *jsiiProxy_ComputeRoute) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ComputeRoute) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/compute_route google_compute_route} Resource.
...
func (j *jsiiProxy_ComputeRoute)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_ComputeRoute)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ComputeRoute)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ComputeRoute)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ComputeRoute_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ComputeRoute) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputeRoute) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ComputeRoute) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputeRoute) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputeRoute) PutParams(value *ComputeRouteParams) {
...
func (c *jsiiProxy_ComputeRoute) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputeRoute) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeRoute) ResetParams() {
	_jsii_.InvokeVoid(
		c,
		"resetParams",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
