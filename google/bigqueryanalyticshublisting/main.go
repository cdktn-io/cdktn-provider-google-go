...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "selectedResourcesInput", GoGetter: "SelectedResourcesInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRestrictQueryResult", GoMethod: "ResetRestrictQueryResult"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "restrictDirectTableAccess", GoGetter: "RestrictDirectTableAccess"},
			_jsii_.MemberProperty{JsiiProperty: "restrictQueryResult", GoGetter: "RestrictQueryResult"},
			_jsii_.MemberProperty{JsiiProperty: "restrictQueryResultInput", GoGetter: "RestrictQueryResultInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
