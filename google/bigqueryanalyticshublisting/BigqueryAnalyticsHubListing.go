...
func (j *jsiiProxy_BigqueryAnalyticsHubListing) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BigqueryAnalyticsHubListing) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BigqueryAnalyticsHubListing) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BigqueryAnalyticsHubListing) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BigqueryAnalyticsHubListing) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/bigquery_analytics_hub_listing google_bigquery_analytics_hub_listing} Resource.
...
func (j *jsiiProxy_BigqueryAnalyticsHubListing)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BigqueryAnalyticsHubListing)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BigqueryAnalyticsHubListing)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BigqueryAnalyticsHubListing_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BigqueryAnalyticsHubListing) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListing) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListing) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListing) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListing) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListing) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
