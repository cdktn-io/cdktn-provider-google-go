...
func (j *jsiiProxy_BigqueryAnalyticsHubListingCommercialInfoList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBigqueryAnalyticsHubListingCommercialInfoList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BigqueryAnalyticsHubListingCommercialInfoList {
	_init_.Initialize()
...
func NewBigqueryAnalyticsHubListingCommercialInfoList_Override(b BigqueryAnalyticsHubListingCommercialInfoList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingCommercialInfoList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingCommercialInfoList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingCommercialInfoList) Resolve(context cdktn.IResolveContext) interface{} {
