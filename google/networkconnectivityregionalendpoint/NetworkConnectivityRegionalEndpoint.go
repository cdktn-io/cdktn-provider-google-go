...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/networkconnectivityregionalendpoint/internal"
...
func (j *jsiiProxy_NetworkConnectivityRegionalEndpoint) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_NetworkConnectivityRegionalEndpoint) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/network_connectivity_regional_endpoint google_network_connectivity_regional_endpoint} Resource.
...
func (j *jsiiProxy_NetworkConnectivityRegionalEndpoint)SetDeletionPolicy(val *string) {
...
func (n *jsiiProxy_NetworkConnectivityRegionalEndpoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkConnectivityRegionalEndpoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkConnectivityRegionalEndpoint) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		n,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkConnectivityRegionalEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
