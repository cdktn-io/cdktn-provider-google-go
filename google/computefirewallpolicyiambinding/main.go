...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ComputeFirewallPolicyIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.computeFirewallPolicyIamBinding.ComputeFirewallPolicyIamBindingCondition",
		reflect.TypeOf((*ComputeFirewallPolicyIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.computeFirewallPolicyIamBinding.ComputeFirewallPolicyIamBindingConditionOutputReference",
		reflect.TypeOf((*ComputeFirewallPolicyIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_ComputeFirewallPolicyIamBindingConditionOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.computeFirewallPolicyIamBinding.ComputeFirewallPolicyIamBindingConfig",
		reflect.TypeOf((*ComputeFirewallPolicyIamBindingConfig)(nil)).Elem(),
	)
}
