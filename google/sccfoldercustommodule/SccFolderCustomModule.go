...
func (j *jsiiProxy_SccFolderCustomModule) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_SccFolderCustomModule) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/scc_folder_custom_module google_scc_folder_custom_module} Resource.
...
func (j *jsiiProxy_SccFolderCustomModule)SetDeletionPolicy(val *string) {
...
func (s *jsiiProxy_SccFolderCustomModule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SccFolderCustomModule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SccFolderCustomModule) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		s,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (s *jsiiProxy_SccFolderCustomModule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
