...
func (j *jsiiProxy_DataGoogleComputeSnapshotSourceDiskEncryptionKeyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeSnapshotSourceDiskEncryptionKeyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeSnapshotSourceDiskEncryptionKeyList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleComputeSnapshot.DataGoogleComputeSnapshotSourceDiskEncryptionKeyList",
...
func NewDataGoogleComputeSnapshotSourceDiskEncryptionKeyList_Override(d DataGoogleComputeSnapshotSourceDiskEncryptionKeyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeSnapshotSourceDiskEncryptionKeyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeSnapshotSourceDiskEncryptionKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeSnapshotSourceDiskEncryptionKeyList) Resolve(context cdktn.IResolveContext) interface{} {
