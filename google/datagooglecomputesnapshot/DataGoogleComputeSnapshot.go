...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/compute_snapshot google_compute_snapshot}.
...
func (j *jsiiProxy_DataGoogleComputeSnapshot) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DataGoogleComputeSnapshot) Params() DataGoogleComputeSnapshotParamsList {
	var returns DataGoogleComputeSnapshotParamsList
	_jsii_.Get(
		j,
		"params",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/compute_snapshot google_compute_snapshot} Data Source.
func NewDataGoogleComputeSnapshot(scope constructs.Construct, id *string, config *DataGoogleComputeSnapshotConfig) DataGoogleComputeSnapshot {
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleComputeSnapshot.DataGoogleComputeSnapshot",
