...
func (c *jsiiProxy_ChronicleNativeDashboard) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ChronicleNativeDashboard) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
