...
func (d *jsiiProxy_DataprocSessionTemplateEnvironmentConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataprocSessionTemplateEnvironmentConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
