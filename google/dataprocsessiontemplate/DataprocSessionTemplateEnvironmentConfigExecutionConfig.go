...
type DataprocSessionTemplateEnvironmentConfigExecutionConfig struct {
	...
	AuthenticationConfig *DataprocSessionTemplateEnvironmentConfigExecutionConfigAuthenticationConfig `field:"optional" json:"authenticationConfig" yaml:"authenticationConfig"`
