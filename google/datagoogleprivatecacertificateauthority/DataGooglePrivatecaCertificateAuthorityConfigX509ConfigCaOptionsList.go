...
func (j *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigX509ConfigCaOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGooglePrivatecaCertificateAuthorityConfigX509ConfigCaOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGooglePrivatecaCertificateAuthorityConfigX509ConfigCaOptionsList {
	_init_.Initialize()
...
func NewDataGooglePrivatecaCertificateAuthorityConfigX509ConfigCaOptionsList_Override(d DataGooglePrivatecaCertificateAuthorityConfigX509ConfigCaOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigX509ConfigCaOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigX509ConfigCaOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigX509ConfigCaOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
