...
func (j *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGooglePrivatecaCertificateAuthorityConfigSubjectConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGooglePrivatecaCertificateAuthority.DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigList",
...
func NewDataGooglePrivatecaCertificateAuthorityConfigSubjectConfigList_Override(d DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigList) Resolve(context cdktn.IResolveContext) interface{} {
