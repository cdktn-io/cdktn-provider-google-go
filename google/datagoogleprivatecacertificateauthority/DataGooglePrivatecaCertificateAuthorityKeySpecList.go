...
func (j *jsiiProxy_DataGooglePrivatecaCertificateAuthorityKeySpecList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGooglePrivatecaCertificateAuthorityKeySpecList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGooglePrivatecaCertificateAuthorityKeySpecList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGooglePrivatecaCertificateAuthority.DataGooglePrivatecaCertificateAuthorityKeySpecList",
...
func NewDataGooglePrivatecaCertificateAuthorityKeySpecList_Override(d DataGooglePrivatecaCertificateAuthorityKeySpecList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGooglePrivatecaCertificateAuthorityKeySpecList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGooglePrivatecaCertificateAuthorityKeySpecList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGooglePrivatecaCertificateAuthorityKeySpecList) Resolve(context cdktn.IResolveContext) interface{} {
