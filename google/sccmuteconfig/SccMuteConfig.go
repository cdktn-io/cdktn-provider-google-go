...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/sccmuteconfig/internal"
...
func (j *jsiiProxy_SccMuteConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SccMuteConfig) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_SccMuteConfig) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_SccMuteConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SccMuteConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SccMuteConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SccMuteConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/scc_mute_config google_scc_mute_config} Resource.
...
func (j *jsiiProxy_SccMuteConfig)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_SccMuteConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SccMuteConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SccMuteConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SccMuteConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SccMuteConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SccMuteConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SccMuteConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SccMuteConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SccMuteConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SccMuteConfig) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		s,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (s *jsiiProxy_SccMuteConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
