...
func (j *jsiiProxy_DataGoogleKmsCryptoKeyVersionTemplateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleKmsCryptoKeyVersionTemplateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleKmsCryptoKeyVersionTemplateList {
	_init_.Initialize()
...
func NewDataGoogleKmsCryptoKeyVersionTemplateList_Override(d DataGoogleKmsCryptoKeyVersionTemplateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleKmsCryptoKeyVersionTemplateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleKmsCryptoKeyVersionTemplateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleKmsCryptoKeyVersionTemplateList) Resolve(context cdktn.IResolveContext) interface{} {
