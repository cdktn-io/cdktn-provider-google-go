...
func (j *jsiiProxy_DataGoogleComputeRegionInstanceTemplateSchedulingOnInstanceStopActionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeRegionInstanceTemplateSchedulingOnInstanceStopActionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeRegionInstanceTemplateSchedulingOnInstanceStopActionList {
	_init_.Initialize()
...
func NewDataGoogleComputeRegionInstanceTemplateSchedulingOnInstanceStopActionList_Override(d DataGoogleComputeRegionInstanceTemplateSchedulingOnInstanceStopActionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeRegionInstanceTemplateSchedulingOnInstanceStopActionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeRegionInstanceTemplateSchedulingOnInstanceStopActionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeRegionInstanceTemplateSchedulingOnInstanceStopActionList) Resolve(context cdktn.IResolveContext) interface{} {
