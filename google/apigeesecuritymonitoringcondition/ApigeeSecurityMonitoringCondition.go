...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/apigeesecuritymonitoringcondition/internal"
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) ConditionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"conditionId",
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) ConditionIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"conditionIdInput",
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) IncludeAllResources() ApigeeSecurityMonitoringConditionIncludeAllResourcesOutputReference {
	var returns ApigeeSecurityMonitoringConditionIncludeAllResourcesOutputReference
	_jsii_.Get(
		j,
		"includeAllResources",
		&returns,
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) IncludeAllResourcesInput() *ApigeeSecurityMonitoringConditionIncludeAllResources {
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) Node() constructs.Node {
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) OrgId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"orgId",
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) OrgIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"orgIdInput",
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) Profile() *string {
	var returns *string
	_jsii_.Get(
		j,
		"profile",
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) ProfileInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"profileInput",
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) Scope() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scope",
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) ScopeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scopeInput",
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) Timeouts() ApigeeSecurityMonitoringConditionTimeoutsOutputReference {
	var returns ApigeeSecurityMonitoringConditionTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) TotalDeployedResources() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) TotalMonitoredResources() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApigeeSecurityMonitoringCondition) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/apigee_security_monitoring_condition google_apigee_security_monitoring_condition} Resource.
func NewApigeeSecurityMonitoringCondition(scope constructs.Construct, id *string, config *ApigeeSecurityMonitoringConditionConfig) ApigeeSecurityMonitoringCondition {
	...
	if err := validateNewApigeeSecurityMonitoringConditionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ApigeeSecurityMonitoringCondition_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-google.apigeeSecurityMonitoringCondition.ApigeeSecurityMonitoringCondition",
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) MoveToId(id *string) {
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) PutIncludeAllResources(value *ApigeeSecurityMonitoringConditionIncludeAllResources) {
	if err := a.validatePutIncludeAllResourcesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) PutTimeouts(value *ApigeeSecurityMonitoringConditionTimeouts) {
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) ResetIncludeAllResources() {
	_jsii_.InvokeVoid(
		a,
		"resetIncludeAllResources",
		nil, // no parameters
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) ResetTimeouts() {
	_jsii_.InvokeVoid(
		a,
		"resetTimeouts",
		nil, // no parameters
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) ToString() *string {
	var returns *string
...
func (a *jsiiProxy_ApigeeSecurityMonitoringCondition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
