...
func (c *jsiiProxy_CloudRunServiceTemplateSpecContainersEnvFromSecretRefOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudRunServiceTemplateSpecContainersEnvFromSecretRefOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
