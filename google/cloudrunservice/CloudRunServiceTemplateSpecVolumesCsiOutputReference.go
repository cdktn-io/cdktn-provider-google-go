...
func (c *jsiiProxy_CloudRunServiceTemplateSpecVolumesCsiOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudRunServiceTemplateSpecVolumesCsiOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
