...
type IamWorkloadIdentityPoolProviderX509OutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *IamWorkloadIdentityPoolProviderX509
	SetInternalValue(val *IamWorkloadIdentityPoolProviderX509)
	// Experimental.
...
func (j *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) InternalValue() *IamWorkloadIdentityPoolProviderX509 {
...
func (j *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) TrustStore() IamWorkloadIdentityPoolProviderX509TrustStoreOutputReference {
	var returns IamWorkloadIdentityPoolProviderX509TrustStoreOutputReference
	_jsii_.Get(
		j,
		"trustStore",
		&returns,
...
func (j *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) TrustStoreInput() *IamWorkloadIdentityPoolProviderX509TrustStore {
...
func (i *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (i *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (i *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (i *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (i *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (i *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (i *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (i *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) PutTrustStore(value *IamWorkloadIdentityPoolProviderX509TrustStore) {
	if err := i.validatePutTrustStoreParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
...
func (i *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (i *jsiiProxy_IamWorkloadIdentityPoolProviderX509OutputReference) ToString() *string {
	var returns *string
