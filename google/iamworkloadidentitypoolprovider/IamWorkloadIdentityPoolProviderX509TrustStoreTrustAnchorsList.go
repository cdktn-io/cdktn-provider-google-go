...
func (j *jsiiProxy_IamWorkloadIdentityPoolProviderX509TrustStoreTrustAnchorsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewIamWorkloadIdentityPoolProviderX509TrustStoreTrustAnchorsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IamWorkloadIdentityPoolProviderX509TrustStoreTrustAnchorsList {
	_init_.Initialize()
...
func NewIamWorkloadIdentityPoolProviderX509TrustStoreTrustAnchorsList_Override(i IamWorkloadIdentityPoolProviderX509TrustStoreTrustAnchorsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IamWorkloadIdentityPoolProviderX509TrustStoreTrustAnchorsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (i *jsiiProxy_IamWorkloadIdentityPoolProviderX509TrustStoreTrustAnchorsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IamWorkloadIdentityPoolProviderX509TrustStoreTrustAnchorsList) Resolve(context cdktf.IResolveContext) interface{} {
