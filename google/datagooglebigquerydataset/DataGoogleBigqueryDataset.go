...
func (j *jsiiProxy_DataGoogleBigqueryDataset) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/data-sources/bigquery_dataset google_bigquery_dataset} Data Source.
func NewDataGoogleBigqueryDataset(scope constructs.Construct, id *string, config *DataGoogleBigqueryDatasetConfig) DataGoogleBigqueryDataset {
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleBigqueryDataset.DataGoogleBigqueryDataset",
...
func (d *jsiiProxy_DataGoogleBigqueryDataset) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataGoogleBigqueryDataset) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
