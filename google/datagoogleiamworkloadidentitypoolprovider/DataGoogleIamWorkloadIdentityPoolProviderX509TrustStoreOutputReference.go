...
func (j *jsiiProxy_DataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreOutputReference {
	_init_.Initialize()
...
func NewDataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreOutputReference_Override(d DataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
