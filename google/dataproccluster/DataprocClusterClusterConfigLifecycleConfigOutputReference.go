...
func (d *jsiiProxy_DataprocClusterClusterConfigLifecycleConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataprocClusterClusterConfigLifecycleConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
