...
func (d *jsiiProxy_DataprocClusterClusterConfigMasterConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataprocClusterClusterConfigMasterConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
