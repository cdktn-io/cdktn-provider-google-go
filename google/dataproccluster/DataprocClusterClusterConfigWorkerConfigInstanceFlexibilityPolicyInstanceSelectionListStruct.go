...
type DataprocClusterClusterConfigWorkerConfigInstanceFlexibilityPolicyInstanceSelectionListStruct struct {
	// disk_config block.
	//
	...
	DiskConfig *DataprocClusterClusterConfigWorkerConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfig `field:"optional" json:"diskConfig" yaml:"diskConfig"`
