...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/notebooksinstanceiammember/internal"
...
func (j *jsiiProxy_NotebooksInstanceIamMember) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NotebooksInstanceIamMember) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NotebooksInstanceIamMember) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NotebooksInstanceIamMember) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NotebooksInstanceIamMember) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/notebooks_instance_iam_member google_notebooks_instance_iam_member} Resource.
func NewNotebooksInstanceIamMember(scope constructs.Construct, id *string, config *NotebooksInstanceIamMemberConfig) NotebooksInstanceIamMember {
	...
	_jsii_.Create(
		"@cdktn/provider-google.notebooksInstanceIamMember.NotebooksInstanceIamMember",
...
func (j *jsiiProxy_NotebooksInstanceIamMember)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NotebooksInstanceIamMember)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NotebooksInstanceIamMember)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NotebooksInstanceIamMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NotebooksInstanceIamMember) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NotebooksInstanceIamMember) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NotebooksInstanceIamMember) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NotebooksInstanceIamMember) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NotebooksInstanceIamMember) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NotebooksInstanceIamMember) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
