...
func (j *jsiiProxy_DataGooglePrivilegedAccessManagerEntitlementEligibleUsersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGooglePrivilegedAccessManagerEntitlementEligibleUsersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGooglePrivilegedAccessManagerEntitlementEligibleUsersList {
	_init_.Initialize()
...
func NewDataGooglePrivilegedAccessManagerEntitlementEligibleUsersList_Override(d DataGooglePrivilegedAccessManagerEntitlementEligibleUsersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGooglePrivilegedAccessManagerEntitlementEligibleUsersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGooglePrivilegedAccessManagerEntitlementEligibleUsersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGooglePrivilegedAccessManagerEntitlementEligibleUsersList) Resolve(context cdktn.IResolveContext) interface{} {
