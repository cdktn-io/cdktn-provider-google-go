...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/privatecacertificatetemplateiammember/internal"
...
func (j *jsiiProxy_PrivatecaCertificateTemplateIamMember) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PrivatecaCertificateTemplateIamMember) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PrivatecaCertificateTemplateIamMember) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PrivatecaCertificateTemplateIamMember) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PrivatecaCertificateTemplateIamMember) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_PrivatecaCertificateTemplateIamMember)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PrivatecaCertificateTemplateIamMember)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PrivatecaCertificateTemplateIamMember)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PrivatecaCertificateTemplateIamMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PrivatecaCertificateTemplateIamMember) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivatecaCertificateTemplateIamMember) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PrivatecaCertificateTemplateIamMember) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivatecaCertificateTemplateIamMember) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PrivatecaCertificateTemplateIamMember) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PrivatecaCertificateTemplateIamMember) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
