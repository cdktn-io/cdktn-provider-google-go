...
func (j *jsiiProxy_StorageHmacKey) validateSetCountParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_StorageHmacKey) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
