...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "oauth2ClientIdWoInput", GoGetter: "Oauth2ClientIdWoInput"},
			_jsii_.MemberProperty{JsiiProperty: "oauth2ClientIdWoVersion", GoGetter: "Oauth2ClientIdWoVersion"},
			_jsii_.MemberProperty{JsiiProperty: "oauth2ClientIdWoVersionInput", GoGetter: "Oauth2ClientIdWoVersionInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "oauth2ClientSecretWoInput", GoGetter: "Oauth2ClientSecretWoInput"},
			_jsii_.MemberProperty{JsiiProperty: "oauth2ClientSecretWoVersion", GoGetter: "Oauth2ClientSecretWoVersion"},
			_jsii_.MemberProperty{JsiiProperty: "oauth2ClientSecretWoVersionInput", GoGetter: "Oauth2ClientSecretWoVersionInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetOauth2ClientId", GoMethod: "ResetOauth2ClientId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOauth2ClientIdWo", GoMethod: "ResetOauth2ClientIdWo"},
			_jsii_.MemberMethod{JsiiMethod: "resetOauth2ClientIdWoVersion", GoMethod: "ResetOauth2ClientIdWoVersion"},
			_jsii_.MemberMethod{JsiiMethod: "resetOauth2ClientSecret", GoMethod: "ResetOauth2ClientSecret"},
			_jsii_.MemberMethod{JsiiMethod: "resetOauth2ClientSecretWo", GoMethod: "ResetOauth2ClientSecretWo"},
			_jsii_.MemberMethod{JsiiMethod: "resetOauth2ClientSecretWoVersion", GoMethod: "ResetOauth2ClientSecretWoVersion"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.computeBackendService.ComputeBackendServiceLogConfigRequestHeaders",
		reflect.TypeOf((*ComputeBackendServiceLogConfigRequestHeaders)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.computeBackendService.ComputeBackendServiceLogConfigRequestHeadersList",
		reflect.TypeOf((*ComputeBackendServiceLogConfigRequestHeadersList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ComputeBackendServiceLogConfigRequestHeadersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.computeBackendService.ComputeBackendServiceLogConfigResponseHeaders",
		reflect.TypeOf((*ComputeBackendServiceLogConfigResponseHeaders)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.computeBackendService.ComputeBackendServiceLogConfigResponseHeadersList",
		reflect.TypeOf((*ComputeBackendServiceLogConfigResponseHeadersList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ComputeBackendServiceLogConfigResponseHeadersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
