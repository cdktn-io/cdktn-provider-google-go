...
func (c *jsiiProxy_ComputeBackendServiceLocalityLbPoliciesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeBackendServiceLocalityLbPoliciesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
