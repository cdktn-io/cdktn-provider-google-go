...
func (j *jsiiProxy_ComputeBackendServiceCdnPolicyBypassCacheOnRequestHeadersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewComputeBackendServiceCdnPolicyBypassCacheOnRequestHeadersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ComputeBackendServiceCdnPolicyBypassCacheOnRequestHeadersList {
	_init_.Initialize()
...
func NewComputeBackendServiceCdnPolicyBypassCacheOnRequestHeadersList_Override(c ComputeBackendServiceCdnPolicyBypassCacheOnRequestHeadersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComputeBackendServiceCdnPolicyBypassCacheOnRequestHeadersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ComputeBackendServiceCdnPolicyBypassCacheOnRequestHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ComputeBackendServiceCdnPolicyBypassCacheOnRequestHeadersList) Resolve(context cdktn.IResolveContext) interface{} {
