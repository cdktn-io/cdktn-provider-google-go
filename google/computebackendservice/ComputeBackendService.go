...
func (c *jsiiProxy_ComputeBackendService) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputeBackendService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputeBackendService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
