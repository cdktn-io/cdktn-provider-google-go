...
func (j *jsiiProxy_ComputeBackendServiceCdnPolicyNegativeCachingPolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewComputeBackendServiceCdnPolicyNegativeCachingPolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ComputeBackendServiceCdnPolicyNegativeCachingPolicyList {
	_init_.Initialize()
...
func NewComputeBackendServiceCdnPolicyNegativeCachingPolicyList_Override(c ComputeBackendServiceCdnPolicyNegativeCachingPolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComputeBackendServiceCdnPolicyNegativeCachingPolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ComputeBackendServiceCdnPolicyNegativeCachingPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ComputeBackendServiceCdnPolicyNegativeCachingPolicyList) Resolve(context cdktn.IResolveContext) interface{} {
