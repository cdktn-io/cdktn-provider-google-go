...
func (j *jsiiProxy_GeminiReleaseChannelSetting) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GeminiReleaseChannelSetting)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
