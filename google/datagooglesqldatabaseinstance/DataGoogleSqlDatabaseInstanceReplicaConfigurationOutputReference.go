...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstanceReplicaConfigurationOutputReference) CascadableReplica() cdktn.IResolvable {
...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstanceReplicaConfigurationOutputReference) FailoverTarget() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"failoverTarget",
...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstanceReplicaConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstanceReplicaConfigurationOutputReference) VerifyServerCertificate() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func NewDataGoogleSqlDatabaseInstanceReplicaConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleSqlDatabaseInstanceReplicaConfigurationOutputReference {
	_init_.Initialize()
...
func NewDataGoogleSqlDatabaseInstanceReplicaConfigurationOutputReference_Override(d DataGoogleSqlDatabaseInstanceReplicaConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstanceReplicaConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleSqlDatabaseInstanceReplicaConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleSqlDatabaseInstanceReplicaConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGoogleSqlDatabaseInstanceReplicaConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleSqlDatabaseInstanceReplicaConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
