...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstance) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstance) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstance) DeletionProtection() cdktn.IResolvable {
...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstance) EnforceNewSqlNetworkArchitecture() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstance) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstance) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstance) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstance)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstance)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstance)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataGoogleSqlDatabaseInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataGoogleSqlDatabaseInstance) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleSqlDatabaseInstance) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleSqlDatabaseInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataGoogleSqlDatabaseInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
