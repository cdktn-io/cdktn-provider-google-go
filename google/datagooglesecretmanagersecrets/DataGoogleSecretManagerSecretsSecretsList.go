...
func (j *jsiiProxy_DataGoogleSecretManagerSecretsSecretsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleSecretManagerSecretsSecretsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleSecretManagerSecretsSecretsList {
	_init_.Initialize()
...
func NewDataGoogleSecretManagerSecretsSecretsList_Override(d DataGoogleSecretManagerSecretsSecretsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretsSecretsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretsSecretsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretsSecretsList) Resolve(context cdktn.IResolveContext) interface{} {
