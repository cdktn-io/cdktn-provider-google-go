...
type OracleDatabaseGoldengateConnectionPropertiesPostgresqlConnectionProperties struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/oracle_database_goldengate_connection#db_system_id OracleDatabaseGoldengateConnection#db_system_id}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/oracle_database_goldengate_connection#ssl_ca_file OracleDatabaseGoldengateConnection#ssl_ca_file}
	SslCaFile *string `field:"optional" json:"sslCaFile" yaml:"sslCaFile"`
	// The certificate of the PostgreSQL server.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/oracle_database_goldengate_connection#ssl_cert_file OracleDatabaseGoldengateConnection#ssl_cert_file}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/oracle_database_goldengate_connection#ssl_crl_file OracleDatabaseGoldengateConnection#ssl_crl_file}
	SslCrlFile *string `field:"optional" json:"sslCrlFile" yaml:"sslCrlFile"`
	// The private key of the PostgreSQL server.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/oracle_database_goldengate_connection#ssl_key_file OracleDatabaseGoldengateConnection#ssl_key_file}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/oracle_database_goldengate_connection#ssl_mode OracleDatabaseGoldengateConnection#ssl_mode}
