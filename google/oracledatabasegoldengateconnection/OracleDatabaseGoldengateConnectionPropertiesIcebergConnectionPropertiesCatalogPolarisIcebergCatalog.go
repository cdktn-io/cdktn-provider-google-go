...
type OracleDatabaseGoldengateConnectionPropertiesIcebergConnectionPropertiesCatalogPolarisIcebergCatalog struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/oracle_database_goldengate_connection#polaris_catalog OracleDatabaseGoldengateConnection#polaris_catalog}
	PolarisCatalog *string `field:"required" json:"polarisCatalog" yaml:"polarisCatalog"`
	// The Polaris principal role.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/oracle_database_goldengate_connection#principal_role OracleDatabaseGoldengateConnection#principal_role}
