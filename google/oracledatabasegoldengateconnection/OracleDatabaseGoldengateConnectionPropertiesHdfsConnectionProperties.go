...
type OracleDatabaseGoldengateConnectionPropertiesHdfsConnectionProperties struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/oracle_database_goldengate_connection#core_site_xml OracleDatabaseGoldengateConnection#core_site_xml}
