...
type OracleDatabaseGoldengateConnectionPropertiesAzureDataLakeStorageConnectionProperties struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/oracle_database_goldengate_connection#account OracleDatabaseGoldengateConnection#account}
	Account *string `field:"optional" json:"account" yaml:"account"`
	// Azure storage account key. This property is required when 'authentication_type' is set to 'SHARED_KEY'.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/oracle_database_goldengate_connection#account_key_secret OracleDatabaseGoldengateConnection#account_key_secret}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/oracle_database_goldengate_connection#azure_authority_host OracleDatabaseGoldengateConnection#azure_authority_host}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/oracle_database_goldengate_connection#azure_tenant_id OracleDatabaseGoldengateConnection#azure_tenant_id}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/oracle_database_goldengate_connection#sas_token_secret OracleDatabaseGoldengateConnection#sas_token_secret}
