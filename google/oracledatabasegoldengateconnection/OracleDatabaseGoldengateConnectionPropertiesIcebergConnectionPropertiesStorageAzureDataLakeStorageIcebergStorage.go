...
type OracleDatabaseGoldengateConnectionPropertiesIcebergConnectionPropertiesStorageAzureDataLakeStorageIcebergStorage struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/oracle_database_goldengate_connection#azure_account OracleDatabaseGoldengateConnection#azure_account}
	AzureAccount *string `field:"required" json:"azureAccount" yaml:"azureAccount"`
	// The container of Azure Data Lake Storage.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/oracle_database_goldengate_connection#container OracleDatabaseGoldengateConnection#container}
