...
func (j *jsiiProxy_DataGoogleApphubDiscoveredWorkloadWorkloadPropertiesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleApphubDiscoveredWorkloadWorkloadPropertiesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleApphubDiscoveredWorkloadWorkloadPropertiesList {
	_init_.Initialize()
...
func NewDataGoogleApphubDiscoveredWorkloadWorkloadPropertiesList_Override(d DataGoogleApphubDiscoveredWorkloadWorkloadPropertiesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleApphubDiscoveredWorkloadWorkloadPropertiesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleApphubDiscoveredWorkloadWorkloadPropertiesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleApphubDiscoveredWorkloadWorkloadPropertiesList) Resolve(context cdktn.IResolveContext) interface{} {
