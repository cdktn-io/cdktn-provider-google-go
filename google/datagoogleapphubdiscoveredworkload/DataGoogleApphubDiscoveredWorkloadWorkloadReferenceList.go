...
func (j *jsiiProxy_DataGoogleApphubDiscoveredWorkloadWorkloadReferenceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleApphubDiscoveredWorkloadWorkloadReferenceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleApphubDiscoveredWorkloadWorkloadReferenceList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleApphubDiscoveredWorkload.DataGoogleApphubDiscoveredWorkloadWorkloadReferenceList",
...
func NewDataGoogleApphubDiscoveredWorkloadWorkloadReferenceList_Override(d DataGoogleApphubDiscoveredWorkloadWorkloadReferenceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleApphubDiscoveredWorkloadWorkloadReferenceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleApphubDiscoveredWorkloadWorkloadReferenceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleApphubDiscoveredWorkloadWorkloadReferenceList) Resolve(context cdktn.IResolveContext) interface{} {
