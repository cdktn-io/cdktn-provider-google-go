...
func (a *jsiiProxy_AlloydbBackupExpiryQuantityList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (a *jsiiProxy_AlloydbBackupExpiryQuantityList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_AlloydbBackupExpiryQuantityList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_AlloydbBackupExpiryQuantityList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
