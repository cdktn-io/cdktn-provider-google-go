...
func (j *jsiiProxy_AccessContextManagerServicePerimeterDryRunEgressPolicyEgressToOutputReference) Roles() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"roles",
...
func (j *jsiiProxy_AccessContextManagerServicePerimeterDryRunEgressPolicyEgressToOutputReference) RolesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"rolesInput",
...
func (j *jsiiProxy_AccessContextManagerServicePerimeterDryRunEgressPolicyEgressToOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAccessContextManagerServicePerimeterDryRunEgressPolicyEgressToOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AccessContextManagerServicePerimeterDryRunEgressPolicyEgressToOutputReference {
	_init_.Initialize()
...
func NewAccessContextManagerServicePerimeterDryRunEgressPolicyEgressToOutputReference_Override(a AccessContextManagerServicePerimeterDryRunEgressPolicyEgressToOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AccessContextManagerServicePerimeterDryRunEgressPolicyEgressToOutputReference)SetRoles(val *[]*string) {
...
func (j *jsiiProxy_AccessContextManagerServicePerimeterDryRunEgressPolicyEgressToOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AccessContextManagerServicePerimeterDryRunEgressPolicyEgressToOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AccessContextManagerServicePerimeterDryRunEgressPolicyEgressToOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AccessContextManagerServicePerimeterDryRunEgressPolicyEgressToOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AccessContextManagerServicePerimeterDryRunEgressPolicyEgressToOutputReference) ResetRoles() {
	_jsii_.InvokeVoid(
		a,
		"resetRoles",
		nil, // no parameters
...
func (a *jsiiProxy_AccessContextManagerServicePerimeterDryRunEgressPolicyEgressToOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
