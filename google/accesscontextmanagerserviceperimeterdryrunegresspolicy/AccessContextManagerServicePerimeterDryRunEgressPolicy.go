...
func (j *jsiiProxy_AccessContextManagerServicePerimeterDryRunEgressPolicy) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_AccessContextManagerServicePerimeterDryRunEgressPolicy) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_AccessContextManagerServicePerimeterDryRunEgressPolicy)SetDeletionPolicy(val *string) {
...
func (a *jsiiProxy_AccessContextManagerServicePerimeterDryRunEgressPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AccessContextManagerServicePerimeterDryRunEgressPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AccessContextManagerServicePerimeterDryRunEgressPolicy) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		a,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (a *jsiiProxy_AccessContextManagerServicePerimeterDryRunEgressPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
