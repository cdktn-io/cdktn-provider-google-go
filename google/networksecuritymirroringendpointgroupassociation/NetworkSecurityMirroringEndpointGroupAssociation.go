...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v19/networksecuritymirroringendpointgroupassociation/internal"
...
func (j *jsiiProxy_NetworkSecurityMirroringEndpointGroupAssociation) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_NetworkSecurityMirroringEndpointGroupAssociation) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/network_security_mirroring_endpoint_group_association google_network_security_mirroring_endpoint_group_association} Resource.
...
func (j *jsiiProxy_NetworkSecurityMirroringEndpointGroupAssociation)SetDeletionPolicy(val *string) {
...
func (n *jsiiProxy_NetworkSecurityMirroringEndpointGroupAssociation) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		n,
		"resetDeletionPolicy",
		nil, // no parameters
