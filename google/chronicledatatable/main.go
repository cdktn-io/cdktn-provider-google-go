...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "approximateRowCount", GoGetter: "ApproximateRowCount"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "columnInfo", GoGetter: "ColumnInfo"},
			_jsii_.MemberProperty{JsiiProperty: "columnInfoInput", GoGetter: "ColumnInfoInput"},
			_jsii_.MemberProperty{JsiiProperty: "connection", GoGetter: "Connection"},
			_jsii_.MemberProperty{JsiiProperty: "constructNodeMetadata", GoGetter: "ConstructNodeMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "count", GoGetter: "Count"},
			_jsii_.MemberProperty{JsiiProperty: "createTime", GoGetter: "CreateTime"},
			_jsii_.MemberProperty{JsiiProperty: "dataTableId", GoGetter: "DataTableId"},
			_jsii_.MemberProperty{JsiiProperty: "dataTableIdInput", GoGetter: "DataTableIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "dataTableUuid", GoGetter: "DataTableUuid"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putColumnInfo", GoMethod: "PutColumnInfo"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRowTimeToLive", GoMethod: "ResetRowTimeToLive"},
			_jsii_.MemberMethod{JsiiMethod: "resetScopeInfo", GoMethod: "ResetScopeInfo"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rowTimeToLive", GoGetter: "RowTimeToLive"},
			_jsii_.MemberProperty{JsiiProperty: "rowTimeToLiveInput", GoGetter: "RowTimeToLiveInput"},
			_jsii_.MemberProperty{JsiiProperty: "rowTimeToLiveUpdateTime", GoGetter: "RowTimeToLiveUpdateTime"},
			...
			_jsii_.MemberProperty{JsiiProperty: "scopeInfoInput", GoGetter: "ScopeInfoInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "keyColumn", GoGetter: "KeyColumn"},
			_jsii_.MemberProperty{JsiiProperty: "keyColumnInput", GoGetter: "KeyColumnInput"},
			_jsii_.MemberProperty{JsiiProperty: "mappedColumnPath", GoGetter: "MappedColumnPath"},
			_jsii_.MemberProperty{JsiiProperty: "mappedColumnPathInput", GoGetter: "MappedColumnPathInput"},
			_jsii_.MemberProperty{JsiiProperty: "originalColumn", GoGetter: "OriginalColumn"},
			_jsii_.MemberProperty{JsiiProperty: "originalColumnInput", GoGetter: "OriginalColumnInput"},
			_jsii_.MemberProperty{JsiiProperty: "repeatedValues", GoGetter: "RepeatedValues"},
			_jsii_.MemberProperty{JsiiProperty: "repeatedValuesInput", GoGetter: "RepeatedValuesInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetColumnType", GoMethod: "ResetColumnType"},
			_jsii_.MemberMethod{JsiiMethod: "resetKeyColumn", GoMethod: "ResetKeyColumn"},
			_jsii_.MemberMethod{JsiiMethod: "resetMappedColumnPath", GoMethod: "ResetMappedColumnPath"},
			_jsii_.MemberMethod{JsiiMethod: "resetRepeatedValues", GoMethod: "ResetRepeatedValues"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "dataAccessScopes", GoGetter: "DataAccessScopes"},
			_jsii_.MemberProperty{JsiiProperty: "dataAccessScopesInput", GoGetter: "DataAccessScopesInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
