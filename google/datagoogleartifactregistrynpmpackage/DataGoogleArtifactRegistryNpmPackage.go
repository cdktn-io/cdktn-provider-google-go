...
package datagoogleartifactregistrynpmpackage
...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/datagoogleartifactregistrynpmpackage/internal"
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) PackageName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"packageName",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) PackageNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"packageNameInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) RepositoryId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"repositoryId",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) RepositoryIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"repositoryIdInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) Tags() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) Version() *string {
	var returns *string
	_jsii_.Get(
		j,
		"version",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/data-sources/artifact_registry_npm_package google_artifact_registry_npm_package} Data Source.
func NewDataGoogleArtifactRegistryNpmPackage(scope constructs.Construct, id *string, config *DataGoogleArtifactRegistryNpmPackageConfig) DataGoogleArtifactRegistryNpmPackage {
	...
	if err := validateNewDataGoogleArtifactRegistryNpmPackageParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGoogleArtifactRegistryNpmPackage{}

	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleArtifactRegistryNpmPackage.DataGoogleArtifactRegistryNpmPackage",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/data-sources/artifact_registry_npm_package google_artifact_registry_npm_package} Data Source.
func NewDataGoogleArtifactRegistryNpmPackage_Override(d DataGoogleArtifactRegistryNpmPackage, scope constructs.Construct, id *string, config *DataGoogleArtifactRegistryNpmPackageConfig) {
	_init_.Initialize()
...
func DataGoogleArtifactRegistryNpmPackage_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-google.dataGoogleArtifactRegistryNpmPackage.DataGoogleArtifactRegistryNpmPackage",
...
func (d *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleArtifactRegistryNpmPackage) ToString() *string {
	var returns *string
