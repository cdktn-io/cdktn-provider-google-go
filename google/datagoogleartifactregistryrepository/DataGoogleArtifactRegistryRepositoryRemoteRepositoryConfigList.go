...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepositoryRemoteRepositoryConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleArtifactRegistryRepositoryRemoteRepositoryConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleArtifactRegistryRepositoryRemoteRepositoryConfigList {
	_init_.Initialize()
...
func NewDataGoogleArtifactRegistryRepositoryRemoteRepositoryConfigList_Override(d DataGoogleArtifactRegistryRepositoryRemoteRepositoryConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepositoryRemoteRepositoryConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepositoryRemoteRepositoryConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepositoryRemoteRepositoryConfigList) Resolve(context cdktn.IResolveContext) interface{} {
