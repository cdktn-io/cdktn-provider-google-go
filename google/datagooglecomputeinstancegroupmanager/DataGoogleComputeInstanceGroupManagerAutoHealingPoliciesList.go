...
func (j *jsiiProxy_DataGoogleComputeInstanceGroupManagerAutoHealingPoliciesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeInstanceGroupManagerAutoHealingPoliciesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeInstanceGroupManagerAutoHealingPoliciesList {
	_init_.Initialize()
...
func NewDataGoogleComputeInstanceGroupManagerAutoHealingPoliciesList_Override(d DataGoogleComputeInstanceGroupManagerAutoHealingPoliciesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeInstanceGroupManagerAutoHealingPoliciesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeInstanceGroupManagerAutoHealingPoliciesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeInstanceGroupManagerAutoHealingPoliciesList) Resolve(context cdktn.IResolveContext) interface{} {
