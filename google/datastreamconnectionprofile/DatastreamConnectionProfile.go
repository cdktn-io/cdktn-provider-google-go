...
func (j *jsiiProxy_DatastreamConnectionProfile) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DatastreamConnectionProfile) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/datastream_connection_profile google_datastream_connection_profile} Resource.
...
func (j *jsiiProxy_DatastreamConnectionProfile)SetDeletionPolicy(val *string) {
...
func (d *jsiiProxy_DatastreamConnectionProfile) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		d,
		"resetDeletionPolicy",
		nil, // no parameters
