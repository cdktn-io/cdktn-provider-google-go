...
func (d *jsiiProxy_DatastreamConnectionProfileMysqlProfileSslConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DatastreamConnectionProfileMysqlProfileSslConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
