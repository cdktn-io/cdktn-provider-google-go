...
func (j *jsiiProxy_DataGoogleAlloydbClusterContinuousBackupConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleAlloydbClusterContinuousBackupConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleAlloydbClusterContinuousBackupConfigList {
	_init_.Initialize()
...
func NewDataGoogleAlloydbClusterContinuousBackupConfigList_Override(d DataGoogleAlloydbClusterContinuousBackupConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleAlloydbClusterContinuousBackupConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleAlloydbClusterContinuousBackupConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleAlloydbClusterContinuousBackupConfigList) Resolve(context cdktn.IResolveContext) interface{} {
