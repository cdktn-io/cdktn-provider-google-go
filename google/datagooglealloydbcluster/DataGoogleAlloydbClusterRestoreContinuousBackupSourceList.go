...
func (j *jsiiProxy_DataGoogleAlloydbClusterRestoreContinuousBackupSourceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleAlloydbClusterRestoreContinuousBackupSourceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleAlloydbClusterRestoreContinuousBackupSourceList {
	_init_.Initialize()
...
func NewDataGoogleAlloydbClusterRestoreContinuousBackupSourceList_Override(d DataGoogleAlloydbClusterRestoreContinuousBackupSourceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleAlloydbClusterRestoreContinuousBackupSourceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleAlloydbClusterRestoreContinuousBackupSourceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleAlloydbClusterRestoreContinuousBackupSourceList) Resolve(context cdktn.IResolveContext) interface{} {
