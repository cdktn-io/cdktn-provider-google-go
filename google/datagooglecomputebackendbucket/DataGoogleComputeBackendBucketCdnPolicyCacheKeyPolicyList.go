...
func (j *jsiiProxy_DataGoogleComputeBackendBucketCdnPolicyCacheKeyPolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeBackendBucketCdnPolicyCacheKeyPolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeBackendBucketCdnPolicyCacheKeyPolicyList {
	_init_.Initialize()
...
func NewDataGoogleComputeBackendBucketCdnPolicyCacheKeyPolicyList_Override(d DataGoogleComputeBackendBucketCdnPolicyCacheKeyPolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeBackendBucketCdnPolicyCacheKeyPolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeBackendBucketCdnPolicyCacheKeyPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeBackendBucketCdnPolicyCacheKeyPolicyList) Resolve(context cdktn.IResolveContext) interface{} {
