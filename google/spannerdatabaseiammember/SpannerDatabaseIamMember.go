...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/spannerdatabaseiammember/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/spanner_database_iam_member google_spanner_database_iam_member} Resource.
...
func (s *jsiiProxy_SpannerDatabaseIamMember) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SpannerDatabaseIamMember) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SpannerDatabaseIamMember) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
