...
type BigqueryDatapolicyv2DataPolicy interface {
	...
	DataGovernanceTag() BigqueryDatapolicyv2DataPolicyDataGovernanceTagOutputReference
	DataGovernanceTagInput() *BigqueryDatapolicyv2DataPolicyDataGovernanceTag
	...
	PutDataGovernanceTag(value *BigqueryDatapolicyv2DataPolicyDataGovernanceTag)
...
func (j *jsiiProxy_BigqueryDatapolicyv2DataPolicy) DataGovernanceTag() BigqueryDatapolicyv2DataPolicyDataGovernanceTagOutputReference {
	var returns BigqueryDatapolicyv2DataPolicyDataGovernanceTagOutputReference
	_jsii_.Get(
		j,
		"dataGovernanceTag",
		&returns,
...
func (j *jsiiProxy_BigqueryDatapolicyv2DataPolicy) DataGovernanceTagInput() *BigqueryDatapolicyv2DataPolicyDataGovernanceTag {
	var returns *BigqueryDatapolicyv2DataPolicyDataGovernanceTag
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/bigquery_datapolicyv2_data_policy google_bigquery_datapolicyv2_data_policy} Resource.
...
func (b *jsiiProxy_BigqueryDatapolicyv2DataPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BigqueryDatapolicyv2DataPolicy) PutDataGovernanceTag(value *BigqueryDatapolicyv2DataPolicyDataGovernanceTag) {
	if err := b.validatePutDataGovernanceTagParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		b,
...
func (b *jsiiProxy_BigqueryDatapolicyv2DataPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BigqueryDatapolicyv2DataPolicy) ResetDataGovernanceTag() {
	_jsii_.InvokeVoid(
		b,
		"resetDataGovernanceTag",
		nil, // no parameters
