...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.bigqueryDatapolicyv2DataPolicy.BigqueryDatapolicyv2DataPolicyDataGovernanceTag",
		reflect.TypeOf((*BigqueryDatapolicyv2DataPolicyDataGovernanceTag)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.bigqueryDatapolicyv2DataPolicy.BigqueryDatapolicyv2DataPolicyDataGovernanceTagOutputReference",
		reflect.TypeOf((*BigqueryDatapolicyv2DataPolicyDataGovernanceTagOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_BigqueryDatapolicyv2DataPolicyDataGovernanceTagOutputReference{}
