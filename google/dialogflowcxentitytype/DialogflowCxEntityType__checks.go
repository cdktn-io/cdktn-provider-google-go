...
func (d *jsiiProxy_DialogflowCxEntityType) validatePutEntitiesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DialogflowCxEntityTypeEntities; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DialogflowCxEntityType) validatePutExcludedPhrasesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DialogflowCxEntityTypeExcludedPhrases; received %#v (a %T)", value, value)
		}
	}
