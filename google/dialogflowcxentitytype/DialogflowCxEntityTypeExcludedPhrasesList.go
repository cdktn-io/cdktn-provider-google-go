...
func (j *jsiiProxy_DialogflowCxEntityTypeExcludedPhrasesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDialogflowCxEntityTypeExcludedPhrasesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DialogflowCxEntityTypeExcludedPhrasesList {
	_init_.Initialize()
...
func NewDialogflowCxEntityTypeExcludedPhrasesList_Override(d DialogflowCxEntityTypeExcludedPhrasesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DialogflowCxEntityTypeExcludedPhrasesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DialogflowCxEntityTypeExcludedPhrasesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DialogflowCxEntityTypeExcludedPhrasesList) Resolve(context cdktn.IResolveContext) interface{} {
