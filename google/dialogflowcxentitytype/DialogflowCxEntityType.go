...
func (j *jsiiProxy_DialogflowCxEntityType) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DialogflowCxEntityType) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DialogflowCxEntityType) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DialogflowCxEntityType) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DialogflowCxEntityType) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DialogflowCxEntityType)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DialogflowCxEntityType)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DialogflowCxEntityType)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DialogflowCxEntityType_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DialogflowCxEntityType) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DialogflowCxEntityType) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DialogflowCxEntityType) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DialogflowCxEntityType) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DialogflowCxEntityType) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DialogflowCxEntityType) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
