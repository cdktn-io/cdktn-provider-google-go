...
func (c *jsiiProxy_ComputeImage) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (c *jsiiProxy_ComputeImage) validatePutGuestOsFeaturesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ComputeImageGuestOsFeatures; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ComputeImage) validatePutParamsParameters(value *ComputeImageParams) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (c *jsiiProxy_ComputeImage) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	if feature == "" {
