...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/compute_image google_compute_image}.
...
func (j *jsiiProxy_ComputeImage) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ComputeImage) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/compute_image google_compute_image} Resource.
...
func (j *jsiiProxy_ComputeImage)SetDeletionPolicy(val *string) {
...
func (c *jsiiProxy_ComputeImage) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputeImage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputeImage) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeImage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
