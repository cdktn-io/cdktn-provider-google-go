...
func (j *jsiiProxy_IdentityPlatformInboundSamlConfigSpConfigSpCertificatesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIdentityPlatformInboundSamlConfigSpConfigSpCertificatesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IdentityPlatformInboundSamlConfigSpConfigSpCertificatesList {
	_init_.Initialize()
...
func NewIdentityPlatformInboundSamlConfigSpConfigSpCertificatesList_Override(i IdentityPlatformInboundSamlConfigSpConfigSpCertificatesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IdentityPlatformInboundSamlConfigSpConfigSpCertificatesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IdentityPlatformInboundSamlConfigSpConfigSpCertificatesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IdentityPlatformInboundSamlConfigSpConfigSpCertificatesList) Resolve(context cdktn.IResolveContext) interface{} {
