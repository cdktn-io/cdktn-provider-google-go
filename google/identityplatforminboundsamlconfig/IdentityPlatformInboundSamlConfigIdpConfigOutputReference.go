...
func (i *jsiiProxy_IdentityPlatformInboundSamlConfigIdpConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IdentityPlatformInboundSamlConfigIdpConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
