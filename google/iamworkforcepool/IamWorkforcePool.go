...
func (j *jsiiProxy_IamWorkforcePool) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_IamWorkforcePool) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/iam_workforce_pool google_iam_workforce_pool} Resource.
...
func (j *jsiiProxy_IamWorkforcePool)SetDeletionPolicy(val *string) {
...
func (i *jsiiProxy_IamWorkforcePool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamWorkforcePool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamWorkforcePool) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		i,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (i *jsiiProxy_IamWorkforcePool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
