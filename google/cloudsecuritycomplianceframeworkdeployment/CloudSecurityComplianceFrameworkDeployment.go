...
func (j *jsiiProxy_CloudSecurityComplianceFrameworkDeployment) Parent() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parent",
...
func (j *jsiiProxy_CloudSecurityComplianceFrameworkDeployment) ParentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/cloud_security_compliance_framework_deployment google_cloud_security_compliance_framework_deployment} Resource.
...
func (j *jsiiProxy_CloudSecurityComplianceFrameworkDeployment)SetParent(val *string) {
...
func (c *jsiiProxy_CloudSecurityComplianceFrameworkDeployment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudSecurityComplianceFrameworkDeployment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudSecurityComplianceFrameworkDeployment) ResetLocation() {
	_jsii_.InvokeVoid(
		c,
		"resetLocation",
		nil, // no parameters
...
func (c *jsiiProxy_CloudSecurityComplianceFrameworkDeployment) ResetOrganization() {
	_jsii_.InvokeVoid(
		c,
		"resetOrganization",
		nil, // no parameters
...
func (c *jsiiProxy_CloudSecurityComplianceFrameworkDeployment) ResetParent() {
	_jsii_.InvokeVoid(
		c,
		"resetParent",
		nil, // no parameters
