...
func (j *jsiiProxy_BackupDrBackupVault) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_BackupDrBackupVault) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_BackupDrBackupVault)SetDeletionPolicy(val *string) {
...
func (b *jsiiProxy_BackupDrBackupVault) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BackupDrBackupVault) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BackupDrBackupVault) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		b,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (b *jsiiProxy_BackupDrBackupVault) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
