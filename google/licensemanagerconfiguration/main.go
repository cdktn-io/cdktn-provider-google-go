...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LicenseManagerConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.licenseManagerConfiguration.LicenseManagerConfigurationConfig",
		reflect.TypeOf((*LicenseManagerConfigurationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.licenseManagerConfiguration.LicenseManagerConfigurationTimeouts",
		reflect.TypeOf((*LicenseManagerConfigurationTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.licenseManagerConfiguration.LicenseManagerConfigurationTimeoutsOutputReference",
		reflect.TypeOf((*LicenseManagerConfigurationTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
