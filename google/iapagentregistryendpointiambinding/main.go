...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google.iapAgentRegistryEndpointIamBinding.IapAgentRegistryEndpointIamBinding",
		reflect.TypeOf((*IapAgentRegistryEndpointIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_IapAgentRegistryEndpointIamBinding{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.iapAgentRegistryEndpointIamBinding.IapAgentRegistryEndpointIamBindingCondition",
		reflect.TypeOf((*IapAgentRegistryEndpointIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.iapAgentRegistryEndpointIamBinding.IapAgentRegistryEndpointIamBindingConditionOutputReference",
		reflect.TypeOf((*IapAgentRegistryEndpointIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.iapAgentRegistryEndpointIamBinding.IapAgentRegistryEndpointIamBindingConfig",
		reflect.TypeOf((*IapAgentRegistryEndpointIamBindingConfig)(nil)).Elem(),
	)
}
