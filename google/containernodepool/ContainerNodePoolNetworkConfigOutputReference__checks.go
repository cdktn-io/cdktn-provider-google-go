...
func (c *jsiiProxy_ContainerNodePoolNetworkConfigOutputReference) validatePutAdditionalNodeNetworkConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ContainerNodePoolNetworkConfigAdditionalNodeNetworkConfigs; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ContainerNodePoolNetworkConfigOutputReference) validatePutAdditionalPodNetworkConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ContainerNodePoolNetworkConfigAdditionalPodNetworkConfigs; received %#v (a %T)", value, value)
		}
	}
