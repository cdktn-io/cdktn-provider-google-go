...
func (j *jsiiProxy_ContainerNodePoolNetworkConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerNodePoolNetworkConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ContainerNodePoolNetworkConfigOutputReference {
	_init_.Initialize()
...
func NewContainerNodePoolNetworkConfigOutputReference_Override(c ContainerNodePoolNetworkConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerNodePoolNetworkConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerNodePoolNetworkConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerNodePoolNetworkConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ContainerNodePoolNetworkConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerNodePoolNetworkConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
