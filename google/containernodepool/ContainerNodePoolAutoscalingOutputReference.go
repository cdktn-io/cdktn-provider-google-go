...
func (j *jsiiProxy_ContainerNodePoolAutoscalingOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerNodePoolAutoscalingOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ContainerNodePoolAutoscalingOutputReference {
	_init_.Initialize()
...
func NewContainerNodePoolAutoscalingOutputReference_Override(c ContainerNodePoolAutoscalingOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerNodePoolAutoscalingOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerNodePoolAutoscalingOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerNodePoolAutoscalingOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ContainerNodePoolAutoscalingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerNodePoolAutoscalingOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
