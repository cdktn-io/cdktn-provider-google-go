...
func (j *jsiiProxy_ContainerNodePoolNodeConfigSoleTenantConfigNodeAffinityList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerNodePoolNodeConfigSoleTenantConfigNodeAffinityList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerNodePoolNodeConfigSoleTenantConfigNodeAffinityList {
	_init_.Initialize()
...
func NewContainerNodePoolNodeConfigSoleTenantConfigNodeAffinityList_Override(c ContainerNodePoolNodeConfigSoleTenantConfigNodeAffinityList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerNodePoolNodeConfigSoleTenantConfigNodeAffinityList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerNodePoolNodeConfigSoleTenantConfigNodeAffinityList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerNodePoolNodeConfigSoleTenantConfigNodeAffinityList) Resolve(context cdktn.IResolveContext) interface{} {
