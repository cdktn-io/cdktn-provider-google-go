...
type ContainerNodePoolNodeConfigLinuxNodeConfigCustomNodeInitInitScript struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/container_node_pool#gcs_generation ContainerNodePool#gcs_generation}
	GcsGeneration *float64 `field:"optional" json:"gcsGeneration" yaml:"gcsGeneration"`
	// The GCS URI of the init script.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/container_node_pool#gcs_uri ContainerNodePool#gcs_uri}
