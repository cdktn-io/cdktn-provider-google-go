...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/container_node_pool google_container_node_pool}.
...
func (j *jsiiProxy_ContainerNodePool) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ContainerNodePool) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ContainerNodePool) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ContainerNodePool) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ContainerNodePool) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/container_node_pool google_container_node_pool} Resource.
...
func (j *jsiiProxy_ContainerNodePool)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ContainerNodePool)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ContainerNodePool)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ContainerNodePool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ContainerNodePool) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerNodePool) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ContainerNodePool) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerNodePool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ContainerNodePool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ContainerNodePool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
