...
func (j *jsiiProxy_DataGoogleFilestoreInstanceFileSharesNfsExportOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleFilestoreInstanceFileSharesNfsExportOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleFilestoreInstanceFileSharesNfsExportOptionsList {
	_init_.Initialize()
...
func NewDataGoogleFilestoreInstanceFileSharesNfsExportOptionsList_Override(d DataGoogleFilestoreInstanceFileSharesNfsExportOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleFilestoreInstanceFileSharesNfsExportOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleFilestoreInstanceFileSharesNfsExportOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleFilestoreInstanceFileSharesNfsExportOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
