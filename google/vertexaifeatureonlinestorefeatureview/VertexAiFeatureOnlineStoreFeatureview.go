...
func (j *jsiiProxy_VertexAiFeatureOnlineStoreFeatureview) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStoreFeatureview) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/vertex_ai_feature_online_store_featureview google_vertex_ai_feature_online_store_featureview} Resource.
...
func (j *jsiiProxy_VertexAiFeatureOnlineStoreFeatureview)SetDeletionPolicy(val *string) {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStoreFeatureview) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStoreFeatureview) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStoreFeatureview) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		v,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureOnlineStoreFeatureview) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
