...
func (j *jsiiProxy_VertexAiFeatureOnlineStoreFeatureviewFeatureRegistrySourceFeatureGroupsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVertexAiFeatureOnlineStoreFeatureviewFeatureRegistrySourceFeatureGroupsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VertexAiFeatureOnlineStoreFeatureviewFeatureRegistrySourceFeatureGroupsList {
	_init_.Initialize()
...
func NewVertexAiFeatureOnlineStoreFeatureviewFeatureRegistrySourceFeatureGroupsList_Override(v VertexAiFeatureOnlineStoreFeatureviewFeatureRegistrySourceFeatureGroupsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VertexAiFeatureOnlineStoreFeatureviewFeatureRegistrySourceFeatureGroupsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStoreFeatureviewFeatureRegistrySourceFeatureGroupsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStoreFeatureviewFeatureRegistrySourceFeatureGroupsList) Resolve(context cdktn.IResolveContext) interface{} {
