...
func (c *jsiiProxy_CloudbuildTriggerGithubPushOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudbuildTriggerGithubPushOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
