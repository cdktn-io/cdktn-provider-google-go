...
func (c *jsiiProxy_CloudbuildTriggerGithubPullRequestOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudbuildTriggerGithubPullRequestOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
