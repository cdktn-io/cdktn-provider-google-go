...
func (j *jsiiProxy_CloudbuildTriggerBuildArtifactsNpmPackagesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudbuildTriggerBuildArtifactsNpmPackagesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CloudbuildTriggerBuildArtifactsNpmPackagesOutputReference {
	_init_.Initialize()
...
func NewCloudbuildTriggerBuildArtifactsNpmPackagesOutputReference_Override(c CloudbuildTriggerBuildArtifactsNpmPackagesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudbuildTriggerBuildArtifactsNpmPackagesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudbuildTriggerBuildArtifactsNpmPackagesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudbuildTriggerBuildArtifactsNpmPackagesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CloudbuildTriggerBuildArtifactsNpmPackagesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudbuildTriggerBuildArtifactsNpmPackagesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
