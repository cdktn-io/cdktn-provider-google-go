...
func (c *jsiiProxy_CloudbuildTriggerGitFileSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudbuildTriggerGitFileSourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
