...
func (j *jsiiProxy_CloudbuildTrigger) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudbuildTrigger) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudbuildTrigger) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudbuildTrigger) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudbuildTrigger) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CloudbuildTrigger)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudbuildTrigger)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudbuildTrigger)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CloudbuildTrigger_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudbuildTrigger) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudbuildTrigger) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudbuildTrigger) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudbuildTrigger) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudbuildTrigger) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudbuildTrigger) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
