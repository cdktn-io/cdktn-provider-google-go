...
func (c *jsiiProxy_CloudbuildTriggerGithubOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudbuildTriggerGithubOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
