...
func (c *jsiiProxy_CloudbuildTriggerBitbucketServerTriggerConfigPullRequestOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudbuildTriggerBitbucketServerTriggerConfigPullRequestOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
