...
func (j *jsiiProxy_CloudbuildTriggerBuildArtifactsObjectsTimingList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudbuildTriggerBuildArtifactsObjectsTimingList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudbuildTriggerBuildArtifactsObjectsTimingList {
	_init_.Initialize()
...
func NewCloudbuildTriggerBuildArtifactsObjectsTimingList_Override(c CloudbuildTriggerBuildArtifactsObjectsTimingList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudbuildTriggerBuildArtifactsObjectsTimingList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudbuildTriggerBuildArtifactsObjectsTimingList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudbuildTriggerBuildArtifactsObjectsTimingList) Resolve(context cdktn.IResolveContext) interface{} {
