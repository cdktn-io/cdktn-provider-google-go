...
func (c *jsiiProxy_CloudbuildTriggerRepositoryEventConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudbuildTriggerRepositoryEventConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
