...
func (b *jsiiProxy_BillingBudgetThresholdRulesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_BillingBudgetThresholdRulesList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*BillingBudgetThresholdRules; received %#v (a %T)", val, val)
		}
	}
