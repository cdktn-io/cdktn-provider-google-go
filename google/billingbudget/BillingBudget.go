...
func (j *jsiiProxy_BillingBudget) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_BillingBudget) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_BillingBudget)SetDeletionPolicy(val *string) {
...
func (b *jsiiProxy_BillingBudget) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BillingBudget) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BillingBudget) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		b,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (b *jsiiProxy_BillingBudget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
