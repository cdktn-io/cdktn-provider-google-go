...
func (b *jsiiProxy_BillingBudgetThresholdRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BillingBudgetThresholdRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
