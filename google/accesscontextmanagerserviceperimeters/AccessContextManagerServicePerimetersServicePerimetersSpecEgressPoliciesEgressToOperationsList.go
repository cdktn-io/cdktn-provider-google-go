...
func (a *jsiiProxy_AccessContextManagerServicePerimetersServicePerimetersSpecEgressPoliciesEgressToOperationsList) Resolve(context cdktf.IResolveContext) interface{} {
