...
type AccessContextManagerServicePerimetersServicePerimetersStatusEgressPoliciesEgressFromSources struct {
	...
	PscEndpoint *AccessContextManagerServicePerimetersServicePerimetersStatusEgressPoliciesEgressFromSourcesPscEndpoint `field:"optional" json:"pscEndpoint" yaml:"pscEndpoint"`
