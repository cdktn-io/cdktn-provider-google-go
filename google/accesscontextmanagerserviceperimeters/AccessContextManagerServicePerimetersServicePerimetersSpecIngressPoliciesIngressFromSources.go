...
type AccessContextManagerServicePerimetersServicePerimetersSpecIngressPoliciesIngressFromSources struct {
	...
	PscEndpoint *AccessContextManagerServicePerimetersServicePerimetersSpecIngressPoliciesIngressFromSourcesPscEndpoint `field:"optional" json:"pscEndpoint" yaml:"pscEndpoint"`
