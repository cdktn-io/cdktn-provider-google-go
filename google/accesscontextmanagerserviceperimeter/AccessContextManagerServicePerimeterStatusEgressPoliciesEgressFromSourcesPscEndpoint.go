...
type AccessContextManagerServicePerimeterStatusEgressPoliciesEgressFromSourcesPscEndpoint struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/access_context_manager_service_perimeter#forwarding_rule AccessContextManagerServicePerimeter#forwarding_rule}
