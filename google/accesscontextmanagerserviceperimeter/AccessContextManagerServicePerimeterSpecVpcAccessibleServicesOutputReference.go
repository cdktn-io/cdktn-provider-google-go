...
func (a *jsiiProxy_AccessContextManagerServicePerimeterSpecVpcAccessibleServicesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AccessContextManagerServicePerimeterSpecVpcAccessibleServicesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
