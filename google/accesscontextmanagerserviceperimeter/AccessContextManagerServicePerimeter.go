...
func (j *jsiiProxy_AccessContextManagerServicePerimeter) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AccessContextManagerServicePerimeter) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AccessContextManagerServicePerimeter) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AccessContextManagerServicePerimeter) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AccessContextManagerServicePerimeter) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AccessContextManagerServicePerimeter)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AccessContextManagerServicePerimeter)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AccessContextManagerServicePerimeter)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AccessContextManagerServicePerimeter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AccessContextManagerServicePerimeter) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AccessContextManagerServicePerimeter) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AccessContextManagerServicePerimeter) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AccessContextManagerServicePerimeter) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AccessContextManagerServicePerimeter) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AccessContextManagerServicePerimeter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
