...
func (j *jsiiProxy_WorkloadIdentityServiceAgentServiceAgentsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_WorkloadIdentityServiceAgentServiceAgentsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_WorkloadIdentityServiceAgentServiceAgentsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (w *jsiiProxy_WorkloadIdentityServiceAgentServiceAgentsList) ComputeFqn() *string {
	var returns *string
...
func (w *jsiiProxy_WorkloadIdentityServiceAgentServiceAgentsList) Get(index *float64) WorkloadIdentityServiceAgentServiceAgentsOutputReference {
	if err := w.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns WorkloadIdentityServiceAgentServiceAgentsOutputReference
...
func (w *jsiiProxy_WorkloadIdentityServiceAgentServiceAgentsList) ToString() *string {
	var returns *string
