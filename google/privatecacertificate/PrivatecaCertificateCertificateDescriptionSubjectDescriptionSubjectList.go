...
func (j *jsiiProxy_PrivatecaCertificateCertificateDescriptionSubjectDescriptionSubjectList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPrivatecaCertificateCertificateDescriptionSubjectDescriptionSubjectList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PrivatecaCertificateCertificateDescriptionSubjectDescriptionSubjectList {
	_init_.Initialize()
...
func NewPrivatecaCertificateCertificateDescriptionSubjectDescriptionSubjectList_Override(p PrivatecaCertificateCertificateDescriptionSubjectDescriptionSubjectList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PrivatecaCertificateCertificateDescriptionSubjectDescriptionSubjectList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PrivatecaCertificateCertificateDescriptionSubjectDescriptionSubjectList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PrivatecaCertificateCertificateDescriptionSubjectDescriptionSubjectList) Resolve(context cdktn.IResolveContext) interface{} {
