...
func (p *jsiiProxy_PrivatecaCertificateConfigSubjectConfigSubjectAltNameOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PrivatecaCertificateConfigSubjectConfigSubjectAltNameOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
