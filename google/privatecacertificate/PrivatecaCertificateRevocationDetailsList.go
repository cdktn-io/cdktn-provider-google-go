...
func (j *jsiiProxy_PrivatecaCertificateRevocationDetailsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPrivatecaCertificateRevocationDetailsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PrivatecaCertificateRevocationDetailsList {
	_init_.Initialize()
...
func NewPrivatecaCertificateRevocationDetailsList_Override(p PrivatecaCertificateRevocationDetailsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PrivatecaCertificateRevocationDetailsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PrivatecaCertificateRevocationDetailsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PrivatecaCertificateRevocationDetailsList) Resolve(context cdktn.IResolveContext) interface{} {
