...
func (j *jsiiProxy_PrivatecaCertificateCertificateDescriptionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPrivatecaCertificateCertificateDescriptionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PrivatecaCertificateCertificateDescriptionOutputReference {
	_init_.Initialize()
...
func NewPrivatecaCertificateCertificateDescriptionOutputReference_Override(p PrivatecaCertificateCertificateDescriptionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PrivatecaCertificateCertificateDescriptionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PrivatecaCertificateCertificateDescriptionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivatecaCertificateCertificateDescriptionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PrivatecaCertificateCertificateDescriptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivatecaCertificateCertificateDescriptionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
