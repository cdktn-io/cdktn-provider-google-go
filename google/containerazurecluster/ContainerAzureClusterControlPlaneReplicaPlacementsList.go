...
func (j *jsiiProxy_ContainerAzureClusterControlPlaneReplicaPlacementsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerAzureClusterControlPlaneReplicaPlacementsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerAzureClusterControlPlaneReplicaPlacementsList {
	_init_.Initialize()
...
func NewContainerAzureClusterControlPlaneReplicaPlacementsList_Override(c ContainerAzureClusterControlPlaneReplicaPlacementsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerAzureClusterControlPlaneReplicaPlacementsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerAzureClusterControlPlaneReplicaPlacementsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerAzureClusterControlPlaneReplicaPlacementsList) Resolve(context cdktn.IResolveContext) interface{} {
