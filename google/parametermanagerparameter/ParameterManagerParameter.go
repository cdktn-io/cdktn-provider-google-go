...
func (j *jsiiProxy_ParameterManagerParameter) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ParameterManagerParameter) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/parameter_manager_parameter google_parameter_manager_parameter} Resource.
...
func (j *jsiiProxy_ParameterManagerParameter)SetDeletionPolicy(val *string) {
...
func (p *jsiiProxy_ParameterManagerParameter) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_ParameterManagerParameter) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_ParameterManagerParameter) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		p,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (p *jsiiProxy_ParameterManagerParameter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
