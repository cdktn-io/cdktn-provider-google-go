...
func (j *jsiiProxy_NetworkSecurityMirroringDeploymentGroup) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_NetworkSecurityMirroringDeploymentGroup) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/network_security_mirroring_deployment_group google_network_security_mirroring_deployment_group} Resource.
...
func (j *jsiiProxy_NetworkSecurityMirroringDeploymentGroup)SetDeletionPolicy(val *string) {
...
func (n *jsiiProxy_NetworkSecurityMirroringDeploymentGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkSecurityMirroringDeploymentGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkSecurityMirroringDeploymentGroup) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		n,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkSecurityMirroringDeploymentGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
