...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "nccGateway", GoGetter: "NccGateway"},
			_jsii_.MemberProperty{JsiiProperty: "nccGatewayInput", GoGetter: "NccGatewayInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetNccGateway", GoMethod: "ResetNccGateway"},
