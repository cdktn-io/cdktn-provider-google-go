...
func (j *jsiiProxy_NetappVolume) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NetappVolume) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_NetappVolume) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NetappVolume) HasReplication() cdktn.IResolvable {
...
func (j *jsiiProxy_NetappVolume) LdapEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"ldapEnabled",
...
func (j *jsiiProxy_NetappVolume) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NetappVolume) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NetappVolume) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_NetappVolume) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/netapp_volume google_netapp_volume} Resource.
...
func (j *jsiiProxy_NetappVolume)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NetappVolume)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NetappVolume)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NetappVolume_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NetappVolume) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetappVolume) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NetappVolume) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetappVolume) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetappVolume) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetappVolume) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
