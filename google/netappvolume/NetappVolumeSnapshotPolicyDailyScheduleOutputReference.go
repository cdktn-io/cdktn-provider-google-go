...
func (n *jsiiProxy_NetappVolumeSnapshotPolicyDailyScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetappVolumeSnapshotPolicyDailyScheduleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
