...
func (j *jsiiProxy_AccessContextManagerAuthorizedOrgsDesc) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AccessContextManagerAuthorizedOrgsDesc) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AccessContextManagerAuthorizedOrgsDesc) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AccessContextManagerAuthorizedOrgsDesc) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AccessContextManagerAuthorizedOrgsDesc) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewAccessContextManagerAuthorizedOrgsDesc(scope constructs.Construct, id *string, config *AccessContextManagerAuthorizedOrgsDescConfig) AccessContextManagerAuthorizedOrgsDesc {
	...
	_jsii_.Create(
		"@cdktn/provider-google.accessContextManagerAuthorizedOrgsDesc.AccessContextManagerAuthorizedOrgsDesc",
...
func (j *jsiiProxy_AccessContextManagerAuthorizedOrgsDesc)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AccessContextManagerAuthorizedOrgsDesc)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AccessContextManagerAuthorizedOrgsDesc)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AccessContextManagerAuthorizedOrgsDesc_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AccessContextManagerAuthorizedOrgsDesc) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AccessContextManagerAuthorizedOrgsDesc) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AccessContextManagerAuthorizedOrgsDesc) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AccessContextManagerAuthorizedOrgsDesc) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AccessContextManagerAuthorizedOrgsDesc) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AccessContextManagerAuthorizedOrgsDesc) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
