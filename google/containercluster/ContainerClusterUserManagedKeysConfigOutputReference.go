...
func (c *jsiiProxy_ContainerClusterUserManagedKeysConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerClusterUserManagedKeysConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
