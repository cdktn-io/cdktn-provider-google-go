...
func (c *jsiiProxy_ContainerClusterAddonsConfigLustreCsiDriverConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerClusterAddonsConfigLustreCsiDriverConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
