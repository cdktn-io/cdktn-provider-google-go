...
func (c *jsiiProxy_ContainerClusterControlPlaneEndpointsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerClusterControlPlaneEndpointsConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
