...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/container_cluster google_container_cluster}.
type ContainerCluster interface {
	...
	NodeCreationConfig() ContainerClusterNodeCreationConfigOutputReference
	NodeCreationConfigInput() *ContainerClusterNodeCreationConfig
	...
	PutNodeCreationConfig(value *ContainerClusterNodeCreationConfig)
...
func (j *jsiiProxy_ContainerCluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ContainerCluster) DataplaneOptimizationMode() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerCluster) DataplaneOptimizationModeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerCluster) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_ContainerCluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ContainerCluster) IgnoreNodeCountChanges() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerCluster) IgnoreNodeCountChangesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerCluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ContainerCluster) NodeCreationConfig() ContainerClusterNodeCreationConfigOutputReference {
	var returns ContainerClusterNodeCreationConfigOutputReference
	_jsii_.Get(
		j,
		"nodeCreationConfig",
		&returns,
...
func (j *jsiiProxy_ContainerCluster) NodeCreationConfigInput() *ContainerClusterNodeCreationConfig {
	var returns *ContainerClusterNodeCreationConfig
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerCluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ContainerCluster) SkipNodePoolRefresh() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"skipNodePoolRefresh",
...
func (j *jsiiProxy_ContainerCluster) SkipNodePoolRefreshInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerCluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ContainerCluster) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/container_cluster google_container_cluster} Resource.
...
func (j *jsiiProxy_ContainerCluster)SetDataplaneOptimizationMode(val *string) {
...
func (j *jsiiProxy_ContainerCluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ContainerCluster)SetIgnoreNodeCountChanges(val interface{}) {
...
func (j *jsiiProxy_ContainerCluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ContainerCluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ContainerCluster)SetSkipNodePoolRefresh(val interface{}) {
...
func ContainerCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ContainerCluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerCluster) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ContainerCluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerCluster) PutNodeCreationConfig(value *ContainerClusterNodeCreationConfig) {
	if err := c.validatePutNodeCreationConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_ContainerCluster) ResetDataplaneOptimizationMode() {
	_jsii_.InvokeVoid(
		c,
		"resetDataplaneOptimizationMode",
		nil, // no parameters
...
func (c *jsiiProxy_ContainerCluster) ResetIgnoreNodeCountChanges() {
	_jsii_.InvokeVoid(
		c,
		"resetIgnoreNodeCountChanges",
		nil, // no parameters
...
func (c *jsiiProxy_ContainerCluster) ResetNodeCreationConfig() {
	_jsii_.InvokeVoid(
		c,
		"resetNodeCreationConfig",
		nil, // no parameters
...
func (c *jsiiProxy_ContainerCluster) ResetSkipNodePoolRefresh() {
	_jsii_.InvokeVoid(
		c,
		"resetSkipNodePoolRefresh",
		nil, // no parameters
...
func (c *jsiiProxy_ContainerCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
