...
func (c *jsiiProxy_ContainerClusterMonitoringConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerClusterMonitoringConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
