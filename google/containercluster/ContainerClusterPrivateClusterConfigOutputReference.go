...
func (c *jsiiProxy_ContainerClusterPrivateClusterConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerClusterPrivateClusterConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
