...
func (c *jsiiProxy_ContainerClusterResourceUsageExportConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerClusterResourceUsageExportConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
