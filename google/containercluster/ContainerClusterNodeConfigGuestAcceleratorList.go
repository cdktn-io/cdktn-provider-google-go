...
func (j *jsiiProxy_ContainerClusterNodeConfigGuestAcceleratorList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerClusterNodeConfigGuestAcceleratorList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerClusterNodeConfigGuestAcceleratorList {
	_init_.Initialize()
...
func NewContainerClusterNodeConfigGuestAcceleratorList_Override(c ContainerClusterNodeConfigGuestAcceleratorList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerClusterNodeConfigGuestAcceleratorList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerClusterNodeConfigGuestAcceleratorList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerClusterNodeConfigGuestAcceleratorList) Resolve(context cdktn.IResolveContext) interface{} {
