...
func (c *jsiiProxy_ContainerClusterNodeConfigOutputReference) validatePutNodeImageConfigParameters(value interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*ContainerClusterNodeConfigNodeImageConfig:
		value := value.(*[]*ContainerClusterNodeConfigNodeImageConfig)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ContainerClusterNodeConfigNodeImageConfig:
		value_ := value.([]*ContainerClusterNodeConfigNodeImageConfig)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ContainerClusterNodeConfigNodeImageConfig; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ContainerClusterNodeConfigOutputReference) validatePutTaintConfigParameters(value *ContainerClusterNodeConfigTaintConfig) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
