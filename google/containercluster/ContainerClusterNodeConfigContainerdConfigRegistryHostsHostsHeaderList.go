...
func (j *jsiiProxy_ContainerClusterNodeConfigContainerdConfigRegistryHostsHostsHeaderList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerClusterNodeConfigContainerdConfigRegistryHostsHostsHeaderList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerClusterNodeConfigContainerdConfigRegistryHostsHostsHeaderList {
	_init_.Initialize()
...
func NewContainerClusterNodeConfigContainerdConfigRegistryHostsHostsHeaderList_Override(c ContainerClusterNodeConfigContainerdConfigRegistryHostsHostsHeaderList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerClusterNodeConfigContainerdConfigRegistryHostsHostsHeaderList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerClusterNodeConfigContainerdConfigRegistryHostsHostsHeaderList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerClusterNodeConfigContainerdConfigRegistryHostsHostsHeaderList) Resolve(context cdktn.IResolveContext) interface{} {
