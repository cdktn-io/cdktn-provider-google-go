...
func (j *jsiiProxy_DnsRecordSetRoutingPolicyPrimaryBackupBackupGeoOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDnsRecordSetRoutingPolicyPrimaryBackupBackupGeoOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DnsRecordSetRoutingPolicyPrimaryBackupBackupGeoOutputReference {
	_init_.Initialize()
...
func NewDnsRecordSetRoutingPolicyPrimaryBackupBackupGeoOutputReference_Override(d DnsRecordSetRoutingPolicyPrimaryBackupBackupGeoOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DnsRecordSetRoutingPolicyPrimaryBackupBackupGeoOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DnsRecordSetRoutingPolicyPrimaryBackupBackupGeoOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DnsRecordSetRoutingPolicyPrimaryBackupBackupGeoOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DnsRecordSetRoutingPolicyPrimaryBackupBackupGeoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DnsRecordSetRoutingPolicyPrimaryBackupBackupGeoOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
