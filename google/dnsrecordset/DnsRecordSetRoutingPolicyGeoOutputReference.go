...
func (j *jsiiProxy_DnsRecordSetRoutingPolicyGeoOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDnsRecordSetRoutingPolicyGeoOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DnsRecordSetRoutingPolicyGeoOutputReference {
	_init_.Initialize()
...
func NewDnsRecordSetRoutingPolicyGeoOutputReference_Override(d DnsRecordSetRoutingPolicyGeoOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DnsRecordSetRoutingPolicyGeoOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DnsRecordSetRoutingPolicyGeoOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DnsRecordSetRoutingPolicyGeoOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DnsRecordSetRoutingPolicyGeoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DnsRecordSetRoutingPolicyGeoOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
