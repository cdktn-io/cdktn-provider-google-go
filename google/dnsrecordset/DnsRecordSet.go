...
func (j *jsiiProxy_DnsRecordSet) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DnsRecordSet) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_DnsRecordSet)SetDeletionPolicy(val *string) {
...
func (d *jsiiProxy_DnsRecordSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DnsRecordSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DnsRecordSet) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		d,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (d *jsiiProxy_DnsRecordSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
