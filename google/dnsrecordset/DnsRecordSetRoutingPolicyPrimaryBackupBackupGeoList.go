...
func (j *jsiiProxy_DnsRecordSetRoutingPolicyPrimaryBackupBackupGeoList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDnsRecordSetRoutingPolicyPrimaryBackupBackupGeoList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DnsRecordSetRoutingPolicyPrimaryBackupBackupGeoList {
	_init_.Initialize()
...
func NewDnsRecordSetRoutingPolicyPrimaryBackupBackupGeoList_Override(d DnsRecordSetRoutingPolicyPrimaryBackupBackupGeoList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DnsRecordSetRoutingPolicyPrimaryBackupBackupGeoList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DnsRecordSetRoutingPolicyPrimaryBackupBackupGeoList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DnsRecordSetRoutingPolicyPrimaryBackupBackupGeoList) Resolve(context cdktn.IResolveContext) interface{} {
