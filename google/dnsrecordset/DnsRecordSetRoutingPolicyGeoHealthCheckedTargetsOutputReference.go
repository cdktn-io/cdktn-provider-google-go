...
func (d *jsiiProxy_DnsRecordSetRoutingPolicyGeoHealthCheckedTargetsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DnsRecordSetRoutingPolicyGeoHealthCheckedTargetsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
