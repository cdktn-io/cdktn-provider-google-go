...
func (d *jsiiProxy_DataplexDatascanDataDiscoverySpecStorageConfigJsonOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataplexDatascanDataDiscoverySpecStorageConfigJsonOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
