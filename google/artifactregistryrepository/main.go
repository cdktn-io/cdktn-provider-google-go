...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.artifactRegistryRepository.ArtifactRegistryRepositoryRemoteRepositoryConfigNoCache",
		reflect.TypeOf((*ArtifactRegistryRepositoryRemoteRepositoryConfigNoCache)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.artifactRegistryRepository.ArtifactRegistryRepositoryRemoteRepositoryConfigNoCacheOutputReference",
		reflect.TypeOf((*ArtifactRegistryRepositoryRemoteRepositoryConfigNoCacheOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
