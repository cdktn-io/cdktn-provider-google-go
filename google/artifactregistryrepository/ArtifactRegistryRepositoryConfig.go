...
type ArtifactRegistryRepositoryConfig struct {
	...
	VulnerabilityScanningConfig *ArtifactRegistryRepositoryVulnerabilityScanningConfig `field:"optional" json:"vulnerabilityScanningConfig" yaml:"vulnerabilityScanningConfig"`
}
