...
func (c *jsiiProxy_ComputeSecurityPolicyRuleRateLimitOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeSecurityPolicyRuleRateLimitOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
