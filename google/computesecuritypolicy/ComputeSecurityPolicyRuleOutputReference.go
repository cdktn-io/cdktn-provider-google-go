...
func (c *jsiiProxy_ComputeSecurityPolicyRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeSecurityPolicyRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
