...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRules) DataScanId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataScanId",
...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRules) DataScanIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataScanIdInput",
...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRules) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRules) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRules) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRules) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRules) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRules) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRules) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRules) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRules) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRules) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRules) Rules() DataGoogleDataplexDataQualityRulesRulesList {
	var returns DataGoogleDataplexDataQualityRulesRulesList
	_jsii_.Get(
		j,
		"rules",
		&returns,
...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRules) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDataGoogleDataplexDataQualityRules(scope constructs.Construct, id *string, config *DataGoogleDataplexDataQualityRulesConfig) DataGoogleDataplexDataQualityRules {
	...
	if err := validateNewDataGoogleDataplexDataQualityRulesParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleDataplexDataQualityRules_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-google.dataGoogleDataplexDataQualityRules.DataGoogleDataplexDataQualityRules",
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRules) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRules) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRules) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRules) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRules) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRules) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRules) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRules) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRules) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRules) ResetLocation() {
	_jsii_.InvokeVoid(
		d,
		"resetLocation",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRules) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRules) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRules) ToString() *string {
	var returns *string
