...
func (j *jsiiProxy_CloudbuildBitbucketServerConfigConnectedRepositoriesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCloudbuildBitbucketServerConfigConnectedRepositoriesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudbuildBitbucketServerConfigConnectedRepositoriesList {
	_init_.Initialize()
...
func NewCloudbuildBitbucketServerConfigConnectedRepositoriesList_Override(c CloudbuildBitbucketServerConfigConnectedRepositoriesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudbuildBitbucketServerConfigConnectedRepositoriesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudbuildBitbucketServerConfigConnectedRepositoriesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CloudbuildBitbucketServerConfigConnectedRepositoriesList) Resolve(context cdktn.IResolveContext) interface{} {
