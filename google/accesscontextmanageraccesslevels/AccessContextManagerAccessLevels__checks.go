...
func (a *jsiiProxy_AccessContextManagerAccessLevels) validatePutAccessLevelsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AccessContextManagerAccessLevelsAccessLevels; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_AccessContextManagerAccessLevels) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_AccessContextManagerAccessLevels) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
