...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchange) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchange) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchange) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchange) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchange) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchange)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchange)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchange)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BigqueryAnalyticsHubDataExchange_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BigqueryAnalyticsHubDataExchange) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BigqueryAnalyticsHubDataExchange) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BigqueryAnalyticsHubDataExchange) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BigqueryAnalyticsHubDataExchange) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BigqueryAnalyticsHubDataExchange) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BigqueryAnalyticsHubDataExchange) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
