...
func (n *jsiiProxy_NetworkServicesLbRouteExtensionExtensionChainsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkServicesLbRouteExtensionExtensionChainsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
