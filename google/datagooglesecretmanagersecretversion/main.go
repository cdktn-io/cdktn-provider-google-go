...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google.dataGoogleSecretManagerSecretVersion.DataGoogleSecretManagerSecretVersion",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "fetchSecretData", GoGetter: "FetchSecretData"},
			_jsii_.MemberProperty{JsiiProperty: "fetchSecretDataInput", GoGetter: "FetchSecretDataInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFetchSecretData", GoMethod: "ResetFetchSecretData"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dataGoogleSecretManagerSecretVersion.DataGoogleSecretManagerSecretVersionConfig",
