...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DiscoveryEngineSearchEngineIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.discoveryEngineSearchEngineIamMember.DiscoveryEngineSearchEngineIamMemberCondition",
		reflect.TypeOf((*DiscoveryEngineSearchEngineIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.discoveryEngineSearchEngineIamMember.DiscoveryEngineSearchEngineIamMemberConditionOutputReference",
		reflect.TypeOf((*DiscoveryEngineSearchEngineIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.discoveryEngineSearchEngineIamMember.DiscoveryEngineSearchEngineIamMemberConfig",
		reflect.TypeOf((*DiscoveryEngineSearchEngineIamMemberConfig)(nil)).Elem(),
	)
}
