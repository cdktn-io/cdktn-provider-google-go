...
func (j *jsiiProxy_IntegrationConnectorsConnectionDestinationConfigDestinationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIntegrationConnectorsConnectionDestinationConfigDestinationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IntegrationConnectorsConnectionDestinationConfigDestinationList {
	_init_.Initialize()
...
func NewIntegrationConnectorsConnectionDestinationConfigDestinationList_Override(i IntegrationConnectorsConnectionDestinationConfigDestinationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IntegrationConnectorsConnectionDestinationConfigDestinationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IntegrationConnectorsConnectionDestinationConfigDestinationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IntegrationConnectorsConnectionDestinationConfigDestinationList) Resolve(context cdktn.IResolveContext) interface{} {
