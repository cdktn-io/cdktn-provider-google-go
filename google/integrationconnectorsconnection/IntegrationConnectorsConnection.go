...
func (i *jsiiProxy_IntegrationConnectorsConnection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IntegrationConnectorsConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IntegrationConnectorsConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
