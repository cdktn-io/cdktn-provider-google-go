...
func (i *jsiiProxy_IntegrationConnectorsConnectionAuthConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IntegrationConnectorsConnectionAuthConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
