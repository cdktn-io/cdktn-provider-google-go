...
type BigtableTableAutomatedBackupPolicy struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/bigtable_table#frequency BigtableTable#frequency}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/bigtable_table#locations BigtableTable#locations}
	Locations *[]*string `field:"optional" json:"locations" yaml:"locations"`
	// How long the automated backups should be retained.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/bigtable_table#retention_period BigtableTable#retention_period}
