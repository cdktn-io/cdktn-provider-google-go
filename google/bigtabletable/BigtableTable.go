...
func (j *jsiiProxy_BigtableTable) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BigtableTable) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BigtableTable) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BigtableTable) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BigtableTable) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/bigtable_table google_bigtable_table} Resource.
...
func (j *jsiiProxy_BigtableTable)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BigtableTable)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BigtableTable)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BigtableTable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BigtableTable) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BigtableTable) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BigtableTable) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BigtableTable) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BigtableTable) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BigtableTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
