...
func (c *jsiiProxy_ComputeDiskSourceImageEncryptionKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeDiskSourceImageEncryptionKeyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
