...
func (j *jsiiProxy_IamWorkforcePoolProviderScimTenant) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_IamWorkforcePoolProviderScimTenant) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/iam_workforce_pool_provider_scim_tenant google_iam_workforce_pool_provider_scim_tenant} Resource.
...
func (j *jsiiProxy_IamWorkforcePoolProviderScimTenant)SetDeletionPolicy(val *string) {
...
func (i *jsiiProxy_IamWorkforcePoolProviderScimTenant) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamWorkforcePoolProviderScimTenant) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamWorkforcePoolProviderScimTenant) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		i,
		"resetDeletionPolicy",
		nil, // no parameters
