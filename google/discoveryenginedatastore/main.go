...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "aclEnabledInput", GoGetter: "AclEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAclEnabled", GoMethod: "ResetAclEnabled"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enableGetProcessedDocumentInput", GoGetter: "EnableGetProcessedDocumentInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "enableLlmLayoutParsingInput", GoGetter: "EnableLlmLayoutParsingInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnableGetProcessedDocument", GoMethod: "ResetEnableGetProcessedDocument"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnableImageAnnotation", GoMethod: "ResetEnableImageAnnotation"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnableLlmLayoutParsing", GoMethod: "ResetEnableLlmLayoutParsing"},
