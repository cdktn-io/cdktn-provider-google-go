...
type DiscoveryEngineDataStore interface {
	...
	SetAclEnabled(val interface{})
	AclEnabledInput() interface{}
...
func (j *jsiiProxy_DiscoveryEngineDataStore) AclEnabled() interface{} {
...
func (j *jsiiProxy_DiscoveryEngineDataStore) AclEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"aclEnabledInput",
...
func (j *jsiiProxy_DiscoveryEngineDataStore) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DiscoveryEngineDataStore) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_DiscoveryEngineDataStore)SetAclEnabled(val interface{}) {
	if err := j.validateSetAclEnabledParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_DiscoveryEngineDataStore)SetDeletionPolicy(val *string) {
...
func (d *jsiiProxy_DiscoveryEngineDataStore) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DiscoveryEngineDataStore) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DiscoveryEngineDataStore) ResetAclEnabled() {
	_jsii_.InvokeVoid(
		d,
		"resetAclEnabled",
		nil, // no parameters
...
func (d *jsiiProxy_DiscoveryEngineDataStore) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		d,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (d *jsiiProxy_DiscoveryEngineDataStore) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
