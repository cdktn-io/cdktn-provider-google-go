...
func (d *jsiiProxy_DataprocMetastoreService) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataprocMetastoreService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataprocMetastoreService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
