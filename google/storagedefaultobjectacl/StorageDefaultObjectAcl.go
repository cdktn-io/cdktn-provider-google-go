...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/storagedefaultobjectacl/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/storage_default_object_acl google_storage_default_object_acl} Resource.
...
func (s *jsiiProxy_StorageDefaultObjectAcl) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageDefaultObjectAcl) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StorageDefaultObjectAcl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
