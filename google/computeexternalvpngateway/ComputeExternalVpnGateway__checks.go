...
func (c *jsiiProxy_ComputeExternalVpnGateway) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (c *jsiiProxy_ComputeExternalVpnGateway) validatePutInterfaceParameters(value interface{}) error {
	...
	case *[]*ComputeExternalVpnGatewayInterface:
		value := value.(*[]*ComputeExternalVpnGatewayInterface)
	...
	case []*ComputeExternalVpnGatewayInterface:
		value_ := value.([]*ComputeExternalVpnGatewayInterface)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ComputeExternalVpnGatewayInterface; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_ComputeExternalVpnGateway) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
