...
func (j *jsiiProxy_DataGoogleStorageBucketObject) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataGoogleStorageBucketObject) EventBasedHold() cdktn.IResolvable {
...
func (j *jsiiProxy_DataGoogleStorageBucketObject) ForceEmptyContentType() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleStorageBucketObject) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataGoogleStorageBucketObject) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGoogleStorageBucketObject) Metadata() cdktn.StringMap {
...
func (j *jsiiProxy_DataGoogleStorageBucketObject) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataGoogleStorageBucketObject) TemporaryHold() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"temporaryHold",
...
func (j *jsiiProxy_DataGoogleStorageBucketObject) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/data-sources/storage_bucket_object google_storage_bucket_object} Data Source.
...
func (j *jsiiProxy_DataGoogleStorageBucketObject)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGoogleStorageBucketObject)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataGoogleStorageBucketObject)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataGoogleStorageBucketObject_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataGoogleStorageBucketObject) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleStorageBucketObject) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleStorageBucketObject) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataGoogleStorageBucketObject) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
