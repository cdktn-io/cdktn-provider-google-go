...
func (j *jsiiProxy_ComputeRegionSecurityPolicyRulesPreconfiguredWafConfigExclusionRequestQueryParamList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewComputeRegionSecurityPolicyRulesPreconfiguredWafConfigExclusionRequestQueryParamList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ComputeRegionSecurityPolicyRulesPreconfiguredWafConfigExclusionRequestQueryParamList {
	_init_.Initialize()
...
func NewComputeRegionSecurityPolicyRulesPreconfiguredWafConfigExclusionRequestQueryParamList_Override(c ComputeRegionSecurityPolicyRulesPreconfiguredWafConfigExclusionRequestQueryParamList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComputeRegionSecurityPolicyRulesPreconfiguredWafConfigExclusionRequestQueryParamList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (c *jsiiProxy_ComputeRegionSecurityPolicyRulesPreconfiguredWafConfigExclusionRequestQueryParamList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ComputeRegionSecurityPolicyRulesPreconfiguredWafConfigExclusionRequestQueryParamList) Resolve(context cdktf.IResolveContext) interface{} {
