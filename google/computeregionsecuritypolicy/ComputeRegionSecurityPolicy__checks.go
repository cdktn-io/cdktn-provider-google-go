...
func (c *jsiiProxy_ComputeRegionSecurityPolicy) validatePutRulesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ComputeRegionSecurityPolicyRules; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ComputeRegionSecurityPolicy) validatePutUserDefinedFieldsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ComputeRegionSecurityPolicyUserDefinedFields; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_ComputeRegionSecurityPolicy) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
