...
func (j *jsiiProxy_FirebaseAppHostingBuildSourceCodebaseAuthorList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewFirebaseAppHostingBuildSourceCodebaseAuthorList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirebaseAppHostingBuildSourceCodebaseAuthorList {
	_init_.Initialize()
...
func NewFirebaseAppHostingBuildSourceCodebaseAuthorList_Override(f FirebaseAppHostingBuildSourceCodebaseAuthorList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FirebaseAppHostingBuildSourceCodebaseAuthorList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (f *jsiiProxy_FirebaseAppHostingBuildSourceCodebaseAuthorList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirebaseAppHostingBuildSourceCodebaseAuthorList) Resolve(context cdktf.IResolveContext) interface{} {
