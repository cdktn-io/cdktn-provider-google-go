...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/datagooglestorageobjectsignedurl/internal"
...
func NewDataGoogleStorageObjectSignedUrl(scope constructs.Construct, id *string, config *DataGoogleStorageObjectSignedUrlConfig) DataGoogleStorageObjectSignedUrl {
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleStorageObjectSignedUrl.DataGoogleStorageObjectSignedUrl",
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
