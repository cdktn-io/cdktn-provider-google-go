...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/firebase_remote_config_remote_config google_firebase_remote_config_remote_config} Resource.
...
func (f *jsiiProxy_FirebaseRemoteConfigRemoteConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FirebaseRemoteConfigRemoteConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
