...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/datagooglekmssecretasymmetric/internal"
...
func (j *jsiiProxy_DataGoogleKmsSecretAsymmetric) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataGoogleKmsSecretAsymmetric) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataGoogleKmsSecretAsymmetric) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGoogleKmsSecretAsymmetric) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataGoogleKmsSecretAsymmetric) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/data-sources/kms_secret_asymmetric google_kms_secret_asymmetric} Data Source.
func NewDataGoogleKmsSecretAsymmetric(scope constructs.Construct, id *string, config *DataGoogleKmsSecretAsymmetricConfig) DataGoogleKmsSecretAsymmetric {
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleKmsSecretAsymmetric.DataGoogleKmsSecretAsymmetric",
...
func (j *jsiiProxy_DataGoogleKmsSecretAsymmetric)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGoogleKmsSecretAsymmetric)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataGoogleKmsSecretAsymmetric)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataGoogleKmsSecretAsymmetric_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataGoogleKmsSecretAsymmetric) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleKmsSecretAsymmetric) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleKmsSecretAsymmetric) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataGoogleKmsSecretAsymmetric) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
