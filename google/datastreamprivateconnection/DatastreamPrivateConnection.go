...
func (d *jsiiProxy_DatastreamPrivateConnection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DatastreamPrivateConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DatastreamPrivateConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
