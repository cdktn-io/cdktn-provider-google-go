...
func (j *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersPortsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudRunV2ServiceTemplateContainersPortsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudRunV2ServiceTemplateContainersPortsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleCloudRunV2Service.DataGoogleCloudRunV2ServiceTemplateContainersPortsList",
...
func NewDataGoogleCloudRunV2ServiceTemplateContainersPortsList_Override(d DataGoogleCloudRunV2ServiceTemplateContainersPortsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersPortsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersPortsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersPortsList) Resolve(context cdktn.IResolveContext) interface{} {
