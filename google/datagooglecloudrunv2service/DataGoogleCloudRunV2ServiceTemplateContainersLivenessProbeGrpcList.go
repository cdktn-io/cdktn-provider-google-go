...
func (j *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeGrpcList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeGrpcList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeGrpcList {
	_init_.Initialize()
...
func NewDataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeGrpcList_Override(d DataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeGrpcList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeGrpcList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeGrpcList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeGrpcList) Resolve(context cdktn.IResolveContext) interface{} {
