...
func (c *jsiiProxy_ComputeSecurityPolicyRuleHeaderActionAOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeSecurityPolicyRuleHeaderActionAOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
