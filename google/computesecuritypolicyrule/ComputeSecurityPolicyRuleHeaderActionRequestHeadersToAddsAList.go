...
func (j *jsiiProxy_ComputeSecurityPolicyRuleHeaderActionRequestHeadersToAddsAList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewComputeSecurityPolicyRuleHeaderActionRequestHeadersToAddsAList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ComputeSecurityPolicyRuleHeaderActionRequestHeadersToAddsAList {
	_init_.Initialize()
...
func NewComputeSecurityPolicyRuleHeaderActionRequestHeadersToAddsAList_Override(c ComputeSecurityPolicyRuleHeaderActionRequestHeadersToAddsAList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComputeSecurityPolicyRuleHeaderActionRequestHeadersToAddsAList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ComputeSecurityPolicyRuleHeaderActionRequestHeadersToAddsAList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ComputeSecurityPolicyRuleHeaderActionRequestHeadersToAddsAList) Resolve(context cdktn.IResolveContext) interface{} {
