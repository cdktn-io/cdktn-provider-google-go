...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/firestorefield/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/firestore_field google_firestore_field}.
...
func (j *jsiiProxy_FirestoreField) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FirestoreField) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_FirestoreField) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_FirestoreField) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FirestoreField) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FirestoreField) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FirestoreField) SkipWait() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"skipWait",
...
func (j *jsiiProxy_FirestoreField) SkipWaitInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"skipWaitInput",
...
func (j *jsiiProxy_FirestoreField) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/firestore_field google_firestore_field} Resource.
...
func (j *jsiiProxy_FirestoreField)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_FirestoreField)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FirestoreField)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FirestoreField)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_FirestoreField)SetSkipWait(val interface{}) {
...
func FirestoreField_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (f *jsiiProxy_FirestoreField) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirestoreField) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FirestoreField) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirestoreField) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FirestoreField) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FirestoreField) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		f,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (f *jsiiProxy_FirestoreField) ResetSkipWait() {
	_jsii_.InvokeVoid(
		f,
		"resetSkipWait",
		nil, // no parameters
