...
func (j *jsiiProxy_DataGoogleLustreInstanceMaintenancePolicyMaintenanceExclusionWindowTimeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleLustreInstanceMaintenancePolicyMaintenanceExclusionWindowTimeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleLustreInstanceMaintenancePolicyMaintenanceExclusionWindowTimeList {
	_init_.Initialize()
...
func NewDataGoogleLustreInstanceMaintenancePolicyMaintenanceExclusionWindowTimeList_Override(d DataGoogleLustreInstanceMaintenancePolicyMaintenanceExclusionWindowTimeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleLustreInstanceMaintenancePolicyMaintenanceExclusionWindowTimeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleLustreInstanceMaintenancePolicyMaintenanceExclusionWindowTimeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleLustreInstanceMaintenancePolicyMaintenanceExclusionWindowTimeList) Resolve(context cdktn.IResolveContext) interface{} {
