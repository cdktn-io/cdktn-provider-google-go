...
type ComputeNetworkFirewallPolicyIamMemberConfig struct {
	// Experimental.
	...
	Condition *ComputeNetworkFirewallPolicyIamMemberCondition `field:"optional" json:"condition" yaml:"condition"`
