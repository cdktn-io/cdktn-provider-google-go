...
func (j *jsiiProxy_DataGoogleCloudQuotasQuotaInfosQuotaInfosList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudQuotasQuotaInfosQuotaInfosList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudQuotasQuotaInfosQuotaInfosList {
	_init_.Initialize()
...
func NewDataGoogleCloudQuotasQuotaInfosQuotaInfosList_Override(d DataGoogleCloudQuotasQuotaInfosQuotaInfosList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudQuotasQuotaInfosQuotaInfosList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudQuotasQuotaInfosQuotaInfosList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCloudQuotasQuotaInfosQuotaInfosList) Resolve(context cdktn.IResolveContext) interface{} {
