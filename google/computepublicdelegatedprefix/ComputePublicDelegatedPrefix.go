...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix)SetDeletionPolicy(val *string) {
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
