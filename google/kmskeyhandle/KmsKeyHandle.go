...
type KmsKeyHandle interface {
	...
	PutTimeouts(value *KmsKeyHandleTimeouts)
...
func (j *jsiiProxy_KmsKeyHandle) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_KmsKeyHandle) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_KmsKeyHandle) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_KmsKeyHandle) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_KmsKeyHandle) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_KmsKeyHandle) KmsKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKey",
...
func (j *jsiiProxy_KmsKeyHandle) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_KmsKeyHandle) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_KmsKeyHandle) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_KmsKeyHandle) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_KmsKeyHandle) Node() constructs.Node {
...
func (j *jsiiProxy_KmsKeyHandle) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_KmsKeyHandle) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_KmsKeyHandle) ResourceTypeSelector() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KmsKeyHandle) ResourceTypeSelectorInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KmsKeyHandle) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KmsKeyHandle) Timeouts() KmsKeyHandleTimeoutsOutputReference {
	var returns KmsKeyHandleTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewKmsKeyHandle(scope constructs.Construct, id *string, config *KmsKeyHandleConfig) KmsKeyHandle {
	...
	if err := validateNewKmsKeyHandleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func KmsKeyHandle_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-google.kmsKeyHandle.KmsKeyHandle",
...
func (k *jsiiProxy_KmsKeyHandle) AddMoveTarget(moveTarget *string) {
...
func (k *jsiiProxy_KmsKeyHandle) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (k *jsiiProxy_KmsKeyHandle) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (k *jsiiProxy_KmsKeyHandle) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (k *jsiiProxy_KmsKeyHandle) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (k *jsiiProxy_KmsKeyHandle) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (k *jsiiProxy_KmsKeyHandle) GetStringAttribute(terraformAttribute *string) *string {
...
func (k *jsiiProxy_KmsKeyHandle) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (k *jsiiProxy_KmsKeyHandle) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KmsKeyHandle) MoveFromId(id *string) {
...
func (k *jsiiProxy_KmsKeyHandle) MoveToId(id *string) {
...
func (k *jsiiProxy_KmsKeyHandle) OverrideLogicalId(newLogicalId *string) {
...
func (k *jsiiProxy_KmsKeyHandle) PutTimeouts(value *KmsKeyHandleTimeouts) {
...
func (k *jsiiProxy_KmsKeyHandle) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KmsKeyHandle) ResetId() {
	_jsii_.InvokeVoid(
		k,
		"resetId",
		nil, // no parameters
...
func (k *jsiiProxy_KmsKeyHandle) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		k,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (k *jsiiProxy_KmsKeyHandle) ResetProject() {
	_jsii_.InvokeVoid(
		k,
		"resetProject",
		nil, // no parameters
...
func (k *jsiiProxy_KmsKeyHandle) ResetTimeouts() {
	_jsii_.InvokeVoid(
		k,
		"resetTimeouts",
		nil, // no parameters
...
func (k *jsiiProxy_KmsKeyHandle) ToString() *string {
	var returns *string
...
func (k *jsiiProxy_KmsKeyHandle) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
