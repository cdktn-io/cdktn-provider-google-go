...
func (n *jsiiProxy_NetworkServicesMulticastDomainGroupStateList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (n *jsiiProxy_NetworkServicesMulticastDomainGroupStateList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_NetworkServicesMulticastDomainGroupStateList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_NetworkServicesMulticastDomainGroupStateList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
