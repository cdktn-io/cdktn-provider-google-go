...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "multicastDomainGroupId", GoGetter: "MulticastDomainGroupId"},
			_jsii_.MemberProperty{JsiiProperty: "multicastDomainGroupIdInput", GoGetter: "MulticastDomainGroupIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "multicastDomains", GoGetter: "MulticastDomains"},
