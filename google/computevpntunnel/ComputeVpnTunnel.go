...
type ComputeVpnTunnel interface {
	...
	ParamsInput() *ComputeVpnTunnelParams
	...
	PutCipherSuite(value *ComputeVpnTunnelCipherSuite)
	PutParams(value *ComputeVpnTunnelParams)
...
func (j *jsiiProxy_ComputeVpnTunnel) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ComputeVpnTunnel) CipherSuite() ComputeVpnTunnelCipherSuiteOutputReference {
	var returns ComputeVpnTunnelCipherSuiteOutputReference
	_jsii_.Get(
		j,
		"cipherSuite",
		&returns,
...
func (j *jsiiProxy_ComputeVpnTunnel) CipherSuiteInput() *ComputeVpnTunnelCipherSuite {
...
func (j *jsiiProxy_ComputeVpnTunnel) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ComputeVpnTunnel) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_ComputeVpnTunnel) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_ComputeVpnTunnel) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ComputeVpnTunnel) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ComputeVpnTunnel) Params() ComputeVpnTunnelParamsOutputReference {
	var returns ComputeVpnTunnelParamsOutputReference
	_jsii_.Get(
		j,
		"params",
		&returns,
...
func (j *jsiiProxy_ComputeVpnTunnel) ParamsInput() *ComputeVpnTunnelParams {
	var returns *ComputeVpnTunnelParams
	_jsii_.Get(
		j,
		"paramsInput",
		&returns,
...
func (j *jsiiProxy_ComputeVpnTunnel) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ComputeVpnTunnel) SharedSecretWo() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sharedSecretWo",
...
func (j *jsiiProxy_ComputeVpnTunnel) SharedSecretWoInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sharedSecretWoInput",
...
func (j *jsiiProxy_ComputeVpnTunnel) SharedSecretWoVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeVpnTunnel) SharedSecretWoVersionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeVpnTunnel) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ComputeVpnTunnel) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/compute_vpn_tunnel google_compute_vpn_tunnel} Resource.
...
func (j *jsiiProxy_ComputeVpnTunnel)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_ComputeVpnTunnel)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ComputeVpnTunnel)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ComputeVpnTunnel)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ComputeVpnTunnel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ComputeVpnTunnel) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputeVpnTunnel) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ComputeVpnTunnel) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputeVpnTunnel) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputeVpnTunnel) PutCipherSuite(value *ComputeVpnTunnelCipherSuite) {
...
func (c *jsiiProxy_ComputeVpnTunnel) PutParams(value *ComputeVpnTunnelParams) {
...
func (c *jsiiProxy_ComputeVpnTunnel) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputeVpnTunnel) ResetCipherSuite() {
	_jsii_.InvokeVoid(
		c,
		"resetCipherSuite",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeVpnTunnel) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeVpnTunnel) ResetParams() {
	_jsii_.InvokeVoid(
		c,
		"resetParams",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeVpnTunnel) ResetSharedSecret() {
	_jsii_.InvokeVoid(
		c,
		"resetSharedSecret",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeVpnTunnel) ResetSharedSecretWo() {
	_jsii_.InvokeVoid(
		c,
		"resetSharedSecretWo",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeVpnTunnel) ResetSharedSecretWoVersion() {
	_jsii_.InvokeVoid(
		c,
		"resetSharedSecretWoVersion",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeVpnTunnel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
