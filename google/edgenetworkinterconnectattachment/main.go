...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "interconnectAttachmentId", GoGetter: "InterconnectAttachmentId"},
			_jsii_.MemberProperty{JsiiProperty: "interconnectAttachmentIdInput", GoGetter: "InterconnectAttachmentIdInput"},
