...
func (j *jsiiProxy_DataGoogleComputeRegionBackendServiceCdnPolicyOutputReference) NegativeCaching() cdktn.IResolvable {
...
func (j *jsiiProxy_DataGoogleComputeRegionBackendServiceCdnPolicyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeRegionBackendServiceCdnPolicyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleComputeRegionBackendServiceCdnPolicyOutputReference {
	_init_.Initialize()
...
func NewDataGoogleComputeRegionBackendServiceCdnPolicyOutputReference_Override(d DataGoogleComputeRegionBackendServiceCdnPolicyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeRegionBackendServiceCdnPolicyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeRegionBackendServiceCdnPolicyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleComputeRegionBackendServiceCdnPolicyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGoogleComputeRegionBackendServiceCdnPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleComputeRegionBackendServiceCdnPolicyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
