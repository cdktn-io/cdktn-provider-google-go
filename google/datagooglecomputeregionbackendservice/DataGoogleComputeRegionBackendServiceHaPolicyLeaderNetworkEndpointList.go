...
func (j *jsiiProxy_DataGoogleComputeRegionBackendServiceHaPolicyLeaderNetworkEndpointList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeRegionBackendServiceHaPolicyLeaderNetworkEndpointList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeRegionBackendServiceHaPolicyLeaderNetworkEndpointList {
	_init_.Initialize()
...
func NewDataGoogleComputeRegionBackendServiceHaPolicyLeaderNetworkEndpointList_Override(d DataGoogleComputeRegionBackendServiceHaPolicyLeaderNetworkEndpointList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeRegionBackendServiceHaPolicyLeaderNetworkEndpointList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeRegionBackendServiceHaPolicyLeaderNetworkEndpointList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeRegionBackendServiceHaPolicyLeaderNetworkEndpointList) Resolve(context cdktn.IResolveContext) interface{} {
