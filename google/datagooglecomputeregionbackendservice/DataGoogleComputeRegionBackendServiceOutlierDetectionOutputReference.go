...
func (d *jsiiProxy_DataGoogleComputeRegionBackendServiceOutlierDetectionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataGoogleComputeRegionBackendServiceOutlierDetectionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
