...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ComputeFirewallPolicyIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.computeFirewallPolicyIamMember.ComputeFirewallPolicyIamMemberCondition",
		reflect.TypeOf((*ComputeFirewallPolicyIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.computeFirewallPolicyIamMember.ComputeFirewallPolicyIamMemberConditionOutputReference",
		reflect.TypeOf((*ComputeFirewallPolicyIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.computeFirewallPolicyIamMember.ComputeFirewallPolicyIamMemberConfig",
		reflect.TypeOf((*ComputeFirewallPolicyIamMemberConfig)(nil)).Elem(),
	)
}
