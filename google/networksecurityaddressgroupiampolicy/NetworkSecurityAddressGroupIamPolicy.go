...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/networksecurityaddressgroupiampolicy/internal"
...
func (n *jsiiProxy_NetworkSecurityAddressGroupIamPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkSecurityAddressGroupIamPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkSecurityAddressGroupIamPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
