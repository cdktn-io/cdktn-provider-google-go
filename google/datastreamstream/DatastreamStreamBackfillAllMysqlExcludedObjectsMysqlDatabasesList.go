...
func (j *jsiiProxy_DatastreamStreamBackfillAllMysqlExcludedObjectsMysqlDatabasesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDatastreamStreamBackfillAllMysqlExcludedObjectsMysqlDatabasesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DatastreamStreamBackfillAllMysqlExcludedObjectsMysqlDatabasesList {
	_init_.Initialize()
...
func NewDatastreamStreamBackfillAllMysqlExcludedObjectsMysqlDatabasesList_Override(d DatastreamStreamBackfillAllMysqlExcludedObjectsMysqlDatabasesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DatastreamStreamBackfillAllMysqlExcludedObjectsMysqlDatabasesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DatastreamStreamBackfillAllMysqlExcludedObjectsMysqlDatabasesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DatastreamStreamBackfillAllMysqlExcludedObjectsMysqlDatabasesList) Resolve(context cdktn.IResolveContext) interface{} {
