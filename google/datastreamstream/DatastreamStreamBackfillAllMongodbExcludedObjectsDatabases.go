...
type DatastreamStreamBackfillAllMongodbExcludedObjectsDatabases struct {
	...
	// collections block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/datastream_stream#collections DatastreamStream#collections}
