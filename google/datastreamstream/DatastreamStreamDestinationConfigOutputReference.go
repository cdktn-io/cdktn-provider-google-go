...
func (d *jsiiProxy_DatastreamStreamDestinationConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DatastreamStreamDestinationConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
