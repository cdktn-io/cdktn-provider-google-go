...
func (j *jsiiProxy_DatastreamStreamBackfillAllSpannerExcludedObjectsSchemasTablesColumnsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDatastreamStreamBackfillAllSpannerExcludedObjectsSchemasTablesColumnsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DatastreamStreamBackfillAllSpannerExcludedObjectsSchemasTablesColumnsList {
	_init_.Initialize()
...
func NewDatastreamStreamBackfillAllSpannerExcludedObjectsSchemasTablesColumnsList_Override(d DatastreamStreamBackfillAllSpannerExcludedObjectsSchemasTablesColumnsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DatastreamStreamBackfillAllSpannerExcludedObjectsSchemasTablesColumnsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DatastreamStreamBackfillAllSpannerExcludedObjectsSchemasTablesColumnsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DatastreamStreamBackfillAllSpannerExcludedObjectsSchemasTablesColumnsList) Resolve(context cdktn.IResolveContext) interface{} {
