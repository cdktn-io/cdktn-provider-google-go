...
func (d *jsiiProxy_DatastreamStreamBackfillAllOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DatastreamStreamBackfillAllOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
