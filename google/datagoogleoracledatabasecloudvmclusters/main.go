...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dataGoogleOracleDatabaseCloudVmClusters.DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersIdentityConnector",
		reflect.TypeOf((*DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersIdentityConnector)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersIdentityConnectorList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersIdentityConnectorOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
