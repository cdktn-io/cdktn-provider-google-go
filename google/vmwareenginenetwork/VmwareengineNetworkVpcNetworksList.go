...
func (j *jsiiProxy_VmwareengineNetworkVpcNetworksList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVmwareengineNetworkVpcNetworksList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VmwareengineNetworkVpcNetworksList {
	_init_.Initialize()
...
func NewVmwareengineNetworkVpcNetworksList_Override(v VmwareengineNetworkVpcNetworksList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VmwareengineNetworkVpcNetworksList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VmwareengineNetworkVpcNetworksList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VmwareengineNetworkVpcNetworksList) Resolve(context cdktn.IResolveContext) interface{} {
