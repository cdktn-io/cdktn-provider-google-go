...
func (j *jsiiProxy_AppEngineApplication) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AppEngineApplication) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AppEngineApplication) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppEngineApplication) Provider() cdktn.TerraformProvider {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/app_engine_application google_app_engine_application} Resource.
...
func (j *jsiiProxy_AppEngineApplication)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AppEngineApplication)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AppEngineApplication)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AppEngineApplication_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AppEngineApplication) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppEngineApplication) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AppEngineApplication) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppEngineApplication) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppEngineApplication) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppEngineApplication) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
