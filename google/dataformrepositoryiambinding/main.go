...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataformRepositoryIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dataformRepositoryIamBinding.DataformRepositoryIamBindingCondition",
		reflect.TypeOf((*DataformRepositoryIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.dataformRepositoryIamBinding.DataformRepositoryIamBindingConditionOutputReference",
		reflect.TypeOf((*DataformRepositoryIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataformRepositoryIamBindingConditionOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dataformRepositoryIamBinding.DataformRepositoryIamBindingConfig",
		reflect.TypeOf((*DataformRepositoryIamBindingConfig)(nil)).Elem(),
	)
}
