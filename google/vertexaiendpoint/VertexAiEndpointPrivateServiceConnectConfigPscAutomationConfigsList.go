...
func (j *jsiiProxy_VertexAiEndpointPrivateServiceConnectConfigPscAutomationConfigsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVertexAiEndpointPrivateServiceConnectConfigPscAutomationConfigsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VertexAiEndpointPrivateServiceConnectConfigPscAutomationConfigsList {
	_init_.Initialize()
...
func NewVertexAiEndpointPrivateServiceConnectConfigPscAutomationConfigsList_Override(v VertexAiEndpointPrivateServiceConnectConfigPscAutomationConfigsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VertexAiEndpointPrivateServiceConnectConfigPscAutomationConfigsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VertexAiEndpointPrivateServiceConnectConfigPscAutomationConfigsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VertexAiEndpointPrivateServiceConnectConfigPscAutomationConfigsList) Resolve(context cdktn.IResolveContext) interface{} {
