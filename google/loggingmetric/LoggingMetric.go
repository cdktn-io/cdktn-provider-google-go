...
func (j *jsiiProxy_LoggingMetric) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LoggingMetric) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_LoggingMetric) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_LoggingMetric) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LoggingMetric) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LoggingMetric) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LoggingMetric) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LoggingMetric)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_LoggingMetric)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LoggingMetric)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LoggingMetric)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LoggingMetric_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LoggingMetric) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LoggingMetric) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LoggingMetric) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LoggingMetric) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LoggingMetric) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LoggingMetric) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		l,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingMetric) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
