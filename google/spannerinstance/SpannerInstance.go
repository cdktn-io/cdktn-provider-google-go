...
func (j *jsiiProxy_SpannerInstance) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SpannerInstance) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_SpannerInstance) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_SpannerInstance) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_SpannerInstance) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SpannerInstance) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SpannerInstance) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SpannerInstance) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SpannerInstance) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_SpannerInstance)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_SpannerInstance)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SpannerInstance)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SpannerInstance)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SpannerInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SpannerInstance) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpannerInstance) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SpannerInstance) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpannerInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SpannerInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SpannerInstance) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		s,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (s *jsiiProxy_SpannerInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
