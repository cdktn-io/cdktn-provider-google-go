...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "autoscalingTargetHighPriorityCpuUtilizationPercentInput", GoGetter: "AutoscalingTargetHighPriorityCpuUtilizationPercentInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "autoscalingTargetTotalCpuUtilizationPercentInput", GoGetter: "AutoscalingTargetTotalCpuUtilizationPercentInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "disableHighPriorityCpuAutoscaling", GoGetter: "DisableHighPriorityCpuAutoscaling"},
			_jsii_.MemberProperty{JsiiProperty: "disableHighPriorityCpuAutoscalingInput", GoGetter: "DisableHighPriorityCpuAutoscalingInput"},
			_jsii_.MemberProperty{JsiiProperty: "disableTotalCpuAutoscaling", GoGetter: "DisableTotalCpuAutoscaling"},
			_jsii_.MemberProperty{JsiiProperty: "disableTotalCpuAutoscalingInput", GoGetter: "DisableTotalCpuAutoscalingInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAutoscalingTargetHighPriorityCpuUtilizationPercent", GoMethod: "ResetAutoscalingTargetHighPriorityCpuUtilizationPercent"},
			_jsii_.MemberMethod{JsiiMethod: "resetAutoscalingTargetTotalCpuUtilizationPercent", GoMethod: "ResetAutoscalingTargetTotalCpuUtilizationPercent"},
			_jsii_.MemberMethod{JsiiMethod: "resetDisableHighPriorityCpuAutoscaling", GoMethod: "ResetDisableHighPriorityCpuAutoscaling"},
			_jsii_.MemberMethod{JsiiMethod: "resetDisableTotalCpuAutoscaling", GoMethod: "ResetDisableTotalCpuAutoscaling"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
