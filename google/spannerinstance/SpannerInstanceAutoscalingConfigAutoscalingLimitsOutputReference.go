...
func (s *jsiiProxy_SpannerInstanceAutoscalingConfigAutoscalingLimitsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpannerInstanceAutoscalingConfigAutoscalingLimitsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
