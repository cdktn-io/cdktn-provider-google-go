...
func (j *jsiiProxy_DataGoogleComputeBackendServiceCdnPolicyCacheKeyPolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeBackendServiceCdnPolicyCacheKeyPolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeBackendServiceCdnPolicyCacheKeyPolicyList {
	_init_.Initialize()
...
func NewDataGoogleComputeBackendServiceCdnPolicyCacheKeyPolicyList_Override(d DataGoogleComputeBackendServiceCdnPolicyCacheKeyPolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeBackendServiceCdnPolicyCacheKeyPolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeBackendServiceCdnPolicyCacheKeyPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeBackendServiceCdnPolicyCacheKeyPolicyList) Resolve(context cdktn.IResolveContext) interface{} {
