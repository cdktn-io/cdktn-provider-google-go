...
func (h *jsiiProxy_HealthcareFhirStore) validatePutNotificationConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*HealthcareFhirStoreNotificationConfigs; received %#v (a %T)", value, value)
		}
	}
...
func (h *jsiiProxy_HealthcareFhirStore) validatePutStreamConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*HealthcareFhirStoreStreamConfigs; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_HealthcareFhirStore) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
