...
func (j *jsiiProxy_ApihubPluginInstanceActionsHubInstanceActionList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ApihubPluginInstanceActionsHubInstanceActionList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ApihubPluginInstanceActionsHubInstanceActionList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_ApihubPluginInstanceActionsHubInstanceActionList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ApihubPluginInstanceActionsHubInstanceActionList)SetWrapsSet(val *bool) {
...
func (a *jsiiProxy_ApihubPluginInstanceActionsHubInstanceActionList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_ApihubPluginInstanceActionsHubInstanceActionList) Get(index *float64) ApihubPluginInstanceActionsHubInstanceActionOutputReference {
	if err := a.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ApihubPluginInstanceActionsHubInstanceActionOutputReference
...
func (a *jsiiProxy_ApihubPluginInstanceActionsHubInstanceActionList) ToString() *string {
	var returns *string
