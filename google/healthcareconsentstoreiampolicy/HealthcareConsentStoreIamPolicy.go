...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/healthcareconsentstoreiampolicy/internal"
...
func (j *jsiiProxy_HealthcareConsentStoreIamPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_HealthcareConsentStoreIamPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_HealthcareConsentStoreIamPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_HealthcareConsentStoreIamPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_HealthcareConsentStoreIamPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/healthcare_consent_store_iam_policy google_healthcare_consent_store_iam_policy} Resource.
func NewHealthcareConsentStoreIamPolicy(scope constructs.Construct, id *string, config *HealthcareConsentStoreIamPolicyConfig) HealthcareConsentStoreIamPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-google.healthcareConsentStoreIamPolicy.HealthcareConsentStoreIamPolicy",
...
func (j *jsiiProxy_HealthcareConsentStoreIamPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_HealthcareConsentStoreIamPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_HealthcareConsentStoreIamPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func HealthcareConsentStoreIamPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (h *jsiiProxy_HealthcareConsentStoreIamPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HealthcareConsentStoreIamPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (h *jsiiProxy_HealthcareConsentStoreIamPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HealthcareConsentStoreIamPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (h *jsiiProxy_HealthcareConsentStoreIamPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (h *jsiiProxy_HealthcareConsentStoreIamPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
