...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/bigqueryanalyticshublistingiammember/internal"
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingIamMember) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingIamMember) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingIamMember) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingIamMember) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingIamMember) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/bigquery_analytics_hub_listing_iam_member google_bigquery_analytics_hub_listing_iam_member} Resource.
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingIamMember)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingIamMember)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingIamMember)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BigqueryAnalyticsHubListingIamMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingIamMember) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingIamMember) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingIamMember) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingIamMember) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingIamMember) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingIamMember) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
