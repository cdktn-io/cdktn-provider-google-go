...
func (c *jsiiProxy_ComputeRegionUrlMapPathMatcherRouteRulesMatchRulesOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_ComputeRegionUrlMapPathMatcherRouteRulesMatchRulesOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	return nil
}

func validateNewComputeRegionUrlMapPathMatcherRouteRulesMatchRulesOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
	return nil
}
