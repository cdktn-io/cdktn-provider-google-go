...
func (j *jsiiProxy_ComputeRegionUrlMapPathMatcherRouteRulesMatchRulesHeaderMatchesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewComputeRegionUrlMapPathMatcherRouteRulesMatchRulesHeaderMatchesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ComputeRegionUrlMapPathMatcherRouteRulesMatchRulesHeaderMatchesList {
	_init_.Initialize()
...
func NewComputeRegionUrlMapPathMatcherRouteRulesMatchRulesHeaderMatchesList_Override(c ComputeRegionUrlMapPathMatcherRouteRulesMatchRulesHeaderMatchesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComputeRegionUrlMapPathMatcherRouteRulesMatchRulesHeaderMatchesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ComputeRegionUrlMapPathMatcherRouteRulesMatchRulesHeaderMatchesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ComputeRegionUrlMapPathMatcherRouteRulesMatchRulesHeaderMatchesList) Resolve(context cdktn.IResolveContext) interface{} {
