...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionBuildConfigOutputReference) EnvironmentVariables() cdktn.StringMap {
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionBuildConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudfunctions2FunctionBuildConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleCloudfunctions2FunctionBuildConfigOutputReference {
	_init_.Initialize()
...
func NewDataGoogleCloudfunctions2FunctionBuildConfigOutputReference_Override(d DataGoogleCloudfunctions2FunctionBuildConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionBuildConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionBuildConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionBuildConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionBuildConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionBuildConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
