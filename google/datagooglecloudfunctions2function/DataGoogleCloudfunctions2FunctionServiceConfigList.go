...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionServiceConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudfunctions2FunctionServiceConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudfunctions2FunctionServiceConfigList {
	_init_.Initialize()
...
func NewDataGoogleCloudfunctions2FunctionServiceConfigList_Override(d DataGoogleCloudfunctions2FunctionServiceConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionServiceConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionServiceConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionServiceConfigList) Resolve(context cdktn.IResolveContext) interface{} {
