...
func (j *jsiiProxy_MonitoringMetricDescriptor) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_MonitoringMetricDescriptor) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/monitoring_metric_descriptor google_monitoring_metric_descriptor} Resource.
...
func (j *jsiiProxy_MonitoringMetricDescriptor)SetDeletionPolicy(val *string) {
...
func (m *jsiiProxy_MonitoringMetricDescriptor) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MonitoringMetricDescriptor) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MonitoringMetricDescriptor) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		m,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (m *jsiiProxy_MonitoringMetricDescriptor) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
