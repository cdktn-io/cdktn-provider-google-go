...
func (j *jsiiProxy_OrgPolicyCustomConstraint) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint)SetDeletionPolicy(val *string) {
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		o,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
