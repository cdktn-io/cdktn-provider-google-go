...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GkeHubFeatureIamPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.gkeHubFeatureIamPolicy.GkeHubFeatureIamPolicyConfig",
		reflect.TypeOf((*GkeHubFeatureIamPolicyConfig)(nil)).Elem(),
	)
}
