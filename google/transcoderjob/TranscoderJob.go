...
func (j *jsiiProxy_TranscoderJob) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_TranscoderJob) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/transcoder_job google_transcoder_job} Resource.
...
func (j *jsiiProxy_TranscoderJob)SetDeletionPolicy(val *string) {
...
func (t *jsiiProxy_TranscoderJob) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		t,
		"resetDeletionPolicy",
		nil, // no parameters
