...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/storage_anywhere_cache google_storage_anywhere_cache} Resource.
...
func (s *jsiiProxy_StorageAnywhereCache) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageAnywhereCache) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StorageAnywhereCache) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
