...
type ComputeRegionNetworkFirewallPolicyWithRulesConfig struct {
	// Experimental.
	...
	Timeouts *ComputeRegionNetworkFirewallPolicyWithRulesTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
