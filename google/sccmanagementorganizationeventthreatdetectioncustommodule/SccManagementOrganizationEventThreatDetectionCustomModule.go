...
func (j *jsiiProxy_SccManagementOrganizationEventThreatDetectionCustomModule) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_SccManagementOrganizationEventThreatDetectionCustomModule) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/scc_management_organization_event_threat_detection_custom_module google_scc_management_organization_event_threat_detection_custom_module} Resource.
...
func (j *jsiiProxy_SccManagementOrganizationEventThreatDetectionCustomModule)SetDeletionPolicy(val *string) {
...
func (s *jsiiProxy_SccManagementOrganizationEventThreatDetectionCustomModule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SccManagementOrganizationEventThreatDetectionCustomModule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SccManagementOrganizationEventThreatDetectionCustomModule) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		s,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (s *jsiiProxy_SccManagementOrganizationEventThreatDetectionCustomModule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
