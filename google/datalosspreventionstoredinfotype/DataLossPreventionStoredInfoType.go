...
func (j *jsiiProxy_DataLossPreventionStoredInfoType) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataLossPreventionStoredInfoType) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DataLossPreventionStoredInfoType) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_DataLossPreventionStoredInfoType) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataLossPreventionStoredInfoType) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataLossPreventionStoredInfoType) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataLossPreventionStoredInfoType) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/data_loss_prevention_stored_info_type google_data_loss_prevention_stored_info_type} Resource.
...
func (j *jsiiProxy_DataLossPreventionStoredInfoType)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_DataLossPreventionStoredInfoType)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataLossPreventionStoredInfoType)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataLossPreventionStoredInfoType)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataLossPreventionStoredInfoType_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataLossPreventionStoredInfoType) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataLossPreventionStoredInfoType) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DataLossPreventionStoredInfoType) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataLossPreventionStoredInfoType) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataLossPreventionStoredInfoType) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataLossPreventionStoredInfoType) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		d,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (d *jsiiProxy_DataLossPreventionStoredInfoType) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
