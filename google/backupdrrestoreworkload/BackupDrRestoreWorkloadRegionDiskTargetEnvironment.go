...
type BackupDrRestoreWorkloadRegionDiskTargetEnvironment struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/resources/backup_dr_restore_workload#region BackupDrRestoreWorkload#region}
	Region *string `field:"required" json:"region" yaml:"region"`
	// Required. Target URLs of the replica zones for the disk.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/resources/backup_dr_restore_workload#replica_zones BackupDrRestoreWorkload#replica_zones}
