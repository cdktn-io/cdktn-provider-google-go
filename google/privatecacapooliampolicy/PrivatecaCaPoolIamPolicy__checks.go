...
func (p *jsiiProxy_PrivatecaCaPoolIamPolicy) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (p *jsiiProxy_PrivatecaCaPoolIamPolicy) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (p *jsiiProxy_PrivatecaCaPoolIamPolicy) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func validatePrivatecaCaPoolIamPolicy_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
