...
func (j *jsiiProxy_DataGooglePubsubSubscriptionDeadLetterPolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGooglePubsubSubscriptionDeadLetterPolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGooglePubsubSubscriptionDeadLetterPolicyList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGooglePubsubSubscription.DataGooglePubsubSubscriptionDeadLetterPolicyList",
...
func NewDataGooglePubsubSubscriptionDeadLetterPolicyList_Override(d DataGooglePubsubSubscriptionDeadLetterPolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGooglePubsubSubscriptionDeadLetterPolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGooglePubsubSubscriptionDeadLetterPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGooglePubsubSubscriptionDeadLetterPolicyList) Resolve(context cdktn.IResolveContext) interface{} {
