...
func NewDataGooglePubsubSubscriptionCloudStorageConfigAvroConfigList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGooglePubsubSubscriptionCloudStorageConfigAvroConfigList {
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGooglePubsubSubscription.DataGooglePubsubSubscriptionCloudStorageConfigAvroConfigList",
...
func (d *jsiiProxy_DataGooglePubsubSubscriptionCloudStorageConfigAvroConfigList) Resolve(context cdktf.IResolveContext) interface{} {
