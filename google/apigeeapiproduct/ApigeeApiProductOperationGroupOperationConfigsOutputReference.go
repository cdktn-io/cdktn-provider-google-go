...
func (a *jsiiProxy_ApigeeApiProductOperationGroupOperationConfigsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApigeeApiProductOperationGroupOperationConfigsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
