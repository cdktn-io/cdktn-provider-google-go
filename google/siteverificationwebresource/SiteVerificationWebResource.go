...
func (j *jsiiProxy_SiteVerificationWebResource) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_SiteVerificationWebResource) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_SiteVerificationWebResource)SetDeletionPolicy(val *string) {
...
func (s *jsiiProxy_SiteVerificationWebResource) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SiteVerificationWebResource) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SiteVerificationWebResource) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		s,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (s *jsiiProxy_SiteVerificationWebResource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
