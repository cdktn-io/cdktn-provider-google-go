...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/workstations_workstation_iam_binding google_workstations_workstation_iam_binding}.
...
func (j *jsiiProxy_WorkstationsWorkstationIamBinding) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WorkstationsWorkstationIamBinding) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WorkstationsWorkstationIamBinding) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WorkstationsWorkstationIamBinding) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WorkstationsWorkstationIamBinding) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/workstations_workstation_iam_binding google_workstations_workstation_iam_binding} Resource.
func NewWorkstationsWorkstationIamBinding(scope constructs.Construct, id *string, config *WorkstationsWorkstationIamBindingConfig) WorkstationsWorkstationIamBinding {
	...
	_jsii_.Create(
		"@cdktn/provider-google.workstationsWorkstationIamBinding.WorkstationsWorkstationIamBinding",
...
func (j *jsiiProxy_WorkstationsWorkstationIamBinding)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WorkstationsWorkstationIamBinding)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WorkstationsWorkstationIamBinding)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WorkstationsWorkstationIamBinding_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WorkstationsWorkstationIamBinding) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WorkstationsWorkstationIamBinding) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WorkstationsWorkstationIamBinding) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WorkstationsWorkstationIamBinding) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WorkstationsWorkstationIamBinding) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WorkstationsWorkstationIamBinding) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
