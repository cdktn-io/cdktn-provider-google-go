...
func (j *jsiiProxy_ChronicleDashboardChart) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ChronicleDashboardChart) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ChronicleDashboardChart) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ChronicleDashboardChart) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ChronicleDashboardChart) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ChronicleDashboardChart)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ChronicleDashboardChart)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ChronicleDashboardChart)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ChronicleDashboardChart_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ChronicleDashboardChart) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ChronicleDashboardChart) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ChronicleDashboardChart) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ChronicleDashboardChart) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ChronicleDashboardChart) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ChronicleDashboardChart) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
