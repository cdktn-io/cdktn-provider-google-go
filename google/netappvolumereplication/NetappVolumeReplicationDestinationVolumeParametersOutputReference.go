...
func (n *jsiiProxy_NetappVolumeReplicationDestinationVolumeParametersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetappVolumeReplicationDestinationVolumeParametersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
