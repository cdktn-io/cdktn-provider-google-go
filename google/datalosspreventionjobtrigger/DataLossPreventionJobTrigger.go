...
func (d *jsiiProxy_DataLossPreventionJobTrigger) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataLossPreventionJobTrigger) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataLossPreventionJobTrigger) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
