...
func (d *jsiiProxy_DataLossPreventionJobTriggerInspectJobInspectConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataLossPreventionJobTriggerInspectJobInspectConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
