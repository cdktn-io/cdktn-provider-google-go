...
func (j *jsiiProxy_SpannerDatabase) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SpannerDatabase) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_SpannerDatabase) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_SpannerDatabase) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SpannerDatabase) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SpannerDatabase) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SpannerDatabase) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SpannerDatabase)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_SpannerDatabase)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SpannerDatabase)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SpannerDatabase)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SpannerDatabase_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SpannerDatabase) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpannerDatabase) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SpannerDatabase) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpannerDatabase) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SpannerDatabase) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SpannerDatabase) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		s,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (s *jsiiProxy_SpannerDatabase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
