...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PubsubSchemaIamPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.pubsubSchemaIamPolicy.PubsubSchemaIamPolicyConfig",
		reflect.TypeOf((*PubsubSchemaIamPolicyConfig)(nil)).Elem(),
	)
}
