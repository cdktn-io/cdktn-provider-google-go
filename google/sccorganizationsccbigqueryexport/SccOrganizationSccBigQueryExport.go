...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/sccorganizationsccbigqueryexport/internal"
...
func (j *jsiiProxy_SccOrganizationSccBigQueryExport) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SccOrganizationSccBigQueryExport) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_SccOrganizationSccBigQueryExport) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_SccOrganizationSccBigQueryExport) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SccOrganizationSccBigQueryExport) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SccOrganizationSccBigQueryExport) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SccOrganizationSccBigQueryExport) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/scc_organization_scc_big_query_export google_scc_organization_scc_big_query_export} Resource.
func NewSccOrganizationSccBigQueryExport(scope constructs.Construct, id *string, config *SccOrganizationSccBigQueryExportConfig) SccOrganizationSccBigQueryExport {
	...
	_jsii_.Create(
		"@cdktn/provider-google.sccOrganizationSccBigQueryExport.SccOrganizationSccBigQueryExport",
...
func (j *jsiiProxy_SccOrganizationSccBigQueryExport)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_SccOrganizationSccBigQueryExport)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SccOrganizationSccBigQueryExport)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SccOrganizationSccBigQueryExport)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SccOrganizationSccBigQueryExport_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SccOrganizationSccBigQueryExport) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SccOrganizationSccBigQueryExport) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SccOrganizationSccBigQueryExport) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SccOrganizationSccBigQueryExport) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SccOrganizationSccBigQueryExport) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SccOrganizationSccBigQueryExport) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		s,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (s *jsiiProxy_SccOrganizationSccBigQueryExport) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
