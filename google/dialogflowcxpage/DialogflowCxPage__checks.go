...
func (d *jsiiProxy_DialogflowCxPage) validatePutEventHandlersParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DialogflowCxPageEventHandlers; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DialogflowCxPage) validatePutTransitionRoutesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DialogflowCxPageTransitionRoutes; received %#v (a %T)", value, value)
		}
	}
