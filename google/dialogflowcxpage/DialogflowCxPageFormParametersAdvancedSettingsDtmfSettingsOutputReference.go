...
func (d *jsiiProxy_DialogflowCxPageFormParametersAdvancedSettingsDtmfSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DialogflowCxPageFormParametersAdvancedSettingsDtmfSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
