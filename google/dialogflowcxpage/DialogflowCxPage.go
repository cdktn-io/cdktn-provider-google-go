...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/dialogflow_cx_page google_dialogflow_cx_page}.
type DialogflowCxPage interface {
	...
	SetId(val *string)
	IdInput() *string
	KnowledgeConnectorSettings() DialogflowCxPageKnowledgeConnectorSettingsOutputReference
	KnowledgeConnectorSettingsInput() *DialogflowCxPageKnowledgeConnectorSettings
	LanguageCode() *string
	...
	PutKnowledgeConnectorSettings(value *DialogflowCxPageKnowledgeConnectorSettings)
...
func (j *jsiiProxy_DialogflowCxPage) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DialogflowCxPage) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DialogflowCxPage) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_DialogflowCxPage) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DialogflowCxPage) KnowledgeConnectorSettings() DialogflowCxPageKnowledgeConnectorSettingsOutputReference {
	var returns DialogflowCxPageKnowledgeConnectorSettingsOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DialogflowCxPage) KnowledgeConnectorSettingsInput() *DialogflowCxPageKnowledgeConnectorSettings {
...
func (j *jsiiProxy_DialogflowCxPage) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DialogflowCxPage) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DialogflowCxPage) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/dialogflow_cx_page google_dialogflow_cx_page} Resource.
...
func (j *jsiiProxy_DialogflowCxPage)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_DialogflowCxPage)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DialogflowCxPage)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DialogflowCxPage)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DialogflowCxPage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DialogflowCxPage) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DialogflowCxPage) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DialogflowCxPage) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DialogflowCxPage) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DialogflowCxPage) PutKnowledgeConnectorSettings(value *DialogflowCxPageKnowledgeConnectorSettings) {
...
func (d *jsiiProxy_DialogflowCxPage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DialogflowCxPage) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		d,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (d *jsiiProxy_DialogflowCxPage) ResetKnowledgeConnectorSettings() {
	_jsii_.InvokeVoid(
		d,
		"resetKnowledgeConnectorSettings",
		nil, // no parameters
...
func (d *jsiiProxy_DialogflowCxPage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
