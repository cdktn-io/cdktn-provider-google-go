...
func (j *jsiiProxy_BeyondcorpAppGatewayAllocatedConnectionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBeyondcorpAppGatewayAllocatedConnectionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BeyondcorpAppGatewayAllocatedConnectionsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google.beyondcorpAppGateway.BeyondcorpAppGatewayAllocatedConnectionsList",
...
func NewBeyondcorpAppGatewayAllocatedConnectionsList_Override(b BeyondcorpAppGatewayAllocatedConnectionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BeyondcorpAppGatewayAllocatedConnectionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BeyondcorpAppGatewayAllocatedConnectionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BeyondcorpAppGatewayAllocatedConnectionsList) Resolve(context cdktn.IResolveContext) interface{} {
