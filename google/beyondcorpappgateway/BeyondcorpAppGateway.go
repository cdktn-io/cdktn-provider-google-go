...
func (b *jsiiProxy_BeyondcorpAppGateway) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BeyondcorpAppGateway) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BeyondcorpAppGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
