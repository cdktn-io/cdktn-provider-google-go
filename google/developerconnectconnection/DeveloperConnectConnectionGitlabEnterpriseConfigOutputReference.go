...
func (d *jsiiProxy_DeveloperConnectConnectionGitlabEnterpriseConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DeveloperConnectConnectionGitlabEnterpriseConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
