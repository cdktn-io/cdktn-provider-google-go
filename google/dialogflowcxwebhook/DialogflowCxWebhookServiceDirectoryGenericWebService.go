...
type DialogflowCxWebhookServiceDirectoryGenericWebService struct {
	...
	ServiceAccountAuthConfig *DialogflowCxWebhookServiceDirectoryGenericWebServiceServiceAccountAuthConfig `field:"optional" json:"serviceAccountAuthConfig" yaml:"serviceAccountAuthConfig"`
