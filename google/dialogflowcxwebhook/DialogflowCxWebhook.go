...
func (j *jsiiProxy_DialogflowCxWebhook) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DialogflowCxWebhook) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DialogflowCxWebhook) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_DialogflowCxWebhook) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DialogflowCxWebhook) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DialogflowCxWebhook) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DialogflowCxWebhook) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DialogflowCxWebhook)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_DialogflowCxWebhook)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DialogflowCxWebhook)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DialogflowCxWebhook)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DialogflowCxWebhook_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DialogflowCxWebhook) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DialogflowCxWebhook) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DialogflowCxWebhook) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DialogflowCxWebhook) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DialogflowCxWebhook) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DialogflowCxWebhook) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		d,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (d *jsiiProxy_DialogflowCxWebhook) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
