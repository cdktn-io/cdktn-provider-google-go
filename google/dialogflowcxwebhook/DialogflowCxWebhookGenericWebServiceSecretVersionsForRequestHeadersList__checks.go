...
func (d *jsiiProxy_DialogflowCxWebhookGenericWebServiceSecretVersionsForRequestHeadersList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
