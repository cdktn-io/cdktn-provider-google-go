...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DnsManagedZoneIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dnsManagedZoneIamBinding.DnsManagedZoneIamBindingCondition",
		reflect.TypeOf((*DnsManagedZoneIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.dnsManagedZoneIamBinding.DnsManagedZoneIamBindingConditionOutputReference",
		reflect.TypeOf((*DnsManagedZoneIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dnsManagedZoneIamBinding.DnsManagedZoneIamBindingConfig",
		reflect.TypeOf((*DnsManagedZoneIamBindingConfig)(nil)).Elem(),
	)
}
