...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enabledTool", GoGetter: "EnabledTool"},
			_jsii_.MemberProperty{JsiiProperty: "enabledToolInput", GoGetter: "EnabledToolInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAccountConnector", GoMethod: "ResetAccountConnector"},
