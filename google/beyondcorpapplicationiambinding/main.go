...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BeyondcorpApplicationIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.beyondcorpApplicationIamBinding.BeyondcorpApplicationIamBindingCondition",
		reflect.TypeOf((*BeyondcorpApplicationIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.beyondcorpApplicationIamBinding.BeyondcorpApplicationIamBindingConditionOutputReference",
		reflect.TypeOf((*BeyondcorpApplicationIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.beyondcorpApplicationIamBinding.BeyondcorpApplicationIamBindingConfig",
		reflect.TypeOf((*BeyondcorpApplicationIamBindingConfig)(nil)).Elem(),
	)
}
