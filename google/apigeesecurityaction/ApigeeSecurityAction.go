...
func (j *jsiiProxy_ApigeeSecurityAction) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ApigeeSecurityAction) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apigee_security_action google_apigee_security_action} Resource.
...
func (j *jsiiProxy_ApigeeSecurityAction)SetDeletionPolicy(val *string) {
...
func (a *jsiiProxy_ApigeeSecurityAction) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApigeeSecurityAction) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApigeeSecurityAction) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		a,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (a *jsiiProxy_ApigeeSecurityAction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
