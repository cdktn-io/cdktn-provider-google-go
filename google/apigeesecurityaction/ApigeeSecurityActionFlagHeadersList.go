...
func (j *jsiiProxy_ApigeeSecurityActionFlagHeadersList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ApigeeSecurityActionFlagHeadersList) InternalValue() interface{} {
...
func (j *jsiiProxy_ApigeeSecurityActionFlagHeadersList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ApigeeSecurityActionFlagHeadersList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_ApigeeSecurityActionFlagHeadersList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ApigeeSecurityActionFlagHeadersList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ApigeeSecurityActionFlagHeadersList)SetWrapsSet(val *bool) {
...
func (a *jsiiProxy_ApigeeSecurityActionFlagHeadersList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_ApigeeSecurityActionFlagHeadersList) Get(index *float64) ApigeeSecurityActionFlagHeadersOutputReference {
	if err := a.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ApigeeSecurityActionFlagHeadersOutputReference
...
func (a *jsiiProxy_ApigeeSecurityActionFlagHeadersList) ToString() *string {
	var returns *string
