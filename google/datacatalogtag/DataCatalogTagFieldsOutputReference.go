...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v16/datacatalogtag/internal"
...
func (d *jsiiProxy_DataCatalogTagFieldsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCatalogTagFieldsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
