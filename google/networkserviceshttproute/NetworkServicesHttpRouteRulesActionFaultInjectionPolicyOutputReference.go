...
func (n *jsiiProxy_NetworkServicesHttpRouteRulesActionFaultInjectionPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkServicesHttpRouteRulesActionFaultInjectionPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
