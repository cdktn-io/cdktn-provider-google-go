...
func (d *jsiiProxy_DialogflowCxFlowNluSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DialogflowCxFlowNluSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
