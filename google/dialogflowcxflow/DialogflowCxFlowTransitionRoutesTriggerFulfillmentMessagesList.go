...
func (j *jsiiProxy_DialogflowCxFlowTransitionRoutesTriggerFulfillmentMessagesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDialogflowCxFlowTransitionRoutesTriggerFulfillmentMessagesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DialogflowCxFlowTransitionRoutesTriggerFulfillmentMessagesList {
	_init_.Initialize()
...
func NewDialogflowCxFlowTransitionRoutesTriggerFulfillmentMessagesList_Override(d DialogflowCxFlowTransitionRoutesTriggerFulfillmentMessagesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DialogflowCxFlowTransitionRoutesTriggerFulfillmentMessagesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DialogflowCxFlowTransitionRoutesTriggerFulfillmentMessagesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DialogflowCxFlowTransitionRoutesTriggerFulfillmentMessagesList) Resolve(context cdktn.IResolveContext) interface{} {
