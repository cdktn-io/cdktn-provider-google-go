...
func (d *jsiiProxy_DialogflowCxFlow) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (d *jsiiProxy_DialogflowCxFlow) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (d *jsiiProxy_DialogflowCxFlow) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (d *jsiiProxy_DialogflowCxFlow) validatePutEventHandlersParameters(value interface{}) error {
	...
	case *[]*DialogflowCxFlowEventHandlers:
		value := value.(*[]*DialogflowCxFlowEventHandlers)
	...
	case []*DialogflowCxFlowEventHandlers:
		value_ := value.([]*DialogflowCxFlowEventHandlers)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DialogflowCxFlowEventHandlers; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DialogflowCxFlow) validatePutTransitionRoutesParameters(value interface{}) error {
	...
	case *[]*DialogflowCxFlowTransitionRoutes:
		value := value.(*[]*DialogflowCxFlowTransitionRoutes)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*DialogflowCxFlowTransitionRoutes:
		value_ := value.([]*DialogflowCxFlowTransitionRoutes)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DialogflowCxFlowTransitionRoutes; received %#v (a %T)", value, value)
		}
	}
...
func validateDialogflowCxFlow_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
...
func (j *jsiiProxy_DialogflowCxFlow) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
