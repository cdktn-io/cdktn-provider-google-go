...
func (j *jsiiProxy_DialogflowCxFlowEventHandlersTriggerFulfillmentConditionalCasesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDialogflowCxFlowEventHandlersTriggerFulfillmentConditionalCasesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DialogflowCxFlowEventHandlersTriggerFulfillmentConditionalCasesList {
	_init_.Initialize()
...
func NewDialogflowCxFlowEventHandlersTriggerFulfillmentConditionalCasesList_Override(d DialogflowCxFlowEventHandlersTriggerFulfillmentConditionalCasesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DialogflowCxFlowEventHandlersTriggerFulfillmentConditionalCasesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DialogflowCxFlowEventHandlersTriggerFulfillmentConditionalCasesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DialogflowCxFlowEventHandlersTriggerFulfillmentConditionalCasesList) Resolve(context cdktn.IResolveContext) interface{} {
