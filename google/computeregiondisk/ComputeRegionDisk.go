...
func (c *jsiiProxy_ComputeRegionDisk) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputeRegionDisk) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputeRegionDisk) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
