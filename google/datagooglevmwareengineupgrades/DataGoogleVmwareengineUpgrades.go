...
func (j *jsiiProxy_DataGoogleVmwareengineUpgrades) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataGoogleVmwareengineUpgrades) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_DataGoogleVmwareengineUpgrades) Count() interface{} {
...
func (j *jsiiProxy_DataGoogleVmwareengineUpgrades) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataGoogleVmwareengineUpgrades) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGoogleVmwareengineUpgrades) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataGoogleVmwareengineUpgrades) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_DataGoogleVmwareengineUpgrades) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataGoogleVmwareengineUpgrades) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/data-sources/vmwareengine_upgrades google_vmwareengine_upgrades} Data Source.
func NewDataGoogleVmwareengineUpgrades(scope constructs.Construct, id *string, config *DataGoogleVmwareengineUpgradesConfig) DataGoogleVmwareengineUpgrades {
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleVmwareengineUpgrades.DataGoogleVmwareengineUpgrades",
...
func (j *jsiiProxy_DataGoogleVmwareengineUpgrades)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataGoogleVmwareengineUpgrades)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGoogleVmwareengineUpgrades)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataGoogleVmwareengineUpgrades)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataGoogleVmwareengineUpgrades_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func DataGoogleVmwareengineUpgrades_IsConstruct(x interface{}) *bool {
	_init_.Initialize()
...
// Experimental.
func DataGoogleVmwareengineUpgrades_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()
...
// Experimental.
func DataGoogleVmwareengineUpgrades_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()
...
func (d *jsiiProxy_DataGoogleVmwareengineUpgrades) AddOverride(path *string, value interface{}) {
...
func (d *jsiiProxy_DataGoogleVmwareengineUpgrades) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (d *jsiiProxy_DataGoogleVmwareengineUpgrades) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleVmwareengineUpgrades) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleVmwareengineUpgrades) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataGoogleVmwareengineUpgrades) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGoogleVmwareengineUpgrades) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGoogleVmwareengineUpgrades) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataGoogleVmwareengineUpgrades) ToMetadata() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataGoogleVmwareengineUpgrades) ToTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataGoogleVmwareengineUpgrades) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
