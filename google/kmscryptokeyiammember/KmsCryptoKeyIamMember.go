...
func (j *jsiiProxy_KmsCryptoKeyIamMember) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_KmsCryptoKeyIamMember) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_KmsCryptoKeyIamMember) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KmsCryptoKeyIamMember) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_KmsCryptoKeyIamMember) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewKmsCryptoKeyIamMember(scope constructs.Construct, id *string, config *KmsCryptoKeyIamMemberConfig) KmsCryptoKeyIamMember {
	...
	_jsii_.Create(
		"@cdktn/provider-google.kmsCryptoKeyIamMember.KmsCryptoKeyIamMember",
...
func (j *jsiiProxy_KmsCryptoKeyIamMember)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KmsCryptoKeyIamMember)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KmsCryptoKeyIamMember)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func KmsCryptoKeyIamMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KmsCryptoKeyIamMember) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KmsCryptoKeyIamMember) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (k *jsiiProxy_KmsCryptoKeyIamMember) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KmsCryptoKeyIamMember) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KmsCryptoKeyIamMember) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KmsCryptoKeyIamMember) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
