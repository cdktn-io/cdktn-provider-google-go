...
func (n *jsiiProxy_NetworkConnectivitySpokeLinkedVpnTunnelsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkConnectivitySpokeLinkedVpnTunnelsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
