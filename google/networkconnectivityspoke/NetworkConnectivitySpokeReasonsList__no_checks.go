...
func (n *jsiiProxy_NetworkConnectivitySpokeReasonsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (n *jsiiProxy_NetworkConnectivitySpokeReasonsList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_NetworkConnectivitySpokeReasonsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_NetworkConnectivitySpokeReasonsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
