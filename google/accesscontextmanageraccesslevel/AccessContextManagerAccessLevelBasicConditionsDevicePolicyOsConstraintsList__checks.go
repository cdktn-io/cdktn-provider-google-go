...
func (a *jsiiProxy_AccessContextManagerAccessLevelBasicConditionsDevicePolicyOsConstraintsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_AccessContextManagerAccessLevelBasicConditionsDevicePolicyOsConstraintsList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*AccessContextManagerAccessLevelBasicConditionsDevicePolicyOsConstraints; received %#v (a %T)", val, val)
		}
	}
