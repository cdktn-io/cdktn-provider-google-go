...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "multicastConsumerAssociation", GoGetter: "MulticastConsumerAssociation"},
			_jsii_.MemberProperty{JsiiProperty: "multicastConsumerAssociationInput", GoGetter: "MulticastConsumerAssociationInput"},
			_jsii_.MemberProperty{JsiiProperty: "multicastGroupConsumerActivationId", GoGetter: "MulticastGroupConsumerActivationId"},
			_jsii_.MemberProperty{JsiiProperty: "multicastGroupConsumerActivationIdInput", GoGetter: "MulticastGroupConsumerActivationIdInput"},
