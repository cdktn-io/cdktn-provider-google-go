...
func (j *jsiiProxy_DeveloperConnectInsightsConfigArtifactConfigsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDeveloperConnectInsightsConfigArtifactConfigsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DeveloperConnectInsightsConfigArtifactConfigsList {
	_init_.Initialize()
...
func NewDeveloperConnectInsightsConfigArtifactConfigsList_Override(d DeveloperConnectInsightsConfigArtifactConfigsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DeveloperConnectInsightsConfigArtifactConfigsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DeveloperConnectInsightsConfigArtifactConfigsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DeveloperConnectInsightsConfigArtifactConfigsList) Resolve(context cdktn.IResolveContext) interface{} {
