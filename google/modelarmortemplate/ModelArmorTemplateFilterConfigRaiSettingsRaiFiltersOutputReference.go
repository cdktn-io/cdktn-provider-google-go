...
func (j *jsiiProxy_ModelArmorTemplateFilterConfigRaiSettingsRaiFiltersOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewModelArmorTemplateFilterConfigRaiSettingsRaiFiltersOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ModelArmorTemplateFilterConfigRaiSettingsRaiFiltersOutputReference {
	_init_.Initialize()
...
func NewModelArmorTemplateFilterConfigRaiSettingsRaiFiltersOutputReference_Override(m ModelArmorTemplateFilterConfigRaiSettingsRaiFiltersOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ModelArmorTemplateFilterConfigRaiSettingsRaiFiltersOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_ModelArmorTemplateFilterConfigRaiSettingsRaiFiltersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ModelArmorTemplateFilterConfigRaiSettingsRaiFiltersOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_ModelArmorTemplateFilterConfigRaiSettingsRaiFiltersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ModelArmorTemplateFilterConfigRaiSettingsRaiFiltersOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
