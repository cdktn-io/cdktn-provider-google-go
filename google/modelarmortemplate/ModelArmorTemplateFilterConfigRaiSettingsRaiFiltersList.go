...
func (j *jsiiProxy_ModelArmorTemplateFilterConfigRaiSettingsRaiFiltersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewModelArmorTemplateFilterConfigRaiSettingsRaiFiltersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ModelArmorTemplateFilterConfigRaiSettingsRaiFiltersList {
	_init_.Initialize()
...
func NewModelArmorTemplateFilterConfigRaiSettingsRaiFiltersList_Override(m ModelArmorTemplateFilterConfigRaiSettingsRaiFiltersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ModelArmorTemplateFilterConfigRaiSettingsRaiFiltersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_ModelArmorTemplateFilterConfigRaiSettingsRaiFiltersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_ModelArmorTemplateFilterConfigRaiSettingsRaiFiltersList) Resolve(context cdktn.IResolveContext) interface{} {
