...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.modelArmorTemplate.ModelArmorTemplateTemplateMetadataFilterVersionSelector",
		reflect.TypeOf((*ModelArmorTemplateTemplateMetadataFilterVersionSelector)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.modelArmorTemplate.ModelArmorTemplateTemplateMetadataFilterVersionSelectorOutputReference",
		reflect.TypeOf((*ModelArmorTemplateTemplateMetadataFilterVersionSelectorOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
