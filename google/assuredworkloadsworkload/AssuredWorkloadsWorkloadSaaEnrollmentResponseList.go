...
func (j *jsiiProxy_AssuredWorkloadsWorkloadSaaEnrollmentResponseList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAssuredWorkloadsWorkloadSaaEnrollmentResponseList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AssuredWorkloadsWorkloadSaaEnrollmentResponseList {
	_init_.Initialize()
...
func NewAssuredWorkloadsWorkloadSaaEnrollmentResponseList_Override(a AssuredWorkloadsWorkloadSaaEnrollmentResponseList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AssuredWorkloadsWorkloadSaaEnrollmentResponseList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AssuredWorkloadsWorkloadSaaEnrollmentResponseList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AssuredWorkloadsWorkloadSaaEnrollmentResponseList) Resolve(context cdktn.IResolveContext) interface{} {
