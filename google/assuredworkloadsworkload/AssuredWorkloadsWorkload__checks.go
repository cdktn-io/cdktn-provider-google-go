...
func (a *jsiiProxy_AssuredWorkloadsWorkload) validatePutResourceSettingsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AssuredWorkloadsWorkloadResourceSettings; received %#v (a %T)", value, value)
		}
	}
