...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "opsAnalyticsQuery", GoGetter: "OpsAnalyticsQuery"},
			_jsii_.MemberProperty{JsiiProperty: "opsAnalyticsQueryInput", GoGetter: "OpsAnalyticsQueryInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putLoggingQuery", GoMethod: "PutLoggingQuery"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOpsAnalyticsQuery", GoMethod: "ResetOpsAnalyticsQuery"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putSummaryFields", GoMethod: "PutSummaryFields"},
			_jsii_.MemberMethod{JsiiMethod: "resetSummaryFieldEnd", GoMethod: "ResetSummaryFieldEnd"},
			_jsii_.MemberMethod{JsiiMethod: "resetSummaryFields", GoMethod: "ResetSummaryFields"},
			_jsii_.MemberMethod{JsiiMethod: "resetSummaryFieldStart", GoMethod: "ResetSummaryFieldStart"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "summaryFieldEnd", GoGetter: "SummaryFieldEnd"},
			_jsii_.MemberProperty{JsiiProperty: "summaryFieldEndInput", GoGetter: "SummaryFieldEndInput"},
			_jsii_.MemberProperty{JsiiProperty: "summaryFields", GoGetter: "SummaryFields"},
			_jsii_.MemberProperty{JsiiProperty: "summaryFieldsInput", GoGetter: "SummaryFieldsInput"},
			_jsii_.MemberProperty{JsiiProperty: "summaryFieldStart", GoGetter: "SummaryFieldStart"},
			_jsii_.MemberProperty{JsiiProperty: "summaryFieldStartInput", GoGetter: "SummaryFieldStartInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "sqlQueryText", GoGetter: "SqlQueryText"},
			_jsii_.MemberProperty{JsiiProperty: "sqlQueryTextInput", GoGetter: "SqlQueryTextInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
