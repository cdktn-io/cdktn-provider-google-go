...
func (v *jsiiProxy_VmwareenginePrivateCloudNsxList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (v *jsiiProxy_VmwareenginePrivateCloudNsxList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_VmwareenginePrivateCloudNsxList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_VmwareenginePrivateCloudNsxList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
