...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/bigtable_gc_policy google_bigtable_gc_policy} Resource.
...
func (b *jsiiProxy_BigtableGcPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BigtableGcPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BigtableGcPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
