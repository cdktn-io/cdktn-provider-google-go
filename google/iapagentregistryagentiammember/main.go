...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IapAgentRegistryAgentIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.iapAgentRegistryAgentIamMember.IapAgentRegistryAgentIamMemberCondition",
		reflect.TypeOf((*IapAgentRegistryAgentIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.iapAgentRegistryAgentIamMember.IapAgentRegistryAgentIamMemberConditionOutputReference",
		reflect.TypeOf((*IapAgentRegistryAgentIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.iapAgentRegistryAgentIamMember.IapAgentRegistryAgentIamMemberConfig",
		reflect.TypeOf((*IapAgentRegistryAgentIamMemberConfig)(nil)).Elem(),
	)
}
