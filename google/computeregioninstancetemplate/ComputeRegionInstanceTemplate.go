...
func (j *jsiiProxy_ComputeRegionInstanceTemplate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ComputeRegionInstanceTemplate) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ComputeRegionInstanceTemplate) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_ComputeRegionInstanceTemplate) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_ComputeRegionInstanceTemplate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ComputeRegionInstanceTemplate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ComputeRegionInstanceTemplate) NumericId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"numericId",
...
func (j *jsiiProxy_ComputeRegionInstanceTemplate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ComputeRegionInstanceTemplate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ComputeRegionInstanceTemplate) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/compute_region_instance_template google_compute_region_instance_template} Resource.
...
func (j *jsiiProxy_ComputeRegionInstanceTemplate)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_ComputeRegionInstanceTemplate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ComputeRegionInstanceTemplate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ComputeRegionInstanceTemplate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ComputeRegionInstanceTemplate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ComputeRegionInstanceTemplate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputeRegionInstanceTemplate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ComputeRegionInstanceTemplate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputeRegionInstanceTemplate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputeRegionInstanceTemplate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputeRegionInstanceTemplate) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeRegionInstanceTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
