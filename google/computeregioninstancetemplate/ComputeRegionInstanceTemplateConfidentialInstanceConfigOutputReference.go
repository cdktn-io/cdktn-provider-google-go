...
func (c *jsiiProxy_ComputeRegionInstanceTemplateConfidentialInstanceConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeRegionInstanceTemplateConfidentialInstanceConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
