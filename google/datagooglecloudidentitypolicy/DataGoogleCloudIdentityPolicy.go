...
func (j *jsiiProxy_DataGoogleCloudIdentityPolicy) Customer() *string {
	var returns *string
	_jsii_.Get(
		j,
		"customer",
...
func (j *jsiiProxy_DataGoogleCloudIdentityPolicy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleCloudIdentityPolicy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleCloudIdentityPolicy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleCloudIdentityPolicy) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleCloudIdentityPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleCloudIdentityPolicy) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleCloudIdentityPolicy) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataGoogleCloudIdentityPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleCloudIdentityPolicy) PolicyQuery() DataGoogleCloudIdentityPolicyPolicyQueryList {
	var returns DataGoogleCloudIdentityPolicyPolicyQueryList
	_jsii_.Get(
		j,
		"policyQuery",
		&returns,
...
func (j *jsiiProxy_DataGoogleCloudIdentityPolicy) Setting() *string {
	var returns *string
	_jsii_.Get(
		j,
		"setting",
...
func (j *jsiiProxy_DataGoogleCloudIdentityPolicy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleCloudIdentityPolicy) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/data-sources/cloud_identity_policy google_cloud_identity_policy} Data Source.
func NewDataGoogleCloudIdentityPolicy(scope constructs.Construct, id *string, config *DataGoogleCloudIdentityPolicyConfig) DataGoogleCloudIdentityPolicy {
	...
	if err := validateNewDataGoogleCloudIdentityPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleCloudIdentityPolicy_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-google.dataGoogleCloudIdentityPolicy.DataGoogleCloudIdentityPolicy",
...
func (d *jsiiProxy_DataGoogleCloudIdentityPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleCloudIdentityPolicy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleCloudIdentityPolicy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleCloudIdentityPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleCloudIdentityPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleCloudIdentityPolicy) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleCloudIdentityPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleCloudIdentityPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleCloudIdentityPolicy) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCloudIdentityPolicy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCloudIdentityPolicy) ToString() *string {
	var returns *string
