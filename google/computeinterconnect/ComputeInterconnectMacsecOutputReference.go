...
func (c *jsiiProxy_ComputeInterconnectMacsecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeInterconnectMacsecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
