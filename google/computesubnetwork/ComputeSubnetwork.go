...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/computesubnetwork/internal"
...
func (j *jsiiProxy_ComputeSubnetwork) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ComputeSubnetwork) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_ComputeSubnetwork) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ComputeSubnetwork) IpCollection() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipCollection",
...
func (j *jsiiProxy_ComputeSubnetwork) IpCollectionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipCollectionInput",
...
func (j *jsiiProxy_ComputeSubnetwork) Ipv6GceEndpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipv6GceEndpoint",
...
func (j *jsiiProxy_ComputeSubnetwork) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ComputeSubnetwork) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ComputeSubnetwork) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ComputeSubnetwork)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_ComputeSubnetwork)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ComputeSubnetwork)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ComputeSubnetwork)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ComputeSubnetwork_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ComputeSubnetwork) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputeSubnetwork) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ComputeSubnetwork) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputeSubnetwork) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputeSubnetwork) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputeSubnetwork) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeSubnetwork) ResetIpCollection() {
	_jsii_.InvokeVoid(
		c,
		"resetIpCollection",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeSubnetwork) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
