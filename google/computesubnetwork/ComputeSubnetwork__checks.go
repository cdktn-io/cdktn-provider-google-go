...
func (c *jsiiProxy_ComputeSubnetwork) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (c *jsiiProxy_ComputeSubnetwork) validatePutSecondaryIpRangeParameters(value interface{}) error {
	...
	case *[]*ComputeSubnetworkSecondaryIpRange:
		value := value.(*[]*ComputeSubnetworkSecondaryIpRange)
	...
	case []*ComputeSubnetworkSecondaryIpRange:
		value_ := value.([]*ComputeSubnetworkSecondaryIpRange)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ComputeSubnetworkSecondaryIpRange; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_ComputeSubnetwork) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
