...
func (j *jsiiProxy_BlockchainNodeEngineBlockchainNodesConnectionInfoList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBlockchainNodeEngineBlockchainNodesConnectionInfoList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BlockchainNodeEngineBlockchainNodesConnectionInfoList {
	_init_.Initialize()
...
func NewBlockchainNodeEngineBlockchainNodesConnectionInfoList_Override(b BlockchainNodeEngineBlockchainNodesConnectionInfoList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BlockchainNodeEngineBlockchainNodesConnectionInfoList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BlockchainNodeEngineBlockchainNodesConnectionInfoList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BlockchainNodeEngineBlockchainNodesConnectionInfoList) Resolve(context cdktn.IResolveContext) interface{} {
