...
type DataprocMetastoreDatabaseIamMemberConfig struct {
	// Experimental.
	...
	Condition *DataprocMetastoreDatabaseIamMemberCondition `field:"optional" json:"condition" yaml:"condition"`
