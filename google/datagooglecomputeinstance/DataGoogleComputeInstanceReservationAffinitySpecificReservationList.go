...
func (j *jsiiProxy_DataGoogleComputeInstanceReservationAffinitySpecificReservationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeInstanceReservationAffinitySpecificReservationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeInstanceReservationAffinitySpecificReservationList {
	_init_.Initialize()
...
func NewDataGoogleComputeInstanceReservationAffinitySpecificReservationList_Override(d DataGoogleComputeInstanceReservationAffinitySpecificReservationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeInstanceReservationAffinitySpecificReservationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeInstanceReservationAffinitySpecificReservationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeInstanceReservationAffinitySpecificReservationList) Resolve(context cdktn.IResolveContext) interface{} {
