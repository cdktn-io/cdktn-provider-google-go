...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/gkebackupbackupplaniampolicy/internal"
...
func (j *jsiiProxy_GkeBackupBackupPlanIamPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GkeBackupBackupPlanIamPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GkeBackupBackupPlanIamPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GkeBackupBackupPlanIamPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GkeBackupBackupPlanIamPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/gke_backup_backup_plan_iam_policy google_gke_backup_backup_plan_iam_policy} Resource.
...
func (j *jsiiProxy_GkeBackupBackupPlanIamPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GkeBackupBackupPlanIamPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GkeBackupBackupPlanIamPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GkeBackupBackupPlanIamPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GkeBackupBackupPlanIamPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GkeBackupBackupPlanIamPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GkeBackupBackupPlanIamPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GkeBackupBackupPlanIamPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GkeBackupBackupPlanIamPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GkeBackupBackupPlanIamPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
