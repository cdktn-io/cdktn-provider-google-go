...
func (a *jsiiProxy_AppEngineDomainMapping) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (j *jsiiProxy_AppEngineDomainMapping) validateSetCountParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_AppEngineDomainMapping) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
