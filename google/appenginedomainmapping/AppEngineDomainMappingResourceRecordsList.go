...
func (j *jsiiProxy_AppEngineDomainMappingResourceRecordsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppEngineDomainMappingResourceRecordsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AppEngineDomainMappingResourceRecordsList {
	_init_.Initialize()
...
func NewAppEngineDomainMappingResourceRecordsList_Override(a AppEngineDomainMappingResourceRecordsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppEngineDomainMappingResourceRecordsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppEngineDomainMappingResourceRecordsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppEngineDomainMappingResourceRecordsList) Resolve(context cdktn.IResolveContext) interface{} {
