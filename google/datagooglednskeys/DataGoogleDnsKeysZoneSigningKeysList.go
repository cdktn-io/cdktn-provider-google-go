...
func (j *jsiiProxy_DataGoogleDnsKeysZoneSigningKeysList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleDnsKeysZoneSigningKeysList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleDnsKeysZoneSigningKeysList {
	_init_.Initialize()
...
func NewDataGoogleDnsKeysZoneSigningKeysList_Override(d DataGoogleDnsKeysZoneSigningKeysList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleDnsKeysZoneSigningKeysList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleDnsKeysZoneSigningKeysList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleDnsKeysZoneSigningKeysList) Resolve(context cdktn.IResolveContext) interface{} {
