...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DiscoveryEngineSearchEngineIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.discoveryEngineSearchEngineIamBinding.DiscoveryEngineSearchEngineIamBindingCondition",
		reflect.TypeOf((*DiscoveryEngineSearchEngineIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DiscoveryEngineSearchEngineIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.discoveryEngineSearchEngineIamBinding.DiscoveryEngineSearchEngineIamBindingConfig",
		reflect.TypeOf((*DiscoveryEngineSearchEngineIamBindingConfig)(nil)).Elem(),
	)
}
