...
func (c *jsiiProxy_ComputeNetworkFirewallPolicyRuleMatchLayer4ConfigsOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_ComputeNetworkFirewallPolicyRuleMatchLayer4ConfigsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *ComputeNetworkFirewallPolicyRuleMatchLayer4Configs; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_ComputeNetworkFirewallPolicyRuleMatchLayer4ConfigsOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewComputeNetworkFirewallPolicyRuleMatchLayer4ConfigsOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
