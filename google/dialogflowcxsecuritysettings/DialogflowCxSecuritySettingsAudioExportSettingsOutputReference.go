...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v16/dialogflowcxsecuritysettings/internal"
...
func (d *jsiiProxy_DialogflowCxSecuritySettingsAudioExportSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DialogflowCxSecuritySettingsAudioExportSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
