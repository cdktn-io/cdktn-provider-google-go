...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/firebase_app_hosting_traffic google_firebase_app_hosting_traffic} Resource.
...
func (f *jsiiProxy_FirebaseAppHostingTraffic) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FirebaseAppHostingTraffic) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FirebaseAppHostingTraffic) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
