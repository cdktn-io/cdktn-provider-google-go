...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IapAgentRegistryMcpServerIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.iapAgentRegistryMcpServerIamMember.IapAgentRegistryMcpServerIamMemberCondition",
		reflect.TypeOf((*IapAgentRegistryMcpServerIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.iapAgentRegistryMcpServerIamMember.IapAgentRegistryMcpServerIamMemberConditionOutputReference",
		reflect.TypeOf((*IapAgentRegistryMcpServerIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.iapAgentRegistryMcpServerIamMember.IapAgentRegistryMcpServerIamMemberConfig",
		reflect.TypeOf((*IapAgentRegistryMcpServerIamMemberConfig)(nil)).Elem(),
	)
}
