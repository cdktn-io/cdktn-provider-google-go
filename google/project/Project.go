...
func (j *jsiiProxy_Project) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Project) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_Project) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Project) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Project) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Project) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Project) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_Project)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Project)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Project)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Project_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_Project) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_Project) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_Project) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_Project) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_Project) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
