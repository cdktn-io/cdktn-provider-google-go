...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v16/apigeekeystoresaliaseskeycertfile/internal"
...
func (a *jsiiProxy_ApigeeKeystoresAliasesKeyCertFileCertsInfoCertInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApigeeKeystoresAliasesKeyCertFileCertsInfoCertInfoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
