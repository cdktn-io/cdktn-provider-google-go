...
func (d *jsiiProxy_DialogflowCxIntent) validatePutParametersParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DialogflowCxIntentParameters; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DialogflowCxIntent) validatePutTrainingPhrasesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DialogflowCxIntentTrainingPhrases; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_DialogflowCxIntent) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
