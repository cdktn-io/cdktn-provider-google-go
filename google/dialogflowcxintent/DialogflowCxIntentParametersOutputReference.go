...
func (d *jsiiProxy_DialogflowCxIntentParametersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DialogflowCxIntentParametersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
