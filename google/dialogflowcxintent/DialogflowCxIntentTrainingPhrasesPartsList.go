...
func (j *jsiiProxy_DialogflowCxIntentTrainingPhrasesPartsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDialogflowCxIntentTrainingPhrasesPartsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DialogflowCxIntentTrainingPhrasesPartsList {
	_init_.Initialize()
...
func NewDialogflowCxIntentTrainingPhrasesPartsList_Override(d DialogflowCxIntentTrainingPhrasesPartsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DialogflowCxIntentTrainingPhrasesPartsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DialogflowCxIntentTrainingPhrasesPartsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DialogflowCxIntentTrainingPhrasesPartsList) Resolve(context cdktn.IResolveContext) interface{} {
