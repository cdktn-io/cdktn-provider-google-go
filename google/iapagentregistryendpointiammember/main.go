...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IapAgentRegistryEndpointIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.iapAgentRegistryEndpointIamMember.IapAgentRegistryEndpointIamMemberCondition",
		reflect.TypeOf((*IapAgentRegistryEndpointIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.iapAgentRegistryEndpointIamMember.IapAgentRegistryEndpointIamMemberConditionOutputReference",
		reflect.TypeOf((*IapAgentRegistryEndpointIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.iapAgentRegistryEndpointIamMember.IapAgentRegistryEndpointIamMemberConfig",
		reflect.TypeOf((*IapAgentRegistryEndpointIamMemberConfig)(nil)).Elem(),
	)
}
