...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/bigqueryconnectioniampolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/bigquery_connection_iam_policy google_bigquery_connection_iam_policy}.
...
func (j *jsiiProxy_BigqueryConnectionIamPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BigqueryConnectionIamPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BigqueryConnectionIamPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BigqueryConnectionIamPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BigqueryConnectionIamPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/bigquery_connection_iam_policy google_bigquery_connection_iam_policy} Resource.
func NewBigqueryConnectionIamPolicy(scope constructs.Construct, id *string, config *BigqueryConnectionIamPolicyConfig) BigqueryConnectionIamPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-google.bigqueryConnectionIamPolicy.BigqueryConnectionIamPolicy",
...
func (j *jsiiProxy_BigqueryConnectionIamPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BigqueryConnectionIamPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BigqueryConnectionIamPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a BigqueryConnectionIamPolicy resource upon running "cdktn plan <stack-name>".
func BigqueryConnectionIamPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BigqueryConnectionIamPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BigqueryConnectionIamPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BigqueryConnectionIamPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BigqueryConnectionIamPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BigqueryConnectionIamPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BigqueryConnectionIamPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
