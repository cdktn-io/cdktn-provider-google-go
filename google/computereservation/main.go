...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.computeReservation.ComputeReservationParams",
		reflect.TypeOf((*ComputeReservationParams)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.computeReservation.ComputeReservationParamsOutputReference",
		reflect.TypeOf((*ComputeReservationParamsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
