...
func (c *jsiiProxy_ComputeReservationSpecificReservationInstancePropertiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeReservationSpecificReservationInstancePropertiesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
