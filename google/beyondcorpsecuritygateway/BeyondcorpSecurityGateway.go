...
type jsiiProxy_BeyondcorpSecurityGateway struct {
	internal.Type__cdktnTerraformResource
}

func (j *jsiiProxy_BeyondcorpSecurityGateway) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) DelegatingServiceAccount() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) ExternalIps() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"externalIps",
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) Hubs() BeyondcorpSecurityGatewayHubsList {
	var returns BeyondcorpSecurityGatewayHubsList
	_jsii_.Get(
		j,
		"hubs",
		&returns,
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) Node() constructs.Node {
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) SecurityGatewayId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"securityGatewayId",
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) SecurityGatewayIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) Timeouts() BeyondcorpSecurityGatewayTimeoutsOutputReference {
	var returns BeyondcorpSecurityGatewayTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
func NewBeyondcorpSecurityGateway(scope constructs.Construct, id *string, config *BeyondcorpSecurityGatewayConfig) BeyondcorpSecurityGateway {
	...
	if err := validateNewBeyondcorpSecurityGatewayParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_BeyondcorpSecurityGateway)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_BeyondcorpSecurityGateway)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BeyondcorpSecurityGateway)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BeyondcorpSecurityGateway)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BeyondcorpSecurityGateway_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateBeyondcorpSecurityGateway_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func BeyondcorpSecurityGateway_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-google.beyondcorpSecurityGateway.BeyondcorpSecurityGateway",
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) GetStringAttribute(terraformAttribute *string) *string {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) MoveFromId(id *string) {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) MoveToId(id *string) {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) OverrideLogicalId(newLogicalId *string) {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		b,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) ResetDisplayName() {
	_jsii_.InvokeVoid(
		b,
		"resetDisplayName",
		nil, // no parameters
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) ResetHubs() {
	_jsii_.InvokeVoid(
		b,
		"resetHubs",
		nil, // no parameters
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) ResetId() {
	_jsii_.InvokeVoid(
		b,
		"resetId",
		nil, // no parameters
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) ResetProject() {
	_jsii_.InvokeVoid(
		b,
		"resetProject",
		nil, // no parameters
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) ResetTimeouts() {
	_jsii_.InvokeVoid(
		b,
		"resetTimeouts",
		nil, // no parameters
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) ToString() *string {
	var returns *string
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
