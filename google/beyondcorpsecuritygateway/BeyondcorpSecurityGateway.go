...
func (j *jsiiProxy_BeyondcorpSecurityGateway) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_BeyondcorpSecurityGateway) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func BeyondcorpSecurityGateway_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (b *jsiiProxy_BeyondcorpSecurityGateway) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
