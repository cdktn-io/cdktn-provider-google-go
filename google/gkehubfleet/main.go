...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "defaultClusterConfig", GoGetter: "DefaultClusterConfig"},
			_jsii_.MemberProperty{JsiiProperty: "defaultClusterConfigInput", GoGetter: "DefaultClusterConfigInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "policyBindings", GoGetter: "PolicyBindings"},
			_jsii_.MemberProperty{JsiiProperty: "policyBindingsInput", GoGetter: "PolicyBindingsInput"},
			_jsii_.MemberMethod{JsiiMethod: "putPolicyBindings", GoMethod: "PutPolicyBindings"},
			_jsii_.MemberMethod{JsiiMethod: "resetEvaluationMode", GoMethod: "ResetEvaluationMode"},
			_jsii_.MemberMethod{JsiiMethod: "resetPolicyBindings", GoMethod: "ResetPolicyBindings"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putBinaryAuthorizationConfig", GoMethod: "PutBinaryAuthorizationConfig"},
			_jsii_.MemberMethod{JsiiMethod: "putSecurityPostureConfig", GoMethod: "PutSecurityPostureConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resetBinaryAuthorizationConfig", GoMethod: "ResetBinaryAuthorizationConfig"},
