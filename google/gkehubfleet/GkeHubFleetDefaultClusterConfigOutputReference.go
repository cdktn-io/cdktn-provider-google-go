...
func (g *jsiiProxy_GkeHubFleetDefaultClusterConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GkeHubFleetDefaultClusterConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
