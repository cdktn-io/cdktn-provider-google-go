...
func (d *jsiiProxy_DataGoogleStorageControlOrganizationIntelligenceConfigFilterIncludedCloudStorageBucketsList) Resolve(context cdktf.IResolveContext) interface{} {
