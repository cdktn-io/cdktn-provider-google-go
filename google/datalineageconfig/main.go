...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ingestionInput", GoGetter: "IngestionInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "integrationSelectorInput", GoGetter: "IntegrationSelectorInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "lineageEnablement", GoGetter: "LineageEnablement"},
			_jsii_.MemberProperty{JsiiProperty: "lineageEnablementInput", GoGetter: "LineageEnablementInput"},
			_jsii_.MemberMethod{JsiiMethod: "putIntegrationSelector", GoMethod: "PutIntegrationSelector"},
			_jsii_.MemberMethod{JsiiMethod: "putLineageEnablement", GoMethod: "PutLineageEnablement"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
