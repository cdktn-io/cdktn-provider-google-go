...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstancesInstancesSettingsInsightsConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleSqlDatabaseInstancesInstancesSettingsInsightsConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleSqlDatabaseInstancesInstancesSettingsInsightsConfigList {
	_init_.Initialize()
...
func NewDataGoogleSqlDatabaseInstancesInstancesSettingsInsightsConfigList_Override(d DataGoogleSqlDatabaseInstancesInstancesSettingsInsightsConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstancesInstancesSettingsInsightsConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleSqlDatabaseInstancesInstancesSettingsInsightsConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleSqlDatabaseInstancesInstancesSettingsInsightsConfigList) Resolve(context cdktn.IResolveContext) interface{} {
