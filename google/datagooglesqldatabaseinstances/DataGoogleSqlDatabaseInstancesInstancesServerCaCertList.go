...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstancesInstancesServerCaCertList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleSqlDatabaseInstancesInstancesServerCaCertList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleSqlDatabaseInstancesInstancesServerCaCertList {
	_init_.Initialize()
...
func NewDataGoogleSqlDatabaseInstancesInstancesServerCaCertList_Override(d DataGoogleSqlDatabaseInstancesInstancesServerCaCertList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstancesInstancesServerCaCertList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleSqlDatabaseInstancesInstancesServerCaCertList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleSqlDatabaseInstancesInstancesServerCaCertList) Resolve(context cdktn.IResolveContext) interface{} {
