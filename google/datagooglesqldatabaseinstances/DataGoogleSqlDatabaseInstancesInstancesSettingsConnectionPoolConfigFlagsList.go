...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstancesInstancesSettingsConnectionPoolConfigFlagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleSqlDatabaseInstancesInstancesSettingsConnectionPoolConfigFlagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleSqlDatabaseInstancesInstancesSettingsConnectionPoolConfigFlagsList {
	_init_.Initialize()
...
func NewDataGoogleSqlDatabaseInstancesInstancesSettingsConnectionPoolConfigFlagsList_Override(d DataGoogleSqlDatabaseInstancesInstancesSettingsConnectionPoolConfigFlagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleSqlDatabaseInstancesInstancesSettingsConnectionPoolConfigFlagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleSqlDatabaseInstancesInstancesSettingsConnectionPoolConfigFlagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleSqlDatabaseInstancesInstancesSettingsConnectionPoolConfigFlagsList) Resolve(context cdktn.IResolveContext) interface{} {
