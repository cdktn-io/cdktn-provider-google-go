...
func (g *jsiiProxy_GkeBackupBackupPlanBackupScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GkeBackupBackupPlanBackupScheduleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
