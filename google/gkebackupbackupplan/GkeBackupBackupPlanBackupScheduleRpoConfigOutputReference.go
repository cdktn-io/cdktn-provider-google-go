...
func (g *jsiiProxy_GkeBackupBackupPlanBackupScheduleRpoConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GkeBackupBackupPlanBackupScheduleRpoConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
