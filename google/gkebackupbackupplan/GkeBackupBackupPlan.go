...
func (j *jsiiProxy_GkeBackupBackupPlan) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GkeBackupBackupPlan) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_GkeBackupBackupPlan) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GkeBackupBackupPlan) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GkeBackupBackupPlan) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GkeBackupBackupPlan) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GkeBackupBackupPlan) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_GkeBackupBackupPlan)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GkeBackupBackupPlan)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GkeBackupBackupPlan)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GkeBackupBackupPlan_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GkeBackupBackupPlan) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GkeBackupBackupPlan) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GkeBackupBackupPlan) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GkeBackupBackupPlan) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GkeBackupBackupPlan) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GkeBackupBackupPlan) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
