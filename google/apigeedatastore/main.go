...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApigeeDatastore)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.apigeeDatastore.ApigeeDatastoreConfig",
		reflect.TypeOf((*ApigeeDatastoreConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.apigeeDatastore.ApigeeDatastoreDatastoreConfig",
		reflect.TypeOf((*ApigeeDatastoreDatastoreConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.apigeeDatastore.ApigeeDatastoreDatastoreConfigOutputReference",
		reflect.TypeOf((*ApigeeDatastoreDatastoreConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.apigeeDatastore.ApigeeDatastoreTimeouts",
		reflect.TypeOf((*ApigeeDatastoreTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.apigeeDatastore.ApigeeDatastoreTimeoutsOutputReference",
		reflect.TypeOf((*ApigeeDatastoreTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
