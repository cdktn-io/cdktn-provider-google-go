...
func (j *jsiiProxy_NetworkServicesMulticastGroupRangeActivationStateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkServicesMulticastGroupRangeActivationStateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkServicesMulticastGroupRangeActivationStateList {
	_init_.Initialize()
...
func NewNetworkServicesMulticastGroupRangeActivationStateList_Override(n NetworkServicesMulticastGroupRangeActivationStateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkServicesMulticastGroupRangeActivationStateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkServicesMulticastGroupRangeActivationStateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkServicesMulticastGroupRangeActivationStateList) Resolve(context cdktn.IResolveContext) interface{} {
