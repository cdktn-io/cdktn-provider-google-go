...
func (d *jsiiProxy_DataFusionInstance) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (d *jsiiProxy_DataFusionInstance) validatePutAcceleratorsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DataFusionInstanceAccelerators; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_DataFusionInstance) validateSetPatchRevisionParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
