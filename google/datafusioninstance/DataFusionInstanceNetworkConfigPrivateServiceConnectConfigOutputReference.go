...
func (d *jsiiProxy_DataFusionInstanceNetworkConfigPrivateServiceConnectConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFusionInstanceNetworkConfigPrivateServiceConnectConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
