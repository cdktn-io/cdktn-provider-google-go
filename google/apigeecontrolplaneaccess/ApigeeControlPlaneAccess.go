...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/apigeecontrolplaneaccess/internal"
...
func (j *jsiiProxy_ApigeeControlPlaneAccess) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApigeeControlPlaneAccess) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApigeeControlPlaneAccess) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApigeeControlPlaneAccess) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApigeeControlPlaneAccess) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apigee_control_plane_access google_apigee_control_plane_access} Resource.
func NewApigeeControlPlaneAccess(scope constructs.Construct, id *string, config *ApigeeControlPlaneAccessConfig) ApigeeControlPlaneAccess {
	...
	_jsii_.Create(
		"@cdktn/provider-google.apigeeControlPlaneAccess.ApigeeControlPlaneAccess",
...
func (j *jsiiProxy_ApigeeControlPlaneAccess)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApigeeControlPlaneAccess)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApigeeControlPlaneAccess)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ApigeeControlPlaneAccess_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApigeeControlPlaneAccess) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApigeeControlPlaneAccess) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApigeeControlPlaneAccess) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApigeeControlPlaneAccess) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApigeeControlPlaneAccess) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApigeeControlPlaneAccess) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
