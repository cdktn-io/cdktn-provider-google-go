...
func (c *jsiiProxy_CloudIdentityGroupMembership) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (c *jsiiProxy_CloudIdentityGroupMembership) validatePutRolesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CloudIdentityGroupMembershipRoles; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_CloudIdentityGroupMembership) validateSetCountParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_CloudIdentityGroupMembership) validateSetCreateIgnoreAlreadyExistsParameters(val interface{}) error {
	if val == nil {
