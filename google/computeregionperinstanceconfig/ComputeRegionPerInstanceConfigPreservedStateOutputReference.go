...
func (c *jsiiProxy_ComputeRegionPerInstanceConfigPreservedStateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeRegionPerInstanceConfigPreservedStateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
