...
func (c *jsiiProxy_ComputeRegionPerInstanceConfigPreservedStateInternalIpOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeRegionPerInstanceConfigPreservedStateInternalIpOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
