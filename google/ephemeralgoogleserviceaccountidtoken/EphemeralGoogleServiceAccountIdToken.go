...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/ephemeralgoogleserviceaccountidtoken/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/ephemeral-resources/service_account_id_token google_service_account_id_token} Ephemeral Resource.
func NewEphemeralGoogleServiceAccountIdToken(scope constructs.Construct, id *string, config *EphemeralGoogleServiceAccountIdTokenConfig) EphemeralGoogleServiceAccountIdToken {
	...
	_jsii_.Create(
		"@cdktn/provider-google.ephemeralGoogleServiceAccountIdToken.EphemeralGoogleServiceAccountIdToken",
