...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.oracleDatabaseExadbVmCluster.OracleDatabaseExadbVmClusterIdentityConnector",
		reflect.TypeOf((*OracleDatabaseExadbVmClusterIdentityConnector)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.oracleDatabaseExadbVmCluster.OracleDatabaseExadbVmClusterIdentityConnectorList",
		reflect.TypeOf((*OracleDatabaseExadbVmClusterIdentityConnectorList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OracleDatabaseExadbVmClusterIdentityConnectorOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
