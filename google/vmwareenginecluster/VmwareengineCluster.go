...
func (j *jsiiProxy_VmwareengineCluster) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_VmwareengineCluster) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/vmwareengine_cluster google_vmwareengine_cluster} Resource.
...
func (j *jsiiProxy_VmwareengineCluster)SetDeletionPolicy(val *string) {
...
func (v *jsiiProxy_VmwareengineCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VmwareengineCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VmwareengineCluster) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		v,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (v *jsiiProxy_VmwareengineCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
