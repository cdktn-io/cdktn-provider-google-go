...
func (j *jsiiProxy_DataGoogleComputeRouterStatusBestRoutesAsPathsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeRouterStatusBestRoutesAsPathsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeRouterStatusBestRoutesAsPathsList {
	_init_.Initialize()
...
func NewDataGoogleComputeRouterStatusBestRoutesAsPathsList_Override(d DataGoogleComputeRouterStatusBestRoutesAsPathsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeRouterStatusBestRoutesAsPathsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeRouterStatusBestRoutesAsPathsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeRouterStatusBestRoutesAsPathsList) Resolve(context cdktn.IResolveContext) interface{} {
