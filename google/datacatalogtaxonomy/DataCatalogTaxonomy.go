...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/datacatalogtaxonomy/internal"
...
func (j *jsiiProxy_DataCatalogTaxonomy) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DataCatalogTaxonomy) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/data_catalog_taxonomy google_data_catalog_taxonomy} Resource.
...
func (j *jsiiProxy_DataCatalogTaxonomy)SetDeletionPolicy(val *string) {
...
func (d *jsiiProxy_DataCatalogTaxonomy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataCatalogTaxonomy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCatalogTaxonomy) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		d,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (d *jsiiProxy_DataCatalogTaxonomy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
