...
func (m *jsiiProxy_MonitoringSloRequestBasedSliDistributionCutOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitoringSloRequestBasedSliDistributionCutOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
