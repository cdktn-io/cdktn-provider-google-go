...
func (j *jsiiProxy_MonitoringSloWindowsBasedSliMetricSumInRangeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitoringSloWindowsBasedSliMetricSumInRangeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MonitoringSloWindowsBasedSliMetricSumInRangeOutputReference {
	_init_.Initialize()
...
func NewMonitoringSloWindowsBasedSliMetricSumInRangeOutputReference_Override(m MonitoringSloWindowsBasedSliMetricSumInRangeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitoringSloWindowsBasedSliMetricSumInRangeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitoringSloWindowsBasedSliMetricSumInRangeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitoringSloWindowsBasedSliMetricSumInRangeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitoringSloWindowsBasedSliMetricSumInRangeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitoringSloWindowsBasedSliMetricSumInRangeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
