...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v17/datagoogleoracledatabasedbnodes/internal"
...
func (j *jsiiProxy_DataGoogleOracleDatabaseDbNodesDbNodesPropertiesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleOracleDatabaseDbNodesDbNodesPropertiesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleOracleDatabaseDbNodesDbNodesPropertiesOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleOracleDatabaseDbNodes.DataGoogleOracleDatabaseDbNodesDbNodesPropertiesOutputReference",
...
func NewDataGoogleOracleDatabaseDbNodesDbNodesPropertiesOutputReference_Override(d DataGoogleOracleDatabaseDbNodesDbNodesPropertiesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleOracleDatabaseDbNodesDbNodesPropertiesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleOracleDatabaseDbNodesDbNodesPropertiesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleOracleDatabaseDbNodesDbNodesPropertiesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGoogleOracleDatabaseDbNodesDbNodesPropertiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleOracleDatabaseDbNodesDbNodesPropertiesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
