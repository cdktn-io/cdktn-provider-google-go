...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/datagooglecomputeregionsslpolicy/internal"
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) PostQuantumKeyExchange() *string {
	var returns *string
	_jsii_.Get(
		j,
