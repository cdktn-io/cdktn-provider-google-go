...
func (j *jsiiProxy_DataGoogleCloudRunServiceTemplateSpecVolumesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudRunServiceTemplateSpecVolumesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleCloudRunServiceTemplateSpecVolumesOutputReference {
	_init_.Initialize()
...
func NewDataGoogleCloudRunServiceTemplateSpecVolumesOutputReference_Override(d DataGoogleCloudRunServiceTemplateSpecVolumesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudRunServiceTemplateSpecVolumesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudRunServiceTemplateSpecVolumesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleCloudRunServiceTemplateSpecVolumesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGoogleCloudRunServiceTemplateSpecVolumesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleCloudRunServiceTemplateSpecVolumesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
