...
func (j *jsiiProxy_DataGoogleCloudRunServiceTemplateSpecVolumesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudRunServiceTemplateSpecVolumesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudRunServiceTemplateSpecVolumesList {
	_init_.Initialize()
...
func NewDataGoogleCloudRunServiceTemplateSpecVolumesList_Override(d DataGoogleCloudRunServiceTemplateSpecVolumesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudRunServiceTemplateSpecVolumesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudRunServiceTemplateSpecVolumesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCloudRunServiceTemplateSpecVolumesList) Resolve(context cdktn.IResolveContext) interface{} {
