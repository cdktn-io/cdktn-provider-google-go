...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleLoggingLogView)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dataGoogleLoggingLogView.DataGoogleLoggingLogViewConfig",
		reflect.TypeOf((*DataGoogleLoggingLogViewConfig)(nil)).Elem(),
	)
}
