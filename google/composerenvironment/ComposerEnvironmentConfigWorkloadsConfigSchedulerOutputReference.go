...
func (c *jsiiProxy_ComposerEnvironmentConfigWorkloadsConfigSchedulerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComposerEnvironmentConfigWorkloadsConfigSchedulerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
