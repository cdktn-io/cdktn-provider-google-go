...
func (c *jsiiProxy_ComposerEnvironmentConfigNodeConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComposerEnvironmentConfigNodeConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
