...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/discovery_engine_target_site google_discovery_engine_target_site}.
...
func (j *jsiiProxy_DiscoveryEngineTargetSite) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DiscoveryEngineTargetSite) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/discovery_engine_target_site google_discovery_engine_target_site} Resource.
...
func (j *jsiiProxy_DiscoveryEngineTargetSite)SetDeletionPolicy(val *string) {
...
func (d *jsiiProxy_DiscoveryEngineTargetSite) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		d,
		"resetDeletionPolicy",
		nil, // no parameters
