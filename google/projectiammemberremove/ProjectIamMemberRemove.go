...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/projectiammemberremove/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/project_iam_member_remove google_project_iam_member_remove} Resource.
...
func (p *jsiiProxy_ProjectIamMemberRemove) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_ProjectIamMemberRemove) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_ProjectIamMemberRemove) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
