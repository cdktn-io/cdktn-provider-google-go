...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/data-sources/secret_manager_regional_secret google_secret_manager_regional_secret}.
...
func (j *jsiiProxy_DataGoogleSecretManagerRegionalSecret) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/data-sources/secret_manager_regional_secret google_secret_manager_regional_secret} Data Source.
