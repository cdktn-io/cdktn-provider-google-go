...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/vertexaideploymentresourcepool/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/vertex_ai_deployment_resource_pool google_vertex_ai_deployment_resource_pool}.
...
func (j *jsiiProxy_VertexAiDeploymentResourcePool) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VertexAiDeploymentResourcePool) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_VertexAiDeploymentResourcePool) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_VertexAiDeploymentResourcePool) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VertexAiDeploymentResourcePool) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VertexAiDeploymentResourcePool) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VertexAiDeploymentResourcePool) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/vertex_ai_deployment_resource_pool google_vertex_ai_deployment_resource_pool} Resource.
...
func (j *jsiiProxy_VertexAiDeploymentResourcePool)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_VertexAiDeploymentResourcePool)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VertexAiDeploymentResourcePool)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VertexAiDeploymentResourcePool)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VertexAiDeploymentResourcePool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VertexAiDeploymentResourcePool) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VertexAiDeploymentResourcePool) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VertexAiDeploymentResourcePool) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VertexAiDeploymentResourcePool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VertexAiDeploymentResourcePool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VertexAiDeploymentResourcePool) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		v,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiDeploymentResourcePool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
