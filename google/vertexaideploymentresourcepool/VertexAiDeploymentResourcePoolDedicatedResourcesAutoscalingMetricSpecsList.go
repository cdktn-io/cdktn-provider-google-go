...
func (j *jsiiProxy_VertexAiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpecsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVertexAiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpecsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VertexAiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpecsList {
	_init_.Initialize()
...
func NewVertexAiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpecsList_Override(v VertexAiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpecsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VertexAiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpecsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VertexAiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpecsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VertexAiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpecsList) Resolve(context cdktn.IResolveContext) interface{} {
