...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IapAgentRegistryIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.iapAgentRegistryIamMember.IapAgentRegistryIamMemberCondition",
		reflect.TypeOf((*IapAgentRegistryIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.iapAgentRegistryIamMember.IapAgentRegistryIamMemberConditionOutputReference",
		reflect.TypeOf((*IapAgentRegistryIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.iapAgentRegistryIamMember.IapAgentRegistryIamMemberConfig",
		reflect.TypeOf((*IapAgentRegistryIamMemberConfig)(nil)).Elem(),
	)
}
