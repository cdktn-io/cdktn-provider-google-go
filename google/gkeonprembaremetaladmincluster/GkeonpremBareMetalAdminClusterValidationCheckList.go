...
func (j *jsiiProxy_GkeonpremBareMetalAdminClusterValidationCheckList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGkeonpremBareMetalAdminClusterValidationCheckList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GkeonpremBareMetalAdminClusterValidationCheckList {
	_init_.Initialize()
...
func NewGkeonpremBareMetalAdminClusterValidationCheckList_Override(g GkeonpremBareMetalAdminClusterValidationCheckList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GkeonpremBareMetalAdminClusterValidationCheckList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GkeonpremBareMetalAdminClusterValidationCheckList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GkeonpremBareMetalAdminClusterValidationCheckList) Resolve(context cdktn.IResolveContext) interface{} {
