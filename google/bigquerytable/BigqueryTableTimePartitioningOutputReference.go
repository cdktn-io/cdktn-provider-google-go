...
func (b *jsiiProxy_BigqueryTableTimePartitioningOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BigqueryTableTimePartitioningOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
