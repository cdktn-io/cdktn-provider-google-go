...
type BigqueryTable interface {
	...
	SetIgnoreAutoGeneratedSchema(val interface{})
	IgnoreAutoGeneratedSchemaInput() interface{}
	...
	ResetFriendlyName()
	ResetId()
	ResetIgnoreAutoGeneratedSchema()
...
func (j *jsiiProxy_BigqueryTable) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BigqueryTable) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_BigqueryTable) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_BigqueryTable) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_BigqueryTable) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BigqueryTable) GeneratedSchemaColumns() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BigqueryTable) IgnoreAutoGeneratedSchema() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BigqueryTable) IgnoreAutoGeneratedSchemaInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"ignoreAutoGeneratedSchemaInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_BigqueryTable) IgnoreSchemaChanges() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"ignoreSchemaChanges",
...
func (j *jsiiProxy_BigqueryTable) IgnoreSchemaChangesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BigqueryTable) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BigqueryTable) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BigqueryTable) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BigqueryTable) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/bigquery_table google_bigquery_table} Resource.
...
func (j *jsiiProxy_BigqueryTable)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_BigqueryTable)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BigqueryTable)SetIgnoreAutoGeneratedSchema(val interface{}) {
	if err := j.validateSetIgnoreAutoGeneratedSchemaParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_BigqueryTable)SetIgnoreSchemaChanges(val *[]*string) {
...
func (j *jsiiProxy_BigqueryTable)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BigqueryTable)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BigqueryTable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BigqueryTable) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BigqueryTable) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BigqueryTable) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BigqueryTable) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BigqueryTable) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BigqueryTable) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		b,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (b *jsiiProxy_BigqueryTable) ResetIgnoreAutoGeneratedSchema() {
	_jsii_.InvokeVoid(
		b,
		"resetIgnoreAutoGeneratedSchema",
		nil, // no parameters
...
func (b *jsiiProxy_BigqueryTable) ResetIgnoreSchemaChanges() {
	_jsii_.InvokeVoid(
		b,
		"resetIgnoreSchemaChanges",
		nil, // no parameters
...
func (b *jsiiProxy_BigqueryTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
