...
func (j *jsiiProxy_DataGoogleComputeHaVpnGatewayVpnInterfacesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeHaVpnGatewayVpnInterfacesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeHaVpnGatewayVpnInterfacesList {
	_init_.Initialize()
...
func NewDataGoogleComputeHaVpnGatewayVpnInterfacesList_Override(d DataGoogleComputeHaVpnGatewayVpnInterfacesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeHaVpnGatewayVpnInterfacesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeHaVpnGatewayVpnInterfacesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeHaVpnGatewayVpnInterfacesList) Resolve(context cdktn.IResolveContext) interface{} {
