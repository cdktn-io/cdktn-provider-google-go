...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/datagoogleiamtestablepermissions/internal"
...
func (j *jsiiProxy_DataGoogleIamTestablePermissions) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataGoogleIamTestablePermissions) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataGoogleIamTestablePermissions) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGoogleIamTestablePermissions) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataGoogleIamTestablePermissions) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/data-sources/iam_testable_permissions google_iam_testable_permissions} Data Source.
...
func (j *jsiiProxy_DataGoogleIamTestablePermissions)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGoogleIamTestablePermissions)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataGoogleIamTestablePermissions)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataGoogleIamTestablePermissions_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataGoogleIamTestablePermissions) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleIamTestablePermissions) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleIamTestablePermissions) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataGoogleIamTestablePermissions) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
