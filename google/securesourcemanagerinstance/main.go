...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "pscAllowedProjects", GoGetter: "PscAllowedProjects"},
			_jsii_.MemberProperty{JsiiProperty: "pscAllowedProjectsInput", GoGetter: "PscAllowedProjectsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPscAllowedProjects", GoMethod: "ResetPscAllowedProjects"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
