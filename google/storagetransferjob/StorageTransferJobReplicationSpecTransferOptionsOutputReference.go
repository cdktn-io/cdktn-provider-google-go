...
func (s *jsiiProxy_StorageTransferJobReplicationSpecTransferOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageTransferJobReplicationSpecTransferOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
