...
func (p *jsiiProxy_PrivatecaCaPoolIssuancePolicyIdentityConstraintsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PrivatecaCaPoolIssuancePolicyIdentityConstraintsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
