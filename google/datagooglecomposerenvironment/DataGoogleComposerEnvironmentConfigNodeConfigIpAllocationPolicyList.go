...
func (j *jsiiProxy_DataGoogleComposerEnvironmentConfigNodeConfigIpAllocationPolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComposerEnvironmentConfigNodeConfigIpAllocationPolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComposerEnvironmentConfigNodeConfigIpAllocationPolicyList {
	_init_.Initialize()
...
func NewDataGoogleComposerEnvironmentConfigNodeConfigIpAllocationPolicyList_Override(d DataGoogleComposerEnvironmentConfigNodeConfigIpAllocationPolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComposerEnvironmentConfigNodeConfigIpAllocationPolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComposerEnvironmentConfigNodeConfigIpAllocationPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComposerEnvironmentConfigNodeConfigIpAllocationPolicyList) Resolve(context cdktn.IResolveContext) interface{} {
