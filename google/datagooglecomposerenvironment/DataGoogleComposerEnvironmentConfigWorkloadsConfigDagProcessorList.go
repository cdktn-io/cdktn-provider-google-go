...
func (j *jsiiProxy_DataGoogleComposerEnvironmentConfigWorkloadsConfigDagProcessorList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComposerEnvironmentConfigWorkloadsConfigDagProcessorList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComposerEnvironmentConfigWorkloadsConfigDagProcessorList {
	_init_.Initialize()
...
func NewDataGoogleComposerEnvironmentConfigWorkloadsConfigDagProcessorList_Override(d DataGoogleComposerEnvironmentConfigWorkloadsConfigDagProcessorList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComposerEnvironmentConfigWorkloadsConfigDagProcessorList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComposerEnvironmentConfigWorkloadsConfigDagProcessorList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComposerEnvironmentConfigWorkloadsConfigDagProcessorList) Resolve(context cdktn.IResolveContext) interface{} {
