...
func (j *jsiiProxy_OracleDatabaseExascaleDbStorageVault) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_OracleDatabaseExascaleDbStorageVault) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_OracleDatabaseExascaleDbStorageVault) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_OracleDatabaseExascaleDbStorageVault) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_OracleDatabaseExascaleDbStorageVault) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_OracleDatabaseExascaleDbStorageVault) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_OracleDatabaseExascaleDbStorageVault) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/oracle_database_exascale_db_storage_vault google_oracle_database_exascale_db_storage_vault} Resource.
...
func (j *jsiiProxy_OracleDatabaseExascaleDbStorageVault)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_OracleDatabaseExascaleDbStorageVault)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_OracleDatabaseExascaleDbStorageVault)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func OracleDatabaseExascaleDbStorageVault_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (o *jsiiProxy_OracleDatabaseExascaleDbStorageVault) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OracleDatabaseExascaleDbStorageVault) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (o *jsiiProxy_OracleDatabaseExascaleDbStorageVault) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OracleDatabaseExascaleDbStorageVault) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OracleDatabaseExascaleDbStorageVault) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_OracleDatabaseExascaleDbStorageVault) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
