...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/gkehubfeaturemembership/internal"
...
func (j *jsiiProxy_GkeHubFeatureMembership) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GkeHubFeatureMembership) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GkeHubFeatureMembership) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GkeHubFeatureMembership) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GkeHubFeatureMembership) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GkeHubFeatureMembership) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GkeHubFeatureMembership) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewGkeHubFeatureMembership(scope constructs.Construct, id *string, config *GkeHubFeatureMembershipConfig) GkeHubFeatureMembership {
	...
	_jsii_.Create(
		"@cdktn/provider-google.gkeHubFeatureMembership.GkeHubFeatureMembership",
...
func (j *jsiiProxy_GkeHubFeatureMembership)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GkeHubFeatureMembership)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GkeHubFeatureMembership)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GkeHubFeatureMembership)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GkeHubFeatureMembership_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GkeHubFeatureMembership) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GkeHubFeatureMembership) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GkeHubFeatureMembership) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GkeHubFeatureMembership) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GkeHubFeatureMembership) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GkeHubFeatureMembership) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GkeHubFeatureMembership) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
