...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGatewayAllocatedConnectionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleBeyondcorpAppGatewayAllocatedConnectionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleBeyondcorpAppGatewayAllocatedConnectionsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleBeyondcorpAppGateway.DataGoogleBeyondcorpAppGatewayAllocatedConnectionsList",
...
func NewDataGoogleBeyondcorpAppGatewayAllocatedConnectionsList_Override(d DataGoogleBeyondcorpAppGatewayAllocatedConnectionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGatewayAllocatedConnectionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleBeyondcorpAppGatewayAllocatedConnectionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleBeyondcorpAppGatewayAllocatedConnectionsList) Resolve(context cdktn.IResolveContext) interface{} {
