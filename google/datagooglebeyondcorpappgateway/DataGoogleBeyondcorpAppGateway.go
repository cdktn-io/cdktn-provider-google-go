...
func (j *jsiiProxy_DataGoogleBeyondcorpAppGateway) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/beyondcorp_app_gateway google_beyondcorp_app_gateway} Data Source.
