...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/healthcaredatasetiammember/internal"
...
func (j *jsiiProxy_HealthcareDatasetIamMember) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_HealthcareDatasetIamMember) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_HealthcareDatasetIamMember) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_HealthcareDatasetIamMember) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_HealthcareDatasetIamMember) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/healthcare_dataset_iam_member google_healthcare_dataset_iam_member} Resource.
func NewHealthcareDatasetIamMember(scope constructs.Construct, id *string, config *HealthcareDatasetIamMemberConfig) HealthcareDatasetIamMember {
	...
	_jsii_.Create(
		"@cdktn/provider-google.healthcareDatasetIamMember.HealthcareDatasetIamMember",
...
func (j *jsiiProxy_HealthcareDatasetIamMember)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_HealthcareDatasetIamMember)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_HealthcareDatasetIamMember)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func HealthcareDatasetIamMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (h *jsiiProxy_HealthcareDatasetIamMember) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HealthcareDatasetIamMember) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (h *jsiiProxy_HealthcareDatasetIamMember) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HealthcareDatasetIamMember) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (h *jsiiProxy_HealthcareDatasetIamMember) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (h *jsiiProxy_HealthcareDatasetIamMember) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
