...
func (j *jsiiProxy_DataGoogleSecretManagerSecretReplicationUserManagedList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleSecretManagerSecretReplicationUserManagedList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleSecretManagerSecretReplicationUserManagedList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleSecretManagerSecret.DataGoogleSecretManagerSecretReplicationUserManagedList",
...
func NewDataGoogleSecretManagerSecretReplicationUserManagedList_Override(d DataGoogleSecretManagerSecretReplicationUserManagedList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretReplicationUserManagedList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretReplicationUserManagedList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretReplicationUserManagedList) Resolve(context cdktn.IResolveContext) interface{} {
