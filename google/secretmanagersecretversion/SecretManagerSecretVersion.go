...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/secretmanagersecretversion/internal"
...
func (j *jsiiProxy_SecretManagerSecretVersion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SecretManagerSecretVersion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecretManagerSecretVersion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecretManagerSecretVersion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/secret_manager_secret_version google_secret_manager_secret_version} Resource.
...
func (j *jsiiProxy_SecretManagerSecretVersion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecretManagerSecretVersion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecretManagerSecretVersion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SecretManagerSecretVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SecretManagerSecretVersion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecretManagerSecretVersion) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecretManagerSecretVersion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecretManagerSecretVersion) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecretManagerSecretVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecretManagerSecretVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
