...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google.apigeeEnvironmentApiRevisionDeployment.ApigeeEnvironmentApiRevisionDeployment",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "basepaths", GoGetter: "Basepaths"},
			...
			_jsii_.MemberProperty{JsiiProperty: "deployStartTime", GoGetter: "DeployStartTime"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSequencedRollout", GoMethod: "ResetSequencedRollout"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sequencedRollout", GoGetter: "SequencedRollout"},
			_jsii_.MemberProperty{JsiiProperty: "sequencedRolloutInput", GoGetter: "SequencedRolloutInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.apigeeEnvironmentApiRevisionDeployment.ApigeeEnvironmentApiRevisionDeploymentConfig",
		reflect.TypeOf((*ApigeeEnvironmentApiRevisionDeploymentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.apigeeEnvironmentApiRevisionDeployment.ApigeeEnvironmentApiRevisionDeploymentTimeouts",
