...
func (c *jsiiProxy_ComputeSnapshotSourceDiskEncryptionKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeSnapshotSourceDiskEncryptionKeyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
