...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.computeSnapshot.ComputeSnapshotParams",
		reflect.TypeOf((*ComputeSnapshotParams)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.computeSnapshot.ComputeSnapshotParamsOutputReference",
		reflect.TypeOf((*ComputeSnapshotParamsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_ComputeSnapshotParamsOutputReference{}
