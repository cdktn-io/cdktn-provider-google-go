...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/tagstagkeyiampolicy/internal"
...
func (j *jsiiProxy_TagsTagKeyIamPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_TagsTagKeyIamPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_TagsTagKeyIamPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_TagsTagKeyIamPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_TagsTagKeyIamPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_TagsTagKeyIamPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_TagsTagKeyIamPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_TagsTagKeyIamPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func TagsTagKeyIamPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (t *jsiiProxy_TagsTagKeyIamPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TagsTagKeyIamPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (t *jsiiProxy_TagsTagKeyIamPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TagsTagKeyIamPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_TagsTagKeyIamPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (t *jsiiProxy_TagsTagKeyIamPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
