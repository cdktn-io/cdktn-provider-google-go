...
func (c *jsiiProxy_CertificateManagerCertificateManagedOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CertificateManagerCertificateManagedOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
