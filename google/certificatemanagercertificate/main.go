...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "pemPrivateKeyWo", GoGetter: "PemPrivateKeyWo"},
			_jsii_.MemberProperty{JsiiProperty: "pemPrivateKeyWoInput", GoGetter: "PemPrivateKeyWoInput"},
			_jsii_.MemberProperty{JsiiProperty: "pemPrivateKeyWoVersion", GoGetter: "PemPrivateKeyWoVersion"},
			_jsii_.MemberProperty{JsiiProperty: "pemPrivateKeyWoVersionInput", GoGetter: "PemPrivateKeyWoVersionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPemPrivateKeyWo", GoMethod: "ResetPemPrivateKeyWo"},
			_jsii_.MemberMethod{JsiiMethod: "resetPemPrivateKeyWoVersion", GoMethod: "ResetPemPrivateKeyWoVersion"},
