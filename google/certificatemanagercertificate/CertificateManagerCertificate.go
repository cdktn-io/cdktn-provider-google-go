...
func (j *jsiiProxy_CertificateManagerCertificate) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_CertificateManagerCertificate) SanDnsnames() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"sanDnsnames",
...
func (j *jsiiProxy_CertificateManagerCertificate) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/certificate_manager_certificate google_certificate_manager_certificate} Resource.
