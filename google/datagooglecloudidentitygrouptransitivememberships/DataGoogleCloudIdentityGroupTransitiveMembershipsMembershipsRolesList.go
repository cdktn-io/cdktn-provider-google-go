...
func (j *jsiiProxy_DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsRolesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsRolesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsRolesList {
	_init_.Initialize()
...
func NewDataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsRolesList_Override(d DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsRolesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsRolesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsRolesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsRolesList) Resolve(context cdktn.IResolveContext) interface{} {
