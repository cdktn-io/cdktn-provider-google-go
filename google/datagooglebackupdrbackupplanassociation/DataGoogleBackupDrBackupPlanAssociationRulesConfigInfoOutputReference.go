...
func (j *jsiiProxy_DataGoogleBackupDrBackupPlanAssociationRulesConfigInfoOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleBackupDrBackupPlanAssociationRulesConfigInfoOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleBackupDrBackupPlanAssociationRulesConfigInfoOutputReference {
	_init_.Initialize()
...
func NewDataGoogleBackupDrBackupPlanAssociationRulesConfigInfoOutputReference_Override(d DataGoogleBackupDrBackupPlanAssociationRulesConfigInfoOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleBackupDrBackupPlanAssociationRulesConfigInfoOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleBackupDrBackupPlanAssociationRulesConfigInfoOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleBackupDrBackupPlanAssociationRulesConfigInfoOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGoogleBackupDrBackupPlanAssociationRulesConfigInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleBackupDrBackupPlanAssociationRulesConfigInfoOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
