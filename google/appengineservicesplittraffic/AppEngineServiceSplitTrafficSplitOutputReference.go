...
func (a *jsiiProxy_AppEngineServiceSplitTrafficSplitOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppEngineServiceSplitTrafficSplitOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
