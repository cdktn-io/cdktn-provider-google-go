...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) validateImportFromParameters(id *string) error {
	if id == nil {
...
func validateAppEngineServiceSplitTraffic_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
