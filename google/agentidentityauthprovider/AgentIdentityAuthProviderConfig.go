...
type AgentIdentityAuthProviderConfig struct {
	...
	AuthProviderTypeParams *AgentIdentityAuthProviderAuthProviderTypeParams `field:"required" json:"authProviderTypeParams" yaml:"authProviderTypeParams"`
	...
	Timeouts *AgentIdentityAuthProviderTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
