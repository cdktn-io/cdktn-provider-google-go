...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "computeInstanceBackupPlanProperties", GoGetter: "ComputeInstanceBackupPlanProperties"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dataGoogleBackupDrBackupPlan.DataGoogleBackupDrBackupPlanComputeInstanceBackupPlanProperties",
		reflect.TypeOf((*DataGoogleBackupDrBackupPlanComputeInstanceBackupPlanProperties)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.dataGoogleBackupDrBackupPlan.DataGoogleBackupDrBackupPlanComputeInstanceBackupPlanPropertiesList",
		reflect.TypeOf((*DataGoogleBackupDrBackupPlanComputeInstanceBackupPlanPropertiesList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
		...
		func() interface{} {
			j := jsiiProxy_DataGoogleBackupDrBackupPlanComputeInstanceBackupPlanPropertiesList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleBackupDrBackupPlanComputeInstanceBackupPlanPropertiesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
