...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "crossProjectMetadata", GoGetter: "CrossProjectMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "crossProjectMetadataInput", GoGetter: "CrossProjectMetadataInput"},
