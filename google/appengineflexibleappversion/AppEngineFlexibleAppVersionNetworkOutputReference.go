...
func (a *jsiiProxy_AppEngineFlexibleAppVersionNetworkOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppEngineFlexibleAppVersionNetworkOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
