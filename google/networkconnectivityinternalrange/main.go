...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "excludeCidrRanges", GoGetter: "ExcludeCidrRanges"},
			_jsii_.MemberProperty{JsiiProperty: "excludeCidrRangesInput", GoGetter: "ExcludeCidrRangesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTargetCidrRange", GoMethod: "ResetTargetCidrRange"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberMethod{JsiiMethod: "synthesizeAttributes", GoMethod: "SynthesizeAttributes"},
			_jsii_.MemberMethod{JsiiMethod: "synthesizeHclAttributes", GoMethod: "SynthesizeHclAttributes"},
			_jsii_.MemberProperty{JsiiProperty: "targetCidrRange", GoGetter: "TargetCidrRange"},
			_jsii_.MemberProperty{JsiiProperty: "targetCidrRangeInput", GoGetter: "TargetCidrRangeInput"},
