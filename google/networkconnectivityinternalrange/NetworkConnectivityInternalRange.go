...
func (j *jsiiProxy_NetworkConnectivityInternalRange) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_NetworkConnectivityInternalRange) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_NetworkConnectivityInternalRange)SetDeletionPolicy(val *string) {
...
func (n *jsiiProxy_NetworkConnectivityInternalRange) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		n,
		"resetDeletionPolicy",
		nil, // no parameters
