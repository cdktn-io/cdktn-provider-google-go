...
func (j *jsiiProxy_SpannerBackupSchedule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SpannerBackupSchedule) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_SpannerBackupSchedule) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_SpannerBackupSchedule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SpannerBackupSchedule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SpannerBackupSchedule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SpannerBackupSchedule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/spanner_backup_schedule google_spanner_backup_schedule} Resource.
...
func (j *jsiiProxy_SpannerBackupSchedule)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_SpannerBackupSchedule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SpannerBackupSchedule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SpannerBackupSchedule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SpannerBackupSchedule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SpannerBackupSchedule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpannerBackupSchedule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SpannerBackupSchedule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpannerBackupSchedule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SpannerBackupSchedule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SpannerBackupSchedule) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		s,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (s *jsiiProxy_SpannerBackupSchedule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
