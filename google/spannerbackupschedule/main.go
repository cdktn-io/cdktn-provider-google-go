...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "fullBackupSpec", GoGetter: "FullBackupSpec"},
			_jsii_.MemberProperty{JsiiProperty: "fullBackupSpecInput", GoGetter: "FullBackupSpecInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "incrementalBackupSpec", GoGetter: "IncrementalBackupSpec"},
			_jsii_.MemberProperty{JsiiProperty: "incrementalBackupSpecInput", GoGetter: "IncrementalBackupSpecInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putFullBackupSpec", GoMethod: "PutFullBackupSpec"},
			_jsii_.MemberMethod{JsiiMethod: "putIncrementalBackupSpec", GoMethod: "PutIncrementalBackupSpec"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIncrementalBackupSpec", GoMethod: "ResetIncrementalBackupSpec"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putCronSpec", GoMethod: "PutCronSpec"},
