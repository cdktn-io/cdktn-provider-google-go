...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/healthcare_dataset google_healthcare_dataset}.
...
func (j *jsiiProxy_HealthcareDataset) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_HealthcareDataset) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_HealthcareDataset) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_HealthcareDataset) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_HealthcareDataset) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/healthcare_dataset google_healthcare_dataset} Resource.
...
func (j *jsiiProxy_HealthcareDataset)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_HealthcareDataset)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_HealthcareDataset)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func HealthcareDataset_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (h *jsiiProxy_HealthcareDataset) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HealthcareDataset) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (h *jsiiProxy_HealthcareDataset) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HealthcareDataset) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (h *jsiiProxy_HealthcareDataset) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (h *jsiiProxy_HealthcareDataset) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
