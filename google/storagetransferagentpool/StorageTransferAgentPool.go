...
func (s *jsiiProxy_StorageTransferAgentPool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageTransferAgentPool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StorageTransferAgentPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
