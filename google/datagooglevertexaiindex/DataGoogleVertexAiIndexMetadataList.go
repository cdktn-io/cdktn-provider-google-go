...
func (j *jsiiProxy_DataGoogleVertexAiIndexMetadataList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleVertexAiIndexMetadataList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleVertexAiIndexMetadataList {
	_init_.Initialize()
...
func NewDataGoogleVertexAiIndexMetadataList_Override(d DataGoogleVertexAiIndexMetadataList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleVertexAiIndexMetadataList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleVertexAiIndexMetadataList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleVertexAiIndexMetadataList) Resolve(context cdktn.IResolveContext) interface{} {
