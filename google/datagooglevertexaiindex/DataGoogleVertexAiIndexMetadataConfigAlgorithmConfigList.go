...
func (j *jsiiProxy_DataGoogleVertexAiIndexMetadataConfigAlgorithmConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleVertexAiIndexMetadataConfigAlgorithmConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleVertexAiIndexMetadataConfigAlgorithmConfigList {
	_init_.Initialize()
...
func NewDataGoogleVertexAiIndexMetadataConfigAlgorithmConfigList_Override(d DataGoogleVertexAiIndexMetadataConfigAlgorithmConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleVertexAiIndexMetadataConfigAlgorithmConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleVertexAiIndexMetadataConfigAlgorithmConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleVertexAiIndexMetadataConfigAlgorithmConfigList) Resolve(context cdktn.IResolveContext) interface{} {
