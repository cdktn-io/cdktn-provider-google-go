...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/parallelstore_instance google_parallelstore_instance} Resource.
...
func (p *jsiiProxy_ParallelstoreInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_ParallelstoreInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_ParallelstoreInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
