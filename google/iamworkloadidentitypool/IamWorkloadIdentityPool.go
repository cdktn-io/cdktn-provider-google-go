...
func (j *jsiiProxy_IamWorkloadIdentityPool) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_IamWorkloadIdentityPool) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_IamWorkloadIdentityPool) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamWorkloadIdentityPool) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamWorkloadIdentityPool) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/iam_workload_identity_pool google_iam_workload_identity_pool} Resource.
...
func (j *jsiiProxy_IamWorkloadIdentityPool)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_IamWorkloadIdentityPool)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamWorkloadIdentityPool)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamWorkloadIdentityPool)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamWorkloadIdentityPool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamWorkloadIdentityPool) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamWorkloadIdentityPool) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamWorkloadIdentityPool) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamWorkloadIdentityPool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamWorkloadIdentityPool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamWorkloadIdentityPool) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		i,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (i *jsiiProxy_IamWorkloadIdentityPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
