...
func (j *jsiiProxy_NetworkConnectivityPolicyBasedRouteFilterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkConnectivityPolicyBasedRouteFilterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) NetworkConnectivityPolicyBasedRouteFilterOutputReference {
	_init_.Initialize()
...
func NewNetworkConnectivityPolicyBasedRouteFilterOutputReference_Override(n NetworkConnectivityPolicyBasedRouteFilterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkConnectivityPolicyBasedRouteFilterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkConnectivityPolicyBasedRouteFilterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkConnectivityPolicyBasedRouteFilterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (n *jsiiProxy_NetworkConnectivityPolicyBasedRouteFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkConnectivityPolicyBasedRouteFilterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
