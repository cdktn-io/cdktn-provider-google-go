...
type GoogleProviderFunctions interface {
...
// The jsii proxy struct for GoogleProviderFunctions
type jsiiProxy_GoogleProviderFunctions struct {
	_ byte // padding
}

func NewGoogleProviderFunctions(providerLocalName *string) GoogleProviderFunctions {
	_init_.Initialize()

	if err := validateNewGoogleProviderFunctionsParameters(providerLocalName); err != nil {
		panic(err)
	}
	j := jsiiProxy_GoogleProviderFunctions{}

	_jsii_.Create(
		"@cdktn/provider-google.providerFunctions.GoogleProviderFunctions",
...
func NewGoogleProviderFunctions_Override(g GoogleProviderFunctions, providerLocalName *string) {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleProviderFunctions) LocationFromId(id *string) *string {
...
func (g *jsiiProxy_GoogleProviderFunctions) NameFromId(id *string) *string {
...
func (g *jsiiProxy_GoogleProviderFunctions) ProjectFromId(id *string) *string {
...
func (g *jsiiProxy_GoogleProviderFunctions) RegionFromId(id *string) *string {
...
func (g *jsiiProxy_GoogleProviderFunctions) RegionFromZone(zone *string) *string {
...
func (g *jsiiProxy_GoogleProviderFunctions) ZoneFromId(id *string) *string {
