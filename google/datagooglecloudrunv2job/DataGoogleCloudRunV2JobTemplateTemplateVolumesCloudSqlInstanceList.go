...
func (j *jsiiProxy_DataGoogleCloudRunV2JobTemplateTemplateVolumesCloudSqlInstanceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudRunV2JobTemplateTemplateVolumesCloudSqlInstanceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudRunV2JobTemplateTemplateVolumesCloudSqlInstanceList {
	_init_.Initialize()
...
func NewDataGoogleCloudRunV2JobTemplateTemplateVolumesCloudSqlInstanceList_Override(d DataGoogleCloudRunV2JobTemplateTemplateVolumesCloudSqlInstanceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudRunV2JobTemplateTemplateVolumesCloudSqlInstanceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudRunV2JobTemplateTemplateVolumesCloudSqlInstanceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCloudRunV2JobTemplateTemplateVolumesCloudSqlInstanceList) Resolve(context cdktn.IResolveContext) interface{} {
