...
func (j *jsiiProxy_ActiveDirectoryDomainTrust) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ActiveDirectoryDomainTrust) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ActiveDirectoryDomainTrust) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_ActiveDirectoryDomainTrust) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ActiveDirectoryDomainTrust) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ActiveDirectoryDomainTrust) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ActiveDirectoryDomainTrust) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ActiveDirectoryDomainTrust)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_ActiveDirectoryDomainTrust)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ActiveDirectoryDomainTrust)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ActiveDirectoryDomainTrust)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ActiveDirectoryDomainTrust_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ActiveDirectoryDomainTrust) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ActiveDirectoryDomainTrust) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ActiveDirectoryDomainTrust) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ActiveDirectoryDomainTrust) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ActiveDirectoryDomainTrust) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ActiveDirectoryDomainTrust) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		a,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (a *jsiiProxy_ActiveDirectoryDomainTrust) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
