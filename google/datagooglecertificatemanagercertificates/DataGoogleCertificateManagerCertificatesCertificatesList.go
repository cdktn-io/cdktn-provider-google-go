...
func (j *jsiiProxy_DataGoogleCertificateManagerCertificatesCertificatesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCertificateManagerCertificatesCertificatesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCertificateManagerCertificatesCertificatesList {
	_init_.Initialize()
...
func NewDataGoogleCertificateManagerCertificatesCertificatesList_Override(d DataGoogleCertificateManagerCertificatesCertificatesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCertificateManagerCertificatesCertificatesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCertificateManagerCertificatesCertificatesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCertificateManagerCertificatesCertificatesList) Resolve(context cdktn.IResolveContext) interface{} {
