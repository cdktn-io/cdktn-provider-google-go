...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/computeregionhealthaggregationpolicy/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/compute_region_health_aggregation_policy google_compute_region_health_aggregation_policy} Resource.
...
func (c *jsiiProxy_ComputeRegionHealthAggregationPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputeRegionHealthAggregationPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
