...
func NewDataGoogleMemorystoreInstanceMaintenancePolicyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleMemorystoreInstanceMaintenancePolicyList {
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleMemorystoreInstance.DataGoogleMemorystoreInstanceMaintenancePolicyList",
...
func (d *jsiiProxy_DataGoogleMemorystoreInstanceMaintenancePolicyList) Resolve(context cdktf.IResolveContext) interface{} {
