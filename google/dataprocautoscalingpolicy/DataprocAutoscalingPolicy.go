...
func (j *jsiiProxy_DataprocAutoscalingPolicy) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DataprocAutoscalingPolicy) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_DataprocAutoscalingPolicy)SetDeletionPolicy(val *string) {
...
func (d *jsiiProxy_DataprocAutoscalingPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataprocAutoscalingPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataprocAutoscalingPolicy) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		d,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (d *jsiiProxy_DataprocAutoscalingPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
