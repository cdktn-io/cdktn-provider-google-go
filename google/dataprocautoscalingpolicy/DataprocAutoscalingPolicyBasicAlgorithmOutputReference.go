...
func (d *jsiiProxy_DataprocAutoscalingPolicyBasicAlgorithmOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataprocAutoscalingPolicyBasicAlgorithmOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
