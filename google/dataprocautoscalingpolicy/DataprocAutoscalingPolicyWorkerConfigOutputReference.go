...
func (d *jsiiProxy_DataprocAutoscalingPolicyWorkerConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataprocAutoscalingPolicyWorkerConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
