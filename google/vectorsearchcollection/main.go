...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dataSchema", GoGetter: "DataSchema"},
			_jsii_.MemberProperty{JsiiProperty: "dataSchemaInput", GoGetter: "DataSchemaInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetVectorSchema", GoMethod: "ResetVectorSchema"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putVertexEmbeddingConfig", GoMethod: "PutVertexEmbeddingConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resetDimensions", GoMethod: "ResetDimensions"},
			_jsii_.MemberMethod{JsiiMethod: "resetVertexEmbeddingConfig", GoMethod: "ResetVertexEmbeddingConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberProperty{JsiiProperty: "textTemplate", GoGetter: "TextTemplate"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "denseVector", GoGetter: "DenseVector"},
			_jsii_.MemberProperty{JsiiProperty: "denseVectorInput", GoGetter: "DenseVectorInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putDenseVector", GoMethod: "PutDenseVector"},
			_jsii_.MemberMethod{JsiiMethod: "putSparseVector", GoMethod: "PutSparseVector"},
			_jsii_.MemberMethod{JsiiMethod: "resetDenseVector", GoMethod: "ResetDenseVector"},
			_jsii_.MemberMethod{JsiiMethod: "resetSparseVector", GoMethod: "ResetSparseVector"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "sparseVector", GoGetter: "SparseVector"},
			_jsii_.MemberProperty{JsiiProperty: "sparseVectorInput", GoGetter: "SparseVectorInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
