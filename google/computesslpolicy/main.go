...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "postQuantumKeyExchange", GoGetter: "PostQuantumKeyExchange"},
			_jsii_.MemberProperty{JsiiProperty: "postQuantumKeyExchangeInput", GoGetter: "PostQuantumKeyExchangeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPostQuantumKeyExchange", GoMethod: "ResetPostQuantumKeyExchange"},
