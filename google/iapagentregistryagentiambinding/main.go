...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IapAgentRegistryAgentIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.iapAgentRegistryAgentIamBinding.IapAgentRegistryAgentIamBindingCondition",
		reflect.TypeOf((*IapAgentRegistryAgentIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.iapAgentRegistryAgentIamBinding.IapAgentRegistryAgentIamBindingConditionOutputReference",
		reflect.TypeOf((*IapAgentRegistryAgentIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.iapAgentRegistryAgentIamBinding.IapAgentRegistryAgentIamBindingConfig",
		reflect.TypeOf((*IapAgentRegistryAgentIamBindingConfig)(nil)).Elem(),
	)
}
