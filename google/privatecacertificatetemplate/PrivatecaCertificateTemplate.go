...
func (j *jsiiProxy_PrivatecaCertificateTemplate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PrivatecaCertificateTemplate) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_PrivatecaCertificateTemplate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PrivatecaCertificateTemplate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PrivatecaCertificateTemplate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PrivatecaCertificateTemplate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_PrivatecaCertificateTemplate) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_PrivatecaCertificateTemplate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PrivatecaCertificateTemplate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PrivatecaCertificateTemplate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PrivatecaCertificateTemplate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PrivatecaCertificateTemplate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivatecaCertificateTemplate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PrivatecaCertificateTemplate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivatecaCertificateTemplate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PrivatecaCertificateTemplate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PrivatecaCertificateTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
