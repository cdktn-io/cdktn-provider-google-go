...
func (j *jsiiProxy_DataGoogleVmwareengineDatastoreNfsDatastoreGoogleFileServiceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleVmwareengineDatastoreNfsDatastoreGoogleFileServiceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleVmwareengineDatastoreNfsDatastoreGoogleFileServiceList {
	_init_.Initialize()
...
func NewDataGoogleVmwareengineDatastoreNfsDatastoreGoogleFileServiceList_Override(d DataGoogleVmwareengineDatastoreNfsDatastoreGoogleFileServiceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleVmwareengineDatastoreNfsDatastoreGoogleFileServiceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleVmwareengineDatastoreNfsDatastoreGoogleFileServiceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleVmwareengineDatastoreNfsDatastoreGoogleFileServiceList) Resolve(context cdktn.IResolveContext) interface{} {
