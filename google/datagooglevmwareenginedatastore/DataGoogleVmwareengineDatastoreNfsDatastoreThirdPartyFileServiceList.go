...
func (j *jsiiProxy_DataGoogleVmwareengineDatastoreNfsDatastoreThirdPartyFileServiceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleVmwareengineDatastoreNfsDatastoreThirdPartyFileServiceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleVmwareengineDatastoreNfsDatastoreThirdPartyFileServiceList {
	_init_.Initialize()
...
func NewDataGoogleVmwareengineDatastoreNfsDatastoreThirdPartyFileServiceList_Override(d DataGoogleVmwareengineDatastoreNfsDatastoreThirdPartyFileServiceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleVmwareengineDatastoreNfsDatastoreThirdPartyFileServiceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleVmwareengineDatastoreNfsDatastoreThirdPartyFileServiceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleVmwareengineDatastoreNfsDatastoreThirdPartyFileServiceList) Resolve(context cdktn.IResolveContext) interface{} {
