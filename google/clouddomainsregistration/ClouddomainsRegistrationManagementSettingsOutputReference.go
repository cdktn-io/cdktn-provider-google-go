...
func (c *jsiiProxy_ClouddomainsRegistrationManagementSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ClouddomainsRegistrationManagementSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
