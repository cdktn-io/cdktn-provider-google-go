...
func (c *jsiiProxy_ClouddomainsRegistrationYearlyPriceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ClouddomainsRegistrationYearlyPriceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
