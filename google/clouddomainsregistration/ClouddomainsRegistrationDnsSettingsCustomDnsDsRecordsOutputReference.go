...
func (c *jsiiProxy_ClouddomainsRegistrationDnsSettingsCustomDnsDsRecordsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ClouddomainsRegistrationDnsSettingsCustomDnsDsRecordsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
