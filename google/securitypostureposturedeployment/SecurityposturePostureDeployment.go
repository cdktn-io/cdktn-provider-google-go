...
func (j *jsiiProxy_SecurityposturePostureDeployment) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_SecurityposturePostureDeployment) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.39.0/docs/resources/securityposture_posture_deployment google_securityposture_posture_deployment} Resource.
...
func (j *jsiiProxy_SecurityposturePostureDeployment)SetDeletionPolicy(val *string) {
...
func (s *jsiiProxy_SecurityposturePostureDeployment) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		s,
		"resetDeletionPolicy",
		nil, // no parameters
