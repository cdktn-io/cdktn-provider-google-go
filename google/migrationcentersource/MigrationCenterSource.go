...
func (m *jsiiProxy_MigrationCenterSource) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MigrationCenterSource) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
