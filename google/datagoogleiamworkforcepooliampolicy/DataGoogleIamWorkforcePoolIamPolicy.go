...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v17/datagoogleiamworkforcepooliampolicy/internal"
...
func NewDataGoogleIamWorkforcePoolIamPolicy(scope constructs.Construct, id *string, config *DataGoogleIamWorkforcePoolIamPolicyConfig) DataGoogleIamWorkforcePoolIamPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-google.dataGoogleIamWorkforcePoolIamPolicy.DataGoogleIamWorkforcePoolIamPolicy",
