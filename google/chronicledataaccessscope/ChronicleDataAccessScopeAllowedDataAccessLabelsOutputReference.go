...
func (c *jsiiProxy_ChronicleDataAccessScopeAllowedDataAccessLabelsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ChronicleDataAccessScopeAllowedDataAccessLabelsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
