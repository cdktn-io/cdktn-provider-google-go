...
func (j *jsiiProxy_DataGoogleCloudbuildTriggerBuildAvailableSecretsSecretManagerList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudbuildTriggerBuildAvailableSecretsSecretManagerList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudbuildTriggerBuildAvailableSecretsSecretManagerList {
	_init_.Initialize()
...
func NewDataGoogleCloudbuildTriggerBuildAvailableSecretsSecretManagerList_Override(d DataGoogleCloudbuildTriggerBuildAvailableSecretsSecretManagerList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudbuildTriggerBuildAvailableSecretsSecretManagerList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudbuildTriggerBuildAvailableSecretsSecretManagerList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCloudbuildTriggerBuildAvailableSecretsSecretManagerList) Resolve(context cdktn.IResolveContext) interface{} {
