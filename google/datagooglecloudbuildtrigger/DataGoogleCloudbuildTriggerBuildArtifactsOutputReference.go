...
func (j *jsiiProxy_DataGoogleCloudbuildTriggerBuildArtifactsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudbuildTriggerBuildArtifactsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleCloudbuildTriggerBuildArtifactsOutputReference {
	_init_.Initialize()
...
func NewDataGoogleCloudbuildTriggerBuildArtifactsOutputReference_Override(d DataGoogleCloudbuildTriggerBuildArtifactsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudbuildTriggerBuildArtifactsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudbuildTriggerBuildArtifactsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleCloudbuildTriggerBuildArtifactsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGoogleCloudbuildTriggerBuildArtifactsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleCloudbuildTriggerBuildArtifactsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
