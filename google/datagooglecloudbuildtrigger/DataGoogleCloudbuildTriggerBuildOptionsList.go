...
func (j *jsiiProxy_DataGoogleCloudbuildTriggerBuildOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudbuildTriggerBuildOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudbuildTriggerBuildOptionsList {
	_init_.Initialize()
...
func NewDataGoogleCloudbuildTriggerBuildOptionsList_Override(d DataGoogleCloudbuildTriggerBuildOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudbuildTriggerBuildOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudbuildTriggerBuildOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCloudbuildTriggerBuildOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
