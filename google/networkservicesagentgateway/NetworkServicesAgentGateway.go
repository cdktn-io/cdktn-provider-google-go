...
func (n *jsiiProxy_NetworkServicesAgentGateway) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkServicesAgentGateway) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
