...
type VertexAiScheduleCreatePipelineJobRequestPipelineJobRuntimeConfig struct {
	...
	InputArtifacts *map[string]*string `field:"optional" json:"inputArtifacts" yaml:"inputArtifacts"`
