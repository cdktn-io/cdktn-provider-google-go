...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customTlsFeatures", GoGetter: "CustomTlsFeatures"},
			_jsii_.MemberProperty{JsiiProperty: "customTlsFeaturesInput", GoGetter: "CustomTlsFeaturesInput"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "description", GoGetter: "Description"},
			_jsii_.MemberProperty{JsiiProperty: "descriptionInput", GoGetter: "DescriptionInput"},
			_jsii_.MemberProperty{JsiiProperty: "excludePublicCaSet", GoGetter: "ExcludePublicCaSet"},
			_jsii_.MemberProperty{JsiiProperty: "excludePublicCaSetInput", GoGetter: "ExcludePublicCaSetInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTlsFeatureProfile", GoMethod: "ResetTlsFeatureProfile"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tlsFeatureProfile", GoGetter: "TlsFeatureProfile"},
			_jsii_.MemberProperty{JsiiProperty: "tlsFeatureProfileInput", GoGetter: "TlsFeatureProfileInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.networkSecurityTlsInspectionPolicy.NetworkSecurityTlsInspectionPolicyConfig",
		reflect.TypeOf((*NetworkSecurityTlsInspectionPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.networkSecurityTlsInspectionPolicy.NetworkSecurityTlsInspectionPolicyTimeouts",
		reflect.TypeOf((*NetworkSecurityTlsInspectionPolicyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.networkSecurityTlsInspectionPolicy.NetworkSecurityTlsInspectionPolicyTimeoutsOutputReference",
