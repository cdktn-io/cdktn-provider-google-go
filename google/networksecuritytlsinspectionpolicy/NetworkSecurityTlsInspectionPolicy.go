...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/networksecuritytlsinspectionpolicy/internal"
...
func (j *jsiiProxy_NetworkSecurityTlsInspectionPolicy) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_NetworkSecurityTlsInspectionPolicy) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/network_security_tls_inspection_policy google_network_security_tls_inspection_policy} Resource.
...
func (j *jsiiProxy_NetworkSecurityTlsInspectionPolicy)SetDeletionPolicy(val *string) {
...
func (n *jsiiProxy_NetworkSecurityTlsInspectionPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkSecurityTlsInspectionPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkSecurityTlsInspectionPolicy) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		n,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkSecurityTlsInspectionPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
