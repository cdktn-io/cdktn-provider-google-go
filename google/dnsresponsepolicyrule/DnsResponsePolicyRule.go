...
func (j *jsiiProxy_DnsResponsePolicyRule) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DnsResponsePolicyRule) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/dns_response_policy_rule google_dns_response_policy_rule} Resource.
...
func (j *jsiiProxy_DnsResponsePolicyRule)SetDeletionPolicy(val *string) {
...
func (d *jsiiProxy_DnsResponsePolicyRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DnsResponsePolicyRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DnsResponsePolicyRule) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		d,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (d *jsiiProxy_DnsResponsePolicyRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
