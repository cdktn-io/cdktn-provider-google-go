...
type DataGoogleBigqueryTable interface {
	...
	SetId(val *string)
	IdInput() *string
	IgnoreAutoGeneratedSchema() cdktn.IResolvable
...
func (j *jsiiProxy_DataGoogleBigqueryTable) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataGoogleBigqueryTable) DeletionProtection() cdktn.IResolvable {
...
func (j *jsiiProxy_DataGoogleBigqueryTable) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_DataGoogleBigqueryTable) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataGoogleBigqueryTable) IgnoreAutoGeneratedSchema() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleBigqueryTable) Labels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"labels",
...
func (j *jsiiProxy_DataGoogleBigqueryTable) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGoogleBigqueryTable) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataGoogleBigqueryTable) RequirePartitionFilter() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleBigqueryTable) ResourceTags() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"resourceTags",
...
func (j *jsiiProxy_DataGoogleBigqueryTable) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataGoogleBigqueryTable) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_DataGoogleBigqueryTable)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGoogleBigqueryTable)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataGoogleBigqueryTable)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataGoogleBigqueryTable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataGoogleBigqueryTable) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleBigqueryTable) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleBigqueryTable) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataGoogleBigqueryTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
