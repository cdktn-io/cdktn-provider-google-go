...
func (j *jsiiProxy_DataGoogleBigqueryTableTableConstraintsPrimaryKeyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleBigqueryTableTableConstraintsPrimaryKeyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleBigqueryTableTableConstraintsPrimaryKeyList {
	_init_.Initialize()
...
func NewDataGoogleBigqueryTableTableConstraintsPrimaryKeyList_Override(d DataGoogleBigqueryTableTableConstraintsPrimaryKeyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleBigqueryTableTableConstraintsPrimaryKeyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleBigqueryTableTableConstraintsPrimaryKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleBigqueryTableTableConstraintsPrimaryKeyList) Resolve(context cdktn.IResolveContext) interface{} {
