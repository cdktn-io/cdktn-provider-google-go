...
func (j *jsiiProxy_DataGoogleBigqueryTableViewList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleBigqueryTableViewList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleBigqueryTableViewList {
	_init_.Initialize()
...
func NewDataGoogleBigqueryTableViewList_Override(d DataGoogleBigqueryTableViewList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleBigqueryTableViewList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleBigqueryTableViewList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleBigqueryTableViewList) Resolve(context cdktn.IResolveContext) interface{} {
