...
func (j *jsiiProxy_NetworkSecurityClientTlsPolicyServerValidationCaOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkSecurityClientTlsPolicyServerValidationCaOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) NetworkSecurityClientTlsPolicyServerValidationCaOutputReference {
	_init_.Initialize()
...
func NewNetworkSecurityClientTlsPolicyServerValidationCaOutputReference_Override(n NetworkSecurityClientTlsPolicyServerValidationCaOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkSecurityClientTlsPolicyServerValidationCaOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkSecurityClientTlsPolicyServerValidationCaOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkSecurityClientTlsPolicyServerValidationCaOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (n *jsiiProxy_NetworkSecurityClientTlsPolicyServerValidationCaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkSecurityClientTlsPolicyServerValidationCaOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
