...
func (n *jsiiProxy_NetworkSecurityClientTlsPolicyServerValidationCaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkSecurityClientTlsPolicyServerValidationCaOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
