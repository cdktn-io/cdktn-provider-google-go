...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/cloud_security_compliance_cloud_control google_cloud_security_compliance_cloud_control}.
...
func (j *jsiiProxy_CloudSecurityComplianceCloudControl) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudSecurityComplianceCloudControl) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudSecurityComplianceCloudControl) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudSecurityComplianceCloudControl) Parent() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parent",
...
func (j *jsiiProxy_CloudSecurityComplianceCloudControl) ParentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentInput",
...
func (j *jsiiProxy_CloudSecurityComplianceCloudControl) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudSecurityComplianceCloudControl) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/cloud_security_compliance_cloud_control google_cloud_security_compliance_cloud_control} Resource.
...
func (j *jsiiProxy_CloudSecurityComplianceCloudControl)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudSecurityComplianceCloudControl)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudSecurityComplianceCloudControl)SetParent(val *string) {
...
func (j *jsiiProxy_CloudSecurityComplianceCloudControl)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CloudSecurityComplianceCloudControl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudSecurityComplianceCloudControl) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudSecurityComplianceCloudControl) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudSecurityComplianceCloudControl) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudSecurityComplianceCloudControl) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudSecurityComplianceCloudControl) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudSecurityComplianceCloudControl) ResetOrganization() {
	_jsii_.InvokeVoid(
		c,
		"resetOrganization",
		nil, // no parameters
...
func (c *jsiiProxy_CloudSecurityComplianceCloudControl) ResetParent() {
	_jsii_.InvokeVoid(
		c,
		"resetParent",
		nil, // no parameters
...
func (c *jsiiProxy_CloudSecurityComplianceCloudControl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
