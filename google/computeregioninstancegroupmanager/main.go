...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.computeRegionInstanceGroupManager.ComputeRegionInstanceGroupManagerInstanceLifecyclePolicyOnRepair",
		reflect.TypeOf((*ComputeRegionInstanceGroupManagerInstanceLifecyclePolicyOnRepair)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ComputeRegionInstanceGroupManagerInstanceLifecyclePolicyOnRepairOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
