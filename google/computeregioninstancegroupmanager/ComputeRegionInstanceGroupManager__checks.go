...
func (c *jsiiProxy_ComputeRegionInstanceGroupManager) validatePutNamedPortParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ComputeRegionInstanceGroupManagerNamedPort; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ComputeRegionInstanceGroupManager) validatePutStatefulDiskParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ComputeRegionInstanceGroupManagerStatefulDisk; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ComputeRegionInstanceGroupManager) validatePutStatefulExternalIpParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ComputeRegionInstanceGroupManagerStatefulExternalIp; received %#v (a %T)", value, value)
		}
	}
