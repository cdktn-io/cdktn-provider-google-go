...
func (j *jsiiProxy_ComputeRegionInstanceGroupManager) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ComputeRegionInstanceGroupManager) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/compute_region_instance_group_manager google_compute_region_instance_group_manager} Resource.
...
func (j *jsiiProxy_ComputeRegionInstanceGroupManager)SetDeletionPolicy(val *string) {
...
func (c *jsiiProxy_ComputeRegionInstanceGroupManager) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputeRegionInstanceGroupManager) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputeRegionInstanceGroupManager) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeRegionInstanceGroupManager) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
