...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/ephemeralgoogleserviceaccountjwt/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/ephemeral-resources/service_account_jwt google_service_account_jwt}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/ephemeral-resources/service_account_jwt google_service_account_jwt} Ephemeral Resource.
func NewEphemeralGoogleServiceAccountJwt(scope constructs.Construct, id *string, config *EphemeralGoogleServiceAccountJwtConfig) EphemeralGoogleServiceAccountJwt {
	...
	_jsii_.Create(
		"@cdktn/provider-google.ephemeralGoogleServiceAccountJwt.EphemeralGoogleServiceAccountJwt",
