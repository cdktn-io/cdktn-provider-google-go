...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.netappBackup.NetappBackupOntapSource",
		reflect.TypeOf((*NetappBackupOntapSource)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.netappBackup.NetappBackupOntapSourceOutputReference",
		reflect.TypeOf((*NetappBackupOntapSourceOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
