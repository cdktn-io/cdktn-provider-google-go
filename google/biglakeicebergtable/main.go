...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.biglakeIcebergTable.BiglakeIcebergTableSortOrder",
		reflect.TypeOf((*BiglakeIcebergTableSortOrder)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.biglakeIcebergTable.BiglakeIcebergTableSortOrderFields",
		reflect.TypeOf((*BiglakeIcebergTableSortOrderFields)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.biglakeIcebergTable.BiglakeIcebergTableSortOrderFieldsList",
		reflect.TypeOf((*BiglakeIcebergTableSortOrderFieldsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BiglakeIcebergTableSortOrderFieldsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BiglakeIcebergTableSortOrderOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
