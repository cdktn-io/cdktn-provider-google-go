...
type BiglakeIcebergTableSchemaFields struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.32.0/docs/resources/biglake_iceberg_table#id BiglakeIcebergTable#id}
	//
