...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/cloudassetfolderfeed/internal"
...
func (j *jsiiProxy_CloudAssetFolderFeed) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudAssetFolderFeed) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_CloudAssetFolderFeed) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_CloudAssetFolderFeed) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudAssetFolderFeed) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudAssetFolderFeed) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudAssetFolderFeed) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CloudAssetFolderFeed)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_CloudAssetFolderFeed)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudAssetFolderFeed)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudAssetFolderFeed)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CloudAssetFolderFeed_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudAssetFolderFeed) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudAssetFolderFeed) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudAssetFolderFeed) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudAssetFolderFeed) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudAssetFolderFeed) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudAssetFolderFeed) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_CloudAssetFolderFeed) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
