...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v16/discoveryenginesearchengine/internal"
...
func (d *jsiiProxy_DiscoveryEngineSearchEngineSearchEngineConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DiscoveryEngineSearchEngineSearchEngineConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
