...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "computeInstanceBackupPlanPropertiesInput", GoGetter: "ComputeInstanceBackupPlanPropertiesInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "diskBackupPlanPropertiesInput", GoGetter: "DiskBackupPlanPropertiesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putComputeInstanceBackupPlanProperties", GoMethod: "PutComputeInstanceBackupPlanProperties"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetComputeInstanceBackupPlanProperties", GoMethod: "ResetComputeInstanceBackupPlanProperties"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.backupDrBackupPlan.BackupDrBackupPlanComputeInstanceBackupPlanProperties",
		reflect.TypeOf((*BackupDrBackupPlanComputeInstanceBackupPlanProperties)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.backupDrBackupPlan.BackupDrBackupPlanComputeInstanceBackupPlanPropertiesOutputReference",
		reflect.TypeOf((*BackupDrBackupPlanComputeInstanceBackupPlanPropertiesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
