...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/compute_resize_request google_compute_resize_request}.
...
func (j *jsiiProxy_ComputeResizeRequest) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ComputeResizeRequest) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/compute_resize_request google_compute_resize_request} Resource.
...
func (j *jsiiProxy_ComputeResizeRequest)SetDeletionPolicy(val *string) {
...
func (c *jsiiProxy_ComputeResizeRequest) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputeResizeRequest) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputeResizeRequest) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeResizeRequest) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
