...
func (c *jsiiProxy_ComputeResizeRequestStatusList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (c *jsiiProxy_ComputeResizeRequestStatusList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_ComputeResizeRequestStatusList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_ComputeResizeRequestStatusList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
