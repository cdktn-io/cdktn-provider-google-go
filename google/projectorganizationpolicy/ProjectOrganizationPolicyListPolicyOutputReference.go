...
func (p *jsiiProxy_ProjectOrganizationPolicyListPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_ProjectOrganizationPolicyListPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
