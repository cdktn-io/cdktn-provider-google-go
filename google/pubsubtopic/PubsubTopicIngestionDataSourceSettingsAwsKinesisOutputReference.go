...
func (p *jsiiProxy_PubsubTopicIngestionDataSourceSettingsAwsKinesisOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PubsubTopicIngestionDataSourceSettingsAwsKinesisOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
