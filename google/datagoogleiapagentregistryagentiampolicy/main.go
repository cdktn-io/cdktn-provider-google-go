...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google.dataGoogleIapAgentRegistryAgentIamPolicy.DataGoogleIapAgentRegistryAgentIamPolicy",
		reflect.TypeOf((*DataGoogleIapAgentRegistryAgentIamPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dataGoogleIapAgentRegistryAgentIamPolicy.DataGoogleIapAgentRegistryAgentIamPolicyConfig",
		reflect.TypeOf((*DataGoogleIapAgentRegistryAgentIamPolicyConfig)(nil)).Elem(),
	)
}
