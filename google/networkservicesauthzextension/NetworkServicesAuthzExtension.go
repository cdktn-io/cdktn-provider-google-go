...
func (j *jsiiProxy_NetworkServicesAuthzExtension) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_NetworkServicesAuthzExtension) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_NetworkServicesAuthzExtension)SetDeletionPolicy(val *string) {
...
func (n *jsiiProxy_NetworkServicesAuthzExtension) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkServicesAuthzExtension) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkServicesAuthzExtension) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		n,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkServicesAuthzExtension) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
