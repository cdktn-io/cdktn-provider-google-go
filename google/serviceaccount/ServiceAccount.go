...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v17/serviceaccount/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/service_account google_service_account} Resource.
func NewServiceAccount(scope constructs.Construct, id *string, config *ServiceAccountConfig) ServiceAccount {
	...
	_jsii_.Create(
		"@cdktn/provider-google.serviceAccount.ServiceAccount",
