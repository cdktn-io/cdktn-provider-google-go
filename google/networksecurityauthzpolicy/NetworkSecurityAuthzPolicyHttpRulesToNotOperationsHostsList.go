...
func (j *jsiiProxy_NetworkSecurityAuthzPolicyHttpRulesToNotOperationsHostsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkSecurityAuthzPolicyHttpRulesToNotOperationsHostsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkSecurityAuthzPolicyHttpRulesToNotOperationsHostsList {
	_init_.Initialize()
...
func NewNetworkSecurityAuthzPolicyHttpRulesToNotOperationsHostsList_Override(n NetworkSecurityAuthzPolicyHttpRulesToNotOperationsHostsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkSecurityAuthzPolicyHttpRulesToNotOperationsHostsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkSecurityAuthzPolicyHttpRulesToNotOperationsHostsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkSecurityAuthzPolicyHttpRulesToNotOperationsHostsList) Resolve(context cdktn.IResolveContext) interface{} {
