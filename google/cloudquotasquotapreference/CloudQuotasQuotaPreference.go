...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/cloud_quotas_quota_preference google_cloud_quotas_quota_preference} Resource.
...
func (c *jsiiProxy_CloudQuotasQuotaPreference) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudQuotasQuotaPreference) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudQuotasQuotaPreference) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
