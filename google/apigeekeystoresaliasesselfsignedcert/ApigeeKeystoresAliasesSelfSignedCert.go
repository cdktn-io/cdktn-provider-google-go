...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/apigee_keystores_aliases_self_signed_cert google_apigee_keystores_aliases_self_signed_cert} Resource.
...
func (a *jsiiProxy_ApigeeKeystoresAliasesSelfSignedCert) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApigeeKeystoresAliasesSelfSignedCert) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApigeeKeystoresAliasesSelfSignedCert) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
