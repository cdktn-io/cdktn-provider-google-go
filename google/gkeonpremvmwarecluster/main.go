...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSkipValidations", GoMethod: "ResetSkipValidations"},
			...
			_jsii_.MemberProperty{JsiiProperty: "skipValidations", GoGetter: "SkipValidations"},
			_jsii_.MemberProperty{JsiiProperty: "skipValidationsInput", GoGetter: "SkipValidationsInput"},
