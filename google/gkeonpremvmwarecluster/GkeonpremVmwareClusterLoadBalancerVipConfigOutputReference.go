...
func (g *jsiiProxy_GkeonpremVmwareClusterLoadBalancerVipConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GkeonpremVmwareClusterLoadBalancerVipConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
