...
func (g *jsiiProxy_GkeonpremVmwareClusterLoadBalancerMetalLbConfigAddressPoolsList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_GkeonpremVmwareClusterLoadBalancerMetalLbConfigAddressPoolsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewGkeonpremVmwareClusterLoadBalancerMetalLbConfigAddressPoolsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
