...
type ChronicleFeedDetailsAmazonS3V2Settings struct {
	...
	Authentication *ChronicleFeedDetailsAmazonS3V2SettingsAuthentication `field:"required" json:"authentication" yaml:"authentication"`
	// S3 URI.
	//
