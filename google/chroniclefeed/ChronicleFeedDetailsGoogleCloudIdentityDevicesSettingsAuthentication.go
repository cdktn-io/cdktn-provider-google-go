...
type ChronicleFeedDetailsGoogleCloudIdentityDevicesSettingsAuthentication struct {
	// claims block.
	//
	...
	Claims *ChronicleFeedDetailsGoogleCloudIdentityDevicesSettingsAuthenticationClaims `field:"optional" json:"claims" yaml:"claims"`
	...
	RsCredentials *ChronicleFeedDetailsGoogleCloudIdentityDevicesSettingsAuthenticationRsCredentials `field:"optional" json:"rsCredentials" yaml:"rsCredentials"`
