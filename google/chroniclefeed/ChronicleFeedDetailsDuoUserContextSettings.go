...
type ChronicleFeedDetailsDuoUserContextSettings struct {
	...
	Authentication *ChronicleFeedDetailsDuoUserContextSettingsAuthentication `field:"optional" json:"authentication" yaml:"authentication"`
	// API hostname.
	//
