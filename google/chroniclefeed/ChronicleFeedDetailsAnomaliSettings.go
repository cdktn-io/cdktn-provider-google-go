...
type ChronicleFeedDetailsAnomaliSettings struct {
	...
	Authentication *ChronicleFeedDetailsAnomaliSettingsAuthentication `field:"optional" json:"authentication" yaml:"authentication"`
}
