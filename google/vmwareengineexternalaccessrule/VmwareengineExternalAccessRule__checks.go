...
func (v *jsiiProxy_VmwareengineExternalAccessRule) validatePutDestinationIpRangesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*VmwareengineExternalAccessRuleDestinationIpRanges; received %#v (a %T)", value, value)
		}
	}
...
func (v *jsiiProxy_VmwareengineExternalAccessRule) validatePutSourceIpRangesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*VmwareengineExternalAccessRuleSourceIpRanges; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_VmwareengineExternalAccessRule) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
