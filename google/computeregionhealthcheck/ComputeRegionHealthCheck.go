...
func (j *jsiiProxy_ComputeRegionHealthCheck) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ComputeRegionHealthCheck) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.39.0/docs/resources/compute_region_health_check google_compute_region_health_check} Resource.
...
func (j *jsiiProxy_ComputeRegionHealthCheck)SetDeletionPolicy(val *string) {
...
func (c *jsiiProxy_ComputeRegionHealthCheck) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
