...
func (j *jsiiProxy_DialogflowCxToolOpenApiSpecTlsConfigCaCertsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDialogflowCxToolOpenApiSpecTlsConfigCaCertsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DialogflowCxToolOpenApiSpecTlsConfigCaCertsList {
	_init_.Initialize()
...
func NewDialogflowCxToolOpenApiSpecTlsConfigCaCertsList_Override(d DialogflowCxToolOpenApiSpecTlsConfigCaCertsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DialogflowCxToolOpenApiSpecTlsConfigCaCertsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DialogflowCxToolOpenApiSpecTlsConfigCaCertsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DialogflowCxToolOpenApiSpecTlsConfigCaCertsList) Resolve(context cdktn.IResolveContext) interface{} {
