...
func (w *jsiiProxy_WorkstationsWorkstationConfigAllowedPortsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (w *jsiiProxy_WorkstationsWorkstationConfigAllowedPortsList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_WorkstationsWorkstationConfigAllowedPortsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_WorkstationsWorkstationConfigAllowedPortsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
