...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BigqueryRoutineIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.bigqueryRoutineIamBinding.BigqueryRoutineIamBindingCondition",
		reflect.TypeOf((*BigqueryRoutineIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.bigqueryRoutineIamBinding.BigqueryRoutineIamBindingConditionOutputReference",
		reflect.TypeOf((*BigqueryRoutineIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.bigqueryRoutineIamBinding.BigqueryRoutineIamBindingConfig",
		reflect.TypeOf((*BigqueryRoutineIamBindingConfig)(nil)).Elem(),
	)
}
