...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster)SetDeletionPolicy(val *string) {
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		o,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
