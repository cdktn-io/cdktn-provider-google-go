...
type OracleDatabaseCloudVmClusterConfig struct {
	...
	BackupOdbSubnet *string `field:"optional" json:"backupOdbSubnet" yaml:"backupOdbSubnet"`
	...
	ExascaleDbStorageVault *string `field:"optional" json:"exascaleDbStorageVault" yaml:"exascaleDbStorageVault"`
