...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/discoveryenginechatengine/internal"
...
func (j *jsiiProxy_DiscoveryEngineChatEngine) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DiscoveryEngineChatEngine) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DiscoveryEngineChatEngine) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DiscoveryEngineChatEngine) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DiscoveryEngineChatEngine) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/discovery_engine_chat_engine google_discovery_engine_chat_engine} Resource.
...
func (j *jsiiProxy_DiscoveryEngineChatEngine)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DiscoveryEngineChatEngine)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DiscoveryEngineChatEngine)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DiscoveryEngineChatEngine_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DiscoveryEngineChatEngine) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DiscoveryEngineChatEngine) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DiscoveryEngineChatEngine) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DiscoveryEngineChatEngine) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DiscoveryEngineChatEngine) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DiscoveryEngineChatEngine) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
