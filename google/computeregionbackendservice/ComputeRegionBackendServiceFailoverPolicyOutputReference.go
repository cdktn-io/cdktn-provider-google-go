...
func (c *jsiiProxy_ComputeRegionBackendServiceFailoverPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeRegionBackendServiceFailoverPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
