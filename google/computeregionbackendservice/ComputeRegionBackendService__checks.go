...
func (c *jsiiProxy_ComputeRegionBackendService) validatePutBackendParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ComputeRegionBackendServiceBackend; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ComputeRegionBackendService) validatePutCustomMetricsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ComputeRegionBackendServiceCustomMetrics; received %#v (a %T)", value, value)
		}
	}
