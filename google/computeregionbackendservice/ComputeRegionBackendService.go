...
func (j *jsiiProxy_ComputeRegionBackendService) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ComputeRegionBackendService) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_ComputeRegionBackendService)SetDeletionPolicy(val *string) {
...
func (c *jsiiProxy_ComputeRegionBackendService) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputeRegionBackendService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputeRegionBackendService) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeRegionBackendService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
