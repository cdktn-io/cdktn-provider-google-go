...
func (c *jsiiProxy_ComputeRegionBackendServiceStrongSessionAffinityCookieOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeRegionBackendServiceStrongSessionAffinityCookieOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
