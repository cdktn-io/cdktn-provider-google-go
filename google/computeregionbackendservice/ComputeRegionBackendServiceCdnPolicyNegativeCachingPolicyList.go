...
func (j *jsiiProxy_ComputeRegionBackendServiceCdnPolicyNegativeCachingPolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewComputeRegionBackendServiceCdnPolicyNegativeCachingPolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ComputeRegionBackendServiceCdnPolicyNegativeCachingPolicyList {
	_init_.Initialize()
...
func NewComputeRegionBackendServiceCdnPolicyNegativeCachingPolicyList_Override(c ComputeRegionBackendServiceCdnPolicyNegativeCachingPolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComputeRegionBackendServiceCdnPolicyNegativeCachingPolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ComputeRegionBackendServiceCdnPolicyNegativeCachingPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ComputeRegionBackendServiceCdnPolicyNegativeCachingPolicyList) Resolve(context cdktn.IResolveContext) interface{} {
