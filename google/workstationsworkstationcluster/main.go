...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetWorkstationAuthorizationUrl", GoMethod: "ResetWorkstationAuthorizationUrl"},
			_jsii_.MemberMethod{JsiiMethod: "resetWorkstationLaunchUrl", GoMethod: "ResetWorkstationLaunchUrl"},
			...
			_jsii_.MemberProperty{JsiiProperty: "workstationAuthorizationUrl", GoGetter: "WorkstationAuthorizationUrl"},
			_jsii_.MemberProperty{JsiiProperty: "workstationAuthorizationUrlInput", GoGetter: "WorkstationAuthorizationUrlInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "workstationLaunchUrl", GoGetter: "WorkstationLaunchUrl"},
			_jsii_.MemberProperty{JsiiProperty: "workstationLaunchUrlInput", GoGetter: "WorkstationLaunchUrlInput"},
		},
		func() interface{} {
