...
type DataprocMetastoreDatabaseIamBindingConfig struct {
	// Experimental.
	...
	Condition *DataprocMetastoreDatabaseIamBindingCondition `field:"optional" json:"condition" yaml:"condition"`
