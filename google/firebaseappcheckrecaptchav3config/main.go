...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "siteSecret", GoGetter: "SiteSecret"},
			_jsii_.MemberProperty{JsiiProperty: "siteSecretInput", GoGetter: "SiteSecretInput"},
			_jsii_.MemberProperty{JsiiProperty: "siteSecretSet", GoGetter: "SiteSecretSet"},
