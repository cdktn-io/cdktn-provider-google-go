...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/networksecuritymirroringdeployment/internal"
...
func (j *jsiiProxy_NetworkSecurityMirroringDeployment) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_NetworkSecurityMirroringDeployment) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_NetworkSecurityMirroringDeployment)SetDeletionPolicy(val *string) {
...
func (n *jsiiProxy_NetworkSecurityMirroringDeployment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkSecurityMirroringDeployment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkSecurityMirroringDeployment) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		n,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkSecurityMirroringDeployment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
