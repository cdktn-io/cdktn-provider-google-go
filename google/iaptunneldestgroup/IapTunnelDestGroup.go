...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/iap_tunnel_dest_group google_iap_tunnel_dest_group} Resource.
...
func (i *jsiiProxy_IapTunnelDestGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IapTunnelDestGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IapTunnelDestGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
