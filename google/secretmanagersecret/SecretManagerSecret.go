...
func (j *jsiiProxy_SecretManagerSecret) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_SecretManagerSecret) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/secret_manager_secret google_secret_manager_secret} Resource.
...
func (j *jsiiProxy_SecretManagerSecret)SetDeletionPolicy(val *string) {
...
func (s *jsiiProxy_SecretManagerSecret) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecretManagerSecret) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecretManagerSecret) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		s,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (s *jsiiProxy_SecretManagerSecret) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
