...
func (j *jsiiProxy_FirebaseAppHostingDomainCustomDomainStatusOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFirebaseAppHostingDomainCustomDomainStatusOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FirebaseAppHostingDomainCustomDomainStatusOutputReference {
	_init_.Initialize()
...
func NewFirebaseAppHostingDomainCustomDomainStatusOutputReference_Override(f FirebaseAppHostingDomainCustomDomainStatusOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FirebaseAppHostingDomainCustomDomainStatusOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FirebaseAppHostingDomainCustomDomainStatusOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirebaseAppHostingDomainCustomDomainStatusOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FirebaseAppHostingDomainCustomDomainStatusOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirebaseAppHostingDomainCustomDomainStatusOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
