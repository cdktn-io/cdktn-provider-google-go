...
func (j *jsiiProxy_KmsCryptoKeyPrimaryList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKmsCryptoKeyPrimaryList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KmsCryptoKeyPrimaryList {
	_init_.Initialize()
...
func NewKmsCryptoKeyPrimaryList_Override(k KmsCryptoKeyPrimaryList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KmsCryptoKeyPrimaryList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KmsCryptoKeyPrimaryList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KmsCryptoKeyPrimaryList) Resolve(context cdktn.IResolveContext) interface{} {
