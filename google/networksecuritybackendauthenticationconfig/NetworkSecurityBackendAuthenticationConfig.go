...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/network_security_backend_authentication_config google_network_security_backend_authentication_config} Resource.
...
func (n *jsiiProxy_NetworkSecurityBackendAuthenticationConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkSecurityBackendAuthenticationConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkSecurityBackendAuthenticationConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
