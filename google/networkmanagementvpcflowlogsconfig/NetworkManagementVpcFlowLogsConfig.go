...
func (j *jsiiProxy_NetworkManagementVpcFlowLogsConfig) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_NetworkManagementVpcFlowLogsConfig) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_NetworkManagementVpcFlowLogsConfig)SetDeletionPolicy(val *string) {
...
func (n *jsiiProxy_NetworkManagementVpcFlowLogsConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkManagementVpcFlowLogsConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkManagementVpcFlowLogsConfig) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		n,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkManagementVpcFlowLogsConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
