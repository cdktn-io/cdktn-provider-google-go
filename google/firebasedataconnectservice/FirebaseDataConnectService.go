...
type FirebaseDataConnectService interface {
	...
	PutTimeouts(value *FirebaseDataConnectServiceTimeouts)
...
func (j *jsiiProxy_FirebaseDataConnectService) AnnotationsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"annotationsInput",
...
func (j *jsiiProxy_FirebaseDataConnectService) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_FirebaseDataConnectService) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_FirebaseDataConnectService) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_FirebaseDataConnectService) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_FirebaseDataConnectService) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_FirebaseDataConnectService) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_FirebaseDataConnectService) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_FirebaseDataConnectService) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_FirebaseDataConnectService) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_FirebaseDataConnectService) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_FirebaseDataConnectService) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_FirebaseDataConnectService) Labels() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labels",
...
func (j *jsiiProxy_FirebaseDataConnectService) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_FirebaseDataConnectService) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_FirebaseDataConnectService) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_FirebaseDataConnectService) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_FirebaseDataConnectService) Node() constructs.Node {
...
func (j *jsiiProxy_FirebaseDataConnectService) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_FirebaseDataConnectService) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_FirebaseDataConnectService) ServiceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceId",
...
func (j *jsiiProxy_FirebaseDataConnectService) ServiceIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceIdInput",
...
func (j *jsiiProxy_FirebaseDataConnectService) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FirebaseDataConnectService) Timeouts() FirebaseDataConnectServiceTimeoutsOutputReference {
	var returns FirebaseDataConnectServiceTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_FirebaseDataConnectService) Uid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uid",
...
func (j *jsiiProxy_FirebaseDataConnectService) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/firebase_data_connect_service google_firebase_data_connect_service} Resource.
func NewFirebaseDataConnectService(scope constructs.Construct, id *string, config *FirebaseDataConnectServiceConfig) FirebaseDataConnectService {
	...
	if err := validateNewFirebaseDataConnectServiceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func FirebaseDataConnectService_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-google.firebaseDataConnectService.FirebaseDataConnectService",
...
func (f *jsiiProxy_FirebaseDataConnectService) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FirebaseDataConnectService) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (f *jsiiProxy_FirebaseDataConnectService) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (f *jsiiProxy_FirebaseDataConnectService) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (f *jsiiProxy_FirebaseDataConnectService) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (f *jsiiProxy_FirebaseDataConnectService) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (f *jsiiProxy_FirebaseDataConnectService) GetStringAttribute(terraformAttribute *string) *string {
...
func (f *jsiiProxy_FirebaseDataConnectService) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (f *jsiiProxy_FirebaseDataConnectService) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FirebaseDataConnectService) MoveFromId(id *string) {
...
func (f *jsiiProxy_FirebaseDataConnectService) MoveToId(id *string) {
...
func (f *jsiiProxy_FirebaseDataConnectService) OverrideLogicalId(newLogicalId *string) {
...
func (f *jsiiProxy_FirebaseDataConnectService) PutTimeouts(value *FirebaseDataConnectServiceTimeouts) {
...
func (f *jsiiProxy_FirebaseDataConnectService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FirebaseDataConnectService) ResetAnnotations() {
	_jsii_.InvokeVoid(
		f,
		"resetAnnotations",
		nil, // no parameters
...
func (f *jsiiProxy_FirebaseDataConnectService) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		f,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (f *jsiiProxy_FirebaseDataConnectService) ResetDisplayName() {
	_jsii_.InvokeVoid(
		f,
		"resetDisplayName",
		nil, // no parameters
...
func (f *jsiiProxy_FirebaseDataConnectService) ResetId() {
	_jsii_.InvokeVoid(
		f,
		"resetId",
		nil, // no parameters
...
func (f *jsiiProxy_FirebaseDataConnectService) ResetLabels() {
	_jsii_.InvokeVoid(
		f,
		"resetLabels",
		nil, // no parameters
...
func (f *jsiiProxy_FirebaseDataConnectService) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		f,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (f *jsiiProxy_FirebaseDataConnectService) ResetProject() {
	_jsii_.InvokeVoid(
		f,
		"resetProject",
		nil, // no parameters
...
func (f *jsiiProxy_FirebaseDataConnectService) ResetTimeouts() {
	_jsii_.InvokeVoid(
		f,
		"resetTimeouts",
		nil, // no parameters
...
func (f *jsiiProxy_FirebaseDataConnectService) ToString() *string {
	var returns *string
...
func (f *jsiiProxy_FirebaseDataConnectService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
