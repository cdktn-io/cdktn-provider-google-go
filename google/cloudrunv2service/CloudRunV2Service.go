...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/cloud_run_v2_service google_cloud_run_v2_service}.
...
func (j *jsiiProxy_CloudRunV2Service) Tags() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_CloudRunV2Service) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/cloud_run_v2_service google_cloud_run_v2_service} Resource.
...
func (j *jsiiProxy_CloudRunV2Service)SetTags(val *map[string]*string) {
...
func (c *jsiiProxy_CloudRunV2Service) ResetTags() {
	_jsii_.InvokeVoid(
		c,
		"resetTags",
		nil, // no parameters
