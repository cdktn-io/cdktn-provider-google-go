...
func (c *jsiiProxy_CloudRunV2ServiceTemplateVpcAccessOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudRunV2ServiceTemplateVpcAccessOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
