...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/document_ai_warehouse_location google_document_ai_warehouse_location} Resource.
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DocumentAiWarehouseLocation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
