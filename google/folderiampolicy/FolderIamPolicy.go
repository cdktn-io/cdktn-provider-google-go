...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/folderiampolicy/internal"
...
func (j *jsiiProxy_FolderIamPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FolderIamPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FolderIamPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FolderIamPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FolderIamPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/folder_iam_policy google_folder_iam_policy} Resource.
...
func (j *jsiiProxy_FolderIamPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FolderIamPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FolderIamPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func FolderIamPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (f *jsiiProxy_FolderIamPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FolderIamPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FolderIamPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FolderIamPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FolderIamPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FolderIamPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
