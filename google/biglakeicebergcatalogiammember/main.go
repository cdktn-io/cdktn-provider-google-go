...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BiglakeIcebergCatalogIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.biglakeIcebergCatalogIamMember.BiglakeIcebergCatalogIamMemberCondition",
		reflect.TypeOf((*BiglakeIcebergCatalogIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.biglakeIcebergCatalogIamMember.BiglakeIcebergCatalogIamMemberConditionOutputReference",
		reflect.TypeOf((*BiglakeIcebergCatalogIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_BiglakeIcebergCatalogIamMemberConditionOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.biglakeIcebergCatalogIamMember.BiglakeIcebergCatalogIamMemberConfig",
		reflect.TypeOf((*BiglakeIcebergCatalogIamMemberConfig)(nil)).Elem(),
	)
}
