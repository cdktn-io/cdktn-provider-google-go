...
func (c *jsiiProxy_ComputeRouterNat) validatePutNat64SubnetworkParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ComputeRouterNatNat64Subnetwork; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ComputeRouterNat) validatePutRulesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ComputeRouterNatRules; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ComputeRouterNat) validatePutSubnetworkParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ComputeRouterNatSubnetwork; received %#v (a %T)", value, value)
		}
	}
