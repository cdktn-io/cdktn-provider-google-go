...
func (f *jsiiProxy_FirebaseAppCheckResourcePolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FirebaseAppCheckResourcePolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
