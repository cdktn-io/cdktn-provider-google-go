...
func (j *jsiiProxy_CertificateManagerCertificateMapEntry) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_CertificateManagerCertificateMapEntry) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_CertificateManagerCertificateMapEntry)SetDeletionPolicy(val *string) {
...
func (c *jsiiProxy_CertificateManagerCertificateMapEntry) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CertificateManagerCertificateMapEntry) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CertificateManagerCertificateMapEntry) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_CertificateManagerCertificateMapEntry) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
