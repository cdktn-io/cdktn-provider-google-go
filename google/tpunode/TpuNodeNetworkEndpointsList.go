...
func (j *jsiiProxy_TpuNodeNetworkEndpointsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTpuNodeNetworkEndpointsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TpuNodeNetworkEndpointsList {
	_init_.Initialize()
...
func NewTpuNodeNetworkEndpointsList_Override(t TpuNodeNetworkEndpointsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TpuNodeNetworkEndpointsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TpuNodeNetworkEndpointsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (t *jsiiProxy_TpuNodeNetworkEndpointsList) Resolve(context cdktn.IResolveContext) interface{} {
