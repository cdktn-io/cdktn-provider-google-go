...
func (c *jsiiProxy_ComputeRouterPeer) validatePutAdvertisedIpRangesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ComputeRouterPeerAdvertisedIpRanges; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ComputeRouterPeer) validatePutCustomLearnedIpRangesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ComputeRouterPeerCustomLearnedIpRanges; received %#v (a %T)", value, value)
		}
	}
