...
func (d *jsiiProxy_DiscoveryEngineLicenseConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DiscoveryEngineLicenseConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
