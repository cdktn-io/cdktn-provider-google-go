...
func (j *jsiiProxy_NetworkServicesTlsRoute) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_NetworkServicesTlsRoute) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/network_services_tls_route google_network_services_tls_route} Resource.
...
func (j *jsiiProxy_NetworkServicesTlsRoute)SetDeletionPolicy(val *string) {
...
func (n *jsiiProxy_NetworkServicesTlsRoute) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkServicesTlsRoute) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkServicesTlsRoute) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		n,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkServicesTlsRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
