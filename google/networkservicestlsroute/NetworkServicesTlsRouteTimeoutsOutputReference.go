...
func (n *jsiiProxy_NetworkServicesTlsRouteTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkServicesTlsRouteTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
