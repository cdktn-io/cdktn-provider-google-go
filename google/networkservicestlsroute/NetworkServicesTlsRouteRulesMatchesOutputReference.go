...
func (n *jsiiProxy_NetworkServicesTlsRouteRulesMatchesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkServicesTlsRouteRulesMatchesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
