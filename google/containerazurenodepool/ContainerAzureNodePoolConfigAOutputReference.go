...
func (c *jsiiProxy_ContainerAzureNodePoolConfigAOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerAzureNodePoolConfigAOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
