...
func (j *jsiiProxy_ComputeAutoscalerAutoscalingPolicyMetricList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewComputeAutoscalerAutoscalingPolicyMetricList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ComputeAutoscalerAutoscalingPolicyMetricList {
	_init_.Initialize()
...
func NewComputeAutoscalerAutoscalingPolicyMetricList_Override(c ComputeAutoscalerAutoscalingPolicyMetricList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComputeAutoscalerAutoscalingPolicyMetricList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ComputeAutoscalerAutoscalingPolicyMetricList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ComputeAutoscalerAutoscalingPolicyMetricList) Resolve(context cdktn.IResolveContext) interface{} {
