...
func (j *jsiiProxy_ComputePacketMirroringMirroredResourcesInstancesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewComputePacketMirroringMirroredResourcesInstancesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ComputePacketMirroringMirroredResourcesInstancesList {
	_init_.Initialize()
...
func NewComputePacketMirroringMirroredResourcesInstancesList_Override(c ComputePacketMirroringMirroredResourcesInstancesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComputePacketMirroringMirroredResourcesInstancesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ComputePacketMirroringMirroredResourcesInstancesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ComputePacketMirroringMirroredResourcesInstancesList) Resolve(context cdktn.IResolveContext) interface{} {
