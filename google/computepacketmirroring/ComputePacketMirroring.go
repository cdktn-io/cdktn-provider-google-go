...
func (j *jsiiProxy_ComputePacketMirroring) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ComputePacketMirroring) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ComputePacketMirroring) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_ComputePacketMirroring) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ComputePacketMirroring) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ComputePacketMirroring) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ComputePacketMirroring) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/compute_packet_mirroring google_compute_packet_mirroring} Resource.
...
func (j *jsiiProxy_ComputePacketMirroring)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_ComputePacketMirroring)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ComputePacketMirroring)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ComputePacketMirroring)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ComputePacketMirroring_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ComputePacketMirroring) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputePacketMirroring) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ComputePacketMirroring) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ComputePacketMirroring) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputePacketMirroring) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputePacketMirroring) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_ComputePacketMirroring) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
