...
type CloudSupportSupportEventSubscriptionConfig struct {
	// Experimental.
	...
	Timeouts *CloudSupportSupportEventSubscriptionTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
