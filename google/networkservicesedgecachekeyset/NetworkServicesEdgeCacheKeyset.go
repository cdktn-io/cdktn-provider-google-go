...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/network_services_edge_cache_keyset google_network_services_edge_cache_keyset} Resource.
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeyset) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
