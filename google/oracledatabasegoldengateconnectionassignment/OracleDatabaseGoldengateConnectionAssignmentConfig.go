...
type OracleDatabaseGoldengateConnectionAssignmentConfig struct {
	// Experimental.
	...
	Properties *OracleDatabaseGoldengateConnectionAssignmentProperties `field:"required" json:"properties" yaml:"properties"`
	...
	Timeouts *OracleDatabaseGoldengateConnectionAssignmentTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
