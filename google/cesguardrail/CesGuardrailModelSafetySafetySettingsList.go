...
func (j *jsiiProxy_CesGuardrailModelSafetySafetySettingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCesGuardrailModelSafetySafetySettingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CesGuardrailModelSafetySafetySettingsList {
	_init_.Initialize()
...
func NewCesGuardrailModelSafetySafetySettingsList_Override(c CesGuardrailModelSafetySafetySettingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CesGuardrailModelSafetySafetySettingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CesGuardrailModelSafetySafetySettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CesGuardrailModelSafetySafetySettingsList) Resolve(context cdktn.IResolveContext) interface{} {
