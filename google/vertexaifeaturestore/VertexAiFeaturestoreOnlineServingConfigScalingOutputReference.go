...
func (v *jsiiProxy_VertexAiFeaturestoreOnlineServingConfigScalingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VertexAiFeaturestoreOnlineServingConfigScalingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
