...
func (j *jsiiProxy_ComputeNetworkAttachment) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_ComputeNetworkAttachment) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_ComputeNetworkAttachment)SetDeletionPolicy(val *string) {
...
func (c *jsiiProxy_ComputeNetworkAttachment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputeNetworkAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputeNetworkAttachment) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeNetworkAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
