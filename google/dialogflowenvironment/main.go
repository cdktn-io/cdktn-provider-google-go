...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "fulfillment", GoGetter: "Fulfillment"},
			_jsii_.MemberProperty{JsiiProperty: "fulfillmentInput", GoGetter: "FulfillmentInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putFulfillment", GoMethod: "PutFulfillment"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "enableTextToSpeech", GoGetter: "EnableTextToSpeech"},
			_jsii_.MemberProperty{JsiiProperty: "enableTextToSpeechInput", GoGetter: "EnableTextToSpeechInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "outputAudioEncoding", GoGetter: "OutputAudioEncoding"},
			_jsii_.MemberProperty{JsiiProperty: "outputAudioEncodingInput", GoGetter: "OutputAudioEncodingInput"},
			_jsii_.MemberMethod{JsiiMethod: "putSynthesizeSpeechConfigs", GoMethod: "PutSynthesizeSpeechConfigs"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnableTextToSpeech", GoMethod: "ResetEnableTextToSpeech"},
			_jsii_.MemberMethod{JsiiMethod: "resetOutputAudioEncoding", GoMethod: "ResetOutputAudioEncoding"},
