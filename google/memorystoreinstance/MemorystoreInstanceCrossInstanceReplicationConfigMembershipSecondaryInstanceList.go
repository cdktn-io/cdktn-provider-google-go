...
func (j *jsiiProxy_MemorystoreInstanceCrossInstanceReplicationConfigMembershipSecondaryInstanceList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewMemorystoreInstanceCrossInstanceReplicationConfigMembershipSecondaryInstanceList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MemorystoreInstanceCrossInstanceReplicationConfigMembershipSecondaryInstanceList {
	_init_.Initialize()
...
func NewMemorystoreInstanceCrossInstanceReplicationConfigMembershipSecondaryInstanceList_Override(m MemorystoreInstanceCrossInstanceReplicationConfigMembershipSecondaryInstanceList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MemorystoreInstanceCrossInstanceReplicationConfigMembershipSecondaryInstanceList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (m *jsiiProxy_MemorystoreInstanceCrossInstanceReplicationConfigMembershipSecondaryInstanceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MemorystoreInstanceCrossInstanceReplicationConfigMembershipSecondaryInstanceList) Resolve(context cdktf.IResolveContext) interface{} {
