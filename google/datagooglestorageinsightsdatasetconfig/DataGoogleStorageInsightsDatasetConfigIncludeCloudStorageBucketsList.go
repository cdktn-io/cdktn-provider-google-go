...
func (j *jsiiProxy_DataGoogleStorageInsightsDatasetConfigIncludeCloudStorageBucketsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleStorageInsightsDatasetConfigIncludeCloudStorageBucketsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleStorageInsightsDatasetConfigIncludeCloudStorageBucketsList {
	_init_.Initialize()
...
func NewDataGoogleStorageInsightsDatasetConfigIncludeCloudStorageBucketsList_Override(d DataGoogleStorageInsightsDatasetConfigIncludeCloudStorageBucketsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleStorageInsightsDatasetConfigIncludeCloudStorageBucketsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleStorageInsightsDatasetConfigIncludeCloudStorageBucketsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleStorageInsightsDatasetConfigIncludeCloudStorageBucketsList) Resolve(context cdktf.IResolveContext) interface{} {
