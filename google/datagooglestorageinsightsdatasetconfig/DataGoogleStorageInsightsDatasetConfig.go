...
func (j *jsiiProxy_DataGoogleStorageInsightsDatasetConfig) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/data-sources/storage_insights_dataset_config google_storage_insights_dataset_config} Data Source.
...
func (d *jsiiProxy_DataGoogleStorageInsightsDatasetConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
