...
func (j *jsiiProxy_EventarcPipeline) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EventarcPipeline) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_EventarcPipeline) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_EventarcPipeline) EffectiveAnnotations() cdktn.StringMap {
...
func (j *jsiiProxy_EventarcPipeline) EffectiveLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"effectiveLabels",
...
func (j *jsiiProxy_EventarcPipeline) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EventarcPipeline) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EventarcPipeline) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EventarcPipeline) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_EventarcPipeline) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_EventarcPipeline)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_EventarcPipeline)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EventarcPipeline)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EventarcPipeline)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EventarcPipeline_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EventarcPipeline) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventarcPipeline) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EventarcPipeline) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventarcPipeline) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EventarcPipeline) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EventarcPipeline) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		e,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (e *jsiiProxy_EventarcPipeline) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
