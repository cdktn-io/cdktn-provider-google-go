...
func (j *jsiiProxy_ComputeNetworkFirewallPolicyWithRulesRuleMatchSrcSecureTagList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewComputeNetworkFirewallPolicyWithRulesRuleMatchSrcSecureTagList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ComputeNetworkFirewallPolicyWithRulesRuleMatchSrcSecureTagList {
	_init_.Initialize()
...
func NewComputeNetworkFirewallPolicyWithRulesRuleMatchSrcSecureTagList_Override(c ComputeNetworkFirewallPolicyWithRulesRuleMatchSrcSecureTagList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComputeNetworkFirewallPolicyWithRulesRuleMatchSrcSecureTagList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ComputeNetworkFirewallPolicyWithRulesRuleMatchSrcSecureTagList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ComputeNetworkFirewallPolicyWithRulesRuleMatchSrcSecureTagList) Resolve(context cdktn.IResolveContext) interface{} {
