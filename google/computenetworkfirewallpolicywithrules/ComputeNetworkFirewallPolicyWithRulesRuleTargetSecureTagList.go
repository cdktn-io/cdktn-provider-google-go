...
func (j *jsiiProxy_ComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList {
	_init_.Initialize()
...
func NewComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList_Override(c ComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList) Resolve(context cdktn.IResolveContext) interface{} {
