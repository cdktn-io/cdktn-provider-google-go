...
func (c *jsiiProxy_Cloudbuildv2ConnectionGithubConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_Cloudbuildv2ConnectionGithubConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
