...
func (c *jsiiProxy_Cloudbuildv2ConnectionGithubEnterpriseConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_Cloudbuildv2ConnectionGithubEnterpriseConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
