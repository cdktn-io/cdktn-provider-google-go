...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/cloudbuildv2connection/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/cloudbuildv2_connection google_cloudbuildv2_connection}.
...
func (j *jsiiProxy_Cloudbuildv2Connection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Cloudbuildv2Connection) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_Cloudbuildv2Connection) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_Cloudbuildv2Connection) EffectiveAnnotations() cdktn.StringMap {
...
func (j *jsiiProxy_Cloudbuildv2Connection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Cloudbuildv2Connection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Cloudbuildv2Connection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Cloudbuildv2Connection) Reconciling() cdktn.IResolvable {
...
func (j *jsiiProxy_Cloudbuildv2Connection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/cloudbuildv2_connection google_cloudbuildv2_connection} Resource.
...
func (j *jsiiProxy_Cloudbuildv2Connection)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_Cloudbuildv2Connection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Cloudbuildv2Connection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Cloudbuildv2Connection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a Cloudbuildv2Connection resource upon running "cdktn plan <stack-name>".
func Cloudbuildv2Connection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_Cloudbuildv2Connection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_Cloudbuildv2Connection) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_Cloudbuildv2Connection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_Cloudbuildv2Connection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_Cloudbuildv2Connection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_Cloudbuildv2Connection) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		c,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (c *jsiiProxy_Cloudbuildv2Connection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
