...
type CesAppVersionSnapshotAgentsRemoteDialogflowAgentOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InputVariableMapping() cdktn.StringMap
	...
	OutputVariableMapping() cdktn.StringMap
	// Experimental.
...
func (j *jsiiProxy_CesAppVersionSnapshotAgentsRemoteDialogflowAgentOutputReference) InputVariableMapping() cdktn.StringMap {
...
func (j *jsiiProxy_CesAppVersionSnapshotAgentsRemoteDialogflowAgentOutputReference) OutputVariableMapping() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CesAppVersionSnapshotAgentsRemoteDialogflowAgentOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCesAppVersionSnapshotAgentsRemoteDialogflowAgentOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CesAppVersionSnapshotAgentsRemoteDialogflowAgentOutputReference {
	_init_.Initialize()
...
func NewCesAppVersionSnapshotAgentsRemoteDialogflowAgentOutputReference_Override(c CesAppVersionSnapshotAgentsRemoteDialogflowAgentOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CesAppVersionSnapshotAgentsRemoteDialogflowAgentOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CesAppVersionSnapshotAgentsRemoteDialogflowAgentOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CesAppVersionSnapshotAgentsRemoteDialogflowAgentOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CesAppVersionSnapshotAgentsRemoteDialogflowAgentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CesAppVersionSnapshotAgentsRemoteDialogflowAgentOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
