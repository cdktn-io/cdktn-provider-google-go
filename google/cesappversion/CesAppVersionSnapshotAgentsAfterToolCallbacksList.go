...
func (j *jsiiProxy_CesAppVersionSnapshotAgentsAfterToolCallbacksList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CesAppVersionSnapshotAgentsAfterToolCallbacksList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_CesAppVersionSnapshotAgentsAfterToolCallbacksList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_CesAppVersionSnapshotAgentsAfterToolCallbacksList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_CesAppVersionSnapshotAgentsAfterToolCallbacksList)SetWrapsSet(val *bool) {
...
func (c *jsiiProxy_CesAppVersionSnapshotAgentsAfterToolCallbacksList) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CesAppVersionSnapshotAgentsAfterToolCallbacksList) Get(index *float64) CesAppVersionSnapshotAgentsAfterToolCallbacksOutputReference {
	if err := c.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns CesAppVersionSnapshotAgentsAfterToolCallbacksOutputReference
...
func (c *jsiiProxy_CesAppVersionSnapshotAgentsAfterToolCallbacksList) ToString() *string {
	var returns *string
