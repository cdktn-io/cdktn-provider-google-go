...
func (h *jsiiProxy_HealthcareHl7V2Store) validatePutNotificationConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*HealthcareHl7V2StoreNotificationConfigs; received %#v (a %T)", value, value)
		}
	}
