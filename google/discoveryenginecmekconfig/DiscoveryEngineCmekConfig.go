...
func (j *jsiiProxy_DiscoveryEngineCmekConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DiscoveryEngineCmekConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DiscoveryEngineCmekConfig) IsDefault() cdktn.IResolvable {
...
func (j *jsiiProxy_DiscoveryEngineCmekConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DiscoveryEngineCmekConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DiscoveryEngineCmekConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DiscoveryEngineCmekConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DiscoveryEngineCmekConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DiscoveryEngineCmekConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DiscoveryEngineCmekConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DiscoveryEngineCmekConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DiscoveryEngineCmekConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DiscoveryEngineCmekConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DiscoveryEngineCmekConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DiscoveryEngineCmekConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DiscoveryEngineCmekConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
