...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "classMethod", GoGetter: "ClassMethod"},
			_jsii_.MemberProperty{JsiiProperty: "classMethodInput", GoGetter: "ClassMethodInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "reasoningEngineId", GoGetter: "ReasoningEngineId"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dataGoogleVertexAiReasoningEngineQuery.DataGoogleVertexAiReasoningEngineQueryConfig",
