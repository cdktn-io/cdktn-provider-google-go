...
func (j *jsiiProxy_DiscoveryEngineRecommendationEngine) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DiscoveryEngineRecommendationEngine) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DiscoveryEngineRecommendationEngine) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DiscoveryEngineRecommendationEngine) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DiscoveryEngineRecommendationEngine) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/discovery_engine_recommendation_engine google_discovery_engine_recommendation_engine} Resource.
...
func (j *jsiiProxy_DiscoveryEngineRecommendationEngine)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DiscoveryEngineRecommendationEngine)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DiscoveryEngineRecommendationEngine)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DiscoveryEngineRecommendationEngine_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DiscoveryEngineRecommendationEngine) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DiscoveryEngineRecommendationEngine) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DiscoveryEngineRecommendationEngine) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DiscoveryEngineRecommendationEngine) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DiscoveryEngineRecommendationEngine) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DiscoveryEngineRecommendationEngine) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
