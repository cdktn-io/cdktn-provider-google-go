...
func (b *jsiiProxy_BeyondcorpSecurityGatewayApplicationEndpointMatchersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BeyondcorpSecurityGatewayApplicationEndpointMatchersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
