...
func (j *jsiiProxy_BeyondcorpSecurityGatewayApplicationEndpointMatchersOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBeyondcorpSecurityGatewayApplicationEndpointMatchersOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BeyondcorpSecurityGatewayApplicationEndpointMatchersOutputReference {
	_init_.Initialize()
...
func NewBeyondcorpSecurityGatewayApplicationEndpointMatchersOutputReference_Override(b BeyondcorpSecurityGatewayApplicationEndpointMatchersOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BeyondcorpSecurityGatewayApplicationEndpointMatchersOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BeyondcorpSecurityGatewayApplicationEndpointMatchersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BeyondcorpSecurityGatewayApplicationEndpointMatchersOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BeyondcorpSecurityGatewayApplicationEndpointMatchersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
