...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IapWebBackendServiceIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.iapWebBackendServiceIamMember.IapWebBackendServiceIamMemberCondition",
		reflect.TypeOf((*IapWebBackendServiceIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google.iapWebBackendServiceIamMember.IapWebBackendServiceIamMemberConditionOutputReference",
		reflect.TypeOf((*IapWebBackendServiceIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.iapWebBackendServiceIamMember.IapWebBackendServiceIamMemberConfig",
		reflect.TypeOf((*IapWebBackendServiceIamMemberConfig)(nil)).Elem(),
	)
}
