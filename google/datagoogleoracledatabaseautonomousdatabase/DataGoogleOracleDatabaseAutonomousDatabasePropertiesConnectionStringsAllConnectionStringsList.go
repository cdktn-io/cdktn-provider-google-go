...
func (d *jsiiProxy_DataGoogleOracleDatabaseAutonomousDatabasePropertiesConnectionStringsAllConnectionStringsList) Resolve(context cdktf.IResolveContext) interface{} {
