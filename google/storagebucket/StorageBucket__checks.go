...
func (s *jsiiProxy_StorageBucket) validatePutCorsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*StorageBucketCors; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_StorageBucket) validatePutLifecycleRuleParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*StorageBucketLifecycleRule; received %#v (a %T)", value, value)
		}
	}
