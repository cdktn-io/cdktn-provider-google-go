...
func (j *jsiiProxy_StorageBucketCorsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageBucketCorsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) StorageBucketCorsOutputReference {
	_init_.Initialize()
...
func NewStorageBucketCorsOutputReference_Override(s StorageBucketCorsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageBucketCorsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageBucketCorsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageBucketCorsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StorageBucketCorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageBucketCorsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
