...
func (s *jsiiProxy_StorageBucketCorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageBucketCorsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
