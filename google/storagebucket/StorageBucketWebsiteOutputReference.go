...
func (s *jsiiProxy_StorageBucketWebsiteOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageBucketWebsiteOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
