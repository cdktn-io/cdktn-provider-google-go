...
func (w *jsiiProxy_WorkbenchInstanceGceSetupOutputReference) validatePutAcceleratorConfigsParameters(value interface{}) error {
	...
	case []*WorkbenchInstanceGceSetupAcceleratorConfigs:
		value_ := value.([]*WorkbenchInstanceGceSetupAcceleratorConfigs)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (w *jsiiProxy_WorkbenchInstanceGceSetupOutputReference) validatePutNetworkInterfacesParameters(value interface{}) error {
	...
	case []*WorkbenchInstanceGceSetupNetworkInterfaces:
		value_ := value.([]*WorkbenchInstanceGceSetupNetworkInterfaces)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (w *jsiiProxy_WorkbenchInstanceGceSetupOutputReference) validatePutServiceAccountsParameters(value interface{}) error {
	...
	case []*WorkbenchInstanceGceSetupServiceAccounts:
		value_ := value.([]*WorkbenchInstanceGceSetupServiceAccounts)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
