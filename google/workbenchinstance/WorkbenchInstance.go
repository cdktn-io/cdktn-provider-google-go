...
func (j *jsiiProxy_WorkbenchInstance) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WorkbenchInstance) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_WorkbenchInstance) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WorkbenchInstance) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WorkbenchInstance) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WorkbenchInstance) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_WorkbenchInstance) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/workbench_instance google_workbench_instance} Resource.
...
func (j *jsiiProxy_WorkbenchInstance)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WorkbenchInstance)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WorkbenchInstance)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WorkbenchInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WorkbenchInstance) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WorkbenchInstance) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WorkbenchInstance) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WorkbenchInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WorkbenchInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WorkbenchInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
