...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleDiscoveryEngineSearchEngineIamPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dataGoogleDiscoveryEngineSearchEngineIamPolicy.DataGoogleDiscoveryEngineSearchEngineIamPolicyConfig",
		reflect.TypeOf((*DataGoogleDiscoveryEngineSearchEngineIamPolicyConfig)(nil)).Elem(),
	)
}
