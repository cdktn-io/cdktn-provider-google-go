...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allowedValuesRegexInput", GoGetter: "AllowedValuesRegexInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAllowedValuesRegex", GoMethod: "ResetAllowedValuesRegex"},
