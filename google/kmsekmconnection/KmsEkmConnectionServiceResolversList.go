...
func (j *jsiiProxy_KmsEkmConnectionServiceResolversList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKmsEkmConnectionServiceResolversList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KmsEkmConnectionServiceResolversList {
	_init_.Initialize()
...
func NewKmsEkmConnectionServiceResolversList_Override(k KmsEkmConnectionServiceResolversList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KmsEkmConnectionServiceResolversList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KmsEkmConnectionServiceResolversList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KmsEkmConnectionServiceResolversList) Resolve(context cdktn.IResolveContext) interface{} {
