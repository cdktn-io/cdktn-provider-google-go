...
func (j *jsiiProxy_OsConfigPatchDeployment) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_OsConfigPatchDeployment) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_OsConfigPatchDeployment)SetDeletionPolicy(val *string) {
...
func (o *jsiiProxy_OsConfigPatchDeployment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OsConfigPatchDeployment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_OsConfigPatchDeployment) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		o,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (o *jsiiProxy_OsConfigPatchDeployment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
