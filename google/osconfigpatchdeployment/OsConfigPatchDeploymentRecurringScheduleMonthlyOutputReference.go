...
func (o *jsiiProxy_OsConfigPatchDeploymentRecurringScheduleMonthlyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OsConfigPatchDeploymentRecurringScheduleMonthlyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
