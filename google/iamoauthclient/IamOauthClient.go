...
func (j *jsiiProxy_IamOauthClient) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IamOauthClient) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IamOauthClient) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamOauthClient) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IamOauthClient) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/iam_oauth_client google_iam_oauth_client} Resource.
...
func (j *jsiiProxy_IamOauthClient)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamOauthClient)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IamOauthClient)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IamOauthClient_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamOauthClient) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamOauthClient) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IamOauthClient) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IamOauthClient) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IamOauthClient) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IamOauthClient) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
