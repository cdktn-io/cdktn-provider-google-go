...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allowedGrantTypes", GoGetter: "AllowedGrantTypes"},
			_jsii_.MemberProperty{JsiiProperty: "allowedGrantTypesInput", GoGetter: "AllowedGrantTypesInput"},
