...
import (
	...
	"github.com/cdktn-io/cdktn-provider-google-go/google/v20/bigqueryanalyticshubdataexchangeiambinding/internal"
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/bigquery_analytics_hub_data_exchange_iam_binding google_bigquery_analytics_hub_data_exchange_iam_binding} Resource.
func NewBigqueryAnalyticsHubDataExchangeIamBinding(scope constructs.Construct, id *string, config *BigqueryAnalyticsHubDataExchangeIamBindingConfig) BigqueryAnalyticsHubDataExchangeIamBinding {
	...
	_jsii_.Create(
		"@cdktn/provider-google.bigqueryAnalyticsHubDataExchangeIamBinding.BigqueryAnalyticsHubDataExchangeIamBinding",
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BigqueryAnalyticsHubDataExchangeIamBinding_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
