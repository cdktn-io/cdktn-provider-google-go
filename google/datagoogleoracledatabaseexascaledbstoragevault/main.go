...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dataGoogleOracleDatabaseExascaleDbStorageVault.DataGoogleOracleDatabaseExascaleDbStorageVaultConfig",
		reflect.TypeOf((*DataGoogleOracleDatabaseExascaleDbStorageVaultConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dataGoogleOracleDatabaseExascaleDbStorageVault.DataGoogleOracleDatabaseExascaleDbStorageVaultProperties",
		reflect.TypeOf((*DataGoogleOracleDatabaseExascaleDbStorageVaultProperties)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dataGoogleOracleDatabaseExascaleDbStorageVault.DataGoogleOracleDatabaseExascaleDbStorageVaultPropertiesExascaleDbStorageDetails",
	...
	_jsii_.RegisterClass(
		"@cdktn/provider-google.dataGoogleOracleDatabaseExascaleDbStorageVault.DataGoogleOracleDatabaseExascaleDbStorageVaultPropertiesList",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google.dataGoogleOracleDatabaseExascaleDbStorageVault.DataGoogleOracleDatabaseExascaleDbStorageVaultPropertiesTimeZone",
