...
func (j *jsiiProxy_FirebaseAppHostingBackendManagedResourcesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFirebaseAppHostingBackendManagedResourcesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirebaseAppHostingBackendManagedResourcesList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google.firebaseAppHostingBackend.FirebaseAppHostingBackendManagedResourcesList",
...
func NewFirebaseAppHostingBackendManagedResourcesList_Override(f FirebaseAppHostingBackendManagedResourcesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FirebaseAppHostingBackendManagedResourcesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FirebaseAppHostingBackendManagedResourcesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirebaseAppHostingBackendManagedResourcesList) Resolve(context cdktn.IResolveContext) interface{} {
